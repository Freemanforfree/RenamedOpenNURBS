...
class MYON_CLASS MYON_ComponentAttributes
{
public:
...
#pragma region RH_C_SHARED_ENUM [MYON_ComponentAttributes::EdgeAttributes] [Rhino.Geometry.EdgeAttributes] [int]

  /// <summary>
  /// <para>MYON_EdgeAttributeFlags are used to report attributes of single edge objects, like
  /// MYON_SubDEdge and MYON_BrepEdge, and aggregate edge demographics in objects with topology
  /// like MYON_SubD, MYON_Mesh and MYON_Brep.</para>
  /// <seealso cref="MYON_BrepEdge::EdgeFlags"/>
  /// <seealso cref="MYON_SubDEdge::EdgeFlags"/>
  /// <seealso cref="MYON_Brep::AggregateEdgeFlags"/>
  /// <seealso cref="MYON_Mesh::AggregateEdgeFlags"/>
  /// <seealso cref="MYON_SubD::AggregateEdgeFlags"/>
  /// </summary>
  enum EdgeAttributes : unsigned int
  {
    ...
    ///<summary> 
    /// MYON_ComponentAttributes::EdgeAttributes::Mask can be used to isolate EdgeAttributes bits
    /// from an unsigned int bit field containing other information.
    ///</summary>
    ///<example> 
    /// Determine if two unsigned ints have identical MYON_ComponentAttributes::EdgeAttributes settings.
    ///<code>
    /// unsigned int combined_flags1 = ...;
    /// unsigned int combined_flags2 = ...;
    /// unsigned int edge_flags1 = (MYON_ComponentAttributes::EdgeAttributes::Mask &amp; combined_flags1);
    /// unsigned int edge_flags2 = (MYON_ComponentAttributes::EdgeAttributes::Mask &amp; combined_flags2);
...
#pragma endregion
  ...
  /// </summary> 
  /// <example>  
  /// This sample shows how to determine if an MYON_SubD is a solid.
  /// <code> 
  /// MYON_SubD subd = ...;
  /// if (MYON_ComponentAttributes::IsSolid(subd.AggregateEdgeComponentAttributes())
  /// { 
  ///   // subd is a solid
  ///   ...
  /// }
  ...
  ///   Value made by bitwise or of MYON_ComponentAttributes::EdgeAttributes values for every edge in the object.
  /// </param>
  /// <returns>True if every edge has exactly two faces.</returns>
  /// <seealso cref="MYON_Brep::EdgeDemographics"/>
  /// <seealso cref="MYON_SUbD::EdgeDemographics"/>
  /// <seealso cref="MYON_Mesh::EdgeDemographics"/>
  /// <seealso cref="MYON_ComponentAttributes::IsSolid"/>
  /// <seealso cref="MYON_ComponentAttributes::IsNotSolid"/>
  /// <seealso cref="MYON_ComponentAttributes::HasBoundary"/>
  /// <seealso cref="MYON_ComponentAttributes::IsOriented"/>
  /// <seealso cref="MYON_ComponentAttributes::IsNotOriented"/>
  /// <seealso cref="MYON_ComponentAttributes::IsManifold"/>
  /// <seealso cref="MYON_ComponentAttributes::IsNotManifold"/>
  static bool IsSolid(
