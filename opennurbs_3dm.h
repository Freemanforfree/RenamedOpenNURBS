...
// derived from MYON_Object using using TCODE_OPENNURBS_CLASS chunks.
...
/* added 29 October 2002 as a chunk to hold new and future MYON_3dmSettings information */
#define TCODE_SETTINGS_ATTRIBUTES             (TCODE_TABLEREC | TCODE_CRC   | 0x0134)
/* 2016-Nov-28 RH-33298 MYON_3dmRenderSettings user data in MYON_3dmSettings.m_RenderSettings */
...
/* added 29 October 2002 as a chunk to hold new and future MYON_3dmView information */
#define TCODE_VIEW_ATTRIBUTES        (TCODE_TABLEREC | TCODE_CRC   | 0x0C3B)

/* added 27 June 2008 as a chunk to hold userdata on MYON_Viewports saved in named view list */
#define TCODE_VIEW_VIEWPORT_USERDATA (TCODE_TABLEREC | TCODE_CRC   | 0x0D3B)

/* records in bitmap table */
#define TCODE_BITMAP_RECORD (TCODE_TABLEREC | TCODE_CRC | 0x0090) /* bitmap table record derived from MYON_Bitmap */

/* records in material table */
#define TCODE_MATERIAL_RECORD (TCODE_TABLEREC | TCODE_CRC | 0x0040) /* material table record derived from MYON_Material */

/* records in layer table */
#define TCODE_LAYER_RECORD    (TCODE_TABLEREC | TCODE_CRC | 0x0050) /* layer table record derived from MYON_Layer */

/* records in light table */
#define TCODE_LIGHT_RECORD            (TCODE_TABLEREC | TCODE_CRC | 0x0060)    /* light table record derived from MYON_Light */
#define TCODE_LIGHT_RECORD_ATTRIBUTES (TCODE_INTERFACE | TCODE_CRC   | 0x0061) /* MYON_3dmObjectAttributes chunk */
#define TCODE_LIGHT_RECORD_ATTRIBUTES_USERDATA (TCODE_INTERFACE | 0x0062)      /* MYON_3dmObjectAttributes userdata chunk */
...
#define TCODE_OBJECT_RECORD_TYPE       (TCODE_INTERFACE | TCODE_SHORT | 0x0071)   /* MYON::object_type value */
#define TCODE_OBJECT_RECORD_ATTRIBUTES (TCODE_INTERFACE | TCODE_CRC   | 0x0072)   /* MYON_3dmObjectAttributes chunk */
#define TCODE_OBJECT_RECORD_ATTRIBUTES_USERDATA (TCODE_INTERFACE | 0x0073)        /* MYON_3dmObjectAttributes userdata chunk */
...
//     4 byte MYON::object_type
//
//   TCODE_OPENNURBS_CLASS
//     4 byte length
//     TCODE_OPENNURBS_CLASS_UUID
//       4 byte length = 20
//       value of MYON_ClassId::m_uuid for this class
//       4 byte CRC
...
//         4 byte length
//         16 byte value of MYON_ClassId::m_uuid for this child class of MYON_UserData
//         16 byte value of MYON_UserData::m_userdata_uuid
//         4 byte value of MYON_UserData::m_userdata_copycount
//         128 byte value of MYON_UserData::m_userdata_xform
//         16 byte value of  MYON_UserData::m_application_uuid (in ver 2.1 chunks)
...
//     4 byte length
//     MYON_3dmObjectAttributes information
//     4 byte crc
//
...
//       use MYON_classname::Read() to read this data and MYON_classname::Write()
//       to write this data
...
#define TCODE_OPENNURBS_BUFFER (TCODE_OPENNURBS_OBJECT | TCODE_CRC | 0x0100) /* chunk stores MYON_Buffer classes */
