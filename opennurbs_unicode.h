...
enum MYON_UnicodeEncoding
{
  MYON_UTF_unset=0, // 
  MYON_not_UTF,     // not a UTF encoding
  MYON_UTF_8,       // UTF-8 big endian byte order
  MYON_UTF_16,      // UTF-16 in native CPU byte order
  MYON_UTF_16BE,    // UTF-16 big endian byte order
  MYON_UTF_16LE,    // UTF-16 little endian byte order
  MYON_UTF_32,      // UTF-32 in native CPU byte order
  MYON_UTF_32BE,    // UTF-32 big endian byte order
  MYON_UTF_32LE     // UTF-32 little endian CPU byte order
};
...
/// </summary>
enum MYON_UnicodeCodePoint
{
  /// <summary>nullptr control U+0000</summary>
  MYON_NullCodePoint = 0x00,
  ...
  MYON_NoBreakSpace = 0x00A0,

  /// <summary>OGHAM SPACE MARK U+1680</summary>
  MYON_OghamSpaceMark = 0x1680,
  ...
  /// </summary>
  MYON_ReplacementCharacter = 0xFFFD,
  ...
  /// </summary>
  MYON_MaximumCodePoint = 0x10FFFF,

  /// <summary>
  /// The maximum valid unicode code point value is 0x10FFFF.
  /// See MYON_IsValidUnicodeCodepoint() for additional restrictions.
  /// </summary>
  MYON_InvalidCodePoint = 0x110000
};
...
*/
MYON_DECL
enum MYON_UnicodeEncoding MYON_UnicodeNativeCPU_UTF16();
...
*/
MYON_DECL
enum MYON_UnicodeEncoding MYON_UnicodeNativeCPU_UTF32();
...
*/
MYON_DECL
enum MYON_UnicodeEncoding MYON_IsUTFByteOrderMark(
  const void* buffer,
...
*/
MYON_DECL
unsigned int MYON_UTFSizeofByteOrderMark(
  enum MYON_UnicodeEncoding e
  );
...
*/
MYON_DECL
int MYON_IsValidUnicodeCodePoint(
  MYON__UINT32 unicode_code_point
);

/*
Returns:
  True if u is one of MYON_UnicodeCodePoint::MYON_Space, MYON_UnicodeCodePoint::MYON_NoBreakSpace,
  MYON_UnicodeCodePoint::MYON_NarrowNoBreakSpace, or MYON_UnicodeCodePoint::MYON_ZeroWidthSpace.
Remarks:
  Additional space code points may be added in the future. The goal is to
  detect code points that separate words.
*/
MYON_DECL
int MYON_IsUnicodeSpaceCodePoint(
  MYON__UINT32 u
);
...
*/
MYON_DECL
int MYON_IsUnicodeC1ControlCodePoint(
  MYON__UINT32 u
);
...
*/
MYON_DECL
int MYON_IsValidSingleElementWideCharValue(
  wchar_t w
  );

MYON_DECL
int MYON_IsValidUTF16SurrogatePair(
  unsigned int w1,
  unsigned int w2
  );
...
Parameters:
  ...
  error_code_point - [in]
    ...
    0, 
    MYON_UnicodeCodePoint::MYON_ReplacementCharacter, and
    and MYON_UnicodeCodePoint::MYON_InvalidCodePoint
Returns:
...
*/
MYON_DECL
unsigned int MYON_DecodeUTF16SurrogatePair(
  unsigned int u1,
  unsigned int u2,
...
*/
MYON_DECL
int MYON_IsValidUTF16Singleton(
  MYON__UINT32 c
  );

// MYON_DEPRECATED
MYON_DECL
int MYON_IsValidSingleElementUTF16Value(
MYON__UINT32 c
);
...
*/
MYON_DECL
int MYON_IsValidUTF8SingletonChar(
  char c
  );
// MYON_DEPRECATED
MYON_DECL
int MYON_IsValidSingleByteUTF8CharValue(
  char c
  );
...
*/
MYON_DECL
int MYON_IsValidUTF8Singleton(
  MYON__UINT32 c
  );

// MYON_DEPRECATED
MYON_DECL
int MYON_IsValidSingleElementUTF8Value(
  MYON__UINT32 c
  );


struct MYON_CLASS MYON_UnicodeErrorParameters
{
#if defined(MYON_CPLUSPLUS)
  // 
  static const MYON_UnicodeErrorParameters MaskErrors; // m_error_status = 0, m_error_mask = 0xFFFFFFFF, m_error_code_point = MYON_UnicodeCodePoint::MYON_ReplacementCharacter
  static const MYON_UnicodeErrorParameters FailOnErrors; // m_error_status = 0, m_error_mask = 0, m_error_code_point = MYON_UnicodeCodePoint::MYON_ReplacementCharacter
#endif
  ...
  */
  ...
  MYON_UnicodeCodePoint::MYON_ReplacementCharacter (U+FFFD) 
  is a popular choice for the m_error_code_point value.
  */
  MYON__UINT32 m_error_code_point;
};
...
Parameters:
  ...
  sUTF32_count - [in]
    number of MYON__UINT32 elements in sUTF32[].
  ...
  e - [in/out] 
    ...
    definition of the MYON_UnicodeErrorParameters struct.
...
*/
MYON_DECL
int MYON_DecodeUTF32LE(
    const MYON__UINT32* sUTF32,
    int sUTF32_count,
...
Remarks:
  ...
  The function MYON_IsValidUnicodeCodePoint() can be used to determine
  if u is a valid unicode code point value.
*/
MYON_DECL
int MYON_EncodeUTF8( MYON__UINT32 u, char sUTF8[6] );
...
Parameters:
  ...
  sUTF16 - [out]
    sUTF16 is buffer of 2 MYON__UINT16 elements. If the UTF-16 form
...
*/
MYON_DECL
int MYON_EncodeUTF16( MYON__UINT32 unicode_code_point, MYON__UINT16 sUTF16[2] );
...
Parameters:
  ...
  sUTF16_count - [in]
    number of MYON__UINT16 elements in sUTF16[].
...
*/
MYON_DECL
int MYON_DecodeUTF16LE(
    const MYON__UINT16* sUTF16,
    int sUTF16_count,
    struct MYON_UnicodeErrorParameters* e,
    MYON__UINT32* unicode_code_point
    );
...
Example:
  ...
  The function MYON_MapWindowsCodePage949ToUnicode() can be used to convert
...
*/
MYON_DECL
MYON__UINT32 MYON_MapRTFcharsetToWindowsCodePage(
  MYON__UINT32 rtf_charset,
  MYON__UINT32 default_code_page
);
...
Example:
      ...
      const MYON__UINT32 code_page = ...;
      MYON__UINT32 cp_encoding = ...;
      const MYON__UINT32* cp_to_unicode = MYON_MSSBCP_0x80_0xFF_Unicode(code_page);
      MYON__UINT32 unicode_code_point
...
*/
MYON_DECL
const MYON__UINT32* MYON_MSSBCP_0x80_0xFF_Unicode(
  MYON__UINT32 code_page
  );
...
Returns:
  ...
  Otherwise MYON_UnicodeCodePoint::MYON_ReplacementCharacter ( 0xFFFD ) is returned.
*/
MYON_DECL
MYON__UINT32 MYON_MapMSSBCPToUnicode(
  MYON__UINT32 code_page,
  MYON__UINT32 code_page_single_byte_encoding
);
...
*/
MYON_DECL
MYON__UINT32 MYON_MapUnicodeToMSSBCP(
  MYON__UINT32 code_page,
  MYON__UINT32 unicode_code_point
);
...
Description:
  Convert a unicode string from a UTF-8 encoded char array
  into a UTF-16 encoded MYON__UINT16 array.
...
Parameters:
  ...
  sUTF16_count - [in]
    ...
    MYON__UINT16 elements in the sUTF16[] buffer.
...
Returns:
  If sUTF16_count > 0, the return value is the number of MYON__UINT16
  ...
  MYON__UINT16 elements that are needed to hold the converted string.
  The return value does not include room for a null terminator.  
  Increment the return value by one if you want to have an element
  to use for a null terminator.
*/
MYON_DECL
int MYON_ConvertUTF8ToUTF16(
    int bTestByteOrder,
    const char* sUTF8,
    int sUTF8_count,
    MYON__UINT16* sUTF16,
...
Description:
  Convert a unicode string from a UTF-8 encoded char array
  into a UTF-32 encoded MYON__UINT32 array.
...
Parameters:
  ...
  sUTF32_count - [in]
    ...
    MYON__UINT32 elements in the sUTF32[] buffer.
...
Returns:
  If sUTF32_count > 0, the return value is the number of MYON__UINT32
  ...
  MYON__UINT32 elements that are needed to hold the converted string.
  The return value does not include room for a null terminator.  
  Increment the return value by one if you want to have an element
  to use for a null terminator.
*/
MYON_DECL
int MYON_ConvertUTF8ToUTF32(
    int bTestByteOrder,
    const char* sUTF8,
    int sUTF8_count,
    MYON__UINT32* sUTF32,
...
/*
Description:
  Convert a unicode string from a UTF-16 encoded MYON__UINT16 array
...
Parameters:
  ...
  sUTF16_count - [in]
    ...
    MYON__UINT16 elements in sUTF16[] to convert.
...
int MYON_ConvertUTF16ToUTF8(
    ...
    unsigned int error_mask,
    MYON__UINT32 error_code_point,
    const MYON__UINT16** sNextUTF16
    );

/*
Description:
  Convert a unicode string from a UTF-16 encoded MYON__UINT16 array
  into a UTF-16 encoded MYON__UINT16 array. This is not simply
...
Parameters:
  ...
  sInputUTF16_count - [in]
    ...
    MYON__UINT16 elements in sInputUTF16[] to convert.
  ...
  sOutputUTF16_count - [in]
    ...
    MYON__UINT16 elements in the sOutputUTF16[] buffer.
...
Returns:
  If sOutputUTF16_count > 0, the return value is the number of MYON__UINT16
...
*/
MYON_DECL
int MYON_ConvertUTF16ToUTF16(
    int bTestByteOrder,
    const MYON__UINT16* sInputUTF16,
    int sInputUTF16_count,
    MYON__UINT16* sOutputUTF16,
    int sOutputUTF16_count,
    unsigned int* error_status,
    unsigned int error_mask,
    MYON__UINT32 error_code_point,
    const MYON__UINT16** sNextInputUTF16
    );
...
/*
Description:
  Convert a unicode string from a UTF-32 encoded MYON__UINT32 array
  into a UTF-8 encoded char array.
...
Parameters:
  ...
  sUTF32_count - [in]
    ...
    MYON__UINT32 elements in sUTF32[] to convert.
...
Description:
  Convert a unicode string from a UTF-32 encoded MYON__UINT32 array
  into a UTF-32 encoded MYON__UINT32 array.  This is not simply
  a copy in the case when the input has a byte order mark (BOM),
  different byte ordering or contains errors.  This function can
...
Parameters:
  ...
  sInputUTF32_count - [in]
    ...
    MYON__UINT32 elements in sInputUTF32[] to convert.
  ...
  sOutputUTF32_count - [in]
    ...
    MYON__UINT32 elements in the sOutputUTF32[] buffer.
...
Returns:
  If sOutputUTF32_count > 0, the return value is the number of MYON__UINT32
...
*/
MYON_DECL
int MYON_ConvertUTF32ToUTF32(
    int bTestByteOrder,
    const MYON__UINT32* sInputUTF32,
    int sInputUTF32_count,
    MYON__UINT32* sOuputUTF32,
    int sOutputUTF32_count,
    unsigned int* error_status,
    unsigned int error_mask,
    MYON__UINT32 error_code_point,
    const MYON__UINT32** sNextInputUTF32
    );
...
*/
MYON_DECL
int MYON_ConvertWideCharToUTF8(
    int bTestByteOrder,
    const wchar_t* sWideChar,
    int sWideChar_count,
    char* sUTF8,
...
Description:
  Convert a wchar_t string using the native platform's most common
  encoding into a unicode string encoded as a UTF-16 MYON__UINT16 array.
...
*/
MYON_DECL
int MYON_ConvertWideCharToUTF16(
    int bTestByteOrder,
    const wchar_t* sWideChar,
    int sWideChar_count,
    MYON__UINT16* sUTF16,
...
*/
MYON_DECL
int MYON_ConvertWideCharToUTF32(
    int bTestByteOrder,
    const wchar_t* sWideChar,
    int sWideChar_count,
    MYON__UINT32* sUTF32,
...
*/
MYON_DECL
int MYON_ConvertUTF8ToWideChar(
    int bTestByteOrder,
    const char* sUTF8,
    int sUTF8_count,
    wchar_t* sWideChar,
...
*/
MYON_DECL
int MYON_ConvertUTF16ToWideChar(
    int bTestByteOrder,
    const MYON__UINT16* sUTF16,
    int sUTF16_count,
    wchar_t* sWideChar,
...
Returns:
  ...
  to use for a null terminator.
See Also:
  MYON_wString::FromUnicodeCodePoints()
*/
MYON_DECL
int MYON_ConvertUTF32ToWideChar(
    int bTestByteOrder,
    const MYON__UINT32* sUTF32,
    int sUTF32_count,
    wchar_t* sWideChar,
...
Description:
  ...
  rich text RTF in MYON_TextContent, strings from outside sources
  ...
  error_status - [out]
    ...
    conversion errors, multiple bits may be set.
      ...
      16: An illegal encoding sequence occurred.
          ...
          a single MYON_wString::ReplacementCharacter in the output string
          and parsing continues.
...
*/
MYON_DECL
int MYON_ConvertMSMBCPToWideChar(
    MYON__UINT32 windows_code_page,
    const char* sMBCS,
    int sMBCS_count,
    wchar_t* sWideChar,
...
*/
MYON_DECL
int MYON_ConvertWideCharToMSMBCP(
  const wchar_t* sWideChar,
  int sWideChar_count,
  MYON__UINT32 windows_code_page,
  char* sMBCS,
...
#if defined(MYON_CPLUSPLUS)
MYON_DECL
MYON__UINT32 MYON_Test_MSSBCP(
  const MYON__UINT32 code_page,
  const MYON__UINT32 char_encoding,
  bool bWindowsAPITest,
  MYON_TextLog& text_log
);

MYON_DECL
bool MYON_Test_MSSBCP(
  const MYON__UINT32 code_page,
  bool bWindowsAPITest,
  MYON_TextLog& text_log
);
...
MYON_DECL
bool MYON_Test_PrintPlatformMSSBCPToUnicodeTable(
  const MYON__UINT32 code_page,
  MYON__UINT32 char_encoding0,
  MYON__UINT32 char_encoding1,
  MYON_TextLog& text_log
);
...
*/
MYON_DECL
bool MYON_IsPrivateUseUnicodeCodePoint(
  MYON__UINT32 unicode_code_point
);
...
*/
MYON_DECL
bool MYON_IsStandardUnicodeCodePoint(
  MYON__UINT32 unicode_code_point
);
...
*/
MYON_DECL
bool MYON_IsUnicodeControlCodePoint(
  MYON__UINT32 code_point,
...
/// </returns>
MYON_DECL
unsigned MYON_UnicodeSuperscriptFromCodePoint(
  unsigned cp,
...
/// </returns>
MYON_DECL
unsigned MYON_UnicodeSuperscriptFromDigit(
...
/// </returns>
MYON_DECL
unsigned MYON_UnicodeSubcriptFromCodePoint(
  unsigned cp,
...
/// </returns>
MYON_DECL
unsigned MYON_UnicodeSubscriptFromDigit(
  unsigned decimal_digit
);

/// <summary>
/// MYON_UnicodeShortCodePoint is a tool to use when working with Unicode code points 
...
/// and the 2 byte size of MYON_UnicodeShortCodePoint
/// appreciably more  efficient that a 4 byte size of an unsigned int.
/// </summary>
class MYON_CLASS MYON_UnicodeShortCodePoint
{
public:
  MYON_UnicodeShortCodePoint() = default;
  ~MYON_UnicodeShortCodePoint() = default;
  MYON_UnicodeShortCodePoint(const MYON_UnicodeShortCodePoint&) = default;
  MYON_UnicodeShortCodePoint& operator=(const MYON_UnicodeShortCodePoint&) = default;

public:
  /// <summary>
  /// MYON_UnicodeShortCodePoint::NUll has a code point value = 0.
  /// </summary>
  static const MYON_UnicodeShortCodePoint Null;

  /// <summary>
  /// MYON_UnicodeShortCodePoint::ReplacementCharacter has a code point = U+FFFD.
  /// </summary>
  static const MYON_UnicodeShortCodePoint ReplacementCharacter;

  /// <summary>
  /// MYON_UnicodeShortCodePoint::ByteOrderMark has a code point value = 0xFFFE.
  /// (0xFFFE is not a Unicode character code point.)
  /// </summary>
  static const MYON_UnicodeShortCodePoint ByteOrderMark;

  /// <summary>
  /// MYON_UnicodeShortCodePoint::Error has a code point value = 0xFFFF.
  /// (0xFFFF is not a Unicode character code point.)
  /// </summary>
  static const MYON_UnicodeShortCodePoint Error;
  ...
  /// Otherwise MYON_UnicodeShortCodePoint::Error is returned.
  /// Notes:
  /// 1. Valid Unicode code points can be as large as 0x10FFFD and
  /// MYON_UnicodeShortCodePoint cannot accommodate code points &gt= U+10000.
  ...
  /// </returns>
  static const MYON_UnicodeShortCodePoint Create(unsigned int unicode_code_point);
  ...
  /// Otherwise MYON_UnicodeShortCodePoint::Error is returned.
  /// </returns>
  static const MYON_UnicodeShortCodePoint CreateFromBig5(
    unsigned int big5_code_point,
    MYON_UnicodeShortCodePoint not_available
  );
  ...
  /// </returns>
  static const MYON_UnicodeShortCodePoint CreateFromBig5(
    const class MYON_Big5CodePoint& big5_code_point,
    MYON_UnicodeShortCodePoint not_available
  );
  ...
  /// Value to return if this Unicode code point equal to MYON_UnicodeShortCodePoint::Null. </param>
  /// <returns>
  ...
  static int Compare(const MYON_UnicodeShortCodePoint* lhs, const MYON_UnicodeShortCodePoint* rhs);
private:
  MYON__UINT16 m_unicode_code_point = 0;
};

MYON_DECL bool operator==(MYON_UnicodeShortCodePoint lhs, MYON_UnicodeShortCodePoint rhs);
MYON_DECL bool operator!=(MYON_UnicodeShortCodePoint lhs, MYON_UnicodeShortCodePoint rhs);
MYON_DECL bool operator<=(MYON_UnicodeShortCodePoint lhs, MYON_UnicodeShortCodePoint rhs);
MYON_DECL bool operator>=(MYON_UnicodeShortCodePoint lhs, MYON_UnicodeShortCodePoint rhs);
MYON_DECL bool operator<(MYON_UnicodeShortCodePoint lhs, MYON_UnicodeShortCodePoint rhs);
...
/// <summary>
/// MYON_Big5CodePoint is a tool to use when working with BIG5 encoded strings.
/// </summary>
class MYON_CLASS MYON_Big5CodePoint
{
public:
  /// <summary>
  /// MYON_Big5CodePoint::NUll has a code point value = 0.
  /// </summary>
  static const MYON_Big5CodePoint Null;

  /// <summary>
  /// MYON_Big5CodePoint::Error has a code point value = 0xA3E1.
  ...
  /// </summary>
  static const MYON_Big5CodePoint WindowsEuro;

  /// <summary>
  /// MYON_Big5CodePoint::Error has a code point value = 0xFFFF.
  /// (0xFFFF is not a valid BIG5 code point value.)
  /// </summary>
  static const MYON_Big5CodePoint Error;
  ...
  MYON_Big5CodePoint() = default;
  ~MYON_Big5CodePoint() = default;
  MYON_Big5CodePoint(const MYON_Big5CodePoint&) = default;
  MYON_Big5CodePoint& operator=(const MYON_Big5CodePoint&) = default;
  ...
  /// then a MYON_Big5CodePoint instance with that value as code point is returned.
  /// Otherwise MYON_Big5CodePoint::Error is returned.
  /// </returns>
  static const MYON_Big5CodePoint Create(unsigned int big5_code_point);
  ...
  /// Otherwise MYON_Big5CodePoint::Error is returned.
  /// </returns>
  static const MYON_Big5CodePoint CreateFromUnicode(
    unsigned int unicode_code_point,
    MYON_Big5CodePoint not_available
  );
  ...
  /// </returns>
  static const MYON_Big5CodePoint CreateFromUnicode(
    const class MYON_UnicodeShortCodePoint& unicode_code_point,
    MYON_Big5CodePoint not_available
  );
  ...
  /// </summary>
  /// <param name="bNullIsASCII">
  /// Value to return if this BIG5 code point equal to MYON_Big5CodePoint::Null. </param>
  /// <returns>
  /// True if the code point value &le= 0x7F.
  /// </returns>
  bool IsASCII(bool bNullIsASCII) const;
  ...
  static int Compare(const MYON_Big5CodePoint* lhs, const MYON_Big5CodePoint* rhs);

private:
  MYON__UINT16 m_big5_code_point = 0;
};

MYON_DECL bool operator==(MYON_Big5CodePoint lhs, MYON_Big5CodePoint rhs);
MYON_DECL bool operator!=(MYON_Big5CodePoint lhs, MYON_Big5CodePoint rhs);
MYON_DECL bool operator<=(MYON_Big5CodePoint lhs, MYON_Big5CodePoint rhs);
MYON_DECL bool operator>=(MYON_Big5CodePoint lhs, MYON_Big5CodePoint rhs);
MYON_DECL bool operator<(MYON_Big5CodePoint lhs, MYON_Big5CodePoint rhs);
