...
/*
    default: code_point = MYON_UnicodeCodePoint::MYON_ReplacementCharacter; break;
  }
  return code_point;  
}
  ...
  __declspec(noinline)
#endif
static MYON__UINT32 Internal_MapWindowsCodePage932ToUnicode_0x(
...
0x8250<SEP>0x2331<SEP>0xFF11<SEP3>// FULLWIDTH DIGIT MYONE
...
*/
  ...
  __declspec(noinline)
#endif
int MYON_Internal_MapWindowsCodePage932ToUnicode(
  MYON__UINT32 code_page_932_character_value,
...
)
{
  ...
  MYON__UINT32 code_point = MYON_UnicodeCodePoint::MYON_ReplacementCharacter;
  bool rc = false;

  const MYON__UINT32 code_page_932_lead_byte_value = code_page_932_character_value / 256;
    ...
    )
  {
    ...
    rc = (MYON_UnicodeCodePoint::MYON_ReplacementCharacter != code_point);
