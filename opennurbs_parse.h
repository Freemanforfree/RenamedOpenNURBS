...
#if !defined(MYON_PARSE_INC_)
#define MYON_PARSE_INC_

class MYON_CLASS MYON_ArithmeticCalculator
{
public:
  MYON_ArithmeticCalculator();
  MYON_ArithmeticCalculator(const MYON_ArithmeticCalculator&);
  MYON_ArithmeticCalculator(MYON_ArithmeticCalculator&&);
  MYON_ArithmeticCalculator& operator=(const MYON_ArithmeticCalculator&);
  MYON_ArithmeticCalculator& operator=(MYON_ArithmeticCalculator&&);
  ...
  enum ERROR_CONDITION
  {
    ...
    program_error = 1,
      // The part of the computer running the MYON_ArithmeticCalculator 
      // code is corrupt or damaged or there is a bug in the
      // MYON_ArithmeticCalculator code.
...
private:
  class MYON_ArithmeticCalculatorImplementation* m_pCalc;
  double m_inplace_buffer[127]; // used for in-place construction of pCalc.
};

class MYON_CLASS MYON_LengthUnitName
{
public:
  MYON_LengthUnitName() = default;
  ~MYON_LengthUnitName() = default;
  MYON_LengthUnitName(const MYON_LengthUnitName&) = default;
  MYON_LengthUnitName& operator=(const MYON_LengthUnitName&) = default;

  static const MYON_LengthUnitName None;

  /*
  Description:
    Get list of length unit names and abbreviations and their corresponding
    unit systems that are recognized by MYON_ParseLengthUnitSystemName().
  ...
  Example:
            unsigned int count = MYON_GetLengthUnitNameList(0,0);
            MYON_UnitName* length_unit_list = new (std::nothrow) MYON_UnitName[capacity];
            count = MYON_GetLengthUnitNameList(count,length_unit_list);
            ...
  ...
  */
  static unsigned int GetLengthUnitNameList( 
    ...
    class MYON_LengthUnitName* length_unit_list
    );

  static MYON_LengthUnitName Create(
  ...
  /*
  Description:
    Dictionary compare of all MYON_LengthUnitName information in the order
  ...
  */  
  ...
  MYON::LengthUnitSystem LengthUnit() const;

  /*
  Returns:
    True if the length unit system is set.
    False if length unit system is MYON::LengthUnitSystem::None or MYON::LengthUnitSystem::Unset.
  */
  bool LengthUnitIsSet() const;

  /*
  Returns:
    True if the length unit system is set or is MYON::LengthUnitSystem::None
  */
  ...
  Returns:
    ...
    False if length unit system is MYON::LengthUnitSystem::None or MYON::LengthUnitSystem::Unset or the name is empty.
  */
...
private:
  ...
  MYON::LengthUnitSystem m_length_unit_system = MYON::LengthUnitSystem::None;        
...
class MYON_CLASS MYON_AngleUnitName
{
public:
  MYON_AngleUnitName() = default;
  ~MYON_AngleUnitName() = default;
  MYON_AngleUnitName(const MYON_AngleUnitName&) = default;
  MYON_AngleUnitName& operator=(const MYON_AngleUnitName&) = default;

  static const MYON_AngleUnitName None;

  /*
  Description:
    Get list of angle unit names and abbreviations and their corresponding
    unit systems that are recognized by MYON_ParseAngleUnitName().
  ...
  Example:
            unsigned int count = MYON_GetAngleUnitNameList(0,0);
            MYON_UnitName* angle_unit_list = new (std::nothrow) MYON_UnitName[capacity];
            count = MYON_GetAngleUnitNameList(count,angle_unit_list);
            ...
  ...
  */
  static unsigned int GetAngleUnitNameList( 
    ...
    class MYON_AngleUnitName* angle_unit_list
    );

  static MYON_AngleUnitName Create(
    unsigned int locale_id,
  ...
  */  
  ...
  MYON::AngleUnitSystem AngleUnit() const;

  /*
  Returns:
    True if the angle unit system is set.
    False if angle unit system is MYON::AngleUnitSystem::None or MYON::AngleUnitSystem::Unset.
  */
  bool AngleUnitIsSet() const;

  /*
  Returns:
    True if the angle unit system is set or is MYON::AngleUnitSystem::None
  */
  ...
  Returns:
    ...
    False if length unit system is MYON::AngleUnitSystem::None or MYON::AngleUnitSystem::Unset or the name is empty.
  */
...
private:
  // Microsoft locale id // http://msdn.microsoft.com/en-us/library/ms912047(v=winembedded.10).aspx
  unsigned int m_locale_id = 0; 
  MYON::AngleUnitSystem m_angle_unit_system = MYON::AngleUnitSystem::None;   
  bool m_bNameIsSingular = false;
  bool m_bNameIsPlural = false;
  const wchar_t* m_name = nullptr;
...
class MYON_CLASS MYON_ParseSettings
{
public:
  enum
  {
  ...
  */
  static const MYON_ParseSettings DefaultSettings;
  ...
  Description:
    ...
    - Any angle values with unspecified units will be
      ...
      most parsing situations.
  */
  static const MYON_ParseSettings DefaultSettingsInRadians;
  ...
  /*
    ...
    - Any angle values with unspecified units will be
      ...
      most parsing situations.
  */
  static const MYON_ParseSettings DefaultSettingsInDegrees;
  ...
  Description:
    ...
    digit.
  */
  static const MYON_ParseSettings IntegerNumberSettings;
  ...
  */
  static const MYON_ParseSettings RationalNumberSettings;
  ...
  */
  static const MYON_ParseSettings DoubleNumberSettings;
  ...
  */
  static const MYON_ParseSettings RealNumberSettings;

  /*
  Description:
    MYON_ParseSetting::FalseSettings has all parsing options
    set to false.
  Remarks:
    A common use of MYON_ParseSettings FalseSettings is to initialize
    MYON_ParseSettings classes that are used to report what happened
    during parsing. Any parsing results value set to true after 
    parsing indicates that type of parsing occurred.
  */
  static const MYON_ParseSettings FalseSettings;
  ...
  MYON_ParseSettings& operator|=(const MYON_ParseSettings& other);
  MYON_ParseSettings& operator&=(const MYON_ParseSettings& other);
  ...
  */
  ...
  Remarks:
    ...
    - Parsing functions with the word "Expression" in their name,
      like MYON_ParseNumberExpression, MYON_ParseLengthExpression,
      and MYON_ParseAngleExpression, support arithmetic parsing.
  */
  ...
  */
  ...
  Remarks:
    ...
    - Parsing functions with the word "Expression" in their name,
      like MYON_ParseNumberExpression, MYON_ParseLengthExpression,
      and MYON_ParseAngleExpression, support formula parsing.
  */
  ...
  */
  ...
  Remarks:
    ...
    - The "E" may be 'e', 'E', unicode decimal exponent symbol
      (code point 0x23E8).  
  See Also:
    MYON_ParseSettings::ParseScientificDNotation.
  */
  ...
  See Also:
    MYON_ParseSettings::ParseScientificENotation.
  */
  ...
  Remarks:
    - The default value is true.
  See Also:
    MYON_ParseSettings::ParseCommaAsDecimalPoint()
    MYON_ParseSettings::ParseFullStopAsDigitSeparator()
    MYON_ParseSettings::ParseCommaAsDigitSeparator()
  */
  ...
  Remarks:
    - The default value is false.
  See Also:
    MYON_ParseSettings::ParseFullStopAsDecimalPoint()
    MYON_ParseSettings::ParseCommaAsDecimalPoint()
    MYON_ParseSettings::ParseCommaAsDigitSeparator()
    MYON_ParseSettings::ParseSpaceAsDigitSeparator()
    MYON_ParseSettings::ParseThinSpaceAsDigitSeparator()
    MYON_ParseSettings::ParseNoBreakSpaceAsDigitSeparator()
    MYON_ParseSettings::ParseNoBreakThinSpaceAsDigitSeparator()
  */
  ...
  */
  ...
  See Also:
    MYON_ParseSettings::ParseIntegerDashFraction()
    MYON_ParseSettings::ParseHyphenMinusAsNumberDash()
    MYON_ParseSettings::ParseHyphenAsNumberDash()
    MYON_ParseSettings::ParseNoBreakHyphenAsNumberDash()
  */
  ...
  */
  ...
  Remarks:
    ...
    - Strings like "1.0/3.0", "3.5/2" or "pi/2" are not parsed
      as rational numbers. Use MYON_ParseSettings::ParseDivision
  ...
  */
  ...
  Example:
    ...
    For example, 
      "3pi" and pi3.0 will return 3.0*MYON_PI. 
  ...
  */
  ...
  Remarks:
    ...
    - Parsing functions with the word "Expression" in their name,
      like MYON_ParseNumberExpression, MYON_ParseLengthExpression,
      and MYON_ParseAngleExpression, support multiplication parsing.
  */
  ...
  Remarks:
    ...
    - Parsing functions with the word "Expression" in their name,
      like MYON_ParseNumberExpression, MYON_ParseLengthExpression,
      and MYON_ParseAngleExpression, support division parsing.
  */
  ...
  */
  ...
  Remarks:
    ...
    - MYON_ParseSettings::IsNumberDash() controls what characters
      are interpreted as number dashes.
  See Also:
    MYON_ParseSettings::ParseRationalNumber()
  */
  ...
  */
  MYON::LengthUnitSystem ContextLengthUnitSystem() const;
  ...
  */
  // MYON_DEPRECTATED
  MYON::AngleUnitSystem DefaultAngleUnitSystem() const;
  ...
  */
  bool IsLeadingWhiteSpace(MYON__UINT32 c) const;
  ...
  */
  bool IsTrailingWhiteSpace(MYON__UINT32 c) const;
  ...
  */
  bool IsInteriorWhiteSpace(MYON__UINT32 c) const;
  ...
  */
  bool IsUnaryMinus(MYON__UINT32 c) const;
  ...
  */
  bool IsUnaryPlus(MYON__UINT32 c) const;
  ...
  */
  char IsDigit(MYON__UINT32 c) const;
  ...
  */
  bool IsDigitSeparator(MYON__UINT32 c) const;
  ...
  */
  bool IsDecimalPoint(MYON__UINT32 c) const;
  ...
  */
  bool IsDecimalExponentSymbol(MYON__UINT32 c) const; // e E (optionally d and/or D)
  ...
  */
  bool IsGreekPi(MYON__UINT32 c) const;
  ...
  */
  bool IsMultiplicationSymbol(MYON__UINT32 c) const;
  ...
  */
  bool IsDivisionSymbol(MYON__UINT32 c) const;
  ...
  */
  bool IsAdditionSymbol(MYON__UINT32 c) const;
  ...
  */
  bool IsSubtractionSymbol(MYON__UINT32 c) const;
  ...
  */
  bool IsLeftParenthesisSymbol(MYON__UINT32 c) const;
  ...
  */
  bool IsRightParenthesisSymbol(MYON__UINT32 c) const;
  ...
  */
  bool IsRationalNumberFractionBar(MYON__UINT32 c) const;
  ...
  Returns:
    ...
    strings like "1-3/4".
  */
  bool IsNumberDash(MYON__UINT32 c) const;
  ...
  Parameters:
    bParseLeadingWhiteSpace - [in]
      True if leading white space should be parsed.
  Remarks:
    See MYON_ParseSettings::ParseLeadingWhiteSpace()
  ...
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseArithmeticExpression()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseMathFunctions()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseExplicitFormulaExpression()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseUnaryMinus()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseUnaryPlus()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseSignificandIntegerPart()
    for details about this property.
  */
  ...
  Parameters:
    bParseSignificandDecimalPoint - [in]
      ...
      number should be parsed.
  Remarks:
    See MYON_ParseSettings::ParseSignificandDecimalPoint()
    for details about this property.
  */
  ...
  Parameters:
    bParseSignificandFractionalPart - [in]
      ...
      number should be parsed.
  Remarks:
    See MYON_ParseSettings::ParseSignificandFractionalPart()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseSignificandDigitSeparators()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseDecimalPoint()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseDAsExponentInScientificENotation()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseScientificENotation()
    for details about this property.
  */
  ...
  Parameters:
    bParseRationalNumber - [in]
      ...
      should be parsed.
  Remarks:
    See MYON_ParseSettings::ParseRationalNumber()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParsePi()
    for details about this property.
  */
  void SetParsePi(
    bool bParsePi
  ...
  Remarks:
    See MYON_ParseSettings::ParseMultiplication()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseDivision()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseAddition()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseSubtraction()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::PairedParentheses()
    for details about this property.
  */
  ...
  Parameters:
    bParseIntegerDashFraction - [in]
      ...
      a single number
  Remarks:
    See MYON_ParseSettings::ParseIntegerDashFraction()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseFeetInches()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseArcDegreesMinutesSeconds()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseWhiteSpaceBetweenValueAndUnitSystem()
    for details about this property.
  */
  ...
  Parameters:
    ...
    will be parsed as 15 inches
  Remarks:
    See MYON_ParseSettings::ParseWhiteSpaceBetweenFeetAndInches()
    for details about this property.
  */
  ...
  Remarks:
    See MYON_ParseSettings::ParseSurveyorsNotation()
    for details about this property.
  */
  ...
  */
  ...
  Description:
    ...
    is MYON::LengthUnitSystem::None. 

  Parameters:
    context_length_unit_system - [in]
      MYON::LengthUnitSystem::Custom and MYON::LengthUnitSystem::Unset
      select MYON::LengthUnitSystem::None.
  */
  ...
  Description:
    ...
    is MYON::LengthUnitSystem::Radians. 

  Parameters:
    default_angle_unit_system - [in]
      MYON::AngleUnitSystem::None and MYON::AngleUnitSystem::Unset
      select MYON::LengthUnitSystem::Radians.
  */
...
private:
  ...
  MYON__UINT32 m_true_default_bits[2];  // a "0" bit is true  - used for defaults that are true
  MYON__UINT32 m_false_default_bits[2]; // a "0" bit is false - used for defaults that are false

  MYON__UINT32 m_reserved_bits = 0;
  ...
  // to determine what arc unit system is being identified.
  MYON__UINT16 m_context_locale_id = 0;
  ...
  // MYON::AngleUnitSystem value, that angle unit system is used.
  // In all other cases, radians are used.
  MYON__UINT8 m_context_angle_unit_system = 0;
...
Parameters:
 ...
 parse_settings - [in]
   ...
   Use one of the predefined
     MYON_ParseSettings::DefaultSettings
     MYON_ParseSettings::IntegerNumberSettings
     MYON_ParseSettings::RationalNumberSettings
     MYON_ParseSettings::RealNumberSettings
...
See Also:
  MYON_ParseNumberExpression
  MYON_ParseLengthExpression
  MYON_ParseAngleExpression
*/
MYON_DECL
int MYON_ParseNumber( 
  const wchar_t* str,
  int str_count,
...
*/
MYON_DECL
int MYON_ParseNumberExpression( 
  const wchar_t* str,
  int str_count,
  MYON_ParseSettings parse_settings,
  MYON_ParseSettings* parse_results,
...
Parameters:
  ...
  length_unit_system - [out] (can be null)
    ...
    system, then *length_unit_system is set to MYON::LengthUnitSystem::None.
...
Parameters:
 ...
 parse_settings - [in]
   ...
   Use MYON_ParseSettings::DefaultSettings for common parsing tasks.
 ...
 length_value_unit_system - [in]
   ...
   you would specify MYON::LengthUnitSystem::Meters here. If you want to use custom
   units, you must use the override with the MYON_UnitSystem
   parameter.
...
Parameters:
  ...
  prefered_locale_id - [in]
    ...
    ambiguity.  A list of Microsoft locale id values can be found at
    http://msdn.microsoft.com/en-us/library/ms912047(v=winembedded.10).
    For example, "Grad" identifies MYON::degrees in German and MYON::gradians
    in US English.
...
Parameters:
 ...
 angle_value_unit_system - [in]
   ...
   you would specify MYON::AngleUnitSystem::Degrees here.
...
Parameters:
 ...
 default_str_angle_unit_system - [in]
   ...
   be used.  If default_str_angle_units is MYON::AngleUnitSystem::None,
   then MYON::radians will be used.
...
Remarks:
  This function uses MYON_ParseAngleExpression() with the 
  angle_value_unit_system parameter set to MYON::radians
  to parse the string. If you need more control over parsing
  options, then use MYON_ParseAngleExpression().
*/
MYON_DECL
...
Remarks:
  This function uses MYON_ParseAngleExpression() with the 
  angle_value_unit_system parameter set to MYON::AngleUnitSystem::Degrees
  to parse the string. If you need more control over parsing
  options, then use MYON_ParseAngleExpression().
*/
MYON_DECL
...
Parameters:
 ...
 point_value_unit_system - [in]
   ...
   be in meters, you would specify MYON::LengthUnitSystem::Meters here. 
   If you want to use custom units, you must use the 
   override with the MYON_UnitSystem parameter.
