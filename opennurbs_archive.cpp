...
const MYON_String Internal_RuntimeEnvironmentToString(
  MYON::RuntimeEnvironment runtime_environment
)
{
  switch (runtime_environment)
  {
  MYON_ENUM_TO_STRING_CASE(MYON::RuntimeEnvironment::Unset);
  MYON_ENUM_TO_STRING_CASE(MYON::RuntimeEnvironment::None);
  MYON_ENUM_TO_STRING_CASE(MYON::RuntimeEnvironment::Windows);
  MYON_ENUM_TO_STRING_CASE(MYON::RuntimeEnvironment::Apple);
  MYON_ENUM_TO_STRING_CASE(MYON::RuntimeEnvironment::Android);
  MYON_ENUM_TO_STRING_CASE(MYON::RuntimeEnvironment::Linux);
  }

  MYON_ERROR("Invalid runtime_environment parameter value.");
  return MYON_String::EmptyString;
}

const MYON_wString Internal_RuntimeEnvironmentToWideString(
  MYON::RuntimeEnvironment runtime_environment
)
{
  const MYON_String s = Internal_RuntimeEnvironmentToString(runtime_environment);
  return MYON_wString(s);
}

unsigned int MYON_BinaryArchive::ArchiveOpenNURBSVersionToWrite(
  ...
  )
{
  ...
  if (
    ...
    && false == MYON_VersionNumberIsYearMonthDateFormat(archive_3dm_version, opennurbs_version)
    )
  {
    unsigned int yyyy = 0;
    unsigned int mm = 0;
    ...
    if (MYON_VersionNumberParse(opennurbs_version, &major_version_number, 0, &yyyy, &mm, &dd, 0))
    {
...
MYON_UserDataItemFilter::MYON_UserDataItemFilter()
  : m_application_id(MYON_nil_uuid)
  , m_item_id(MYON_nil_uuid)
  , m_precedence(0)
  , m_bSerialize(false)
{}
...
int MYON_UserDataItemFilter::Compare(
  const class MYON_UserDataItemFilter* a,
  const class MYON_UserDataItemFilter* b
  )
{
  ...
  int rc = MYON_UuidCompare(a->m_application_id, b->m_application_id);
  if (0 != rc)
    return rc;

  rc = MYON_UuidCompare(a->m_item_id, b->m_item_id);
  if (0 != rc)
    return rc;
...
public:
  ...
  Parameters:
    ...
    bReadSuccess - [out]
      ...
      changed.
  */
  MYON_ReadChunkHelper(
    MYON_BinaryArchive&,
    bool& bReadSuccess
    );
  ~MYON_ReadChunkHelper();

  MYON_BinaryArchive& m_binary_archive;
  MYON__UINT32 m_chunk_tcode = 0;
  bool m_bSupressPartiallyReadChunkWarning = false;
  MYON__INT64 m_chunk_value = 0;
  bool& m_bReadSuccess;
...
private:
  ...
  MYON_ReadChunkHelper() = delete;
  MYON_ReadChunkHelper(const MYON_ReadChunkHelper&) = delete;
  MYON_ReadChunkHelper& operator=(const MYON_ReadChunkHelper&) = delete;
};

MYON_ReadChunkHelper::MYON_ReadChunkHelper(
...
bool MYON_IsUnsignedChunkTypecode( MYON__UINT32 typecode )
{
...
static
bool DownSizeINT( MYON__INT64 i64, MYON__INT32* i32 )
{
  const static MYON__INT64 i32max = 2147483647;
  ...
  MYON_ERROR("i64 too big to convert to 4 byte signed int");
  *i32 = 0;
  return false;
}

static
bool DownSizeUINT( MYON__UINT64 u64, MYON__UINT32* u32 )
{
  if ( u64 <= 0xFFFFFFFF )
  {
    *u32 = (MYON__UINT32)u64;
    return true;
  }

  MYON_ERROR("u64 too big to convert to 4 byte unsigned int");
  *u32 = 0;
  return false;
}

struct MYON__3dmV1LayerIndex
{
  int m_layer_index;
  int m_layer_name_length;
  char* m_layer_name;
  struct MYON__3dmV1LayerIndex* m_next;
};

MYON_BinaryArchive::MYON_BinaryArchive( MYON::archive_mode mode )
  : m_mode(mode)
{
  if (MYON::archive_mode::read3dm == mode || MYON::archive_mode::write3dm == mode)
    m_bChunkBoundaryCheck = true;
  m_annotation_context.SetReferencedBinaryArchive(this);
}

class MYON_3dmTableStatusLink
{
public:
  MYON_3dmTableStatusLink() = default;
  ~MYON_3dmTableStatusLink() = default;
  MYON_3dmTableStatusLink(const MYON_3dmTableStatusLink&) = default;
  MYON_3dmTableStatusLink& operator=(const MYON_3dmTableStatusLink&) = default;

  MYON_3dmTableStatusLink* m_next = nullptr;
  MYON_3dmArchiveTableStatus m_table_status;
};

MYON_BinaryArchive::~MYON_BinaryArchive()
{
  if ( 0 != m_V1_layer_list )
  {
    struct MYON__3dmV1LayerIndex* next = m_V1_layer_list;
    m_V1_layer_list = 0;
    for ( int i = 0; 0 != next && i < 1000; i++ )
    {
      struct MYON__3dmV1LayerIndex* p = next;
      next = p->m_next;
      onfree(p);
    }
  }
  ...
  MYON_3dmTableStatusLink* next = m_3dm_table_status_list;
  m_3dm_table_status_list = nullptr;
  while (nullptr != next)
  {
    MYON_3dmTableStatusLink* p = next;
    next = const_cast<MYON_3dmTableStatusLink*>(next->m_next);
    delete p;
  }

  m_annotation_context.SetReferencedDimStyle(nullptr,nullptr,MYON_UNSET_INT_INDEX);
...
bool MYON_BinaryArchive::ArchiveFileMoved() const
{
  return m_b3dmArchiveMoved;
}

const MYON_wString& MYON_BinaryArchive::ArchiveFileName() const
{
  return m_archive_file_name;
}

const MYON_wString& MYON_BinaryArchive::ArchiveDirectoryName() const
{
  return m_archive_directory_name;
}

const MYON_wString& MYON_BinaryArchive::ArchiveFullPath() const
{
  return m_archive_full_path;
}

const MYON_wString& MYON_BinaryArchive::ArchiveSavedAsFullPath() const
{
  return m_archive_saved_as_full_path;
}

const wchar_t* MYON_BinaryArchive::ArchiveFileNameAsPointer() const
{
  return static_cast<const wchar_t*>(m_archive_file_name);
}

const wchar_t* MYON_BinaryArchive::ArchiveDirectoryNameAsPointer() const
{
  return static_cast<const wchar_t*>(m_archive_directory_name);
}

const wchar_t* MYON_BinaryArchive::ArchiveFullPathAsPointer() const
{
  return static_cast<const wchar_t*>(m_archive_full_path);
}

const wchar_t* MYON_BinaryArchive::ArchiveSavedAsFullPathPointer() const
{
  return static_cast<const wchar_t*>(m_archive_saved_as_full_path);
}

void MYON_BinaryArchive::SetArchiveFullPath(
  ...
  )
{
  if (m_archive_full_path.IsNotEmpty())
  {
    ...
    if (false == m_archive_full_path.EqualOrdinal(archive_full_path, false))
    {
      ...
      MYON_ERROR("Attempt to change archive path.");
    }
    return;
  }

  MYON_wString local_full_path(archive_full_path);
  archive_full_path = local_full_path;

  MYON_wString archive_file_name;
  MYON_wString archive_directory_name;
  ...
  if (nullptr != archive_full_path && 0 != archive_full_path[0])
  {
    ...
    if (archive_full_path == f || (nullptr !=  d && f > archive_full_path && MYON_FileSystemPath::IsRelativePath(archive_full_path) ) )
    {
      const MYON_wString current_directory = MYON_FileSystemPath::CurrentDirectory(true);
      if (current_directory.IsNotEmpty())
      {
        local_full_path = MYON_FileSystemPath::CombinePaths(static_cast<const wchar_t*>(current_directory), false, archive_full_path, true, false);
        archive_full_path = local_full_path;
        on_wsplitpath(archive_full_path, &dr, &d, &f, &e);
      }
    }
...
{
  MYON_wString s(archive_directory_name);
  s.TrimRight(L"/\\");
  if (s.IsEmpty() || (2 == s.Length() && ':' == s[1]))
    s = archive_directory_name;

  const MYON_wString local_directory_name(s);
  ...
  if (nullptr != archive_file_name)
  {
    ...
    case '\\':
    case ':':
      MYON_ERROR("archive_file_name is not valid.");
      archive_file_name = nullptr;
    }
  }
  const MYON_wString local_file_name(archive_file_name);
  ...
  {
    m_archive_full_path = MYON_wString::EmptyString;
    m_archive_full_path += MYON_FileSystemPath::DirectorySeparator;
...
MYON_BinaryArchive::eStorageDeviceError MYON_BinaryArchive::StorageDeviceErrorFromUnsigned(
  unsigned int storage_device_error_as_unsigned
  )
{
  switch (storage_device_error_as_unsigned)
  {
  MYON_ENUM_FROM_UNSIGNED_CASE(MYON_BinaryArchive::eStorageDeviceError::None);
  MYON_ENUM_FROM_UNSIGNED_CASE(MYON_BinaryArchive::eStorageDeviceError::WriteFailed);
  MYON_ENUM_FROM_UNSIGNED_CASE(MYON_BinaryArchive::eStorageDeviceError::SeekFailedDuringWriting);
  MYON_ENUM_FROM_UNSIGNED_CASE(MYON_BinaryArchive::eStorageDeviceError::ReadFailed);
  MYON_ENUM_FROM_UNSIGNED_CASE(MYON_BinaryArchive::eStorageDeviceError::SeekFailedDuringReading);
  MYON_ENUM_FROM_UNSIGNED_CASE(MYON_BinaryArchive::eStorageDeviceError::UnknownDeviceError);
  }

  MYON_ERROR("Invalid storage_device_error_as_unsigned parmeter.");
  return MYON_BinaryArchive::eStorageDeviceError::UnknownDeviceError;
}

unsigned int MYON_BinaryArchive::StorageDeviceError() const
{
  return m_storage_device_error;
}

void MYON_BinaryArchive::SetStorageDeviceError(
  ...
  )
{
  if (0 != storage_device_error)
  {
    ...
    {
      MYON_ERROR("Damaged file and / or buggy code. Please investigate.");
      m_storage_device_error = storage_device_error;
    }
  }
}

bool MYON_BinaryArchive::ToggleByteOrder(
...
MYON__UINT64 MYON_BinaryArchive::CurrentPosition() const
{
  return m_current_positionX;
}

bool MYON_BinaryArchive::Internal_IncrementCurrentPosition(
  MYON__UINT64 delta
)
{
  // TODO: Add error detection.
  const MYON__UINT64 new_pos = m_current_positionX + delta;
  m_current_positionX = new_pos;
  return true;
}

bool MYON_BinaryArchive::Internal_DecrementCurrentPosition(
  MYON__UINT64 delta
)
{
  ...
  MYON_ERROR("Attempt to set current position before start of archive.");

  return false;
}


bool MYON_BinaryArchive::SeekFromStart( MYON__UINT64 bytes_from_start )
{
  if (UnsetMode())
  {
    MYON_ERROR("Invalid archive Mode().");
    return false;
  }

  if (m_bChunkBoundaryCheck)
  {
    const MYON_3DM_BIG_CHUNK* c = m_chunk.Last();
    if (nullptr != c)
    {
      MYON_ERROR("Attempt to seek before beginning of current chunk.");
      return false;
    }
  } 
  ...
  if (0 != CurrentPosition() )
  {
    ...
    {
      MYON_ERROR("Internal_SeekToStartOverride() failed.");
      if (ReadMode())
        SetStorageDeviceError(MYON_BinaryArchive::eStorageDeviceError::SeekFailedDuringReading);
      if (WriteMode())
        SetStorageDeviceError(MYON_BinaryArchive::eStorageDeviceError::SeekFailedDuringWriting);
      return false;
    }
...
bool MYON_BinaryArchive::SeekForward( MYON__UINT64 bytes_forward )
{
  return Internal_SeekCur(true, bytes_forward);
}

bool MYON_BinaryArchive::SeekBackward( MYON__UINT64 bytes_backward )
{
  return Internal_SeekCur(false, bytes_backward);
}

bool MYON_BinaryArchive::Internal_SeekCur( bool bForward, MYON__UINT64 offset )
{
  ...
  const MYON__UINT64 current_pos = CurrentPosition();

  if (false == bForward && offset > current_pos)
  {
    MYON_ERROR("Attempt to seek before archive beginning.");
    return false;
  }

  const MYON__UINT64 new_pos
    = bForward
    ? (current_pos + offset)
    : (current_pos - offset);
  ...
  if (m_bChunkBoundaryCheck)
  {
    ...
    if (nullptr != c && c->m_start_offset <= current_pos && current_pos <= c->m_end_offset )
    {
      if (new_pos > c->m_end_offset)
      {
        ...
        MYON_ERROR("Attempt to seek beyond end of current chunk.");
        return false;
      }
  ...
  int ioffset;
  const MYON__UINT64 max_internal_seek = 2147483632; // < maximum signed 4 bytes int = 2147483647
  while ( offset > 0 )
  {
    const MYON__UINT64 delta = (offset > max_internal_seek) ? max_internal_seek : offset;
    ioffset = dir*((int)delta);
    if (false == Internal_SeekFromCurrentPositionOverride(ioffset))
    {
      MYON_ERROR("Internal_SeekFromCurrentPositionOverride(ioffset) failed.");
      if (ReadMode())
        SetStorageDeviceError(MYON_BinaryArchive::eStorageDeviceError::SeekFailedDuringReading);
      if (WriteMode())
        SetStorageDeviceError(MYON_BinaryArchive::eStorageDeviceError::SeekFailedDuringWriting);
...
bool
MYON_BinaryArchive::ReadChar(    // Read an array of 8 bit chars
...
bool
MYON_BinaryArchive::ReadChar(    // Read a single 8 bit char
  char* p
)
{
  return ReadByte(1, p);
...
bool
MYON_BinaryArchive::ReadChar(    // Read an array of 8 bit signed chars
		size_t count,       // number of chars to read
  MYON__INT8*  p
		)
{
...
bool
MYON_BinaryArchive::ReadChar(    // Read an array of 8 bit unsigned chars
...
bool
MYON_BinaryArchive::ReadChar(    // Read a single 8 bit signed char
		MYON__INT8* p
		)
{
  return ReadByte( 1, p );
...
bool
MYON_BinaryArchive::ReadChar(    // Read a single 8 bit unsigned char
		MYON__UINT8* p
		)
{
  return ReadByte( 1, p );
...
bool
MYON_BinaryArchive::ReadInt16( // Read an array of 16 bit integers
		size_t count,            // number of unsigned integers to read
		MYON__INT16* p
		)
{
  bool rc = ReadByte( count<<1, p );
  if (rc && m_endian == MYON::endian::big_endian)
  {
    // reverse byte order
...
bool
MYON_BinaryArchive::ReadShort(   // Read an array of 16 bit shorts
...
#pragma MYON_PRAGMA_WARNING_DISABLE_MSC(4127)
  ...
  if ( 2 == sizeof(*p) )
  {
    rc = ReadInt16( count, (MYON__INT16*)p );
  }
  else
  {
    size_t j;
...
bool
MYON_BinaryArchive::ReadShort(   // Read an array of 16 bit unsigned shorts
		size_t count,       // number of unsigned chars to read
		MYON__UINT16* p
		)
{
...
bool
MYON_BinaryArchive::ReadShort(   // Read a single 16 bit signed short
		MYON__INT16* p
		)
{
...
bool
MYON_BinaryArchive::ReadShort(   // Read a single 16 bit unsigned short
		MYON__UINT16* p
		)
{
  return ReadShort( 1, p );
...
bool
MYON_BinaryArchive::ReadInt32( // Read an array of 32 bit signed integers
...
bool
MYON_BinaryArchive::ReadInt( // Read an array of signed integers
		size_t count,          // number of signed chars to read
		MYON__INT32* p
		)
{
...
#pragma MYON_PRAGMA_WARNING_DISABLE_MSC( 4127 )
  ...
  if ( 4 == sizeof(*p) )
  {
    rc = ReadInt32( count, (MYON__INT32*)p );
  }
  else
  {
    rc = true;
...
bool
MYON_BinaryArchive::ReadInt( // Read an array of 32 bit unsigned integers
		size_t count,       // number of unsigned chars to read
		MYON__UINT32* p
		)
{
...
bool
MYON_BinaryArchive::ReadInt( // Read a single 32 bit signed integer
		MYON__INT32* p
		)
{
  return ReadInt( 1, p );
...
bool
MYON_BinaryArchive::ReadInt( // Read a single 32 bit unsigned integer
		MYON__UINT32* p
		)
{
  return ReadInt( 1, p );
...
bool MYON_BinaryArchive::ReadBigInt( // Read an array of 64 bit signed integers
		size_t count,
		MYON__INT64* p 
		)
{
...
bool MYON_BinaryArchive::ReadBigInt( // Read an array of 64 bit unsigned integers
		size_t count,
		MYON__UINT64* p
		)
{
  return ReadInt64(1,(MYON__INT64*)p);
}

bool MYON_BinaryArchive::ReadBigInt( // Read a single 64 bit signed integer
		MYON__INT64* p
		)
{
  return ReadInt64(1,p);
...
bool MYON_BinaryArchive::ReadBigInt( // Read a single 64 bit unsigned integer
		MYON__UINT64* p
		)
{
  return ReadInt64(1,(MYON__INT64*)p);
...
bool
MYON_BinaryArchive::ReadLong( // Read an array of 32 bit signed integers
...
bool
MYON_BinaryArchive::ReadLong( // Read an array of 32 bit integers
		size_t count,       // number of unsigned chars to read
		unsigned long* p
		)
{
...
bool
MYON_BinaryArchive::ReadLong( // Read a single 32 bit signed integer
		long* p
		)
{
#pragma MYON_PRAGMA_WARNING_PUSH
...
bool
MYON_BinaryArchive::ReadLong( // Read a single 32 bit unsigned integer
		unsigned long* p
		)
{
#pragma MYON_PRAGMA_WARNING_PUSH
...
bool
MYON_BinaryArchive::ReadFloat(   // Read an array of floats
		size_t count,       // number of unsigned chars to read
		float* p
		)
{
  // 32 bit floats and 32 bit integers have same size and endian issues
  return ReadInt32( count, (MYON__INT32*)p );
}

bool
MYON_BinaryArchive::ReadFloat(   // Read a single float
		float* p
		)
{
...
bool
MYON_BinaryArchive::ReadDouble(  // Read an array of IEEE 64 bit doubles
		size_t count,       // number of unsigned chars to read
		double* p
		)
{
...
bool
MYON_BinaryArchive::ReadDouble(  // Read a single double
		double* p
		)
{
...
bool
MYON_BinaryArchive::ReadColor( MYON_Color& color )
{
...
bool
MYON_BinaryArchive::ReadColor(MYON_4fColor& color)
{
  float f = 0.f;
...
bool MYON_BinaryArchive::WriteBoundingBox(const MYON_BoundingBox& bbox)
{
...
bool MYON_BinaryArchive::ReadBoundingBox(MYON_BoundingBox& bbox)
{
...
bool 
MYON_BinaryArchive::WriteXform( const MYON_Xform& x )
{
  return WriteDouble( 16, &x.m_xform[0][0] );
}

bool 
MYON_BinaryArchive::ReadXform( MYON_Xform& x )
{
  return ReadDouble( 16, &x.m_xform[0][0] );
}
bool 
MYON_BinaryArchive::WritePlaneEquation( const MYON_PlaneEquation& plane_equation )
{
...
bool 
MYON_BinaryArchive::ReadPlaneEquation( MYON_PlaneEquation& plane_equation )
{
...
bool 
MYON_BinaryArchive::WritePlane( const MYON_Plane& plane )
{
...
bool 
MYON_BinaryArchive::ReadPlane( MYON_Plane& plane )
{
...
bool 
MYON_BinaryArchive::WriteLine( const MYON_Line& line )
{
...
bool 
MYON_BinaryArchive::ReadLine( MYON_Line& line )
{
...
bool 
MYON_BinaryArchive::WriteArc(const MYON_Arc& arc )
{
...
bool 
MYON_BinaryArchive::ReadArc( MYON_Arc& arc )
{
...
bool 
MYON_BinaryArchive::WriteCircle(const MYON_Circle& circle)
{
  ...
  if (rc)
    rc = WritePoint( circle.PointAt(0.5*MYON_PI) );
  if (rc)
    rc = WritePoint( circle.PointAt(MYON_PI) );
  /*
  if (rc)
...
bool 
MYON_BinaryArchive::ReadCircle(MYON_Circle& circle)
{
  MYON_3dPoint scratch;
...
bool 
MYON_BinaryArchive::WriteInterval( const MYON_Interval& t )
{
  return WriteDouble( 2, t.m_t );
}

bool 
MYON_BinaryArchive::ReadInterval( MYON_Interval& t )
{
  return ReadDouble( 2, t.m_t );
}

bool
MYON_BinaryArchive::ReadUuid( MYON_UUID& uuid )
{
  bool    rc = ReadInt32( 1, (MYON__INT32*)(&uuid.Data1) );
  if (rc) rc = ReadInt16( 1, (MYON__INT16*)(&uuid.Data2) );
  if (rc) rc = ReadInt16( 1, (MYON__INT16*)(&uuid.Data3) );
  if (rc) rc = ReadByte( 8, uuid.Data4 );
  return rc;
}

bool MYON_BinaryArchive::ReadDisplayMaterialRef( MYON_DisplayMaterialRef& dmr )
{
...
bool
MYON_BinaryArchive::ReadTime( struct tm& utc )
{
  ...
  if ( rc ) {
    ...
    if ( utc.tm_yday < 0 || utc.tm_yday > 366 )
      rc = false;
    if ( !rc ) {
      MYON_ERROR("MYON_BinaryArchive::ReadTime() - bad time in archive");
    }
  }
  return rc;
}
...
bool
MYON_BinaryArchive::ReadStringSize( // Read size of nullptr terminated string
    size_t* sizeof_string          // (returned size includes nullptr terminator)
    )
{
  MYON__UINT32 ui32 = 0;
  bool rc = ReadInt32(1,(MYON__INT32*)&ui32);
  ...
  if (rc)
  {
    ...
    if ( 0 != (0xF000000 & ui32) )
    {
      ...
      MYON_ERROR("string element count is impossibly large");
      rc = false;
    }
    else if ( ui32 > 0 )
    {
      // make sure this is possible
      const MYON_3DM_BIG_CHUNK* curchunk = m_chunk.Last();
      if ( 0 != curchunk && 0 == (TCODE_SHORT & curchunk->m_typecode) )
      {
        if (    curchunk->m_big_value < 0 
             || ((MYON__INT64)ui32) > curchunk->m_big_value 
           )
        {
          MYON_ERROR("string element count exceeds current chunk size");
          rc = false;
        }
      }
    }
...
bool
MYON_BinaryArchive::ReadStringUTF8ElementCount(
  ...
  if (rc)
  {
    ...
    else if ( ui32 > 0 )
    {
      ...
      if ( 0 != curchunk && 0 == (TCODE_SHORT & curchunk->m_typecode) )
      {
        ...
        {
          MYON_ERROR("string byte count exceeds current chunk size");
          rc = false;
        }
      }
    }
...
bool
MYON_BinaryArchive::ReadStringUTF16ElementCount(
    size_t* string_utf16_element_count
    )
{
  MYON__UINT32 ui32 = 0;
  bool rc = ReadInt32(1,(MYON__INT32*)&ui32);
  // Note that ui32 = number of MYON__UINT16 elements in the string array, 
  ...
  if (rc)
  {
    ...
    else if ( ui32 > 0 )
    {
      ...
      if ( 0 != curchunk && 0 == (TCODE_SHORT & curchunk->m_typecode) )
      {
        const MYON__UINT64 unread_byte_count = curchunk->LengthRemaining(CurrentPosition());
        const MYON__UINT64 string_byte_count = (2 * ui32); // 2 = sizeof(MYON__UINT16)
...
bool
MYON_BinaryArchive::ReadString(         // Read nullptr terminated string
...
bool
MYON_BinaryArchive::ReadString(          // Read nullptr terminated unicode string
...
bool
MYON_BinaryArchive::ReadString( MYON_String& s )
{
  s.Destroy();
...
bool
MYON_BinaryArchive::ReadString( MYON_wString& s )
{
#if defined(MYON_COMPILER_MSC)
#pragma MYON_PRAGMA_WARNING_PUSH
// Disable the MSC /W4 "conditional expression is constant" warning
...
#pragma MYON_PRAGMA_WARNING_DISABLE_MSC( 4127 )
  ...
  {
    // string_utf16_element_count = number of MYON__INT16 elements in
    // the string.  This is almost always the same as the
    // number of unicode code points. However, if one of
    // the code points happens to require two MYON__INT16 
    ...
    if ( 2 == sizeof(wchar_t) ) 
    {
      ...
      rc = ReadInt16( string_utf16_element_count, (MYON__INT16*)s.Array() );
      if (rc)
    ...
    else if ( 4 == sizeof(wchar_t)  )
    {
      ...
      // utf16_buffer[].
      MYON_SimpleArray<MYON__UINT16> utf16_buffer(istring_utf16_element_count);
      rc = ReadInt16(string_utf16_element_count,(MYON__INT16*)utf16_buffer.Array());
      if(rc)
      {
        ...
        rc = false;
        const MYON__UINT16* sUTF16 = utf16_buffer.Array();
        const int bTestByteOrder = false;
        const int sUTF16_count = istring_utf16_element_count-1;
        const MYON__UINT32 error_code_point = 0xFFFD;
        const unsigned int error_mask = 0xFFFFFFFF;
        unsigned int error_status = 0;

        const int utf32_array_count = MYON_ConvertUTF16ToUTF32(
            bTestByteOrder,
            sUTF16,
            sUTF16_count,
            ...
            error_mask,
            error_code_point,
            0 // const MYON__UINT16** sNextUTF16
            );
        ...
        else if ( utf32_array_count > 0 )
        {
          ...
          const int utf32_array_count1 = MYON_ConvertUTF16ToUTF32(
              bTestByteOrder,
              sUTF16,
              sUTF16_count,
...
bool MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_MappingChannel>& a)
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
  ...
  {
    // MYON_MappingChannel::Write() puts the element in a chunk
    rc = a[i].Write(*this);
  }
  return rc;
}

bool MYON_BinaryArchive::WriteArray( const MYON_ClassArray<MYON_MaterialRef>& a)
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
  ...
  for  ( i = 0; i < count && rc; i++ )
  {
    // MYON_MaterialRef::Write() puts the element in a chunk
    rc = a[i].Write(*this);
  }
  return rc;
}
...
bool MYON_BinaryArchive::WriteArray( int count, const MYON_Layer* a)
{
  int i;
  if ( count < 0 || 0 == a )
    count = 0;
...
bool MYON_BinaryArchive::WriteArray( int count, const MYON_Layer*const* a)
{
  int i;
  if ( count < 0 || 0 == a )
    count = 0;
...
bool MYON_BinaryArchive::WriteArray( const MYON_ClassArray<MYON_MappingRef>& a )
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
  ...
  for  ( i = 0; i < count && rc; i++ )
  {
    // MYON_MappingRef::Write() puts the element in a chunk
    rc = a[i].Write(*this);
  }
  return rc;
}
...
bool MYON_BinaryArchive::WriteArray( const MYON_ClassArray<MYON_ObjRef>& a)
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
  ...
  for  ( i = 0; i < count && rc; i++ )
  {
    // MYON_ObjRef::Write() puts the element in a chunk
    rc = a[i].Write(*this);
  }
  return rc;
}

bool MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_ObjRef_IRefID>& a)
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
  ...
  for  ( i = 0; i < count && rc; i++ )
  {
    // MYON_ObjRef_IRefID::Write() puts the element in a chunk
    rc = a[i].Write(*this);
  }
  return rc;
}

bool MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_MappingChannel>& a )
{
  a.Empty();
  int i, count;
...
bool MYON_BinaryArchive::ReadArray( MYON_ClassArray<MYON_MaterialRef>& a)
{
  a.Empty();
  int i, count;
  bool rc = ReadInt( &count );
...
bool MYON_BinaryArchive::ReadArray( MYON_ObjectArray<class MYON_Layer>& a)
{
  a.Empty();
  int i, count;
  bool rc = ReadInt( &count );
...
bool MYON_BinaryArchive::ReadArray( MYON_SimpleArray<class MYON_Layer*>& a)
{
  a.Empty();
  MYON_Layer* layer;
  int i, count;
...
bool MYON_BinaryArchive::ReadArray( MYON_ClassArray<MYON_MappingRef>& a)
{
  a.Empty();
  int i, count;
  bool rc = ReadInt( &count );
...
bool MYON_BinaryArchive::ReadArray( MYON_ClassArray<MYON_ObjRef>& a)
{
  a.Empty();
  int i, count;
  bool rc = ReadInt( &count );
...
bool MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_ObjRef_IRefID>& a)
{
  a.Empty();
  int i, count;
  bool rc = ReadInt( &count );
...
bool MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_DisplayMaterialRef>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool 
MYON_BinaryArchive::ReadArray( MYON_ClassArray<MYON_String>& a)
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool 
MYON_BinaryArchive::ReadArray( MYON_ClassArray<MYON_wString>& a)
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_DisplayMaterialRef>& a )
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool 
MYON_BinaryArchive::WriteArray( const MYON_ClassArray<MYON_String>& a )
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool 
MYON_BinaryArchive::WriteArray( const MYON_ClassArray<MYON_wString>& a )
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool 
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<bool>& a )
{
#if defined(MYON_COMPILER_MSC)
// Disable the MSC /W4 "conditional expression is constant" warning
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<char>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON__INT8>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt(&count);
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON__INT16>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON__INT32>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray(MYON_SimpleArray<MYON__UINT8>& a)
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt(&count);
...
bool
MYON_BinaryArchive::ReadArray(MYON_SimpleArray<MYON__UINT16>& a)
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt(&count);
...
bool
MYON_BinaryArchive::ReadArray(MYON_SimpleArray<MYON__UINT32>& a)
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt(&count);
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<float>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<double>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_Color>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_2dPoint>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_3dPoint>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_4dPoint>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_2dVector>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_3dVector>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_Xform>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_2fPoint>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_3fPoint>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_4fPoint>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_2fVector>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_3fVector>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_UUID>& a )
{
  a.Empty();
  MYON_UUID uuid;
  int i, count = 0;
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_UuidIndex>& a )
{
  a.Empty();
  MYON_UuidIndex idi;
  int i, count = 0;
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_UuidPtr>& a )
{
  a.Empty();
  MYON_UuidPtr idi;
  int i, count = 0;
  ...
  if ( rc && count > 0 ) 
  {
    ...
    for ( i = 0; i < count && rc; i++ )
    {
      ...
      if ( rc )
      {
        MYON__UINT64 ptr = 0; // 64 bits on all platforms
        rc = ReadBigInt(&ptr);
        if (rc)
        {
          idi.m_ptr = (MYON__UINT_PTR)ptr;
          a.Append(idi);
        }
      }
    }
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_UUID>& a )
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_UuidIndex>& a )
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_UuidPtr>& a )
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
  ...
  for  ( i = 0; i < count && rc; i++ )
  {
    ...
    if (rc)
    {
      MYON__UINT64 ptr = (MYON__UINT64)a[i].m_ptr;
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_LinetypeSegment>& a )
{
  a.Empty();
  MYON_LinetypeSegment seg;
  int i, count = 0;
  bool rc = ReadInt( &count );
  if ( rc && count > 0 ) 
  {
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_LinetypeSegment>& a )
{
  int i, count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool MYON_BinaryArchive::ReadLinetypeSegment(MYON_LinetypeSegment& seg)
{
  seg = MYON_LinetypeSegment::OneMillimeterLine;
  bool rc = ReadDouble(&seg.m_length);
  if (rc)
  {
    // MYON_LinetypeSegment::eSegType::Unset was not added initialy, so juggling values is required for
    ...
    {
    case 0:
      i = static_cast<unsigned int>(MYON_LinetypeSegment::eSegType::stLine);
      break;
    case 1:
      i = static_cast<unsigned int>(MYON_LinetypeSegment::eSegType::stSpace);
      break;
    case MYON_UNSET_UINT_INDEX:
      i = static_cast<unsigned int>(MYON_LinetypeSegment::eSegType::Unset);
      break;
    }
    seg.m_seg_type = MYON_LinetypeSegment::SegmentTypeFromUnsigned(i);
  }
  return rc;
}


bool MYON_BinaryArchive::WriteLinetypeSegment( const MYON_LinetypeSegment& seg)
{
  ...
  if (rc)
  {
    ...
    {
    case MYON_LinetypeSegment::eSegType::Unset:
      i = MYON_UNSET_UINT_INDEX;
      break;
    case MYON_LinetypeSegment::eSegType::stLine:
      i = 0;
      break;
    case MYON_LinetypeSegment::eSegType::stSpace:
      i = 1;
      break;
    default:
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_SurfaceCurvature>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool
MYON_BinaryArchive::ReadArray( MYON_SimpleArray<MYON_ClippingPlaneInfo>& a )
{
  a.Empty();
  int count = 0;
  bool rc = ReadInt( &count );
...
bool MYON_BinaryArchive::WriteBool( bool b )
{
...
bool MYON_BinaryArchive::WriteBoolTrue()
{
...
bool MYON_BinaryArchive::WriteBoolFalse()
{
...
bool MYON_BinaryArchive::ReadBool( bool *b )
{
  unsigned char c;
  bool rc = ReadChar(&c);
  if (rc && b)
  {
    if ( c != 0 && c != 1 )
    {
      const unsigned int version_6_0_August_24_2017 = MYON_VersionNumberConstruct(6, 0, 2017, 8, 24, 0);
      ...
      else
      {
        ...
        MYON_ERROR("MYON_BinaryArchive::ReadBool - bool value != 0 and != 1");
        rc = false;
      }
    }
    *b = c?true:false;
...
bool
MYON_BinaryArchive::WriteChar(    // Write an array of 8 bit chars
...
bool
MYON_BinaryArchive::WriteChar(    // Write a single 8 bit char
  char c
)
{
...
bool
MYON_BinaryArchive::WriteChar(    // Write an array of 8 bit signed chars
  size_t count,       // number of chars to write
  const MYON__INT8* p
)
{
...
bool
MYON_BinaryArchive::WriteChar(    // Write an array of 8 bit unsigned chars
...
bool
MYON_BinaryArchive::WriteChar(    // Write a single 8 bit signed char
		MYON__INT8 c
		)
{
  return WriteByte( 1, &c );
...
bool
MYON_BinaryArchive::WriteChar(    // Write a single 8 bit unsigned char
		MYON__UINT8 c
		)
{
  return WriteByte( 1, &c );
...
bool
MYON_BinaryArchive::WriteInt16(   // Write an array of 16 bit shorts
		size_t count,               // number of shorts to write
		const MYON__INT16* p
		)
{
  bool rc = true;
  if (m_endian == MYON::endian::big_endian)
  {
    if ( count > 0 ) 
    {
...
bool
MYON_BinaryArchive::WriteShort(   // Write an array of 16 bit shorts
		size_t count,       // number of shorts to write
		const MYON__INT16* p
		)
{
...
#pragma MYON_PRAGMA_WARNING_DISABLE_MSC( 4127 )
  ...
  if ( 2 == sizeof(*p) )
  {
    rc = WriteInt16( count, (const MYON__INT16*)p );
  }
  else
  {
    rc = true;
...
bool
MYON_BinaryArchive::WriteShort(   // Write an array of 16 bit unsigned shorts
		size_t count,       // number of shorts to write
		const MYON__UINT16* p
		)
{
...
bool
MYON_BinaryArchive::WriteShort(   // Write a single 16 bit short
		MYON__INT16 s
		)
{
...
bool
MYON_BinaryArchive::WriteShort(   // Write a single 16 bit unsigned short
		MYON__UINT16 s
		)
{
  return WriteShort( 1, &s );
...
bool
MYON_BinaryArchive::WriteInt32( // Write an array of 32 bit integers
...
bool
MYON_BinaryArchive::ReadInt64( // Read an array of 64 bit integers
...
bool
MYON_BinaryArchive::WriteInt64( // Write an array of 64 bit integers
		size_t count,	            // number of ints to write
		const MYON__INT64* p    
		)
{
...
bool
MYON_BinaryArchive::WriteInt( // Write an array of integers
		size_t count,	          // number of ints to write
		const MYON__INT32* p
		)
{
...
#pragma MYON_PRAGMA_WARNING_DISABLE_MSC( 4127 )
  ...
  if ( 4 == sizeof(*p) )
  {
    rc = WriteInt32( count, (const MYON__INT32*)p );
  }
  else
  {
    MYON__INT32 i32;
...
bool
MYON_BinaryArchive::WriteSize(size_t sz)
{
...
bool
MYON_BinaryArchive::ReadSize(size_t* sz)
{
  unsigned int u = 0;
  bool rc = ReadInt(&u);
  if (rc)
...
bool MYON_BinaryArchive::WriteBigSize(size_t sz)
{
  MYON__UINT64 u = (MYON__UINT64)sz;
  return WriteInt64(1,(MYON__INT64*)&u);
}

bool MYON_BinaryArchive::ReadBigSize( size_t* sz )
{
  MYON__UINT64 u;
  bool rc = ReadInt64(1,(MYON__INT64*)&u);
  if (rc)
    *sz = (size_t)u;
  return rc;
}

bool MYON_BinaryArchive::WriteBigTime(time_t t)
{
  MYON__UINT64 u = (MYON__UINT64)t;
  return WriteInt64(1,(MYON__INT64*)&u);
}

bool MYON_BinaryArchive::ReadBigTime( time_t* t )
{
  MYON__UINT64 u;
  bool rc = ReadInt64(1,(MYON__INT64*)&u);
  if (rc)
...
bool
MYON_BinaryArchive::WriteInt( // Write an array of 32 bit integers
		size_t count,	      // number of ints to write
		const MYON__UINT32* p
		)
{
...
bool
MYON_BinaryArchive::WriteInt( // Write a single 32 bit signed integer
		MYON__INT32 i
		)
{
  return WriteInt( 1, &i );
...
bool
MYON_BinaryArchive::WriteInt( // Write a single 32 bit unsigned integer
		MYON__UINT32 i
		)
{
  return WriteInt( 1, &i );
...
bool MYON_BinaryArchive::WriteBigInt( // Write an array of 64 bit integers
		size_t count,
		const MYON__INT64* p      
		)
{
...
bool MYON_BinaryArchive::WriteBigInt( // Write an array of 64 bit integers
		size_t count,
		const MYON__UINT64* p     
		)
{
  return WriteInt64(count,(const MYON__INT64*)p);
}

bool MYON_BinaryArchive:: WriteBigInt( // Write a single 64 bit integer
		MYON__INT64 i
		)
{
...
bool MYON_BinaryArchive::WriteBigInt( // Write a single 64 bit unsigned integer
		MYON__UINT64 u
		)
{
  return WriteInt64(1,(const MYON__INT64*)&u);
}



bool
MYON_BinaryArchive::WriteLong( // Write an array of longs
...
bool
MYON_BinaryArchive::WriteLong( // Write a single long
		long i
		)
{
#pragma MYON_PRAGMA_WARNING_PUSH
...
bool
MYON_BinaryArchive::WriteLong( // Write a single unsigned long
		unsigned long i
		)
{
#pragma MYON_PRAGMA_WARNING_PUSH
...
bool
MYON_BinaryArchive::WriteFloat(   // Write a number of IEEE floats
...
bool
MYON_BinaryArchive::WriteFloat(   // Write a single float
		float f
		)
{
...
bool
MYON_BinaryArchive::WriteDouble(  // Write a single double
		size_t count,       // number of doubles
		const double* p
		)
{
...
bool
MYON_BinaryArchive::WriteComponentIndex(
		const MYON_COMPONENT_INDEX& ci
		)
{
...
bool
MYON_BinaryArchive::ReadComponentIndex(
		MYON_COMPONENT_INDEX& ci
		)
{
  int t;
  ci.m_type = MYON_COMPONENT_INDEX::invalid_type;
  ci.m_index = 0;
  bool rc = ReadInt( &t );
  if (rc)
  {
    ...
    if (rc)
    {
      ci.m_type = MYON_COMPONENT_INDEX::Type(t);
    }
...
bool
MYON_BinaryArchive::WriteColor( const MYON_Color& color )
{
...
bool
MYON_BinaryArchive::WriteColor(const MYON_4fColor& color)
{
...
bool
MYON_BinaryArchive::WriteVector (
...
bool
MYON_BinaryArchive::WriteVector (
  const MYON_3dVector& v
  )
{
  return WriteDouble( 3, &v.x );
}

bool MYON_BinaryArchive::WriteDisplayMaterialRef( const MYON_DisplayMaterialRef& dmr )
{
...
bool
MYON_BinaryArchive::WriteUuid( const MYON_UUID& uuid )
{
  bool    rc = WriteInt32( 1, (const MYON__INT32*)(&uuid.Data1) );
  if (rc) rc = WriteInt16( 1, (const MYON__INT16*)(&uuid.Data2) );
  if (rc) rc = WriteInt16( 1, (const MYON__INT16*)(&uuid.Data3) );
  if (rc) rc = WriteByte( 8, uuid.Data4 );
  return rc;
}

bool
MYON_BinaryArchive::WriteTime( const struct tm& utc )
{
  // utc = coordinated universal time ( a.k.a GMT, UTC )
  // (From ANSI C time() and gmtime().)
...
bool
MYON_BinaryArchive::WriteString( // Write nullptr terminated UTF-8 encoded unicode string
    const char* sUTF8
    )
{
  size_t string_utf8_element_count = 0;
  ...
  MYON__UINT32 ui32 = (MYON__UINT32)string_utf8_element_count;
  bool rc = WriteInt32(1,(MYON__INT32*)&ui32);
  if ( rc && string_utf8_element_count > 0 )
...
bool
MYON_BinaryArchive::WriteUTF16String(  
  ...
  )
{
  ...
  MYON__UINT32 ui32 = (MYON__UINT32)string_utf16_element_count;
  bool rc = WriteInt32(1,(MYON__INT32*)&ui32);
  if ( rc && string_utf16_element_count > 0 )
  {
...
bool
MYON_BinaryArchive::WriteString( const MYON_String& sUTF8 )
{
  // The MYON_String::IsValid call prevents corrupt strings from breaking file IO
...
bool MYON_BinaryArchive::WriteWideString(
  ...
  )
{
  ...
  for (;;)
  {
    ...
    for (;;)
    {
      ...
      int sUTF8_count = MYON_ConvertWideCharToUTF8(
        bTestByteOrder,
        sWideChar,
        sWideChar_count,
        sUTF8_buffer,
      ...
      {
        MYON_ERROR("Invalid wide char string - incomplete write.");
...
bool MYON_BinaryArchive::ReadWideString(
  MYON_wString& wide_string
  )
{
  wide_string = MYON_wString::EmptyString;
  ...
  for (;;)
  {
    ...
    for (int char_buffer_index=0; /*true*/; char_buffer_index = 1-char_buffer_index)
    {
      ...
      else if (chunk_byte_count > 0)
      {
        ...
        // in this comment.
        MYON_ERROR("char buffer reading stalled.");
        break;
      }
      ...
      if (chunk_byte_count > 0 && buffer_capacity == char_buffer_count[char_buffer_index])
      {
        ...
        if (c < 0 || c > 127)
        {
          ...
          if (c < 0 || c > 127)
          {
            ...
            MYON_ERROR("archive contents damaged.");
            break;
          }
        }
      }
      ...
      error_status = 0;
      sNextUTF8 = nullptr;
      int WideChar_count = MYON_ConvertUTF8ToWideChar(
        bTestByteOrder,
      ...
      {
        MYON_ERROR("Invalid UTF-8 encoding - incomplete string read.");
...
bool
MYON_BinaryArchive::WriteString( const MYON_wString& s )
{
...
#pragma MYON_PRAGMA_WARNING_DISABLE_MSC( 4127 )
  ...
  // The MYON_wString::IsValid call prevents corrupt strings from breaking file IO
  // The parameter MUST be false here.
  s.IsValid(false);
  ...
  {
    MYON__UINT32 ui32 = 0;
    rc = WriteInt32(1,(MYON__INT32*)&ui32);
  }
  else if ( 2 == sizeof(wchar_t) && string_element_count > 0 ) 
  {
    MYON__UINT32 ui32 = (MYON__UINT32)string_element_count;
    rc = WriteInt32(1,(MYON__INT32*)&ui32);
    if (rc)
      rc = WriteInt16( string_element_count, (const MYON__INT16*)s.Array() );
  }
  else if ( 4 == sizeof(wchar_t) && string_element_count > 0 )
  {
    ...
    const int bTestByteOrder = false;
    const MYON__UINT32* sUTF32 = (const MYON__UINT32*)s.Array();
    const int sUTF32_count = (int)(string_element_count-1);
    const unsigned int error_mask = 0xFFFFFFFF;
    const MYON__UINT32 error_code_point = 0xFFFD; 
    unsigned int error_status = 0;

    const int sUTF16_count = MYON_ConvertUTF32ToUTF16(
      bTestByteOrder,
      sUTF32,
      sUTF32_count,
      0, // MYON__UINT16* sUTF16,
      0, // int sUTF16_count,
      &error_status,
      error_mask,
      error_code_point,
    ...
    {
      error_status = 0;
      MYON_SimpleArray<MYON__UINT16> utf16_buffer(sUTF16_count+1);
      utf16_buffer.SetCount(sUTF16_count+1);
      const int sUTF16_count1 = MYON_ConvertUTF32ToUTF16(
        bTestByteOrder,
        sUTF32,
        sUTF32_count,
        utf16_buffer.Array(),
      ...
      if ( sUTF16_count1 == sUTF16_count )
      {
        ...
        const MYON__UINT32 ui32 = (MYON__UINT32)(sUTF16_count+1);
        rc = WriteInt32(1,(const MYON__INT32*)&ui32);
        if ( rc && ui32 > 0 )
          rc = WriteInt16( ui32, (const MYON__INT16*)utf16_buffer.Array() );
      }
    }
  }
  return rc;  
...
bool MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<bool>& a )
{
#if defined(MYON_COMPILER_MSC)
#pragma MYON_PRAGMA_WARNING_PUSH
// Disable the MSC /W4 "conditional expression is constant" warning
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<char>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray(const MYON_SimpleArray<MYON__INT8>& a)
{
  int count = a.Count();
  if (count < 0)
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON__INT16>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON__INT32>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray(const MYON_SimpleArray<MYON__UINT8>& a)
{
  int count = a.Count();
  if (count < 0)
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray(const MYON_SimpleArray<MYON__UINT16>& a)
{
  int count = a.Count();
  if (count < 0)
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray(const MYON_SimpleArray<MYON__UINT32>& a)
{
  int count = a.Count();
  if (count < 0)
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<float>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<double>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_Color>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_2dPoint>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_3dPoint>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_4dPoint>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_2dVector>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_3dVector>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_Xform>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_2fPoint>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_3fPoint>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_4fPoint>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_2fVector>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_3fVector>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_SurfaceCurvature>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteArray( const MYON_SimpleArray<MYON_ClippingPlaneInfo>& a )
{
  int count = a.Count();
  if ( count < 0 )
    count = 0;
...
bool
MYON_BinaryArchive::WriteObject( const MYON_Object* o )
{
  bool rc = false;
  if ( o )
    rc = WriteObject(*o);
...
bool MYON_BinaryArchive::ShouldSerializeUserDataItem(
    MYON_UUID application_id,
    MYON_UUID item_id
    ) const
{
  if (application_id == MYON_nil_uuid)
    return false;
  ...
  static const MYON_UUID MYON_V4V5_MeshNgonUserData_ID =
  ...
  unsigned int opennurbs_userdata_application_version = MYON_IsOpennurbsApplicationId(application_id);
  if (opennurbs_userdata_application_version >= 4)
  {
       ...
       )
    {
      ...
      // classes with an application id of MYON_opennurbs5_id are
    ...
    if (4 == opennurbs_userdata_application_version
      ...
      && MYON_V4V5_MeshNgonUserData_ID == item_id
      )
    {
      // MYON_V4V5_MeshNgonUserData is the only "critical" core 
      // opennurbs user data with an application id of 
      // MYON_opennurbs4_id and is saved only in V4 and V5 files.
      return true;
    }
  }

  const MYON_UserDataItemFilter *f = m_user_data_filter.Array();
  ...
  if (m_3dm_version > 0)
  {
    ...
    for (i--; i > 0; i--)
    {
      if (application_id == f[i].m_application_id)
      {
        for (;;)
        {
          if (MYON_nil_uuid == f[i].m_item_id || item_id == f[i].m_item_id)
  ...
  for (i--; i > 0; i--)
  {
    if (application_id == f[i].m_application_id)
    {
      if (item_id == f[i].m_item_id)
        return f[i].m_bSerialize;
      if (false == bFoundNilItemId && MYON_nil_uuid == f[i].m_item_id)
      {
...
bool MYON_BinaryArchive::ShouldSerializeUserDataDefault() const
{
...
bool MYON_BinaryArchive::SetShouldSerializeUserDataDefault(
  bool bSerialize
  )
{
...
bool MYON_BinaryArchive::SetShouldSerializeUserDataItem(
  MYON_UUID application_id,
  MYON_UUID item_id,
  ...
  )
{
  ...
  if (MYON_nil_uuid == application_id)
    return false;
  ...
  if (MYON_nil_uuid == application_id && MYON_nil_uuid == item_id)
  {
    m_user_data_filter[0].m_bSerialize = bSerializeUserDataItem ? true : false;
    return true;
  }

  MYON_UserDataItemFilter& f = m_user_data_filter.AppendNew();
...
bool MYON_BinaryArchive::ShouldWriteUserDataItem(
  const class MYON_Object* object,
  const class MYON_UserData* ud
  ) const
{
  if (nullptr == object)
    return false;
...
bool MYON_BinaryArchive::ShouldSerializeNoUserData() const
{
...
bool MYON_BinaryArchive::ShouldSerializeAllUserData() const
{
  const unsigned int count = m_user_data_filter.UnsignedCount();
  if (count <= 0)
...
bool MYON_BinaryArchive::ShouldSerializeSomeUserData() const
{
  const unsigned int count = m_user_data_filter.UnsignedCount();
  if (count <= 0)
    return false; // All user data is serialized
...
bool MYON_BinaryArchive::ObjectHasUserDataToWrite(const MYON_Object* object) const
{
  if (nullptr == object)
    return false;

  for (const MYON_UserData* ud = object->FirstUserData(); 0 != ud; ud = ud->Next())
  {
...
static
bool IsCoreUserData( const MYON_UserData* ud )
{
  // Userdata with IO code we trust.
  if ( 0 == ud )
    return false;
  
  if (MYON_IsRhinoApplicationId(ud->m_application_uuid) > 0)
    return true;

  if (MYON_IsOpennurbsApplicationId(ud->m_application_uuid) > 0)
    return true;
...
bool
MYON_BinaryArchive::WriteObject( const MYON_Object& model_object )
{
  // writes polymorphic object derived from MYON_Object in a way that
  // it can be recreated from MYON_BinaryArchive::ReadObject

  if ( m_3dm_version >= 1 && m_3dm_version <= 50 )
  {
    const MYON::object_type model_object_type = model_object.ObjectType();
    switch (model_object_type)
    {
    case MYON::object_type::curve_object:
      {
        if (m_3dm_version > 2)
          break;
        const MYON_Curve* curve = static_cast<const MYON_Curve*>(&model_object);
        if (nullptr == curve)
          break;
        if (nullptr != MYON_NurbsCurve::Cast(curve))
          break;
    ...
    case MYON::object_type::surface_object:
      {
        if (m_3dm_version > 2)
          break;
        const MYON_Surface* surface = static_cast<const MYON_Surface*>(&model_object);
        if (nullptr == surface)
          break;
        if (nullptr != MYON_NurbsSurface::Cast(surface))
          break;
    ...
    case MYON::extrusion_object:
      {
        if (m_3dm_version > 4)
          break;
        // 29 September 2010 Dale Lear
        //   MYON_Extrusion was added in V5.  It must be translated
        //   to a brep or surface to save it in a V4 file.
        const MYON_Extrusion* extrusion = MYON_Extrusion::Cast(&model_object);
        if (nullptr == extrusion)
          break;
        MYON_Object* V4_object = nullptr;
    ...
    case MYON::annotation_object:
      {
        const MYON_Annotation* V6_annotation = MYON_Annotation::Cast(&model_object);
        if (nullptr != V6_annotation)
          return Internal_WriteV5AnnotationObject(*V6_annotation, nullptr);
        if (m_3dm_version > 2)
          break;

        const MYON_OBSOLETE_V5_Annotation* V5_annotation = MYON_OBSOLETE_V5_Annotation::Cast(&model_object);
        if (nullptr != V5_annotation)
          return Internal_WriteV2AnnotationObject(*V5_annotation, nullptr);
      }
      break;

    case MYON::object_type::text_dot:
      {
        if (m_3dm_version > 2)
          break;
        const MYON_TextDot* text_dot = MYON_TextDot::Cast(&model_object);
        if (nullptr == text_dot)
          break;
        MYON_OBSOLETE_V2_TextDot V2_text_dot;
...
bool MYON_BinaryArchive::Internal_WriteV5AnnotationObject(
  const MYON_Annotation& V6_annotation,
  const MYON_3dmAnnotationContext* annotation_context
)
{
  if (m_3dm_version < 1 || m_3dm_version > 50)
  {
    MYON_ERROR("m_3dm_version must be bewtween 1 and 5");
    return false;
  }
  ...
  const MYON_UUID model_dim_style_id = V6_annotation.DimensionStyleId();
  int V5_3dm_archive_dim_style_index = MYON_UNSET_INT_INDEX;
  if (MYON_nil_uuid != model_dim_style_id)
  {
    for (unsigned int i = 0; i < m_archive_dim_style_table.UnsignedCount(); i++)
    {
      const MYON_DimStyle* model_dim_style = m_archive_dim_style_table[i];
    ...
    {
      const MYON_DimStyle& system_dim_style = MYON_DimStyle::SystemDimstyleFromId(model_dim_style_id);
  ...
  const MYON_DimStyle* override_style = nullptr;
  ...
  {
    const MYON_DimStyle& v6_override_style = V6_annotation.DimensionStyle(*dim_style);
    if (v6_override_style.ParentId() == dim_style->Id() && v6_override_style.HasOverrides())
    {
      const MYON_SHA1_Hash override_content_hash = v6_override_style.ContentHash();
      for (unsigned int i = 0; i < m_archive_dim_style_table.UnsignedCount(); i++)
      {
        const MYON_DimStyle* model_dim_style = m_archive_dim_style_table[i];
...
bool MYON_BinaryArchive::Internal_WriteObject(
  const MYON_Object& model_object
)
{
  const MYON_ClassId* pID = model_object.ClassId();
  if ( nullptr == pID )
  {
    MYON_ERROR("archive_object->ClassId() is nullptr.");
    return false;
  }
  ...
  for (;;)
  {
    ...
    if (false == BeginWrite3dmChunk(TCODE_OPENNURBS_CLASS_UUID, 0))
      break;
    const MYON_UUID object_class_id = pID->Uuid();
    ...
    {
      MYON_ERROR("archive_object->Write() failed.");
    }
...
bool MYON_BinaryArchive::WriteObjectUserData( const MYON_Object& object )
{
  if ( m_3dm_version < 3 )
  {
  ...
  bool rc = true;
  const MYON_UserData* ud;
  MYON_UUID userdata_classid;

  MYON_UserData* delete_this_ud = 0;
  ...
  for (ud = object.FirstUserData(); ud && rc; ud = ud->m_userdata_next) 
  {
    if (0 != delete_this_ud)
    {
      ...
      {
        if (const_cast<MYON_Object&>(object).DetachUserData(delete_this_ud))
    ...
    if (ud->DeleteAfterWrite(*this,&object))
      delete_this_ud = const_cast< MYON_UserData* >(ud);
    ...
    if ( 0 == MYON_UuidCompare( ud->m_userdata_uuid, MYON_nil_uuid ) )
      continue;
    if ( &object != ud->m_userdata_owner )
      continue;
    const MYON_ClassId* cid = ud->ClassId();
    if ( 0 == cid )
      continue;
    if ( cid == &MYON_CLASS_RTTI(MYON_UserData) )
      continue;
    if ( cid == &MYON_CLASS_RTTI(MYON_Object) )
      continue;
    ...
    // and ud is MYON_UnknownUserData.
    userdata_classid = ud->UserDataClassUuid();
    if ( 0 == MYON_UuidCompare( userdata_classid, MYON_nil_uuid ) )
      continue;
    if ( 0 == MYON_UuidCompare( userdata_classid, MYON_CLASS_ID(MYON_UserData) ) )
      continue;
    if ( 0 == MYON_UuidCompare( userdata_classid, MYON_CLASS_ID(MYON_Object) ) )
      continue;
    if (0 == MYON_UuidCompare(userdata_classid, MYON_CLASS_ID(MYON_UnknownUserData)))
      continue;
    if (0 == MYON_UuidCompare(userdata_classid, MYON_CLASS_ID(MYON_ObsoleteUserData)))
      continue;
    ...
    if ( 3 == m_3dm_version )
    {
      ...
      if ( m_V3_plugin_id_list.BinarySearch( &ud->m_application_uuid, MYON_UuidCompare ) < 0 )
        continue;
    }
    ...
    if ( MYON_UuidIsNil( ud->m_application_uuid ) )
    {
      // As of version 200909190 - a non-nil application_uuid is 
      // required in order for user data to be saved in a 
      // 3dm archive.
      MYON_Error(__FILE__,__LINE__,"Not saving %s userdata - m_application_uuid is nil.",cid->ClassName());
      continue; 
    }

    // See if we have unknown user data (goo) and make sure
    // IsUnknownUserData() agrees with MYON_UnknownUserData::Cast().
    const MYON_UnknownUserData* unknown_ud = MYON_UnknownUserData::Cast(ud);
    if ( 0 == unknown_ud )
    {
      if ( ud->IsUnknownUserData() )
      {
        MYON_ERROR("MYON_UnknownUserData::Cast(ud) is null and ud->IsUnknownUserData() is true.");
    ...
    else
    {
      if ( !ud->IsUnknownUserData() )
      {
        MYON_ERROR("MYON_UnknownUserData::Cast(ud) is not null and ud->IsUnknownUserData() is false.");
        continue; // something's wrong
      }
    }
    ...
    if (rc) {
      ...
      if (rc) 
      {
        ...
        if ( rc )
        {
          ...
          unsigned int app_ver_to_write = MYON_BinaryArchive::ArchiveOpenNURBSVersionToWrite(file_format_ver, app_ver);
      ...
      if (rc) 
      {
        ...
        if ( rc ) 
        {
          if ( 0 != unknown_ud )
          {
            ...
            //   MYON_UnknownUserData::Write() writes.  The
          ...
          {
            MYON_ERROR("m_user_data_depth < 0");
            m_user_data_depth = 0;
          }
          m_user_data_depth++;
...
int
MYON_BinaryArchive::LoadUserDataApplication( MYON_UUID application_id )
{
...
int MYON_BinaryArchive::ReadObject( MYON_Object** ppObject )
{
  if ( nullptr == ppObject ) 
  {
    MYON_ERROR("MYON_BinaryArchive::ReadObject() called with nullptr ppObject.");
    return 0;
  }
  *ppObject = nullptr;
...
int MYON_BinaryArchive::ReadObject( MYON_Object& object )
{
  MYON_Object* pObject = &object;
  return ReadObjectHelper(&pObject);
}


int MYON_BinaryArchive::ReadObjectHelper( MYON_Object** ppObject )
{
  ...
  //            new objects.
  MYON__UINT32 tcode;
  MYON__INT64 length_TCODE_OPENNURBS_CLASS = 0;
  MYON__INT64 length_TCODE_OPENNURBS_CLASS_UUID = 0;
  MYON__INT64 length_TCODE_OPENNURBS_CLASS_DATA = 0;
  MYON_UUID uuid;
  const MYON_ClassId* pID = 0;
  MYON_Object* pObject = *ppObject; // If not null, use input
  const bool bDestinationIsManaged = (nullptr == pObject);
  const MYON__INT64 sizeof_chunk_header = (MYON__INT64)(4 + SizeofChunkLength());
  const MYON__INT64 expected_length_TCODE_OPENNURBS_CLASS_UUID = 20;

  //bool bBogusUserData = false;

  // all MYON_Objects written by WriteObject are in a TCODE_OPENNURBS_CLASS chunk
  if ( false == BeginRead3dmBigChunk( &tcode, &length_TCODE_OPENNURBS_CLASS ) )
    return 0;

  // When a nullptr MYON_Object is written, the file has
  // 
  ...
  //
  // When a non-nullptr MYON_Object is written, the file has
  // 
  ...
  {
    MYON_ERROR("MYON_BinaryArchive::ReadObject() didn't find TCODE_OPENNURBS_CLASS block.");
  }
  else if ( length_TCODE_OPENNURBS_CLASS < expected_length_TCODE_OPENNURBS_CLASS_UUID + sizeof_chunk_header) 
  {
    MYON_ERROR("MYON_BinaryArchive::ReadObject() TCODE_OPENNURBS_CLASS chunk length too small.");
  }
  else 
  {
    ...
    for (;;) 
    {
      ...
      for (;;)
      {
        ...
        {
          MYON_ERROR("MYON_BinaryArchive::ReadObject() didn't find TCODE_OPENNURBS_CLASS_UUID block");
          break;
        }
        if (expected_length_TCODE_OPENNURBS_CLASS_UUID != length_TCODE_OPENNURBS_CLASS_UUID)
        {
          MYON_ERROR("MYON_BinaryArchive::ReadObject() TCODE_OPENNURBS_CLASS_UUID has invalid length");
          break;
        }
      ...
      rc = 1;
      if ( !MYON_UuidCompare( &uuid, &MYON_nil_uuid ) ) 
      {
        // nil UUID written if nullptr pointer is passed to WriteObject();
        break;
      }

      // Use UUID to get MYON_ClassId for this class //////////////////////////////////
      if ( nullptr != pObject )
      {
        pID = pObject->ClassId();
        if ( nullptr == pID ) 
        {
          ...
          MYON_WARNING(" pObject->ClassId() returned nullptr.");
          rc = 3;
          break;
        }
        if ( nullptr != pID && uuid != pID->Uuid() )
        {
          MYON_ERROR("MYON_BinaryArchive::ReadObject() - uuid does not match intput pObject's class id.");
          pID = 0;
          rc = 2;
          break;
        }
      ...
      {
        pID = MYON_ClassId::ClassId( uuid );
      }

      if ( nullptr == pID ) 
      {
        // If you get here and you are not calling MYON::Begin() at some point in your
        // executable, then call MYON::Begin() to force all class definition to be linked.
        // If you are callig MYON::Begin(), then either the uuid is garbage or you are 
        // attempting to read an object with old code.
        // Visit http://www.opennurbs.org to get the latest OpenNURBS code.
        MYON_WARNING("MYON_BinaryArchive::ReadObject() MYON_ClassId::ClassId(uuid) returned nullptr.");
        rc = 3;
        break;
      }
      ///////////////////////////////////////////////////////////////////////////////
      ...
      {
        MYON_ERROR("MYON_BinaryArchive::ReadObject() didn't find TCODE_OPENNURBS_CLASS_DATA block");
        rc = 0;
      }
      else if ( length_TCODE_OPENNURBS_CLASS_DATA <= 0  )
      {
        MYON_ERROR("MYON_BinaryArchive::ReadObject() TCODE_OPENNURBS_CLASS_DATA chunk length too small");
        rc = 0;
      }
      else 
      {
        ...
        if ( nullptr == pObject ) 
        {
          MYON_ERROR("MYON_BinaryArchive::ReadObject() pID->Create() returned nullptr.");
          rc = 0;
        }
        else 
        {
          ...
          {
            rc = 0;
            MYON_ERROR("MYON_BinaryArchive::ReadObject() pObject->Read() failed.");
          ...
          else 
          {
            *ppObject = pObject;
            if (
              nullptr != MYON_InstanceDefinition::Cast(pObject)
              && 60 == Archive3dmVersion() 
              && ArchiveOpenNURBSVersion() <= 2348834153
              )
            {
              // April 2016
              // The MYON_InstanceDefinition Read()/Write() code for V5 and early V6 WIPs was
...
bool MYON_BinaryArchive::ReadObjectUserDataAnonymousChunk( 
          ...
          MYON_UserData* ud )
{
     ...
     )
  {
    ...
    MYON_ReadChunkHelper ch(*this,bChunkReadSuccess);
    if (    !bChunkReadSuccess
         || TCODE_ANONYMOUS_CHUNK != ch.m_chunk_tcode
         || length_TCODE_ANONYMOUS_CHUNK != (MYON__UINT64)ch.m_chunk_value
       )
    {
      return false;
    }
    if ( ud->IsUnknownUserData() )
    {
      ...
      MYON_3DM_BIG_CHUNK* c = m_chunk.Last();
      const MYON__UINT64 sizeof_CRC = c->SizeofCRC();
  ...
  else
  {
    ...
    {
      MYON_Read3dmBufferArchive memory_archive(
        sizeof_buffer,
        buffer,
        false,
        archive_3dm_version,
      ...
      MYON_ReadChunkHelper ch(memory_archive,bChunkReadSuccess);
      if ( bTweakArchiveVersion )
          ...
          )
{
  bool rc = true;
  MYON__UINT32 t = 0;
  MYON__INT64 length_TCODE_OPENNURBS_CLASS_USERDATA_HEADER = 0;
  ...
  if ( major_userdata_version == 2 )
  {
    ...
    {
      MYON_ERROR("version 2.0 TCODE_OPENNURBS_CLASS_USERDATA chunk is missing TCODE_OPENNURBS_CLASS_USERDATA_HEADER chunk.");
  ...
  if ( major_userdata_version == 2 ) 
  {
    if ( minor_userdata_version >= 1 )
    {
      ...
      if ( minor_userdata_version >= 2 )
      {
        ...
        // into the file by MYON_UnknownUserData.
  ...
  if (!rc)
  {
    MYON_ERROR("Unable to read user data header information.");
    return false;
  }
...
bool MYON_BinaryArchive::ReadObjectUserData( MYON_Object& object )
{
  bool rc = true;
  bool bChunkReadSuccess = true;
  ...
  {
    // Note:
    //  The destructor ~MYON_ReadChunkHelper() may set bChunkReadSuccess
    ...
    if ( ch.m_chunk_value < (MYON__INT64)(8 + 4 * SizeofChunkLength()) )
    {
      MYON_ERROR("TCODE_OPENNURBS_CLASS_USERDATA chunk is too short");
      continue;
    }
    ...
    if ( !rc )
    {
      MYON_ERROR("Unable to read TCODE_OPENNURBS_CLASS_USERDATA chunk version numbers");
      break;
    }
    ...
    MYON__INT64 length_TCODE_ANONYMOUS_CHUNK = 0;
    for(;;)
    {
      MYON__UINT32 t = 0;
      ...
      {
        MYON_ERROR("Reading object user data - unable to find TCODE_ANONYMOUS_CHUNK");
        rc = false;
        break;
      }
      if ( length_TCODE_ANONYMOUS_CHUNK < 4 )
      {
        MYON_ERROR("Reading object user data - length of TCODE_ANONYMOUS_CHUNK < 4");
        rc = false;
        break;
      }
      break;
    ...
    for(;;)
    {
      const MYON_ClassId* udId = MYON_ClassId::ClassId( ud_header.m_classid );
      if ( 0 == udId ) 
      {
        // The application that created this userdata is not active
        if ( !MYON_UuidIsNil(ud_header.m_appid) )
        {
          // see if we can load the application
          if ( 1 == LoadUserDataApplication(ud_header.m_appid) )
          {
            // try again
            udId = MYON_ClassId::ClassId( ud_header.m_classid );
          }
        }
        ...
        if ( 0 == udId )
        {
          ...
          // in an MYON_UnknownUserData class so that it can
          // persist.
          udId = &MYON_CLASS_RTTI(MYON_UnknownUserData);
        }
      }

      MYON_Object* tmp = udId->Create();
      ud = MYON_UserData::Cast(tmp);
      if ( 0 == ud )
      {
        MYON_ERROR("Reading object user data - unable to create userdata class");
        if ( tmp )
          delete tmp;
        tmp = 0;
        break;
    ...
    if ( 0 == ud )
    {
      ...
      // its MYON_OBJECT_DECLARE/MYON_OBJECT_IMPLEMENT stuff.
      MYON_ERROR("Unable to create object user data class. Flawed class id information.");
      ...
      if ( MYON_UuidIsNil(ud_header.m_appid) )
      {
        ...
        case 4:
          if ( ArchiveOpenNURBSVersion() < 200909190 )
          {
            ...
            ud_header.m_appid = MYON_v4_userdata_id;
          }
          break;
        }
      }
    ...
    if ( ud->IsUnknownUserData() ) 
    {
      MYON_UnknownUserData* uud = MYON_UnknownUserData::Cast(ud);
      if ( uud ) 
      {
...
bool MYON_BinaryArchive::Write3dmChunkVersion(
...
bool MYON_BinaryArchive::Read3dmChunkVersion(
  int* major_version, // major // 0 to 15
  int* minor_version // minor // 0 to 16
  )
{
...
int MYON_BinaryArchive::Archive3dmVersion() const
{
  // 1,2,3,4,5,50,60,...
  return m_3dm_version;
}

unsigned int MYON_BinaryArchive::ArchiveOpenNURBSVersion() const
{
  return m_3dm_opennurbs_version;
}

MYON::RuntimeEnvironment MYON_BinaryArchive::ArchiveRuntimeEnvironment() const
{
  return m_archive_runtime_environment;
}

size_t MYON_BinaryArchive::ArchiveStartOffset() const
{
...
bool MYON_BinaryArchive::BeginWrite3dmChunk( unsigned int typecode, int value )
{
  MYON__INT64 value64 = 0;
  if ( 0 != value )
  {
    if ( MYON_IsUnsignedChunkTypecode(typecode) )
    {
      // treat value parameter as an unsigned int
      MYON__UINT32 u32 = (MYON__UINT32)value;
      MYON__UINT64 u64 = u32;
      value64 = (MYON__INT64)u64;
    }
    else
    {
...
bool MYON_BinaryArchive::BeginWrite3dmBigChunk( MYON__UINT32 typecode, MYON__INT64 value64 )
{
  if (false == WriteMode())
  {
    MYON_ERROR("WriteMode() = false.");
    return false;
  }
  m_bDoChunkCRC = false; // no CRC on chunks because length is written twice.
  bool rc = WriteInt32( 1, (MYON__INT32*)&typecode );
  if (rc)
...
bool MYON_BinaryArchive::BeginWrite3dmAnonymousChunk(
  int version
)
{
  ...
  if (version < 0)
  {
    MYON_ERROR("Incorrect version value.");
    return false;
  }
  return BeginWrite3dmChunk(TCODE_ANONYMOUS_CHUNK, major_version, version);
}

bool MYON_BinaryArchive::BeginRead3dmAnonymousChunk(
  int* version
)
{
  int major_version = 0;
  ...
  {
    MYON_ERROR("Incorrect major_version value.");
...
bool 
MYON_BinaryArchive::BeginWrite3dmChunk(
          unsigned int tcode,
          int major_version,
          int minor_version
          )
{
  ...
  {
    MYON_ERROR("MYON_BinaryArchive::BeginWrite3dmChunk - input tcode = 0");
  }
  else if ( 0 != (tcode & TCODE_SHORT) )
  {
    MYON_ERROR("MYON_BinaryArchive::BeginWrite3dmChunk - input tcode has short flag set.");
  }
  else if ( major_version <= 0 )
  {
    MYON_ERROR("MYON_BinaryArchive::BeginWrite3dmChunk - input major_version <= 0.");
  }
  else if ( minor_version < 0 )
  {
    MYON_ERROR("MYON_BinaryArchive::BeginWrite3dmChunk - input minor_version < 0.");
  }
  else
  {
...
bool 
MYON_BinaryArchive::EndWrite3dmChunk()
{
  if (false == WriteMode())
  {
    MYON_ERROR("WriteMode() = false.");
  ...
  if ( c ) 
  {
    if ( c->m_bLongChunk ) 
    {
      if ( c->m_do_crc16 ) 
      {
        ...
        MYON__UINT16 crc = MYON_CRC16( c->m_crc16, 2, two_zero_bytes );
        rc = WriteInt16( 1, (MYON__INT16*)&crc );
        if (c->m_crc16) 
        {
          // should never happen unless MYON_CRC16() code is damaged
          Internal_ReportCRCError();
          MYON_ERROR("MYON_BinaryArchive::EndWrite3dmChunk: CRC16 computation error.");
        }
      }
      else if ( c->m_do_crc32 ) 
      {
        // write 32 bit CRC
        const MYON__UINT32 crc0 = c->m_crc32; 
        rc = WriteInt32( 1, (MYON__INT32*)&crc0 );
      }
      else {
        rc = true;
      }
      ...
      // write length
      m_bDoChunkCRC = 0;
      const MYON__UINT64 offset = CurrentPosition();
      if ( offset < c->m_start_offset ) 
      {
        MYON_ERROR("MYON_BinaryArchive::EndWrite3dmChunk() - chunk length < 0");
        rc = false;
      }
      else 
      {
        ...
        MYON__UINT64 length = (offset - c->m_start_offset);
        ...
        {
          MYON_ERROR("MYON_BinaryArchive::EndWrite3dmChunk() - CurrentPosition() != offset");
          rc = false;
        }
      }
    }
    ...
    else
    {
      if ( c->m_bLongChunk )
      {
        MYON__UINT64 current_pos = CurrentPosition();
...
bool MYON_BinaryArchive::Write3dmGoo( const MYON_3dmGoo& goo )
{
  bool rc = false;
...
bool MYON_BinaryArchive::PeekAt3dmChunkType( unsigned int* typecode, int* value )
{
  ...
  if ( rc )
  {
    ...
    {
      MYON__INT32 i32 = 0;
      if ( MYON_IsUnsignedChunkTypecode(tc) )
        rc = DownSizeUINT((MYON__UINT64)i64,(MYON__UINT32*)&i32);
      else
...
bool MYON_BinaryArchive::PeekAt3dmBigChunkType( 
      ...
      )
{
  ...
  const MYON__UINT64 pos0 = CurrentPosition();
  MYON__UINT32 t = 0;
  MYON__INT64 v = 0;
  ...
  const MYON__UINT64 pos1 = CurrentPosition();
...
bool MYON_BinaryArchive::Seek3dmChunkFromStart( 
      ...
      )
{
  ...
  if ( ReadMode() ) 
  {
    ...
    if ( c ) 
    {
      ...
      if ( !MYON_IsLongChunkTypecode(c->m_typecode) ) 
      {
        MYON_ERROR("MYON_BinaryArchive::Seek3dmChunkFromStart() - current chunk is not a long chunk");
        return false;
      }
      if ( c->m_big_value < 0 ) 
      {
        MYON_ERROR("MYON_BinaryArchive::Seek3dmChunkFromStart() called with an active chunk that has m_value < 0");
        return false;
      }
      if ( pos0 < c->m_start_offset || pos0 > c->m_end_offset ) 
      {
        MYON_ERROR("MYON_BinaryArchive::Seek3dmChunkFromStart() called with out of bounds current position");
        return false;
      }
...
MYON__UINT64 MYON_3DM_BIG_CHUNK::Length() const
{
  return (MYON_IsLongChunkTypecode(m_typecode) && m_big_value >= 0 )
    ? ((MYON__UINT64)m_big_value)
    : 0;
}

MYON__UINT64 MYON_3DM_BIG_CHUNK::SizeofCRC() const
{
  const MYON__UINT64 sizeof_crc = m_do_crc32 ? 4 : (m_do_crc16 ? 2 : 0);
  return sizeof_crc;
}


MYON__UINT64 MYON_3DM_BIG_CHUNK::LengthRemaining(
...
bool MYON_BinaryArchive::Seek3dmChunkFromCurrentPosition( 
      ...
      )
{
  ...
  {
    const MYON_3DM_BIG_CHUNK* c = m_chunk.Last();
    const MYON__UINT64 pos1 = c ? c->m_start_offset + c->Length() : 0;
    const MYON__UINT64 pos_start = CurrentPosition();
    MYON__UINT64 pos_prev = 0;
    MYON__UINT64 pos = 0;
    unsigned int t;
    MYON__INT64 v64;
...
bool MYON_BinaryArchive::BeginRead3dmBigChunk( unsigned int* typecode, MYON__INT64* value )
{
  if (false == ReadMode())
  {
    MYON_ERROR("ReadMode() = false.");
    if (typecode)
      *typecode = 0;
    if (value)
      *value = 0;
  ...
  if (rc) 
  {
    if ( t == TCODE_ENDOFFILE ) 
    {
      ...
      MYON__UINT64 sizeof_file = 0;
      if ( rc )
        rc = ReadChunkValue( t, &v );
      if ( rc && v >= 0 && ((MYON__UINT64)v) >= SizeofChunkLength() ) 
      {
        MYON__UINT64 EOF_chunk_length = (MYON__UINT64)v;
        MYON__UINT64 pos0 = CurrentPosition();
        rc = ReadEOFSizeOfFile( &sizeof_file );
        MYON__UINT64 pos1 = CurrentPosition();
        if ( pos0 > 0 && pos1 > pos0 )
        {
        ...
        if ( rc ) 
        {
          ...
          {
            MYON__UINT64 pos2 = CurrentPosition(); 
            if ( m_3dm_version <= 1 )
            {
              if ( !AtEnd() ) 
              {
            ...
            else
            {
              ...
              if ( pos2 != sizeof_file ) {
                MYON_ERROR("MYON_BinaryArchive::BeginRead3dmChunk() - Rogue eof marker in v2 file.\n");
              }
            }
      ...
      {
        MYON_ERROR( "MYON_BinaryArchive::BeginRead3dmChunk() - file is damaged." );
        rc = false;
        t = 0; // ?? file is trashed ??
      }
    }
...
bool 
MYON_BinaryArchive::BeginRead3dmChunk(
          ...
          )
{
  ...
  {
    MYON_ERROR("MYON_BinaryArchive::BeginRead3dmChunk - input expected_tcode = 0");
  }
  else if ( 0 != (expected_tcode & TCODE_SHORT) )
  {
    MYON_ERROR("MYON_BinaryArchive::BeginRead3dmChunk - input expected_tcode has short flag set.");
  }
  else if ( 0 == major_version )
  {
    MYON_ERROR("MYON_BinaryArchive::BeginRead3dmChunk - input major_version nullptr");
  }
  else if ( 0 == minor_version )
  {
    MYON_ERROR("MYON_BinaryArchive::BeginRead3dmChunk - input minor_version nullptr");
  }
  else
  {
    *major_version = 0;
    *minor_version = 0;
    ...
    {
      MYON_ERROR("MYON_BinaryArchive::BeginRead3dmChunk - unexpected tcode");
      rc = false;
    }
    else if ( value < 8 )
    {
      MYON_ERROR("MYON_BinaryArchive::BeginRead3dmChunk - unexpected chunk length");
      rc = false;
    }
    else
    {
      ...
      if (rc)
      {
        if ( expected_tcode != tcode || value < 8 )
        {
          ...
          MYON_ERROR("MYON_BinaryArchive::BeginRead3dmChunk - unexpected tcode or chunk length - archive driver or device may be bad");
          rc = false;
        }
        else
        {
          ...
          {
            MYON_ERROR("MYON_BinaryArchive::BeginRead3dmChunk - major_version < 1");
            rc = false;
          }
          if (rc)
          {
            ...
            {
              MYON_ERROR("MYON_BinaryArchive::BeginRead3dmChunk - minor_version < 0");
              rc = false;
            }
          }
        }
...
bool MYON_BinaryArchive::EndRead3dmChunk()
{
  return EndRead3dmChunk(false);
}

bool MYON_BinaryArchive::EndRead3dmChunk(bool bSupressPartiallyReadChunkWarning)  
{
  if (false == ReadMode())
  {
    MYON_ERROR("ReadMode() = false.");
  ...
  if ( c ) 
  {
    MYON__UINT64 file_offset = CurrentPosition();
    MYON__UINT64 end_offset = c->m_start_offset;
    if ( c->m_bLongChunk )
    {
      if ( c->m_big_value < 0 )
      {
        Internal_ReportCriticalError();
        MYON_ERROR("MYON_BinaryArchive::EndRead3dmChunk - negative chunk length");
      }
      else
      {
        end_offset += ((MYON__UINT64)c->m_big_value);
      }
    }
    ...
    if ( c->m_bLongChunk ) 
    {
      ...
      if ( c->m_do_crc16 ) 
      {
        if ( file_offset+2 == end_offset )
        {
          ...
          if (rc) 
          {
            ...
            {
              Internal_ReportCRCError();
              MYON_ERROR("MYON_BinaryArchive::EndRead3dmChunk: CRC16 error.");
            }
          }
        }
        else
      ...
      else if ( c->m_do_crc32 ) 
      {
        ...
        {
          // read 32 bit CRC
          MYON__UINT32 crc1 = c->m_crc32;
          MYON__UINT32 crc0;
          m_bChunkBoundaryCheck = false;
          rc = ReadInt32( 1, (MYON__INT32*)&crc0 );
          m_bChunkBoundaryCheck = bChunkBoundaryCheck;
          if (rc) 
          {
            file_offset+=4;
            ...
            {
              Internal_ReportCRCError();
              MYON_ERROR("MYON_BinaryArchive::EndRead3dmChunk: CRC32 error.");
            }
          }
        }
        else
    ...
    {
      Internal_ReportCriticalError();
      MYON_ERROR("MYON_BinaryArchive::EndRead3dmChunk: current position before start of current chunk.");
    ...
    {
      Internal_ReportCriticalError();
      MYON_ERROR("MYON_BinaryArchive::EndRead3dmChunk: current position after end of current chunk.");
      if ( !SeekFromStart( end_offset ) )
        rc = false;
    }
    else if ( file_offset != end_offset ) 
    {
      ...
      if ( file_offset != c->m_start_offset ) 
      {
        if ( m_3dm_version != 1 || (m_error_message_mask&0x02) == 0 ) 
        {
          ...
          const bool bHaveAppDate = MYON_VersionNumberParse(
            MYON::Version(),
            &app_major_version,
            0,
            &app_year,
            ...
            )
          {
            ...
            {
              MYON_WARNING("MYON_BinaryArchive::EndRead3dmChunk: partially read chunk - skipping bytes at end of current chunk.");
            }
          }
        }
      }
...
bool MYON_BinaryArchive::BeginWriteDictionary(
...
#pragma MYON_PRAGMA_WARNING_DISABLE_MSC( 4127 )
  ...
  if ( rc )
  {
    for(;;)
    {
      ...
      {
        MYON_wString s(dictionary_name);
        rc = WriteString(s);
      }
      if (!rc) break;
      break;
...
bool MYON_BinaryArchive::EndWriteDictionary()
{
...
bool MYON_BinaryArchive::BeginWriteDictionaryEntry(
        int de_type, 
...
bool MYON_BinaryArchive::EndWriteDictionaryEntry()
{
  int chunk_count = m_chunk.Count();
...
bool MYON_BinaryArchive::BeginReadDictionary(
        MYON_UUID* dictionary_id,
        unsigned int* version,
...
bool MYON_BinaryArchive::EndReadDictionary()
{
  int chunk_count = m_chunk.Count();
  bool rc = ( chunk_count > 0 && TCODE_DICTIONARY == m_chunk[chunk_count-1].m_typecode )
          ? EndRead3dmChunk()
...
int MYON_BinaryArchive::BeginReadDictionaryEntry(
        int* de_type, 
        MYON_wString& entry_name
        )
{
  unsigned int tcode = 0;
  MYON__INT64 chunk_length = 0;
  int chunk_count = m_chunk.Count();
...
bool MYON_BinaryArchive::EndReadDictionaryEntry()
{
  int chunk_count = m_chunk.Count();
  bool rc = ( chunk_count > 0 && TCODE_DICTIONARY_ENTRY == m_chunk[chunk_count-1].m_typecode )
          ? EndRead3dmChunk()
...
bool MYON_BinaryArchive::Read3dmGoo( MYON_3dmGoo& goo )
{
  ...
  if (c) 
  {
    ...
    if ( c->m_bLongChunk )
      rc = DownSizeUINT(c->Length(),(MYON__UINT32*)&goo.m_value);
    else
...
bool MYON_BinaryArchive::WriteChunkTypecode( MYON__UINT32 typecode )
{
  return WriteInt32(1,(MYON__INT32*)&typecode);
}

bool MYON_BinaryArchive::ReadChunkTypecode( MYON__UINT32* typecode )
{
  MYON__UINT32 tc = 0;
  bool rc = ReadInt32(1,(MYON__INT32*)&tc);
  if (rc && typecode )
    *typecode = tc;
  return rc;
}

bool MYON_BinaryArchive::WriteChunkValue( MYON__UINT32 typecode, MYON__INT64 big_value )
{
  bool rc;
  ...
  else if ( MYON_IsUnsignedChunkTypecode(typecode) )
  {
    // treat big_value as an unsigned int
    MYON__UINT32 u32 = 0;
    rc = DownSizeUINT((MYON__UINT64)big_value,&u32);
    if ( !WriteInt32(1,(MYON__INT32*)&u32) )
      rc = false;
  }
  else
  {
...
bool MYON_BinaryArchive::WriteChunkLength( MYON__UINT64 length )
{
  bool rc;
  if ( 8 == SizeofChunkLength() )
  {
    rc = WriteInt64(1,(MYON__INT64*)&length);
  }
  else
  {
    MYON__UINT32 u32 = 0;
...
bool MYON_BinaryArchive::ReadEOFSizeOfFile( MYON__UINT64* sizeof_file )
{
  bool rc;
  MYON__INT64 u64 = 0;
  if ( 8 == SizeofChunkLength() )
  {
    ...
    rc = ReadInt64(1,(MYON__INT64*)&u64);
  }
  else
  {
    // file has a 4 byte file size
    MYON__UINT32 u32 = 0;
    rc = ReadInt32(1,(MYON__INT32*)&u32);
    if ( rc )
      u64 = u32;
  }
  if ( rc && 0 != sizeof_file )
...
bool MYON_BinaryArchive::WriteEOFSizeOfFile( MYON__UINT64 sizeof_file )
{
  bool rc;
  if ( 8 == SizeofChunkLength() )
  {
    // file has a 8 byte file size
    rc = WriteInt64(1,(MYON__INT64*)&sizeof_file);
  }
  else
  {
    // file has a 4 byte file size
    ...
    rc = WriteInt32(1,(MYON__INT32*)&u32);
  }
  return rc;
}

bool MYON_BinaryArchive::ReadChunkValue( MYON__UINT32 typecode, MYON__INT64* value64 )
{
  bool rc;
  MYON__INT64 i64 = 0;
  if ( 8 == SizeofChunkLength() )
...
bool MYON_BinaryArchive::ChunkBoundaryCheck() const
{
  return m_bChunkBoundaryCheck;
}

void MYON_BinaryArchive::SetChunkBoundaryCheck(
...
size_t MYON_BinaryArchive::SizeofChunkLength() const
{
...
bool MYON_BinaryArchive::PushBigChunk( MYON__UINT32 typecode, MYON__INT64 big_value )
{
  MYON_3DM_BIG_CHUNK c;
  memset(&c,0,sizeof(c));
  c.m_typecode  = typecode;
  c.m_big_value = big_value;
  MYON__UINT64 length = 0;
  MYON__UINT64 sizeof_crc = 0;
...
void MYON_BinaryArchive::EnableSave3dmRenderMeshes(
...
unsigned int MYON_BinaryArchive::Save3dmRenderMeshObjectTypeFlags() const
{
  return m_save_3dm_render_mesh_flags;
}

bool MYON_BinaryArchive::Save3dmRenderMesh(
...
void MYON_BinaryArchive::EnableSave3dmAnalysisMeshes(
  unsigned int object_type_flags,
...
unsigned int MYON_BinaryArchive::Save3dmAnalysisMeshObjectTypeFlags() const
{
  return m_save_3dm_analysis_mesh_flags;
}

bool MYON_BinaryArchive::Save3dmAnalysisMesh(
  MYON::object_type object_type
  ) const
{
...
void MYON_BinaryArchive::SetUseBufferCompression(
...
bool MYON_BinaryArchive::UseBufferCompression() const
{
  return m_bUseBufferCompression;
}
  
void MYON_BinaryArchive::SetSave3dmPreviewImage(
...
bool MYON_BinaryArchive::Save3dmPreviewImage() const
{
  return m_bSave3dmPreviewImage;
}

void MYON_BinaryArchive::SetModelSerialNumber(
...
void MYON_BinaryArchive::ClearModelSerialNumber()
{
...
void MYON_BinaryArchive::SetCheckForRemappedIds(
...
bool MYON_BinaryArchive::CheckForRemappedIds() const
{
  return this->m_bCheckForRemappedIds;
}


unsigned int MYON_BinaryArchive::ModelSerialNumber() const
{
  return m_model_serial_number;
}

unsigned int MYON_BinaryArchive::ReferenceModelSerialNumber() const
{
  return m_reference_model_serial_number;
}

unsigned int MYON_BinaryArchive::InstanceDefinitionModelSerialNumber() const
{
  return m_instance_definition_model_serial_number;
}

void MYON_BinaryArchive::SortUserDataFilter()
{
  ...
  if (count0 > 0)
  {
    if (count0 > 1)
    {
      m_user_data_filter.QuickSort(MYON_UserDataItemFilter::Compare);

      // remove duplicates
      MYON_UserDataItemFilter* f = m_user_data_filter.Array();
      unsigned int i0 = 1;
      f[0].m_precedence = 0;
      f[1].m_precedence = 1;
...
bool MYON_BinaryArchive::Begin3dmTable(
  MYON::archive_mode expected_mode,
  MYON_3dmArchiveTableType table
  )
{
  if (MYON_3dmArchiveTableType::Unset != Active3dmTable())
  {
    MYON_ERROR("Attempt to begin reading or writing a 3dm archive table while another table is active.");

    // call End3dmTable() but do not modify m_3dm_active_table or m_3dm_previous_table values.
    const MYON_3dmArchiveTableType saved_3dm_active_table = Active3dmTable();
    const MYON_3dmArchiveTableType saved_3dm_previous_table = Previous3dmTable();
  ...
  if (MYON::archive_mode::read3dm != expected_mode && MYON::archive_mode::write3dm != expected_mode)
  {
    MYON_ERROR("Invalid expected_mode parameter value.");
    return End3dmTable(table,false);
  }

  if (expected_mode != Mode())
  {
    MYON_ERROR("Archive read/write mode is opposited expected_mode.");
    return End3dmTable(table,false);
  }

  if ( table == MYON_3dmArchiveTableType::start_section )
  {
    // m_3dm_version is set during reading of the start section.
    if (0 != m_3dm_version && MYON::archive_mode::read3dm == Mode())
    {
      MYON_ERROR("Archive m_3dm_version is set during start section reading.");
      return End3dmTable(table,false);
    }
  }
  else
  {
    if (m_3dm_version <= 0)
    {
      MYON_ERROR("Archive m_3dm_version <= 0.");
      return End3dmTable(table,false);
    }
  }

  if (1 == m_3dm_version && MYON::archive_mode::write3dm == expected_mode)
  {
    MYON_ERROR("Current opennurbs does not write version 1 files.");
    return End3dmTable(table,false);
  }

  if (MYON_3dmArchiveTableType::Unset == table)
  {
    MYON_ERROR("Invalid table parameter value.");
    return End3dmTable(table,false);
  }
  ...
  {
    if (MYON_3dmArchiveTableType::user_table != table
      || MYON_3dmArchiveTableType::user_table != Previous3dmTable()
      )
    {
      MYON_ERROR("Multiple attempt to begin reading or writing a 3dm archive section.");
      return End3dmTable(table, false);
    }
  }

  for (MYON_3dmTableStatusLink* table_link = m_3dm_table_status_list; nullptr != table_link; table_link = table_link->m_next )
  {
  ...
  const unsigned int settings_index = static_cast<unsigned int>(MYON_3dmArchiveTableType::settings_table);
  while (previous_index < settings_index)
  {
    const unsigned int start_index = static_cast<unsigned int>(MYON_3dmArchiveTableType::start_section);
    const unsigned int properties_index = static_cast<unsigned int>(MYON_3dmArchiveTableType::properties_table);
    ...
    if (previous_index == properties_index && table_index == settings_index)
      break;
    MYON_ERROR("Must read/write 3dm archive start, properties and settings sections first.");
  ...
  MYON_3dmTableStatusLink* table_link = new MYON_3dmTableStatusLink();
  table_link->m_table_status.m_table_type = table;
  table_link->m_table_status.m_state = MYON_3dmArchiveTableStatus::TableState::Started;
...
bool MYON_BinaryArchive::Internal_Begin3dmTableRecord(
  MYON_3dmArchiveTableType table
  )
{
  if (MYON_3dmArchiveTableType::Unset == table)
  {
    Internal_ReportCriticalError();
    MYON_ERROR("Attempt to read/write a table record outside the scope of BeginRead/Write3dm...Table() / EndRead/Write3dm...Table().");
    return false;
  }
  if (Active3dmTable() != table)
  {
    Internal_ReportCriticalError();
    MYON_ERROR("Attempt to read/write a table record of the wrong type.");
    return false;
  }
  else
  {
    if ( nullptr != m_3dm_table_status_list 
      ...
      && MYON_3dmArchiveTableStatus::TableState::Started == m_3dm_table_status_list->m_table_status.m_state 
      )
      m_3dm_table_status_list->m_table_status.m_state = MYON_3dmArchiveTableStatus::TableState::InProgress;
  }
...
bool MYON_BinaryArchive::Read3dmTableRecord(
  MYON_3dmArchiveTableType table,
  void** ptr
  )
{
...
void MYON_BinaryArchive::Internal_Increment3dmTableItemCount()
{
  if (nullptr != m_3dm_table_status_list
    && Active3dmTable() == m_3dm_table_status_list->m_table_status.m_table_type
    && MYON_3dmArchiveTableStatus::TableState::InProgress == m_3dm_table_status_list->m_table_status.m_state
    )
  {
  ...
  {
    MYON_ERROR("Table item reading/writing not in progress.");
  }
}


bool MYON_BinaryArchive::End3dmTable(
  MYON_3dmArchiveTableType table,
  bool bSuccess
  )
{
  ...
  if (0 == m_chunk.Count())
  {
    ...
    {
      MYON_ERROR("End3dmTable() table does not match the active table setting.");
      rc = false;
    }
    ...
    {
      if (
        MYON_3dmArchiveTableType::user_table != table
        || MYON_3dmArchiveTableType::user_table != Previous3dmTable()
        )
      {
        MYON_ERROR("3dm archive tables read/written in incorrect order.");
        rc = false;
      }
    }
    ...
    if ( nullptr != m_3dm_table_status_list && m_3dm_active_table == m_3dm_table_status_list->m_table_status.m_table_type )
      m_3dm_table_status_list->m_table_status.m_state = MYON_3dmArchiveTableStatus::TableState::Finished;
    m_3dm_active_table = MYON_3dmArchiveTableType::Unset;
  }
  else
  {
    if (bReportError)
    ...
    MYON_ERROR("End3dmTable() called while chunks are open.");
    rc = false;
  }

  if (false == rc && MYON_3dmArchiveTableType::Unset == m_3dm_first_failed_table)
  {
    MYON_ERROR("Reading or writing 3dm archive first failure.");
    m_3dm_first_failed_table = table;
  }
  return rc;
}

bool MYON_BinaryArchive::WriteModelComponentName(const MYON_ModelComponent & model_component)
{
  MYON_wString valid_name;
  if (
    0 == m_user_data_depth
    && MYON_BinaryArchive::TableComponentType(this->m_3dm_active_table) == model_component.ComponentType()
    )
  {
    bool bPermitReferencePrefix = false;
    if (false == MYON_ModelComponent::IsValidComponentName(m_manifest, model_component, bPermitReferencePrefix, valid_name))
    {
...
void MYON_BinaryArchive::IntentionallyWriteCorrupt3dmStartSectionForExpertTesting()
{
  if (MYON::archive_mode::write3dm == m_mode)
  {
    ...
    {
      MYON_ERROR("Please read the instructions in the header file.");
...
bool MYON_BinaryArchive::Write3dmStartSection(int version, const char* sStartSectionComment)
{
  if (!Begin3dmTable(MYON::archive_mode::write3dm,MYON_3dmArchiveTableType::start_section))
    return false;

  m_archive_runtime_environment = MYON::CurrentRuntimeEnvironment();
  ...
  if ( version > MYON_BinaryArchive::CurrentArchiveVersion() )
  {
    MYON_ERROR("3dm archive version must be <= MYON_BinaryArchive::CurrentArchiveVersion() ");
    return End3dmTable(MYON_3dmArchiveTableType::start_section,false);
  }
       ...
       )
  {
    ...
    MYON_ERROR("3dm archive version must be 2, 3, 4, 50, 60, 70, ...");
    return End3dmTable(MYON_3dmArchiveTableType::start_section,false);
  }
  ...
  m_3dm_opennurbs_version = MYON::Version();
  ...
  for (;;)
  {
    ...
    const MYON_String runtime(Internal_RuntimeEnvironmentToString(MYON::CurrentRuntimeEnvironment()));
    char s[2048];
    const size_t s_capacity = sizeof(s)/sizeof(s[0]);
    int s_len 
      = MYON_String::FormatIntoBuffer(
        s,s_capacity,
  ...
  return End3dmTable(MYON_3dmArchiveTableType::start_section,rc);
}
...
static MYON::RuntimeEnvironment Internal_RuntimeEnvironmentFromString(
...
)
{
  ...
  const MYON_String runtime_windows(Internal_RuntimeEnvironmentToString(MYON::RuntimeEnvironment::Windows));
  const MYON_String runtime_android(Internal_RuntimeEnvironmentToString(MYON::RuntimeEnvironment::Android));
  const MYON_String runtime_apple(Internal_RuntimeEnvironmentToString(MYON::RuntimeEnvironment::Apple));
  ...
  for ( int i0 = 0; i0 < 2; i0++)
  {
    for (int pass = 0; pass < 3; pass++)
    {
      ...
      MYON::RuntimeEnvironment r = MYON::RuntimeEnvironment::Unset;
      switch (pass)
      {
      case 0:
        tokens = sRuntimeWindows;
        r = MYON::RuntimeEnvironment::Windows;
        break;
      case 1:
        tokens = sRuntimeAndroid;
        r = MYON::RuntimeEnvironment::Android;
        break;
      case 2:
        tokens = sRuntimeApple;
        r = MYON::RuntimeEnvironment::Apple;
        break;
      }
...
static MYON::RuntimeEnvironment Internal_RuntimeEnvironmentFromWideString(
  const MYON_wString& wide_string
)
{
  const MYON_String str(wide_string);
  return Internal_RuntimeEnvironmentFromString(str);
}


bool MYON_BinaryArchive::Read3dmStartSection( int* version, MYON_String& s )
{
  ...
  if (!Begin3dmTable(MYON::archive_mode::read3dm,MYON_3dmArchiveTableType::start_section))
    return false;

  m_archive_3dm_start_section_comment = MYON_String::EmptyString;
  
  SortUserDataFilter();

  unsigned int typecode = 0;
  MYON__INT64 length = -1;
  if ( version )
  ...
  if ( 0 != strncmp( s3d, "3D Geometry File Format ", 24) ) 
  {
    ...
    if (0 == offset)
    {
      MYON_ERROR("3dm start section header not found.");
      return End3dmTable(MYON_3dmArchiveTableType::start_section,false);
    }
  ...
  while (i < 32)
  {
    ...
    if ( s3d[i] < '0' || s3d[i] > '9' )
    {
      ...
      MYON_ERROR("3dm start section header is not valid.");
      return End3dmTable(MYON_3dmArchiveTableType::start_section,false);
    }
  ...
  if (ver <= 0)
  {
    MYON_ERROR("3dm start section version is not valid.");
    return End3dmTable(MYON_3dmArchiveTableType::start_section,false);
  }
  ...
  for (;;)
  {
    ...
    if ( length > 0 ) 
    {
      ...
      {
        MYON_ERROR("MYON_BinaryArchive::Read3dmStartSection - start section string is unreasonably long.");
        rc = false;
      }
      else 
      {
  ...
  if (MYON::RuntimeEnvironment::Unset == m_archive_runtime_environment)
  {
        ...
        switch(typecode)
        {
          ...
          default:
            if ( TCODE_TABLE == (typecode & 0xFFFF0000) ) {
              ...
              MYON_WARNING("MYON_BinaryArchive::Read3dmStartSection(): Archive has V1 header and V2 body. Continuing to read V2 body.");
              m_3dm_version = 2;
              if ( version )
                *version = 2;
            }
  ...
  if (0 == m_3dm_version)
  {
    MYON_ERROR("3dm archive start section is damaged.");
    m_3dm_version = 10*MYON::VersionMajor();
    rc = false;
  }
...
const MYON_String& MYON_BinaryArchive::Archive3dmStartSectionComment() const
{
  return m_archive_3dm_start_section_comment;
}

const MYON_3dmProperties& MYON_BinaryArchive::Archive3dmProperties() const
{
  if (nullptr != m_archive_3dm_properties)
    return *m_archive_3dm_properties;

  return MYON_3dmProperties::Empty;
}

const MYON_3dmSettings& MYON_BinaryArchive::Archive3dmSettings() const
{
  if (nullptr != m_archive_3dm_settings)
    return *m_archive_3dm_settings;

  return MYON_3dmSettings::Default;
}

bool MYON_BinaryArchive::Write3dmProperties(
      const MYON_3dmProperties& prop
      )
{
  if (!Begin3dmTable(MYON::archive_mode::write3dm,MYON_3dmArchiveTableType::properties_table))
    return false;
  ...
  const bool final_rc = End3dmTable(MYON_3dmArchiveTableType::properties_table,rc);
  if (final_rc)
  {
    m_archive_3dm_properties = new MYON_3dmProperties(prop);
  }
  return final_rc;
}
...
bool MYON_BinaryArchive::Read3dmProperties( MYON_3dmProperties& prop )
{
  prop = MYON_3dmProperties::Empty;

  if (!Begin3dmTable(MYON::archive_mode::read3dm,MYON_3dmArchiveTableType::properties_table))
    return false;
  ...
  // In MYON_3dmProperties::Read(), m_3dm_opennurbs_version will be 
    ...
    for(;;) 
    {
      ...
      if ( tcode == TCODE_PROPERTIES_TABLE )
      {
        ...
        if (rc)
        {
          ...
          //   path information in MYON_FileReference classes 
  ...
  else 
  {
    ...
    for(;;) 
    {
      ...
      case 1: // comments section has application name
        ...
        {
          MYON_ERROR("Comment length > 1000000");
        }
        else if ( big_value > 1 )
        {
  ...
  if (0 == m_3dm_opennurbs_version)
  {
    ...
    {
      MYON_ERROR("The 3dm archive properties section is damaged.");
      m_3dm_opennurbs_version = MYON::Version();
    }
  }
...
bool MYON_BinaryArchive::Write3dmSettings(
      const MYON_3dmSettings& settings
      )
{
  if (!Begin3dmTable(MYON::archive_mode::write3dm,MYON_3dmArchiveTableType::settings_table))
    return false;
  ...
  if ( rc && 3 == Archive3dmVersion() )
  {
    ...
    for ( i = 0; i < count; i++ )
    {
      const MYON_UUID& pid = settings.m_plugin_list[i].m_plugin_id;
      if ( !MYON_UuidIsNil(pid) )
    ...
    m_V3_plugin_id_list.Append( MYON_v3_userdata_id );
    m_V3_plugin_id_list.Append( MYON_v4_userdata_id );
    m_V3_plugin_id_list.Append( MYON_opennurbs4_id );
    m_V3_plugin_id_list.Append( MYON_opennurbs5_id );
    m_V3_plugin_id_list.Append( MYON_opennurbs6_id );
    m_V3_plugin_id_list.Append( MYON_opennurbs7_id );
    m_V3_plugin_id_list.Append( MYON_rhino3_id );
    m_V3_plugin_id_list.Append( MYON_rhino4_id );
    m_V3_plugin_id_list.Append( MYON_rhino5_id );
    m_V3_plugin_id_list.Append( MYON_rhino6_id );
    m_V3_plugin_id_list.Append( MYON_rhino7_id );
    m_V3_plugin_id_list.QuickSort( MYON_UuidCompare );
  }

  bool final_rc = End3dmTable(MYON_3dmArchiveTableType::settings_table,rc);

  if (final_rc)
  {
    m_archive_3dm_settings = new MYON_3dmSettings(settings);
...
bool MYON_BinaryArchive::Read3dmSettings( MYON_3dmSettings& settings )
{
  if (!Begin3dmTable(MYON::archive_mode::read3dm,MYON_3dmArchiveTableType::settings_table))
    return false;
...
bool MYON_BinaryArchive::ArchiveContains3dmTable(
  MYON_3dmArchiveTableType table,
  unsigned int archive_3dm_version,
  ...
  )
{
  ...
  switch (table)
  {
  case MYON_3dmArchiveTableType::Unset:
    rc = false;
    break;
  case MYON_3dmArchiveTableType::start_section:
    rc = true;
    break;
  case MYON_3dmArchiveTableType::properties_table:
    rc = true;
    break;
  case MYON_3dmArchiveTableType::settings_table:
    rc = true;
    break;
  case MYON_3dmArchiveTableType::bitmap_table:
    rc = (archive_3dm_version >= 2);
    break;
  case MYON_3dmArchiveTableType::texture_mapping_table:
    rc = (archive_3dm_version >= 4 && opennurbs_library_version >= 200511110);
    break;
  case MYON_3dmArchiveTableType::material_table:
    rc = true;
    break;
  case MYON_3dmArchiveTableType::linetype_table:
    rc = (archive_3dm_version >= 4 && opennurbs_library_version >= 200503170 );
    break;
  case MYON_3dmArchiveTableType::layer_table:
    rc = true;
    break;
  case MYON_3dmArchiveTableType::group_table:
    rc = (archive_3dm_version >= 2 && opennurbs_library_version >= 200012210);
    break;
  case MYON_3dmArchiveTableType::text_style_table:
    rc =  (archive_3dm_version >= 3 && opennurbs_library_version >= 200109180);
    break;
  case MYON_3dmArchiveTableType::dimension_style_table:
    rc =  (archive_3dm_version >= 3 && opennurbs_library_version >= 200109260);
    break;
  case MYON_3dmArchiveTableType::light_table:
    rc = true;
    break;
  case MYON_3dmArchiveTableType::hatchpattern_table:
    rc = (archive_3dm_version >= 4 && opennurbs_library_version >= 200405030);
    break;
  case MYON_3dmArchiveTableType::instance_definition_table:
    rc = (archive_3dm_version >= 3 && opennurbs_library_version >= 200205110);
    break;
  case MYON_3dmArchiveTableType::object_table:
    rc = true;
    break;
  case MYON_3dmArchiveTableType::historyrecord_table:
    rc = ( archive_3dm_version >= 4 && opennurbs_library_version >= 200601180 );
    break;
  case MYON_3dmArchiveTableType::user_table:
    rc = ( archive_3dm_version >= 4);
    break;
  case MYON_3dmArchiveTableType::end_mark:
    rc = true;
    break;
  default:
    rc = false;
  ...
  ) const
{
  ...
  if (MYON::archive_mode::read3dm == Mode())
    opennurbs_library_version = m_3dm_opennurbs_version;
  else if (MYON::archive_mode::write3dm == Mode())
    opennurbs_library_version = MYON::Version();

  if ( 0 == opennurbs_library_version && m_3dm_version <= 3)
    opennurbs_library_version = 200012210;
  
  return MYON_BinaryArchive::ArchiveContains3dmTable(
    table,
    m_3dm_version,
...
MYON_3dmArchiveTableType MYON_BinaryArchive::TableTypeFromTypecode( unsigned int typecode )
{
  MYON_3dmArchiveTableType tt;
  switch(typecode) 
  {
  case 0:
    ...
    break;
  case TCODE_PROPERTIES_TABLE: 
    tt = MYON_3dmArchiveTableType::properties_table;
    break;
  case TCODE_SETTINGS_TABLE:  
    tt = MYON_3dmArchiveTableType::settings_table;
    break;
  case TCODE_BITMAP_TABLE:    
    tt = MYON_3dmArchiveTableType::bitmap_table;
    break;
  case TCODE_TEXTURE_MAPPING_TABLE:
    tt = MYON_3dmArchiveTableType::texture_mapping_table; 
    break;
  case TCODE_MATERIAL_TABLE:  
    tt = MYON_3dmArchiveTableType::material_table;
    break;
  case TCODE_LINETYPE_TABLE:  
    tt = MYON_3dmArchiveTableType::linetype_table;
    break;
  case TCODE_LAYER_TABLE:   
    tt = MYON_3dmArchiveTableType::layer_table;
    break;
  case TCODE_LIGHT_TABLE:   
    tt = MYON_3dmArchiveTableType::light_table;
    break;
  case TCODE_OBJECT_TABLE:  
    tt = MYON_3dmArchiveTableType::object_table;
    break;
  case TCODE_GROUP_TABLE:  
    tt = MYON_3dmArchiveTableType::group_table;
    break;
  case TCODE_FONT_TABLE: 
    tt = MYON_3dmArchiveTableType::text_style_table;
    break;
  case TCODE_DIMSTYLE_TABLE: 
    tt = MYON_3dmArchiveTableType::dimension_style_table; 
    break;
  case TCODE_HATCHPATTERN_TABLE:
    tt = MYON_3dmArchiveTableType::hatchpattern_table; 
    break;
  case TCODE_INSTANCE_DEFINITION_TABLE:
    tt = MYON_3dmArchiveTableType::instance_definition_table; 
    break;
  case TCODE_HISTORYRECORD_TABLE:
    tt = MYON_3dmArchiveTableType::historyrecord_table; 
    break;
  case TCODE_USER_TABLE: 
    tt = MYON_3dmArchiveTableType::user_table; 
    break;
  default:
    MYON_ERROR("invalid typecode value");
    tt = MYON_3dmArchiveTableType::Unset;
    break;
  }
  return tt;
}

bool MYON_BinaryArchive::BeginWrite3dmTable( unsigned int typecode )
{
  if (0 == typecode)
  {
    MYON_ERROR("MYON_BinaryArchive::BeginWrite3dmTable() bad typecode");
    return false;
  }
  const MYON_3dmArchiveTableType tt = TableTypeFromTypecode(typecode);
  if (tt == MYON_3dmArchiveTableType::Unset) 
  {
    MYON_ERROR("MYON_BinaryArchive::BeginWrite3dmTable() bad typecode");
    return false;
  }
  if ( Active3dmTable() != MYON_3dmArchiveTableType::Unset )
  {
    MYON_ERROR("MYON_BinaryArchive::BeginWrite3dmTable() m_active_table != no_active_table");
    return false;
  }
  if ( 0 != m_chunk.Count() ) 
  {
    MYON_ERROR("MYON_BinaryArchive::BeginWrite3dmTable() m_chunk.Count() != 0");
    return false;
  }
  if (false == Begin3dmTable(MYON::archive_mode::write3dm,tt))
    return false;
...
bool MYON_BinaryArchive::EndWrite3dmTable( unsigned int typecode )
{
  const MYON_3dmArchiveTableType tt = TableTypeFromTypecode(typecode);
  if (tt == MYON_3dmArchiveTableType::Unset)
  {
    MYON_ERROR("MYON_BinaryArchive::EndWrite3dmTable() bad typecode");
    return false;
  }
  if ( Active3dmTable() != tt )
  {
    MYON_ERROR("MYON_BinaryArchive::EndWrite3dmTable() m_active_table != t");
    return false;
  }
  if ( m_chunk.Count() != 1 )
  {
    MYON_ERROR("MYON_BinaryArchive::EndWrite3dmTable() m_chunk.Count() != 1");
    return false;
  }
  const MYON_3DM_BIG_CHUNK* c = m_chunk.Last();
  if ( 0 == c || c->m_typecode != typecode ) 
  {
    MYON_ERROR("MYON_BinaryArchive::EndWrite3dmTable() m_chunk.Last()->typecode != typecode");
    return false;
  }
...
bool MYON_BinaryArchive::BeginRead3dmTable( unsigned int typecode )
{
  bool rc = false;
  if (MYON::archive_mode::read3dm != Mode())
  {
    MYON_ERROR("MYON_BinaryArchive::BeginRead3dmTable() MYON::archive_mode::read3dm != Mode()");
    return false;
  }

  if (0 == typecode) 
  {
    MYON_ERROR("MYON_BinaryArchive::BeginRead3dmTable() bad typecode");
    return false;
  }
  ...
  const bool bUserTable = ( TCODE_USER_TABLE == typecode || MYON_3dmArchiveTableType::user_table == tt );

  if (static_cast<unsigned int>(tt) <= static_cast<unsigned int>(MYON_3dmArchiveTableType::settings_table))
  {
    MYON_ERROR("MYON_BinaryArchive::BeginRead3dmTable cannot be used for start, properties, or settings table.");
    return false;
  }
  ...
  if (false == ArchiveContains3dmTable(tt))
  {
    ...
    return Begin3dmTable(MYON::archive_mode::read3dm,tt);
  }
  ...
  if ( m_3dm_version <= 1 ) 
  {
      ...
      rc = SeekFromStart(32)?true:false;
      if (Begin3dmTable(MYON::archive_mode::read3dm, tt))
      {
        if (false == rc)
          End3dmTable(tt, false);
      }
  ...
  if ( rc )
  {
    if ( tcode != typecode ) 
    {
          ...
          && 200405190 <= m_3dm_opennurbs_version )
      {
        ...
        // an MYON_ERROR alert about something we can work around
      ...
      if ( bSeekFromStart )
      {
        MYON_ERROR("MYON_BinaryArchive::BeginRead3dmTable() - current file position not at start of table - searching");
        rc = Seek3dmChunkFromStart( typecode );
      }
    }
    if ( rc ) 
    {
      rc = Begin3dmTable(MYON::archive_mode::read3dm,tt);
      if (rc)
      {
        tcode = 0;
        big_value = 0;
        ...
        {
          MYON_ERROR("MYON_BinaryArchive::BeginRead3dmTable() - corrupt table - skipping");
          rc = false;
          if (EndRead3dmChunk())
          {
            ...
            MYON__UINT64 filelength = 0;
            MYON__UINT32 table_record_record = 0;
            MYON_UUID class_uuid = MYON_nil_uuid;
            MYON__UINT64 min_length_data = 0;
            switch (typecode)
            {
            case TCODE_BITMAP_TABLE:
              table_record_record = TCODE_BITMAP_RECORD;
              class_uuid = MYON_nil_uuid;  // multiple types of opennurbs objects in bitmap tables
              min_length_data = 40;
              break;

            case TCODE_TEXTURE_MAPPING_TABLE:
              table_record_record = TCODE_TEXTURE_MAPPING_RECORD;
              class_uuid = MYON_CLASS_ID(MYON_TextureMapping);
              min_length_data = sizeof(MYON_TextureMapping);
              break;

            case TCODE_MATERIAL_TABLE:
              table_record_record = TCODE_MATERIAL_RECORD;
              class_uuid = MYON_CLASS_ID(MYON_Material);
              min_length_data = 114;
              break;

            case TCODE_LINETYPE_TABLE:
              table_record_record = TCODE_LINETYPE_RECORD;
              class_uuid = MYON_CLASS_ID(MYON_Linetype);
              min_length_data = 20;
              break;

            case TCODE_LAYER_TABLE:
              table_record_record = TCODE_LAYER_RECORD;
              class_uuid = MYON_CLASS_ID(MYON_Layer);
              min_length_data = 30;
              break;

            case TCODE_GROUP_TABLE:
              table_record_record = TCODE_GROUP_RECORD;
              class_uuid = MYON_CLASS_ID(MYON_Group);
              min_length_data = 20;
              break;

            case TCODE_FONT_TABLE:
              table_record_record = TCODE_FONT_RECORD;
              class_uuid = MYON_CLASS_ID(MYON_TextStyle);
              min_length_data = 30;
              break;
            ...
            case TCODE_DIMSTYLE_TABLE:
              ...
              class_uuid 
                = (m_3dm_version >= 60)
                ? MYON_CLASS_ID(MYON_DimStyle)
                : MYON_CLASS_ID(MYON_V5x_DimStyle);
              min_length_data = 30;
              break;

            case TCODE_LIGHT_TABLE:
              table_record_record = TCODE_LIGHT_RECORD;
              class_uuid = MYON_CLASS_ID(MYON_Light);
              min_length_data = 30;
              break;

            case TCODE_HATCHPATTERN_TABLE:
              table_record_record = TCODE_HATCHPATTERN_RECORD;
              class_uuid = MYON_CLASS_ID(MYON_HatchPattern);
              min_length_data = 30;
              break;

            case TCODE_INSTANCE_DEFINITION_TABLE:
              table_record_record = TCODE_INSTANCE_DEFINITION_RECORD;
              class_uuid = MYON_CLASS_ID(MYON_InstanceDefinition);
              min_length_data = 30;
              break;

            case TCODE_OBJECT_TABLE:
              table_record_record = TCODE_OBJECT_RECORD;
              class_uuid = MYON_nil_uuid; // multiple object types in this table
              min_length_data = 26; // MYON_Point data is 3 doubles + 2 byte version number
              break;

            case TCODE_HISTORYRECORD_TABLE:
              table_record_record = TCODE_HISTORYRECORD_RECORD;
              class_uuid = MYON_CLASS_ID(MYON_HistoryRecord);
              min_length_data = sizeof(MYON_HistoryRecord);
              break;
              ...
              if ( FindMisplacedTable(filelength, typecode, table_record_record, class_uuid, min_length_data) )
              {
                ...
                if (PeekAt3dmBigChunkType(&tcode, &big_value))
                {
                  if (tcode == typecode)
                  {
                    // try one last time
                    End3dmTable(tt,true);
                    m_3dm_previous_table = MYON_3dmArchiveTableType::settings_table;
                    rc = Begin3dmTable(MYON::archive_mode::read3dm, tt);
                    if (rc)
                    {
                      tcode = 0;
...
int MYON_BinaryArchive::GetCurrentChunk(MYON_3DM_CHUNK& chunk) const
{
  MYON_3DM_BIG_CHUNK big_chunk;
  memset(&chunk,0,sizeof(MYON_3DM_CHUNK));
  ...
  if ( rc > 0 )
  {
    ...
    MYON__INT32 i32 = 0;
    if ( MYON_IsLongChunkTypecode( big_chunk.m_typecode ) )
      DownSizeUINT( (MYON__UINT64)big_chunk.m_big_value, (MYON__UINT32*)&i32 );
    else
...
int MYON_BinaryArchive::GetCurrentChunk(MYON_3DM_BIG_CHUNK& chunk) const
{
  ...
  {
    memset(&chunk,0,sizeof(MYON_3DM_BIG_CHUNK));
  }
  return rc;
}
...
const unsigned char* BufferValidateTcode( 
          ...
          const unsigned char* buffer, 
          const unsigned char* buffer_end,
          MYON__UINT32 expected_tcode )
{
  MYON__UINT32 tc = expected_tcode ? 0 : 1;
...
const unsigned char* BufferToUuid(
          ...
          MYON_UUID& uuid )
{
  MYON__UINT32 data1=0;
  MYON__UINT16 data2=0, data3=0;
...
const unsigned char* EmergencyFindTable_UuidHelper( 
          ...
          const unsigned char* buffer,
          const unsigned char* buffer_end,
          const MYON__UINT32 expected_tcode,
          const MYON_UUID* expected_uuid
          )
{
  MYON__INT64 chunk_value;
  MYON__UINT32 c, cc;
  ...
  const bool bLookForUserTableRecordHeader = (TCODE_USER_TABLE_UUID == expected_tcode
                                              && ((MYON__UINT64)chunk_value) >= (16+4+sizeof_chunk_value+21+4+4)
                                             );
  ...
  if ( 0 == buffer )
    return 0;
  cc = MYON_CRC32(0,4,&uuid.Data1);
  cc = MYON_CRC32(cc,2,&uuid.Data2);
  cc = MYON_CRC32(cc,2,&uuid.Data3);
  cc = MYON_CRC32(cc,8,&uuid.Data4[0]);
  if ( c != cc )
    return 0;
...
bool MYON_BinaryArchive::FindMisplacedTable( 
        MYON__UINT64 filelength,
        const MYON__UINT32 table_tcode,
        const MYON__UINT32 table_record_tcode,
        ...
        )
{
  ...
  const bool bReverseByteOrder = (MYON::endian::big_endian == Endian());
  ...
  if ( TCODE_OBJECT_TABLE == table_tcode && !bFindObjectTable )
    return false;
  if ( bFindUserTable && MYON_UuidIsNil(class_uuid) )
  {
    // must provide plug-in id when searching for user tables
    MYON_ERROR("MYON_BinaryArchive::FindMisplacedTable - must provide plug-in id when searching for user tables");
    return false;
  }
  ...
  MYON__UINT64 pos1 = CurrentPosition();
  MYON__UINT64 pos;
  MYON__UINT64 empty_table_pos = 0;    // position of first empty table candidate
  ...
  while(!bAtEOF)
  {
    ...
    // m_error_message_mask disables calls to MYON_Error when we
    ...
    if ( 0 == buffer || i64 <= 0 )
      continue;
    const MYON__UINT64 length_of_table = (MYON__UINT64)i64;
    ...
    if ( 0 == buffer || i64 <= 0 )
      continue;
    const MYON__UINT64 length_of_record = (MYON__UINT64)i64;


    if ( bFindUserTable )
    {
      MYON__UINT64 expected_length_of_table = length_of_user_uuid_and_header 
                                          + sizeof_chunk_header
                                          + length_of_record;
    ...
    else
    {
      ...
      if ( 0 == buffer || i64 <= 0 )
        continue;
      const MYON__UINT64 length_of_on_class = (MYON__UINT64)i64;
      ...
      const unsigned char* buffer0 = buffer;
      buffer = EmergencyFindTable_UuidHelper(bReverseByteOrder,sizeof_chunk_value,buffer,buffer_end,TCODE_OPENNURBS_CLASS_UUID,(MYON_UuidIsNil(class_uuid) ? nullptr : &class_uuid));
      if ( 0 == buffer || buffer <= buffer0)
        continue;
      ...
      if ( 0 == buffer || i64 < 0 )
        continue;
      const MYON__UINT64 length_of_data = (MYON__UINT64)i64;
  ...
  if (rc)
  {
    MYON_3dmArchiveTableType tt = TableTypeFromTypecode(table_tcode);
    if (MYON_3dmArchiveTableType::Unset != tt)
    {
      // permit a second try
      if (static_cast<unsigned int>(Previous3dmTable()) > static_cast<unsigned int>(MYON_3dmArchiveTableType::properties_table) )
        m_3dm_previous_table = MYON_3dmArchiveTableType::properties_table;
    }
  }
...
bool MYON_BinaryArchive::FindTableInDamagedArchive(
...
bool MYON_BinaryArchive::EndRead3dmTable( unsigned int typecode )
{
  bool rc = false;
  if (0 == typecode)
  {
    MYON_ERROR("MYON_BinaryArchive::EndRead3dmTable() bad typecode");
    return false;
  }
  ...
  if ( Active3dmTable() != tt ) 
  {
    MYON_ERROR("MYON_BinaryArchive::EndRead3dmTable() m_active_table != t");
    return false;
  }
  ...
  if ( m_3dm_version == 1 ) 
  {
    if ( m_chunk.Count() != 0 )
    {
      MYON_ERROR("MYON_BinaryArchive::EndRead3dmTable() v1 file m_chunk.Count() != 0");
      return false;
    }
  ...
  else {
    {
      if ( m_chunk.Count() != 1 ) 
      {
        MYON_ERROR("MYON_BinaryArchive::EndRead3dmTable() v2 file m_chunk.Count() != 1");
        return false;
      }
      const MYON_3DM_BIG_CHUNK* c = m_chunk.Last();
      if ( 0 == c || c->m_typecode != typecode ) 
      {
        MYON_ERROR("MYON_BinaryArchive::EndRead3dmTable() m_chunk.Last()->typecode != typecode");
        return false;
      }
      rc = EndRead3dmChunk();
    }
...
MYON_ModelComponent::Type MYON_BinaryArchive::TableComponentType(
  MYON_3dmArchiveTableType table_type
)
{
  MYON_ModelComponent::Type model_component_type;
  switch (table_type)
  {
  case MYON_3dmArchiveTableType::Unset:
    model_component_type = MYON_ModelComponent::Type::Unset;
    break;
  case MYON_3dmArchiveTableType::start_section:
    model_component_type = MYON_ModelComponent::Type::Unset;
    break;
  ...
  case MYON_3dmArchiveTableType::settings_table:
    ...
    break;
  case MYON_3dmArchiveTableType::bitmap_table:
    model_component_type = MYON_ModelComponent::Type::Image;
    break;
  case MYON_3dmArchiveTableType::texture_mapping_table:
    model_component_type = MYON_ModelComponent::Type::TextureMapping;
    break;
  case MYON_3dmArchiveTableType::material_table:
    model_component_type = MYON_ModelComponent::Type::RenderMaterial;
    break;
  case MYON_3dmArchiveTableType::linetype_table:
    model_component_type = MYON_ModelComponent::Type::LinePattern;
    break;
  case MYON_3dmArchiveTableType::layer_table:
    model_component_type = MYON_ModelComponent::Type::Layer;
    break;
  case MYON_3dmArchiveTableType::group_table:
    model_component_type = MYON_ModelComponent::Type::Group;
    break;
  case MYON_3dmArchiveTableType::text_style_table:
    model_component_type = MYON_ModelComponent::Type::TextStyle;
    break;
  case MYON_3dmArchiveTableType::leader_style_table:
    model_component_type = MYON_ModelComponent::Type::Unset;
    break;
  case MYON_3dmArchiveTableType::dimension_style_table:
    model_component_type = MYON_ModelComponent::Type::DimStyle;
    break;
  case MYON_3dmArchiveTableType::light_table:
    model_component_type = MYON_ModelComponent::Type::RenderLight;
    break;
  case MYON_3dmArchiveTableType::hatchpattern_table:
    model_component_type = MYON_ModelComponent::Type::HatchPattern;
    break;
  case MYON_3dmArchiveTableType::instance_definition_table:
    model_component_type = MYON_ModelComponent::Type::InstanceDefinition;
    break;
  case MYON_3dmArchiveTableType::object_table:
    model_component_type = MYON_ModelComponent::Type::ModelGeometry;
    break;
  case MYON_3dmArchiveTableType::historyrecord_table:
    model_component_type = MYON_ModelComponent::Type::HistoryRecord;
    break;
  case MYON_3dmArchiveTableType::user_table:
    model_component_type = MYON_ModelComponent::Type::Unset;
    break;
...
MYON_3dmArchiveTableType MYON_BinaryArchive::Active3dmTable() const
{
  return m_3dm_active_table;
}

MYON_3dmArchiveTableType MYON_BinaryArchive::Previous3dmTable() const
{
  return m_3dm_previous_table;
}


MYON_3dmArchiveTableType MYON_BinaryArchive::FirstFailed3dmTable() const
{
  return m_3dm_first_failed_table;
}

bool MYON_BinaryArchive::BeginWrite3dmBitmapTable()
{
  return BeginWrite3dmTable( TCODE_BITMAP_TABLE );
}

bool MYON_BinaryArchive::EndWrite3dmBitmapTable()
{
  return EndWrite3dmTable( TCODE_BITMAP_TABLE );
}

bool MYON_BinaryArchive::Write3dmImageComponent(
  ...
  )
{
  ...
  for (;;)
  {
    const MYON_Bitmap* image = MYON_Bitmap::Cast(model_component);
    if (nullptr == image)
    {
      MYON_ERROR("model_component parameter is not an image component.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmBitmap( const MYON_Bitmap& bitmap )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::bitmap_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::bitmap_table) )
    return false;
  ...
  if ( m_3dm_version > 1 ) 
  {
    ...
    {
      Internal_ReportCriticalError();
      MYON_ERROR("MYON_BinaryArchive::Write3dmBitmap() must be called in BeginWrite3dmBitmapTable() block");
      rc = false;
    }
  }
  return rc;
...
bool MYON_BinaryArchive::BeginRead3dmBitmapTable()
{
  return BeginRead3dmTable( TCODE_BITMAP_TABLE );
}

bool MYON_BinaryArchive::EndRead3dmBitmapTable()
{
  return EndRead3dmTable( TCODE_BITMAP_TABLE );
}

int MYON_BinaryArchive::Read3dmBitmap(  // returns 0 at end of bitmap table
                                      //         1 bitmap successfully read
          MYON_Bitmap** ppBitmap // bitmap returned here
          )
{
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::bitmap_table, (void**)ppBitmap))
    return 0;

  MYON_Bitmap* bitmap = 0;
  int rc = 0;
  if ( m_3dm_version != 1 )
  {
    MYON__UINT32 tcode = 0;
    ...
    if ( BeginRead3dmBigChunk( &tcode, &big_value ) ) 
    {
      if ( tcode == TCODE_BITMAP_RECORD ) 
      {
        ...
        if ( ReadObject( &p ) ) 
        {
          bitmap = MYON_Bitmap::Cast(p);
          if (nullptr == bitmap)
          {
            MYON_ERROR("MYON_BinaryArchive::Read3dmBitmap() - corrupt bitmap table");
            delete p;
          }
          else
          {
...
bool MYON_BinaryArchive::BeginWrite3dmLayerTable()
{
  return BeginWrite3dmTable( TCODE_LAYER_TABLE );
}

bool MYON_BinaryArchive::Write3dmLayerComponent(
  const MYON_ModelComponentReference& model_component_reference
  )
{
  ...
  )
{
  ...
  for (;;)
  {
    const MYON_Layer* layer = MYON_Layer::Cast(model_component);
    if (nullptr == layer)
    {
      MYON_ERROR("model_component parameter is not a layer component.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmLayer( const MYON_Layer&  layer )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::layer_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::layer_table) )
    return false;
  ...
  if ( c && c->m_typecode == TCODE_LAYER_TABLE )
  {
    ...
    Internal_ReportCriticalError();
    MYON_ERROR("MYON_BinaryArchive::Write3dmLayer() must be called in BeginWrite3dmLayerTable(2) block");
    rc = false;
  }
...
bool MYON_BinaryArchive::EndWrite3dmLayerTable()
{
  return EndWrite3dmTable( TCODE_LAYER_TABLE );
}

bool MYON_BinaryArchive::BeginRead3dmLayerTable()
{
...
int MYON_BinaryArchive::Read3dmV1LayerIndex(const char* sV1LayerName) const
{
  // returns V1 layer index

  int layer_index = -1;

  if (    MYON::archive_mode::read3dm == m_mode
  ...
  {
    struct MYON__3dmV1LayerIndex* p = m_V1_layer_list;
    int i;
...
bool MYON_BinaryArchive::Read3dmV1Layer( MYON_Layer*& layer )
{
  MYON_String s;
  bool rc = 0;
  MYON__UINT32 tcode;
  ...
  if ( layer ) {
    ...
    for (;;) 
    {
      ...
      case TCODE_LAYERNAME:
        {
          ...
          {
            MYON_ERROR("MYON_BinaryArchive::Read3dmV1Layer() - invalid layer name length");
          }
          else
          {
            s.SetLength(slen);
      ...
      case TCODE_RGB:
        {
          MYON__UINT64 rgb64 = (MYON__UINT64)big_value;
          MYON__UINT32 rgb32 = (MYON__UINT32)rgb64;
          layer->SetColor( MYON_Color((MYON__UINT32)rgb32) );
        }
        break;
  ...
  else if (rc && layer)
  {
         ...
         )
    {
      ...
      {
        struct MYON__3dmV1LayerIndex* p = (struct MYON__3dmV1LayerIndex*)oncalloc(1, sizeof(*p) + (s_length+1)*sizeof(*p->m_layer_name) );
...
int MYON_BinaryArchive::Read3dmLayer( MYON_Layer** ppLayer )
{
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::layer_table, (void**)ppLayer))
    return 0;
  ...
  else 
  {
    ...
    if ( BeginRead3dmBigChunk( &tcode, &big_value ) )
    {
      if ( tcode == TCODE_LAYER_RECORD )
      {
        ...
        if (nullptr == layer) {
          MYON_ERROR("MYON_BinaryArchive::Read3dmLayer() - corrupt layer table");
        }
      }
      else if ( tcode != TCODE_ENDOFTABLE ) {
        MYON_ERROR("MYON_BinaryArchive::Read3dmLayer() - corrupt layer table");
  ...
  if ( layer )
    layer->HasPerViewportSettings(MYON_nil_uuid); // this call sets MYON_Layer::m__runtime_flags
  *ppLayer = layer;
  return (layer) ? 1 : 0;
}

bool MYON_BinaryArchive::EndRead3dmLayerTable()
{
...
bool MYON_BinaryArchive::BeginWrite3dmGroupTable()
{
  return BeginWrite3dmTable( TCODE_GROUP_TABLE );
}

bool MYON_BinaryArchive::Write3dmGroupComponent(
  const MYON_ModelComponentReference& model_component_reference
  )
{
  ...
  )
{
  ...
  for (;;)
  {
    const MYON_Group* group = MYON_Group::Cast(model_component);
    if (nullptr == group)
    {
      MYON_ERROR("model_component parameter is not a group component.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmGroup( const MYON_Group&  group )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::group_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::group_table) )
    return false;
  ...
  if ( c && c->m_typecode == TCODE_GROUP_TABLE ) 
  {
    ...
    MYON_ERROR("MYON_BinaryArchive::Write3dmGroup() must be called in BeginWrite3dmGroupTable() block");
    rc = false;
  }
...
bool MYON_BinaryArchive::EndWrite3dmGroupTable()
{
  return EndWrite3dmTable( TCODE_GROUP_TABLE );
}

bool MYON_BinaryArchive::BeginRead3dmGroupTable()
{
  return BeginRead3dmTable( TCODE_GROUP_TABLE );
}

int MYON_BinaryArchive::Read3dmGroup( MYON_Group** ppGroup )
{
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::group_table, (void**)ppGroup))
    return 0;
  ...
  if ( BeginRead3dmBigChunk( &tcode, &big_value ) ) 
  {
    if ( tcode == TCODE_GROUP_RECORD ) 
    {
     Internal_Increment3dmTableItemCount();
      ...
      if (!group) {
        MYON_ERROR("MYON_BinaryArchive::Read3dmGroup() - corrupt group table");
      }
    }
    else if ( tcode != TCODE_ENDOFTABLE ) {
      MYON_ERROR("MYON_BinaryArchive::Read3dmGroup() - corrupt group table");
...
bool MYON_BinaryArchive::EndRead3dmGroupTable()
{
...
const MYON_TextStyle* MYON_BinaryArchive::ArchiveTextStyleFromArchiveTextStyleIndex(
...
////bool MYON_BinaryArchive::WriteArchiveTextStyleIndex(
...
////     ? Write3dmReferencedComponentIndex(MYON_ModelComponent::Type::DimStyle, dim_style_model_index)
////     : WriteInt(v6_text_style_index);
////  return rc;
////}

////bool MYON_BinaryArchive::BeginWrite3dmTextStyleTable()
////{
////  // Does nothing. Text style information is on MYON_DimStyle.
////  MYON_ERROR("do not call MYON_BinaryArchive::BeginWrite3dmTextStyleTable.");
////  return true;
////}
////
////bool MYON_BinaryArchive::Write3dmTextStyle(
////  const class MYON_TextStyle& text_style
////)
////{
////  // Does nothing. Text style information is on MYON_DimStyle.
////  MYON_ERROR("do not call MYON_BinaryArchive::Write3dmTextStyle.");
////  return true;
////}
////
////bool MYON_BinaryArchive::EndWrite3dmTextStyleTable()
////{
////  // Does nothing. Text style information is on MYON_DimStyle.
////  MYON_ERROR("do not call MYON_BinaryArchive::EndWrite3dmTextStyleTable.");
////  return true;
////}

////bool MYON_BinaryArchive::Internal_BeginWrite3dmTextStyleTable()
////{
...
//bool MYON_BinaryArchive::Write3dmTextStyleComponent(
//  const MYON_ModelComponentReference& model_component_reference
//  )
//{
...
//  for (;;)
//  {
//    const MYON_TextStyle* text_style = MYON_TextStyle::Cast(model_component);
//    if (nullptr == text_style)
//    {
//      MYON_ERROR("model_component parameter is not a text style component.");
//      break;
//    }
...
bool MYON_BinaryArchive::Internal_Write3dmTextStyle(
  const class MYON_TextStyle& text_style
  )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::text_style_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::text_style_table) )
   return false;
  ...
  {
    MYON_ERROR("MYON_BinaryArchive::Write3dmTextStyle() must be called in BeginWrite3dmTextStyleTable() block");
    rc = false;
  }
...
////bool MYON_BinaryArchive::Internal_EndWrite3dmTextStyleTable()
////{
////  return EndWrite3dmTable( TCODE_FONT_TABLE );
////}
////
////bool MYON_BinaryArchive::BeginRead3dmTextStyleTable()
////{
////  MYON_ERROR("Do not call BeginRead3dmTextStyleTable()");
////  return true;
////}
////
////
////int MYON_BinaryArchive::Read3dmTextStyle(MYON_TextStyle** ppTextStyle)
////{
////  MYON_ERROR("Do not call Read3dmTextStyle()");
////  return 0;
////}
////
////bool MYON_BinaryArchive::EndRead3dmTextStyleTable()
////{
////  MYON_ERROR("Do not call EndRead3dmTextStyleTable()");
////  return true;
////}

int MYON_BinaryArchive::Internal_Read3dmTextStyle( MYON_TextStyle** ppTextStyle )
{
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::text_style_table, (void**)ppTextStyle))
    return 0;

  MYON__UINT32 tcode = 0;
  MYON__INT64 big_value = 0;
  MYON_TextStyle* text_style = nullptr;
  if ( BeginRead3dmBigChunk( &tcode, &big_value ) ) 
  {
    if ( tcode == TCODE_FONT_RECORD )
    {
      ...
      if ( ReadObject( &p ) ) 
      {
        text_style = MYON_TextStyle::Cast(p);
        if ( !text_style )
          delete p;
        else
        {
      ...
      if (!text_style) {
        MYON_ERROR("MYON_BinaryArchive::Read3dmTextStyle() - corrupt text_style table");
      }
    }
    else if ( tcode != TCODE_ENDOFTABLE ) {
      MYON_ERROR("MYON_BinaryArchive::Read3dmTextStyle() - corrupt text_style table");
...
bool MYON_BinaryArchive::Internal_Write3dmDimStyle( const MYON_DimStyle&  dimstyle, bool bUpdateManifest )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::dimension_style_table))
    return true;
  
  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::dimension_style_table) )
   return false;
  ...
  if ( c && c->m_typecode == TCODE_DIMSTYLE_TABLE )
  {
    ...
    if ( rc )
    {
      ...
      {
        const MYON_V5x_DimStyle V5_dimstyle(
  ...
  {
    MYON_ERROR("MYON_BinaryArchive::Write3dmDimStyle() must be called in BeginWrite3dmDimStyleTable() block");
    rc = false;
  }
...
bool MYON_BinaryArchive::BeginWrite3dmDimStyleTable()
{
  // August 2016. text style information is now on MYON_DimStyle
  ...
  {
    MYON_ERROR("BeginWrite3dmDimStyleTable() called at the wrong time.");
    return false;
  }

  const unsigned int previous_table_index = static_cast<unsigned int>(Previous3dmTable());
  const unsigned int text_style_table_index = static_cast<unsigned int>(MYON_3dmArchiveTableType::text_style_table);
  if (previous_table_index >= text_style_table_index)
  {
    MYON_ERROR("archive contains text style information. This is incorrect.");
    return false;
  }
...
bool MYON_BinaryArchive::Write3dmDimStyleComponent(
  const MYON_ModelComponentReference& model_component_reference
  )
{
  ...
  )
{
  ...
  for (;;)
  {
    const MYON_DimStyle* dimension_style = MYON_DimStyle::Cast(model_component);
...
bool MYON_BinaryArchive::Write3dmDimStyle( const MYON_DimStyle&  dimstyle )
{
  if ( dimstyle.ParentIdIsNotNil() || dimstyle.HasOverrides())
  {
    MYON_ERROR("Override dimstyles are not stored in the dimstyle table in V6 files.");
  ...
  if (1 == m_archive_dim_style_table_status)
  {
    ...
    {
      MYON_ERROR("Write3dmDimStyle() called at the incorrect time");
      return false;
    }
  ...
  MYON_DimStyle* copy_of_model_dimstyle = new MYON_DimStyle(dimstyle);
...
bool MYON_BinaryArchive::EndWrite3dmDimStyleTable()
{
  if (m_archive_dim_style_table_status < 1 || m_archive_dim_style_table_status > 2)
  {
    MYON_ERROR("EndWrite3dmDimStyleTable() called at the incorrect time");
    return false;
  }
  ...
  bool rc = true;
  {
    ...
    if (Archive3dmVersion() < 60)
    {
      ...
      {
        const MYON_DimStyle* dim_style = m_archive_dim_style_table[j];
        if (nullptr == dim_style)
          continue;
        MYON_TextStyle archive_text_style;
...
const MYON_DimStyle* MYON_BinaryArchive::Internal_ArchiveCurrentDimStyle()
{
  MYON::LengthUnitSystem model_unit_system = MYON::LengthUnitSystem::Unset;
  if (nullptr != m_archive_3dm_settings)
  {
    model_unit_system = m_archive_3dm_settings->m_ModelUnitsAndTolerances.m_unit_system.UnitSystem();
    const MYON_UUID id = m_archive_3dm_settings->CurrentDimensionStyleId();
    if (MYON_nil_uuid != id)
    {
      for (unsigned int i = 0; i < m_archive_dim_style_table.UnsignedCount(); i++)
      {
    ...
    if (MYON::IsTerrestrialLengthUnit(model_unit_system))
    {
      double unit_scale = 1e300;
      const MYON_DimStyle* inch_mm_ds = nullptr;
      const MYON_DimStyle* unit_scale_ds = nullptr;
      for (unsigned int i = 0; i < m_archive_dim_style_table.UnsignedCount(); i++)
      {
        const MYON_DimStyle* archive_dim_style = m_archive_dim_style_table[i];
        if (archive_dim_style->ParentIdIsNotNil())
        ...
        const MYON::LengthUnitSystem ds_unit_system = archive_dim_style->UnitSystem();
        if (ds_unit_system == model_unit_system)
          return archive_dim_style;

        if (nullptr == m_archive_current_dim_style)
        {
          if (MYON::IsUnitedStatesCustomaryLengthUnit(model_unit_system) && MYON::LengthUnitSystem::Inches == ds_unit_system)
          {
            inch_mm_ds = archive_dim_style;
          }
          else if (MYON::IsMetricLengthUnit(model_unit_system) && MYON::LengthUnitSystem::Millimeters == ds_unit_system)
          {
            inch_mm_ds = archive_dim_style;
          }
        }

        double s = MYON::UnitScale(model_unit_system, ds_unit_system);
        if (s < 1.0)
          s = MYON::UnitScale(ds_unit_system, model_unit_system);
  ...
  const MYON_DimStyle* system_ds;
  if (MYON::IsUnitedStatesCustomaryLengthUnit(model_unit_system))
    system_ds = &MYON_DimStyle::DefaultInchDecimal;  
  else if (MYON::IsMetricLengthUnit(model_unit_system))
    system_ds = &MYON_DimStyle::DefaultMillimeterSmall;
  else
    system_ds = &MYON_DimStyle::Default;

  // invent a current dimstyle. Happens when reading files written by Rhino 1.1.
  MYON_DimStyle* current_ds = new MYON_DimStyle(*system_ds);
  current_ds->SetId();
...
double MYON_BinaryArchive::Internal_ArchiveModelSpaceTextScale() const
{
  ...
  return (model_space_text_scale > 0.0 && MYON_IsValid(model_space_text_scale)) ? model_space_text_scale : default_model_space_text_scale;
}

void MYON_BinaryArchive::Internal_ConvertTextStylesToDimStyles()
{
  ...
  for (int i = 0; i < m_archive_text_style_table.Count(); i++)
  {
    MYON_2dex& ts_to_ds = m_text_style_to_dim_style_archive_index_map.AppendNew();
    ts_to_ds.i = i;
    ts_to_ds.j 
  ...
  for (;;)
  {
    ...
    bool bParsedVersionNumber = MYON_VersionNumberParse(
      archive_opennurbs_version,
      &version_major,
      &version_minor,
      &version_year,
  ...
  {
    MYON_2dex& ts_to_ds = m_text_style_to_dim_style_archive_index_map[i];
    if (MYON_UNSET_INT_INDEX != ts_to_ds.j)
      continue; // this text style is already mapped.

    const MYON_TextStyle* text_style = m_archive_text_style_table[i];
    if (nullptr == text_style)
    {
    ...
    for (int j = 0; j < archive_dim_style_count; j++)
    {
      ...
      if (MYON_UNSET_INT_INDEX == ts_to_ds.j || d < delta_scale)
      {
        ts_to_ds.j = j;
        delta_scale = d;
        if (0.0 == delta_scale)
    ...
    if (MYON_UNSET_INT_INDEX == ts_to_ds.j)
    {
      ...
      MYON_DimStyle* dim_style = MYON_DimStyle::CreateFromFont(&font, model_view_text_scale, nullptr, &m_manifest, nullptr);
      ts_to_ds.j = m_archive_dim_style_table.Count();
      dim_style->ClearIndex();
      dim_style->SetId();
      const MYON::LengthUnitSystem dim_style_unit_system
        = MYON::IsUnitedStatesCustomaryLengthUnit(Archive3dmSettings().m_ModelUnitsAndTolerances.m_unit_system.UnitSystem())
...
bool MYON_BinaryArchive::BeginRead3dmDimStyleTable()
{
  // August 2016. text style information is now on MYON_DimStyle
  // A text style table must still be saved in archives so earlier versions of Rhino
  // can read the archives written by new versions.
  if (0 != m_archive_dim_style_table_status || MYON_UNSET_UINT_INDEX != m_archive_dim_style_table_read_index)
  {
    MYON_ERROR("BeginRead3dmDimStyleTable() has already been called.");
    return false;
  }
  ...
  for (int i = 0; i < archive_text_style_count; i++)
  {
    MYON_2dex& ts_to_ds = m_text_style_to_dim_style_archive_index_map.AppendNew();
    ts_to_ds.i = i;
    ts_to_ds.j = MYON_UNSET_INT_INDEX;
  }
  ...
  for (;;)
  {
    MYON_DimStyle* archive_dim_style = nullptr;
    int rc = Internal_Read3dmDimStyle(&archive_dim_style);
    const MYON::LengthUnitSystem archive_unit_system = Archive3dmSettings().m_ModelUnitsAndTolerances.m_unit_system.UnitSystem();
    if (nullptr != archive_dim_style)
    {
      if (archive_dim_style->ParentId() == archive_dim_style->Id())
      {
        MYON_ERROR("Invalid dimstyle parent id in archive.");
      ...
      archive_dim_style->SetUnitSystemFromContext(true, archive_unit_system, MYON::LengthUnitSystem::None);
  ...
  if (m_bLegacyOverrideDimStylesInArchive)
  {
    ...
    {
      MYON_DimStyle* archive_dim_style = m_archive_dim_style_table[j];
      if (archive_dim_style->ParentIdIsNil())
        continue;

      const MYON_UUID parent_id = archive_dim_style->ParentId();

      MYON_DimStyle* archive_parent_dim_style = nullptr;
      for (unsigned int i = 0; i < m_archive_dim_style_table.UnsignedCount(); i++)
      {
        MYON_DimStyle* ds = m_archive_dim_style_table[i];
  ...
  int V5_archive_dim_style_index = MYON_UNSET_INT_INDEX;
  if (nullptr != m_archive_current_dim_style)
  {
...
int MYON_BinaryArchive::Read3dmDimStyle(
...
)
{
  ...
  if (1 != m_archive_dim_style_table_status || m_archive_dim_style_table_read_index >= MYON_UNSET_UINT_INDEX - 1)
  {
    MYON_ERROR("All calls to Read3dmDimStyle() must be after a single call to BeginRead3dmDimStyleTable() and before a single call to EndRead3dmDimStyleTable().");
    return 0;
  }

  MYON_DimStyle* dim_style = nullptr;
  while (m_archive_dim_style_table_read_index < m_archive_dim_style_table.UnsignedCount())
  {
    ...
    MYON_DimStyle* archive_dim_style = m_archive_dim_style_table[i];
    if (nullptr == archive_dim_style)
      continue;
    if (archive_dim_style->ParentIdIsNotNil())
      continue;

    MYON_DimStyle* managed_dim_style = new MYON_DimStyle(*archive_dim_style);
  ...
  if (nullptr == dim_style)
  {
    m_archive_dim_style_table_read_index = MYON_UNSET_UINT_INDEX - 1;
    return 0;
  }
...
int MYON_BinaryArchive::Internal_Read3dmDimStyle(
  class MYON_DimStyle**ppDimStyle
  )
{
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::dimension_style_table, (void**)ppDimStyle))
    return 0;
  ...
  if ( BeginRead3dmBigChunk( &tcode, &big_value ) ) 
  {
    if ( tcode == TCODE_DIMSTYLE_RECORD )
    {
      ...
      if ( ReadObject( &p ) ) 
      {
        MYON_DimStyle* V6_dimstyle = MYON_DimStyle::Cast(p);
        int legacy_text_style_index = MYON_UNSET_INT_INDEX;
        if (nullptr == V6_dimstyle)
        {
          MYON_V5x_DimStyle* V5_dimstyle = MYON_V5x_DimStyle::Cast(p);
          if (nullptr != V5_dimstyle)
          {
            legacy_text_style_index = V5_dimstyle->V5TextStyle().Index();
            V6_dimstyle = new MYON_DimStyle(
              this->Archive3dmSettings().m_ModelUnitsAndTolerances.m_unit_system.UnitSystem(),
              *V5_dimstyle
            );
            ...
            V6_dimstyle->SetLeaderTextVerticalAlignment(MYON::TextVerticalAlignment::MiddleOfTop);
            ...
            V6_dimstyle->SetUnitSystem(MYON::LengthUnitSystem::None);
            V6_dimstyle->SetUnitSystemFromContext(true,Archive3dmSettings().m_ModelUnitsAndTolerances.m_unit_system.UnitSystem(),MYON::LengthUnitSystem::None);
            delete V5_dimstyle;
          }
          else
          {
        ...
        if (nullptr == V6_dimstyle) 
        {
          MYON_ERROR("MYON_BinaryArchive::Read3dmDimStyle() - corrupt annotation style table");
        }
        else
        {
          rc = 1;
...
bool MYON_BinaryArchive::EndRead3dmDimStyleTable()
{
  return EndRead3dmTable( TCODE_DIMSTYLE_TABLE );
}


const MYON_DimStyle& MYON_BinaryArchive::ArchiveCurrentDimStyle() const
{
  return
    (nullptr == m_archive_current_dim_style)
...
const int MYON_BinaryArchive::ArchiveCurrentDimStyleIndex() const
{
  const MYON_DimStyle& dim_style = ArchiveCurrentDimStyle();
  if (dim_style.IsSystemComponent())
    return dim_style.Index();

  const MYON_ComponentManifestItem& item = m_manifest.ItemFromId(MYON_ModelComponent::Type::DimStyle,ArchiveCurrentDimStyle().Id());
  if (item.IsValid())
    return item.Index();
...
const MYON_UUID MYON_BinaryArchive::ArchiveCurrentDimStyleId() const
{
...
bool MYON_BinaryArchive::BeginWrite3dmHatchPatternTable()
{
  return BeginWrite3dmTable( TCODE_HATCHPATTERN_TABLE );
}

bool MYON_BinaryArchive::Write3dmHatchPatternComponent(
  const MYON_ModelComponentReference& model_component_reference
  )
{
  ...
  )
{
  ...
  for (;;)
  {
    const MYON_HatchPattern* hatch_pattern = MYON_HatchPattern::Cast(model_component);
    if (nullptr == hatch_pattern)
    {
      MYON_ERROR("model_component parameter is not a hatch pattern component.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmHatchPattern( const MYON_HatchPattern&  pattern )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::hatchpattern_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::hatchpattern_table) )
   return false;
  ...
  {
    MYON_ERROR("MYON_BinaryArchive::Write3dmHatchPattern() must be called in BeginWrite3dmHatchPatternTable() block");
    rc = false;
  }
...
bool MYON_BinaryArchive::EndWrite3dmHatchPatternTable()
{
  return EndWrite3dmTable( TCODE_HATCHPATTERN_TABLE );
}

bool MYON_BinaryArchive::BeginRead3dmHatchPatternTable()
{
  return BeginRead3dmTable( TCODE_HATCHPATTERN_TABLE );
}

int MYON_BinaryArchive::Read3dmHatchPattern( MYON_HatchPattern** ppPattern )
{
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::hatchpattern_table, (void**)ppPattern))
    return 0;
  ...
  if( BeginRead3dmBigChunk( &tcode, &big_value)) 
  {
    if ( tcode == TCODE_HATCHPATTERN_RECORD ) 
    {
      ...
      if ( m_3dm_opennurbs_version < 200511010 )
      {
        ...
        // before version 200511010 didn't use MYON_Object IO.
        hatch_pattern = new MYON_HatchPattern;
        if( !hatch_pattern->Read( *this))
        {
          delete hatch_pattern;
          hatch_pattern = nullptr;
          MYON_ERROR("MYON_BinaryArchive::Read3dmHatchPattern() - corrupt hatch pattern table");
        }
      }
      else
      {
        ...
        if ( ReadObject( &p ) ) 
        {
          hatch_pattern = MYON_HatchPattern::Cast(p);
          if ( nullptr == hatch_pattern )
            delete p;
        }
        if (nullptr == hatch_pattern) 
...
bool MYON_BinaryArchive::EndRead3dmHatchPatternTable()
{
...
bool MYON_BinaryArchive::BeginWrite3dmLinetypeTable()
{
  bool rc = BeginWrite3dmTable( TCODE_LINETYPE_TABLE );
  return rc;
}

bool MYON_BinaryArchive:: Write3dmLinePatternComponent(
  const MYON_ModelComponentReference& model_component_reference
  )
{
  ...
  )
{
  ...
  for (;;)
  {
    const MYON_Linetype* line_pattern = MYON_Linetype::Cast(model_component);
    if (nullptr == line_pattern)
    {
      MYON_ERROR("model_component parameter is not a line pattern component.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmLinetype(
  const MYON_Linetype& line_pattern
  )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::linetype_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::linetype_table) )
    return false;
  ...
  if( Active3dmTable() != MYON_3dmArchiveTableType::linetype_table ) 
  {
    Internal_ReportCriticalError();
    MYON_ERROR("MYON_BinaryArchive::Write3dmLinetype() - m_active_table != linetype_table");
  }
  ...
  {
    Internal_ReportCriticalError();
    MYON_ERROR("MYON_BinaryArchive::Write3dmLinetype() must be called in BeginWrite3dmLinetypeTable() block");
    rc = false;
  }
...
bool MYON_BinaryArchive::EndWrite3dmLinetypeTable()
{
  return EndWrite3dmTable( TCODE_LINETYPE_TABLE );
}

bool MYON_BinaryArchive::BeginRead3dmLinetypeTable()
{
  return BeginRead3dmTable( TCODE_LINETYPE_TABLE );
}

int MYON_BinaryArchive::Read3dmLinetype( MYON_Linetype** ppLinetype )
{
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::linetype_table, (void**)ppLinetype))
    return 0;

  MYON__UINT32 tcode = 0;
  MYON__INT64 big_value = 0;
  MYON_Linetype* linetype = nullptr;
  int rc = -1;
  if( BeginRead3dmBigChunk( &tcode, &big_value)) 
  {
    if ( tcode == TCODE_LINETYPE_RECORD ) 
    {
      ...
      {
        Internal_ReportCriticalError();
        MYON_ERROR("MYON_BinaryArchive::Read3dmLinetype() - corrupt linetype table");
      }
    }
    else if ( tcode == TCODE_ENDOFTABLE ) 
    {
...
bool MYON_BinaryArchive::EndRead3dmLinetypeTable()
{
...
bool MYON_BinaryArchive::BeginWrite3dmInstanceDefinitionTable()
{
  return BeginWrite3dmTable( TCODE_INSTANCE_DEFINITION_TABLE );
}

bool MYON_BinaryArchive::Write3dmInstanceDefinitionComponent(
  ...
  )
{
  ...
  for (;;)
  {
    const MYON_InstanceDefinition* instance_definition = MYON_InstanceDefinition::Cast(model_component);
    if (nullptr == instance_definition)
    {
      MYON_ERROR("model_component parameter is not an instance definition component.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmInstanceDefinition( const MYON_InstanceDefinition&  idef )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::instance_definition_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::instance_definition_table) )
   return false;
  ...
  if ( c && c->m_typecode == TCODE_INSTANCE_DEFINITION_TABLE )
  {
    ...
    MYON_ERROR("MYON_BinaryArchive::Write3dmInstanceDefinition() must be called in BeginWrite3dmInstanceDefinitionTable() block");
    rc = false;
  }
...
bool MYON_BinaryArchive::EndWrite3dmInstanceDefinitionTable()
{
  return EndWrite3dmTable( TCODE_INSTANCE_DEFINITION_TABLE );
}

bool MYON_BinaryArchive::BeginRead3dmInstanceDefinitionTable()
{
  return BeginRead3dmTable( TCODE_INSTANCE_DEFINITION_TABLE );
}

int MYON_BinaryArchive::Read3dmInstanceDefinition( MYON_InstanceDefinition** ppInstanceDefinition )
{
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::instance_definition_table, (void**)ppInstanceDefinition))
    return 0;

  MYON__UINT32 tcode = 0;
  MYON__INT64 big_value = 0;
  MYON_InstanceDefinition* idef = nullptr;
  if ( BeginRead3dmBigChunk( &tcode, &big_value ) ) 
  {
    if ( tcode == TCODE_INSTANCE_DEFINITION_RECORD )
    {
      ...
      MYON_Object* p = 0;
      if ( ReadObject( &p ) ) {
        idef = MYON_InstanceDefinition::Cast(p);
        if ( !idef )
          delete p;
      }
      if (!idef) {
        MYON_ERROR("MYON_BinaryArchive::Read3dmInstanceDefinition() - corrupt instance definition table");
      }
    }
    else if ( tcode != TCODE_ENDOFTABLE ) {
      MYON_ERROR("MYON_BinaryArchive::Read3dmInstanceDefinition() - corrupt instance definition table");
...
bool MYON_BinaryArchive::EndRead3dmInstanceDefinitionTable()
{
...
bool MYON_BinaryArchive::BeginWrite3dmTextureMappingTable()
{
  return BeginWrite3dmTable( TCODE_TEXTURE_MAPPING_TABLE );
}

bool MYON_BinaryArchive::Write3dmTextureMappingComponent(
  const MYON_ModelComponentReference& model_component_reference
  )
{
  ...
  )
{
  ...
  for (;;)
  {
    const MYON_TextureMapping* texture_mapping = MYON_TextureMapping::Cast(model_component);
    if (nullptr == texture_mapping)
    {
      MYON_ERROR("model_component parameter is not a texture mapping component.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmTextureMapping( const MYON_TextureMapping& texture_mapping )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::texture_mapping_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::texture_mapping_table) )
    return false;
  ...
  if ( m_3dm_active_table != MYON_3dmArchiveTableType::texture_mapping_table ) 
  {
    MYON_ERROR("MYON_BinaryArchive::Write3dmTextureMapping() - m_active_table != texture_mapping_table");
  }

  const MYON_3DM_BIG_CHUNK* c = m_chunk.Last();
  if ( !c || c->m_typecode != TCODE_TEXTURE_MAPPING_TABLE )
  {
    MYON_ERROR("MYON_BinaryArchive::Write3dmTextureMapping() - active chunk typecode != TCODE_TEXTURE_MAPPING_TABLE");
  }
  else 
  {
...
bool MYON_BinaryArchive::EndWrite3dmTextureMappingTable()
{
  return EndWrite3dmTable( TCODE_TEXTURE_MAPPING_TABLE );
}

bool MYON_BinaryArchive::BeginRead3dmTextureMappingTable()
{
  return BeginRead3dmTable( TCODE_TEXTURE_MAPPING_TABLE );
}

int MYON_BinaryArchive::Read3dmTextureMapping( MYON_TextureMapping** ppTextureMapping )
{
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::texture_mapping_table, (void**)ppTextureMapping))
    return 0;
  ...
  if ( BeginRead3dmBigChunk( &tcode, &big_value ) )
  {
    if ( tcode == TCODE_TEXTURE_MAPPING_RECORD ) 
    {
      ...
      if ( ReadObject( &p ) ) 
      {
        texture_mapping = MYON_TextureMapping::Cast(p);
        if ( !texture_mapping )
          delete p;
        else 
        {
      ...
      {
        Internal_ReportCriticalError();
        MYON_ERROR("MYON_BinaryArchive::Read3dmTextureMapping() - corrupt texture_mapping table");
      }
    }
    else if ( tcode == TCODE_ENDOFTABLE ) 
    {
...
bool MYON_BinaryArchive::EndRead3dmTextureMappingTable()
{
...
bool MYON_BinaryArchive::BeginWrite3dmHistoryRecordTable()
{
  return BeginWrite3dmTable( TCODE_HISTORYRECORD_TABLE );
}

bool MYON_BinaryArchive::Write3dmHistoryRecordComponent(
  const class MYON_ModelComponentReference& model_component_reference
  )
{
  ...
  )
{
  ...
  for (;;)
  {
    const MYON_HistoryRecord* history_record = MYON_HistoryRecord::Cast(model_component);
    if (nullptr == history_record)
    {
      MYON_ERROR("model_component parameter is not a history record component.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmHistoryRecord( const MYON_HistoryRecord& history_record )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::historyrecord_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::historyrecord_table) )
   return false;
  ...
  {
    MYON_ERROR("MYON_BinaryArchive::Write3dmHistoryRecord() - active chunk typecode != TCODE_HISTORYRECORD_TABLE");
  }
  else 
  {
...
bool MYON_BinaryArchive::EndWrite3dmHistoryRecordTable()
{
  return EndWrite3dmTable( TCODE_HISTORYRECORD_TABLE );
}

bool MYON_BinaryArchive::BeginRead3dmHistoryRecordTable()
{
  return BeginRead3dmTable( TCODE_HISTORYRECORD_TABLE );
}

int MYON_BinaryArchive::Read3dmHistoryRecord( MYON_HistoryRecord*& history_record )
{
  history_record = nullptr;
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::historyrecord_table, (void**)&history_record))
    return 0;
  ...
  if ( BeginRead3dmBigChunk( &tcode, &big_value ) )
  {
    if ( tcode == TCODE_HISTORYRECORD_RECORD ) 
    {
      ...
      if ( ReadObject( &p ) ) 
      {
        history_record = MYON_HistoryRecord::Cast(p);
        if ( nullptr == history_record )
        {
          delete p;
        }
      ...
      if (nullptr == history_record)
      {
        MYON_ERROR("MYON_BinaryArchive::Read3dmHistoryRecord() - corrupt history_record table");
      }
    }
    else if ( tcode == TCODE_ENDOFTABLE ) 
    {
...
bool MYON_BinaryArchive::EndRead3dmHistoryRecordTable()
{
...
bool MYON_BinaryArchive::BeginWrite3dmMaterialTable()
{
  return BeginWrite3dmTable( TCODE_MATERIAL_TABLE );
}

bool MYON_BinaryArchive::Write3dmMaterialComponent(
  const MYON_ModelComponentReference& model_component_reference
  )
{
  ...
  )
{
  ...
  for (;;)
  {
    const MYON_Material* render_material = MYON_Material::Cast(model_component);
    if (nullptr == render_material)
    {
      MYON_ERROR("model_component parameter is not a render material component.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmMaterial( const MYON_Material& material )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::material_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::material_table) )
   return false;
  ...
  {
    Internal_ReportCriticalError();
    MYON_ERROR("MYON_BinaryArchive::Write3dmMaterial() - active chunk typecode != TCODE_MATERIAL_TABLE");
  }
  else 
  {
...
bool MYON_BinaryArchive::EndWrite3dmMaterialTable()
{
  return EndWrite3dmTable( TCODE_MATERIAL_TABLE );
}

bool MYON_BinaryArchive::BeginRead3dmMaterialTable()
{
  m_3dm_v1_material_index = 0;
  return BeginRead3dmTable( TCODE_MATERIAL_TABLE );
}

bool MYON_BinaryArchive::Read3dmV1String( MYON_String& s )
{
  int string_length = 0;
  s.Empty();
...
public:
  ...
  m_type;
  MYON_String m_string; 
  MYON_3dVector m_vector;
};

bool MYON_BinaryArchive::Read3dmV1AttributesOrMaterial( 
                         MYON_3dmObjectAttributes* attributes,
                         MYON_Material* material,
                         bool& bHaveMat,
                         unsigned int end_mark_tcode,
                         MYON__3dmV1_XDATA* xdata
                         )
{
  ...
  if ( 0 != xdata )
  {
    xdata->m_type = MYON__3dmV1_XDATA::unknown_xdata;
  }
  ...
  for (;;) 
  {
    ...
    case TCODE_LAYERREF:
         ...
         )
      {
        ...
        const MYON_ManifestMapItem& map_item = m_manifest_map.MapItemFromSourceIndex(MYON_ModelComponent::Type::Layer, file_layer_index);
    ...
    case TCODE_RGB:
      if ( big_value != 0xFFFFFF ) 
      {
        if ( material ) 
        {
          ...
          material->SetShine((u >> 24)/100.0*MYON_Material::MaxShine);
        }
        bHaveMat = true;
      }
      break;		
    ...
    case TCODE_TEXTUREMAP:
      {
        ...
        if ( s.Length() > 0 ) 
        {
          if ( material )
          {
            MYON_Texture& tx = material->m_textures.AppendNew();
            tx.m_image_file_reference.SetFullPath(s,false);
            tx.m_type = MYON_Texture::TYPE::bitmap_texture;
          }
          bHaveMat = true;
        }
      }
      ...
      if ( material ) {
        ...
        if ( s.Length() ) 
        {
          if ( material )
          {
            MYON_Texture& tx = material->m_textures.AppendNew();
            tx.m_image_file_reference.SetFullPath(s,false);
            tx.m_type = MYON_Texture::TYPE::bump_texture;
          }
          bHaveMat = true;
        }
      }
    ...
    case TCODE_XDATA:
      ...
      if ( attributes ) 
      {
        ...
        if ( !on_stricmp("RhHidePrevLayer",static_cast< const char* >(xid)) )
        {
          if ( sizeof_data > 0 )
          {
            ...
            if ( ReadByte(sizeof_data,buffer) )
            {
              ...
              //if ( 0 != xdata )
              //{
              //  xdata->m_type = MYON__3dmV1_XDATA::hidden_object_layer_name;
          ...
          if ( sizeof_data > 0 )
          {
            ...
            if ( ReadByte(sizeof_data,buffer)  )
            {
              if ( -1 == xdata_layer_index )
              {
                ...
                {
                  attributes->m_layer_index = xdata_layer_index;
                  attributes->SetMode(MYON::locked_object);
                }
              }
              else
              {
              ...
              //if ( 0 != xdata )
              //{
              //  xdata->m_type = MYON__3dmV1_XDATA::locked_object_layer_name;
              //  xdata->m_string = buffer;            
              //}
            }
            onfree(buffer);
        ...
        else if ( !on_stricmp("RhAnnotateArrow",static_cast< const char* >(xid)) && 24 == sizeof_data )
        {
          ...
          MYON_3dVector arrow_direction;
          if ( ReadVector( arrow_direction ) && 0 != xdata )
          {
            xdata->m_type = MYON__3dmV1_XDATA::arrow_direction;
        ...
        else if ( !on_stricmp("RhAnnotateDot",static_cast< const char* >(xid)) )
        {
          if ( sizeof_data > 0 )
          {
            ...
            {
              xdata->m_type = MYON__3dmV1_XDATA::dot_text;
              xdata->m_string = buffer;            
            }
            onfree(buffer);
          }
...
int MYON_BinaryArchive::Read3dmV1Material( MYON_Material** ppMaterial )
{
  int rc = 0;
  // returns -1: failure
  ...
  while( 0 == rc )
  {
    ...
    case TCODE_RH_POINT:
      // v1 3d point
      {
        MYON_3DM_BIG_CHUNK* point_chunk = m_chunk.Last();
        MYON__UINT64 pos0 = 0;
        if (    0 != point_chunk 
        ...
        MYON_3dPoint pt; // need to read point to get to material defn
             ...
             && 0 == point_chunk->m_big_value )
        {
          ...
          MYON__UINT64 pos1 = CurrentPosition();
          MYON__UINT64 chunk_length = (pos1 > pos0) ? (pos1 - pos0) : 0;
          if ( chunk_length >= 32 && chunk_length < 0x0FFFFFFF )
            point_chunk->m_big_value = (MYON__INT64)chunk_length;
        }
      }
      break;
    ...
    if ( bHaveMat && ppMaterial) 
    {
      ...
      *ppMaterial = new MYON_Material(material);
...
int MYON_BinaryArchive::Read3dmMaterial( MYON_Material** ppMaterial )
{
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::material_table, (void**)ppMaterial))
    return 0;
  ...
  if ( m_3dm_version == 1 ) 
  {
    MYON_Material* V1_material = nullptr;
    rc = MYON_BinaryArchive::Read3dmV1Material( &V1_material );
  ...
  else 
  {
    ...
    if ( BeginRead3dmBigChunk( &tcode, &big_value ) )
    {
      if ( tcode == TCODE_MATERIAL_RECORD ) 
      {
        ...
        if (!material)
        {
          MYON_ERROR("MYON_BinaryArchive::Read3dmMaterial() - corrupt material table");
        }
      }
      else if ( tcode == TCODE_ENDOFTABLE ) 
      {
...
bool MYON_BinaryArchive::EndRead3dmMaterialTable()
{
  return EndRead3dmTable( TCODE_MATERIAL_TABLE );
}


bool MYON_BinaryArchive::BeginWrite3dmLightTable()
{
  return BeginWrite3dmTable( TCODE_LIGHT_TABLE );
}

bool MYON_BinaryArchive::Write3dmModelLightComponent(
  const MYON_ModelComponentReference& model_component_reference
  )
{
  return Write3dmModelLightComponent(MYON_ModelGeometryComponent::Cast(model_component_reference.ModelComponent()));
}

bool MYON_BinaryArchive::Write3dmModelLightComponent(
  const MYON_ModelGeometryComponent* model_light
  )
{
  bool rc = false;
  for (;;)
  {
    ...
    {
      MYON_ERROR("model_light parameter is nullptr.");
      break;
    }

    const MYON_Light* light = MYON_Light::Cast(model_light->Geometry(nullptr));
    if (nullptr == light)
    {
      MYON_ERROR("model_light parameter is empty.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmLight( const MYON_Light& light,  const MYON_3dmObjectAttributes* attributes )
{
  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::light_table))
    return true;

  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::light_table) )
   return false;
  ...
  if ( c && c->m_typecode == TCODE_LIGHT_TABLE ) {
    ...
    if (rc) 
    {
      ...
      Internal_Write3dmLightOrGeometryUpdateManifest(MYON_ModelComponent::Type::RenderLight, light.m_light_id, light.m_light_index, light.m_light_name);
    ...
    MYON_ERROR("MYON_BinaryArchive::Write3dmMaterial() - active chunk typecode != TCODE_LIGHT_TABLE");
  }
  return rc;
}

bool MYON_BinaryArchive::EndWrite3dmLightTable()
{
  return EndWrite3dmTable( TCODE_LIGHT_TABLE );
}

bool MYON_BinaryArchive::BeginRead3dmLightTable()
{
  return BeginRead3dmTable( TCODE_LIGHT_TABLE );
}

int MYON_BinaryArchive::Read3dmV1Light(  // returns 0 at end of light table
                    //         1 light successfully read
                    //        -1 if file is corrupt
          MYON_Light** ppLight, // light returned here
          MYON_3dmObjectAttributes* pAttributes// optional - if NOT nullptr, object attributes are
                                  //            returned here
          )
{
  bool bHaveMat;
  ...
  // TODO - read v1 lights
  if ( m_chunk.Count() != 0 ) {
    MYON_ERROR("MYON_BinaryArchive::Read3dmV1Light() m_chunk.Count() != 0");
    return false;
  }
  bool rc = false;
  MYON__UINT32 tcode = 0;
  ...
  if (rc) {
    ...
    for(;;)
    {
      ...
      if (ppLight ) 
      {
        MYON_3dVector Z = MYON_CrossProduct( xaxis, yaxis );
        MYON_3dPoint  location = height*Z + origin;
        MYON_3dVector direction = -Z;

        if( height > 0.0)
          direction *= height;
        MYON_Light* light = new MYON_Light;
...
int MYON_BinaryArchive::Read3dmModelLight(
  class MYON_ModelGeometryComponent** model_light
  )
{
  if ( nullptr != model_light )
    *model_light = nullptr;
  MYON_Light* light = nullptr;
  ...
  if (1 == rc && nullptr != light)
  {
    ...
    MYON_ModelGeometryComponent* p = MYON_ModelGeometryComponent::CreateManaged(light,attributes,nullptr);
    if (nullptr != p)
    {
...
int MYON_BinaryArchive::Read3dmLight( MYON_Light** ppLight, MYON_3dmObjectAttributes* attributes )
{
  if ( attributes )
    attributes->Default();
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::light_table, (void**)ppLight))
    return 0;
  ...
  else 
  {
    ...
    if ( BeginRead3dmBigChunk( &tcode, &big_value ) ) 
    {
      if ( tcode == TCODE_LIGHT_RECORD )
      {
        ...
        MYON_Object* p = 0;
        if ( ReadObject( &p ) ) {
          light = MYON_Light::Cast(p);
          if ( !light )
            delete p;
        }
        if (!light) {
          MYON_ERROR("MYON_BinaryArchive::Read3dmLight() - corrupt light table");
        }
        else {
          *ppLight = light;
          rc = 1;
  ...
  if ( nullptr != ppLight && nullptr != (*ppLight) )
  {
    ...
    if (MYON_nil_uuid == (*ppLight)->m_light_id)
    {
      if (nullptr != attributes)
      {
        ...
        (*ppLight)->m_light_id = MYON_CreateId();
    }
...
bool MYON_BinaryArchive::EndRead3dmLightTable()
{
  return EndRead3dmTable( TCODE_LIGHT_TABLE );
}

bool MYON_BinaryArchive::BeginWrite3dmObjectTable()
{
  return BeginWrite3dmTable( TCODE_OBJECT_TABLE );
}

bool MYON_BinaryArchive::Write3dmModelGeometryComponent( 
  const class MYON_ModelComponentReference& model_component_reference
  )
{
  return Write3dmModelGeometryComponent(MYON_ModelGeometryComponent::Cast(model_component_reference.ModelComponent()));
}
bool MYON_BinaryArchive::Write3dmModelGeometryComponent(
  ...
  )
{
  ...
  for (;;)
  {
    ...
    {
      MYON_ERROR("model_geometry parameter is nullptr.");
      break;
    }
...
bool MYON_BinaryArchive::Write3dmObject( 
          const MYON_Object& object, 
          const MYON_3dmObjectAttributes* attributes 
          )
{
  if ( false == Internal_Begin3dmTableRecord(MYON_3dmArchiveTableType::object_table) )
    return false;
  ...
  if ( Archive3dmVersion() <= 2 && object.ObjectType() == MYON::pointset_object )
  {
    // There were no point clouds in V1 and V2 files and we cannot handle
    // this problem inside of MYON_PointCloud::Write() because we have to
    // write multiple point objects.  (c.f. MYON_Brep::Write()).
    const MYON_PointCloud* pc = MYON_PointCloud::Cast(&object);
    if ( 0 != pc )
    {
  ...
  m_annotation_context.SetViewContext( (nullptr != attributes) ? attributes->m_space : MYON_3dmAnnotationContext::Default.ViewContext() );
  ...
  if ( c && c->m_typecode == TCODE_OBJECT_TABLE ) 
  {
    ...
    if (rc) {
      ...
      if ( rc && nullptr != attributes ) {
        ...
        if (rc) {
          rc = attributes->Write( *this )?true:false;
          if (rc && MYON_nil_uuid != attributes->m_uuid)
            Internal_Write3dmLightOrGeometryUpdateManifest(MYON_ModelComponent::Type::ModelGeometry, attributes->m_uuid, MYON_UNSET_INT_INDEX, MYON_wString::EmptyString);
      ...
      MYON_ERROR("MYON_BinaryArchive::Write3dmObject() - active chunk typecode != TCODE_OBJECT_TABLE");
    }
  }

  m_annotation_context.SetViewContext( MYON_3dmAnnotationContext::Default.ViewContext() );

  return rc;
}

bool MYON_BinaryArchive::EndWrite3dmObjectTable()
{
  return EndWrite3dmTable( TCODE_OBJECT_TABLE );
}

bool MYON_BinaryArchive::BeginRead3dmObjectTable()
{
  m_3dm_v1_material_index = 0;
  return BeginRead3dmTable( TCODE_OBJECT_TABLE );
}

bool MYON_BinaryArchive::ReadV1_TCODE_RH_POINT(
  MYON_Object** ppObject,
  MYON_3dmObjectAttributes* pAttributes
  )
{
  MYON__UINT64 pos0 = 0;
  MYON_3DM_BIG_CHUNK* point_chunk = m_chunk.Last();
  ...
  if (rc) 
  {
    ...
    switch ( xdata.m_type )
    {
    case MYON__3dmV1_XDATA::arrow_direction:
      if ( xdata.m_vector.Length() > MYON_ZERO_TOLERANCE )
      {
        MYON_OBSOLETE_V2_AnnotationArrow* arrow = new MYON_OBSOLETE_V2_AnnotationArrow();
        arrow->m_tail = pt;
      ...
      {
        *ppObject = new MYON_Point(pt);
      }
      break;

    case MYON__3dmV1_XDATA::dot_text:
      {
        MYON_OBSOLETE_V2_TextDot* dot = new MYON_OBSOLETE_V2_TextDot();
        dot->point = pt;
...
static
void TweakAnnotationPlane( MYON_Plane& plane )
{
...
static bool ReadV1_TCODE_ANNOTATION_Helper( MYON_BinaryArchive& archive, char* buffer, MYON_wString& tc )
{
  char* cp = 0;
  int j = 0;
...
bool MYON_BinaryArchive::ReadV1_TCODE_ANNOTATION(
  unsigned int tcode,
  MYON_Object** ppObject,
  MYON_3dmObjectAttributes* pAttributes
  )
{
  ...
  *ppObject = nullptr;
  ...
  case TCODE_TEXT_BLOCK:
    {
         ...
         )
      {
        ...
        MYON_OBSOLETE_V2_TextObject* text = new MYON_OBSOLETE_V2_TextObject;
        text->SetType( MYON_INTERNAL_OBSOLETE::V5_eAnnotationType::dtTextBlock);
  ...
  case TCODE_ANNOTATION_LEADER:
    {
      ...
      if( i == RHINO_ANNOTATION_LEADER_VERSION_1)
      {
        ...
        MYON_OBSOLETE_V2_Leader* ldr = new MYON_OBSOLETE_V2_Leader;
        ldr->SetType( MYON_INTERNAL_OBSOLETE::V5_eAnnotationType::dtLeader);
  ...
  case TCODE_LINEAR_DIMENSION:
    {
      ...
      if( i == RHINO_LINEAR_DIMENSION_VERSION_1)
      {
        ...
        MYON_OBSOLETE_V2_DimLinear* dim = new MYON_OBSOLETE_V2_DimLinear;
        switch( i )
        {
        case DimHorizontal:
        case DimVertical:
        case DimRotated:
        case DimLinear:
          dim->SetType( MYON_INTERNAL_OBSOLETE::V5_eAnnotationType::dtDimLinear);
          break;
        default:
          dim->SetType( MYON_INTERNAL_OBSOLETE::V5_eAnnotationType::dtDimAligned);
          break;
        }
  ...
  case TCODE_ANGULAR_DIMENSION:
    {
      ...
      if( i == RHINO_ANGULAR_DIMENSION_VERSION_1)
      {
        ...
        MYON_OBSOLETE_V2_DimAngular* dim = new MYON_OBSOLETE_V2_DimAngular;
        dim->SetType( MYON_INTERNAL_OBSOLETE::V5_eAnnotationType::dtDimAngular);
  ...
  case TCODE_RADIAL_DIMENSION:
    {
      ...
      if( i == RHINO_RADIAL_DIMENSION_VERSION_1)
      {
        ...
        MYON_OBSOLETE_V2_DimRadial* dim = new MYON_OBSOLETE_V2_DimRadial;

        switch( i)
        {
        case DimDiameter:
          dim->SetType( MYON_INTERNAL_OBSOLETE::V5_eAnnotationType::dtDimDiameter);
          break;
        case DimRadius:
          dim->SetType( MYON_INTERNAL_OBSOLETE::V5_eAnnotationType::dtDimRadius);
          break;
        }
  ...
  // TCODE_TEXT_BLOCK:         MYON_OBSOLETE_V2_TextObject
  // TCODE_ANNOTATION_LEADER:  MYON_OBSOLETE_V2_Leader
  // TCODE_LINEAR_DIMENSION:   MYON_OBSOLETE_V2_DimLinear
  // TCODE_ANGULAR_DIMENSION:  MYON_OBSOLETE_V2_DimAngular
  // TCODE_RADIAL_DIMENSION:   MYON_OBSOLETE_V2_DimRadial
  //return true if successful and false for failure.
}


bool MYON_BinaryArchive::ReadV1_TCODE_MESH_OBJECT(
                                                MYON_Object** ppObject,
                                                MYON_3dmObjectAttributes* pAttributes
                                                )
{
...
static bool BeginRead3dmLEGACYSTUFF( MYON_BinaryArchive& file, unsigned int stuff_tcode )
{
  // begins reading stuff chunk
  bool rc = false;
  MYON__UINT32 tcode = !stuff_tcode;
  MYON__INT64 big_value = 0;
  for (;;) 
  {
...
static MYON_NurbsCurve* ReadV1_TCODE_LEGACY_SPLSTUFF( MYON_BinaryArchive& file )
{
  // reads contents of a v1 TCODE_LEGACY_SPLSTUFF chunk
  MYON_NurbsCurve* pNurbsCurve = 0;
  ...
  pNurbsCurve = new MYON_NurbsCurve( dim, is_rat?true:false, order, cv_count );
...
static bool ReadV1_TCODE_LEGACY_SPL( MYON_BinaryArchive& file,
...
static MYON_NurbsSurface* ReadV1_TCODE_LEGACY_SRFSTUFF( MYON_BinaryArchive& file )
{
  // reads contents of TCODE_LEGACY_SRFSTUFF chunk
  MYON_NurbsSurface* pNurbsSurface = 0;
  ...
  pNurbsSurface = new MYON_NurbsSurface( dim, is_rat?true:false, 
                                       order[0], order[1], 
...
static bool ReadV1_TCODE_LEGACY_SRF( MYON_BinaryArchive& file,
...
MYON_Curve* ReadV1_TCODE_LEGACY_CRVSTUFF( MYON_BinaryArchive& file )
{
  // reads contents of a v1 TCODE_LEGACY_CRVSTUFF chunk
  MYON_Curve* curve = 0;
  MYON_PolyCurve* polycurve = 0;
  MYON_NurbsCurve* segment = 0;
  bool rc = false;
  MYON__UINT32 tcode = 0;
  MYON__INT64 big_value = 0;
  int i;
  ...
  for (;;) {
    ...
    for ( i = 0; i < segment_count; i++ ) {
      ...
      if ( !segment )
        break;
      if ( i == 0 )
        polycurve = new MYON_PolyCurve(segment_count);
      ...
      {
        MYON_LineCurve* line = new MYON_LineCurve();
  ...
  if ( rc && polycurve ) 
  {
    ...
    {
      MYON_PolylineCurve* pline = new MYON_PolylineCurve();
...
bool MYON_Brep::ReadV1_LegacyTrimStuff( MYON_BinaryArchive& file, 
        MYON_BrepFace&, // face - formal parameter intentionally ignored
        MYON_BrepLoop& loop )
{
  ...
  MYON_Curve* curve2d = nullptr;
  MYON_Curve* curve3d = nullptr;
  ...
  if ( bHasEdge ) {
    ...
    MYON_BrepEdge& edge = NewEdge(curve3d_index);
    MYON_BrepTrim& trim = NewTrim( edge, 
                                    revedge ? true : false,
                                    loop,
                                    curve2d_index
                                    );
    ...
    MYON_BrepTrim& trim = NewTrim( revedge ? true : false,
                                    loop,
                                    curve2d_index
                                    );
    trim_index = trim.m_trim_index;
...
bool MYON_Brep::ReadV1_LegacyTrim( MYON_BinaryArchive& file, 
                            MYON_BrepFace& face,
                            MYON_BrepLoop& loop )
{
  bool rc = false;
...
bool MYON_Brep::ReadV1_LegacyLoopStuff( MYON_BinaryArchive& file, 
                               MYON_BrepFace& face )
{
  ...
  MYON_BrepLoop& loop = NewLoop( loop_type, face );
...
bool MYON_Brep::ReadV1_LegacyLoop( MYON_BinaryArchive& file, 
                                        MYON_BrepFace& face )
{
  bool rc = false;
...
bool MYON_Brep::ReadV1_LegacyFaceStuff( MYON_BinaryArchive& file )
{
  // reads contents of TCODE_LEGACY_FACSTUFF chunk
  MYON_NurbsSurface* surface = 0;
  MYON_Workspace ws;
  int flipnorm = 0;
  int ftype = 0;
  int bndcnt = 0;
  ...
  // create face
  MYON_BrepFace& face = NewFace(srf_index);
  ...
  if ( twincnt > 0 ) {
    ...
    for ( ti = ti0, si = 0; ti < ti1 && si < twincnt; ti++ ) {
      if (m_T[ti].m_type != MYON_BrepTrim::seam )
        continue;
      seam_i[si++] = ti;
    }
...
bool MYON_Brep::ReadV1_LegacyShellStuff( MYON_BinaryArchive& file )
{
  ...
  if ( twincnt > 0 ) {
    ...
    for ( ti = ti0, si = 0; ti < ti1 && si < twincnt; ti++ ) {
      if (m_T[ti].m_type != MYON_BrepTrim::mated )
        continue;
      share_i[si++] = ti;
    }
...
bool MYON_BinaryArchive::ReadV1_TCODE_LEGACY_CRV(
  MYON_Object** ppObject,
  MYON_3dmObjectAttributes* pAttributes
  )
{
  MYON_Curve* curve = nullptr;
  bool rc = false;
  MYON__UINT32 tcode = 0;
  MYON__INT64 big_value = 0;
  bool bHaveMat = false;
...
bool MYON_BinaryArchive::ReadV1_TCODE_LEGACY_FAC(
  MYON_Object** ppObject,
  MYON_3dmObjectAttributes* pAttributes
  )
{
...
bool MYON_BinaryArchive::ReadV1_TCODE_LEGACY_SHL(
  MYON_Object** ppObject,
  MYON_3dmObjectAttributes* pAttributes
  )
{
...
static
MYON_NurbsCurve* ReadV1_RHINOIO_NURBS_CURVE_OBJECT_DATA( MYON_BinaryArchive& file )
{
  ...
  if ( tcode == TCODE_RHINOIO_OBJECT_DATA ) for (;;) {
    ...
    curve = new MYON_NurbsCurve(dim,is_rat,order,cv_count);
...
static
MYON_NurbsSurface* ReadV1_RHINOIO_NURBS_SURFACE_OBJECT_DATA( MYON_BinaryArchive& file )
{
  // read TCODE_RHINOIO_OBJECT_DATA chunk that is contained in a
  ...
  if ( tcode == TCODE_RHINOIO_OBJECT_DATA ) for (;;) {
    ...
    surface = new MYON_NurbsSurface(dim,is_rat,order[0],order[1],cv_count[0],cv_count[1]);
...
bool MYON_BinaryArchive::ReadV1_TCODE_RHINOIO_OBJECT_NURBS_CURVE(
  MYON_Object** ppObject,
  MYON_3dmObjectAttributes* pAttributes
  )
{
...
bool MYON_BinaryArchive::ReadV1_TCODE_RHINOIO_OBJECT_NURBS_SURFACE(
  MYON_Object** ppObject,
  MYON_3dmObjectAttributes* pAttributes
  )
{
...
static
MYON_Curve* ReadV1_RHINOIO_BREP_CURVE( MYON_BinaryArchive& file )
{
  MYON_Curve* curve = nullptr;
  MYON_PolyCurve* pcurve = nullptr;
  MYON_NurbsCurve* nurbs_curve = nullptr;
...
bool MYON_BinaryArchive::ReadV1_TCODE_RHINOIO_OBJECT_BREP(
  MYON_Object** ppObject,
  MYON_3dmObjectAttributes* pAttributes
  )
{
  MYON_3dPoint m_oldTrim_mP[2];
  bool bHaveMat = false;
  bool rc = false;
  MYON_Brep* brep = 0;
  MYON__UINT32 tcode = 0;
  ...
  if ( tcode == TCODE_RHINOIO_OBJECT_DATA ) for (;;) {
    ...
    for ( i = 0; i < sz; i++ ) {
      MYON_Curve* curve = ReadV1_RHINOIO_BREP_CURVE( *this );
      if ( !curve )
        break;
    ...
    brep->m_V.Reserve(sz);
    for ( i = 0; i < sz; i++ ) {
      MYON_BrepVertex& vertex = brep->NewVertex();
    ...
    for ( i = 0; i < sz; i++ ) 
    {
      MYON_Interval proxy_domain;
      MYON_BrepEdge& edge = brep->NewEdge();
    ...
    brep->m_T.Reserve(sz);
    for ( i = 0; i < sz; i++ ) {
      MYON_BrepTrim& trim = brep->NewTrim();
      ...
      if ( !ReadInt( &j ) ) break;
      switch(j) {
      case 1: trim.m_type = MYON_BrepTrim::boundary; break;
      case 2: trim.m_type = MYON_BrepTrim::mated; break;
      case 3: trim.m_type = MYON_BrepTrim::seam; break;
      case 4: trim.m_type = MYON_BrepTrim::singular; break;
      }
    ...
    brep->m_L.Reserve(sz);
    for ( i = 0; i < sz; i++ ) {
      MYON_BrepLoop& loop = brep->NewLoop(MYON_BrepLoop::unknown);
      if ( !ReadInt( &loop.m_loop_index ) ) break;
      if ( !ReadArray( loop.m_ti ) ) break;
      if ( !ReadInt( &j ) ) break;
      switch (j) {
      case 1: loop.m_type = MYON_BrepLoop::outer; break;
      case 2: loop.m_type = MYON_BrepLoop::inner; break;
      case 3: loop.m_type = MYON_BrepLoop::slit; break;
      }
    ...
    brep->m_F.Reserve(sz);
    for ( i = 0; i < sz; i++ ) {
      MYON_BrepFace& face = brep->NewFace();
...
int
MYON_BinaryArchive::Read3dmV1Object( 
  MYON_Object** ppObject,                // object is returned here
  MYON_3dmObjectAttributes* pAttributes, // optional - object attributes 
  ...
  )
{
  ...
  for (;;)
  {
    ...
    case  TCODE_ANGULAR_DIMENSION:
    case  TCODE_RADIAL_DIMENSION:
      if (0 != (MYON::annotation_object & object_filter))
      {
    ...
    case TCODE_RH_POINT:
      // v1 3d point
      if (0 != (MYON::point_object & object_filter)) {
    ...
    case TCODE_MESH_OBJECT:
      // v1 mesh
      if (0 != (MYON::mesh_object & object_filter)) {
    ...
    if (1 == rc && nullptr != pAttributes && MYON_nil_uuid == pAttributes->m_uuid)
      pAttributes->m_uuid = MYON_CreateId(); // v1 files did not have ids.
...
#if 1
class MYON_OBSOLETE_CCustomMeshUserData : public MYON_UserData
{
	MYON_OBJECT_DECLARE(MYON_OBSOLETE_CCustomMeshUserData);
public:
  MYON_OBSOLETE_CCustomMeshUserData();
	~MYON_OBSOLETE_CCustomMeshUserData();
...
MYON_OBJECT_IMPLEMENT(MYON_OBSOLETE_CCustomMeshUserData, MYON_UserData, "69F27695-3011-4FBA-82C1-E529F25B5FD9");

MYON_OBSOLETE_CCustomMeshUserData::MYON_OBSOLETE_CCustomMeshUserData()
{
	m_userdata_copycount = 0;
	m_userdata_uuid = MYON_CLASS_ID(MYON_OBSOLETE_CCustomMeshUserData);
...
bool MYON_OBSOLETE_CCustomMeshUserData::Read(MYON_BinaryArchive& ba)
{
  int i = 0;
  if ( !ba.ReadInt( &i ) )
    return false;    
...
bool MYON_OBSOLETE_CCustomMeshUserData::GetDescription( MYON_wString& s )
{
...
int MYON_BinaryArchive::Read3dmModelGeometry(
...
int MYON_BinaryArchive::Read3dmModelGeometryForExperts(
...
)
{
  ...
  MYON_Geometry* geometry = MYON_Geometry::Cast(p);
  if (1 == rc && nullptr != geometry)
  {
    *model_geometry = MYON_ModelGeometryComponent::CreateForExperts(bManageGeometry,geometry,bManageAttributes,attributes,nullptr);
  }
  else
  {
    delete p;
...
int MYON_BinaryArchive::Read3dmObject( 
  MYON_Object** ppObject,                // object is returned here
  MYON_3dmObjectAttributes* pAttributes, // optional - object attributes 
  unsigned int object_filter           // optional filter made by or-ing object_type bits
  )
{
  ...
  if ( false == Read3dmTableRecord(MYON_3dmArchiveTableType::object_table, (void**)ppObject))
    return 0;
  ...
  {
    MYON__UINT32 tcode = 0;
    MYON__INT64 length_TCODE_OBJECT_RECORD = 0;
    MYON__INT64 value_TCODE_OBJECT_RECORD_TYPE = 0;
    MYON__INT64 length_TCODE_OBJECT_RECORD_ATTRIBUTES = 0;
      ...
      if ( tcode == TCODE_OBJECT_RECORD ) 
      {
        ...
        if (BeginRead3dmBigChunk( &tcode, &value_TCODE_OBJECT_RECORD_TYPE )) 
        {
          if ( tcode != TCODE_OBJECT_RECORD_TYPE ) {
            rc = -1;
            MYON_ERROR("MYON_BinaryArchive::Read3dmObject() - missing TCODE_OBJECT_RECORD_TYPE chunk.");
          }
        ...
        MYON_ERROR("MYON_BinaryArchive::Read3dmObject() - corrupt object table");
        rc = -1;
      }
      else
        rc = 0;
        ...
        else if ( tcode == TCODE_OBJECT_RECORD_ATTRIBUTES_USERDATA )
        {
          if ( 0 != pAttributes )
          {
            ...
            else
            {
              ...
              MYON_OBSOLETE_CCustomMeshUserData* ud = MYON_OBSOLETE_CCustomMeshUserData::Cast(pAttributes->GetUserData(MYON_CLASS_ID(MYON_OBSOLETE_CCustomMeshUserData)));
              if ( ud )
              {
              ...
              auto* sl = MYON_UserStringList::Cast(pAttributes->GetUserData(MYON_CLASS_ID(MYON_UserStringList)));
              if (sl)
              {
    ...
    )
  {
    ...
    MYON_Object* updated_object = Internal_ConvertObject(*ppObject, pAttributes);
...
bool MYON_BinaryArchive::EndRead3dmObjectTable()
{
...
bool MYON_BinaryArchive::BeginWrite3dmUserTable( const MYON_UUID& usertable_uuid )
{
  return BeginWrite3dmUserTable(usertable_uuid, false, 0, 0 );
}

bool MYON_BinaryArchive::BeginWrite3dmUserTable(
    MYON_UUID plugin_id,
    bool bSavingGoo,
    int goo_3dm_version,
...
{
  if ( m_3dm_active_table != MYON_3dmArchiveTableType::Unset ) 
  {
    MYON_ERROR("MYON_BinaryArchive::BeginWrite3dmUserTable() - m_active_table != no_active_table");
  }
  if ( !MYON_UuidCompare( &MYON_nil_uuid, &plugin_id ) ) {
    MYON_ERROR("MYON_BinaryArchive::BeginWrite3dmUserTable() - nil usertable_uuid not permitted.");
    return false;
  }

  if (false == ArchiveContains3dmTable(MYON_3dmArchiveTableType::user_table))
    return false;
    ...
    if (rc)
    {
      ...
      if (rc)
      {
        ...
        if ( rc )
        {
          ...
          unsigned int opennurbs_version_to_write = MYON_BinaryArchive::ArchiveOpenNURBSVersionToWrite(goo_3dm_version, goo_opennurbs_version);
          if (rc)
...
bool MYON_BinaryArchive::Write3dmAnonymousUserTableRecord( 
    MYON_UUID plugin_id,
    int goo_3dm_version,
    unsigned int goo_opennurbs_version,
    const MYON_3dmGoo& goo
    )
{
  if ( MYON_UuidIsNil(plugin_id) )
    return false;
  ...
  if ( goo_3dm_version <= 3 )
    return false;
  if (   !MYON_VersionNumberIsValid(goo_opennurbs_version) 
      && !MYON_VersionNumberIsYearMonthDateFormat(goo_3dm_version,goo_opennurbs_version)
     )
  {
    return false;
  }
...
bool MYON_BinaryArchive::Write3dmAnonymousUserTable( const MYON_3dmGoo& goo )
{
  bool rc = false;
  const MYON_3DM_BIG_CHUNK* c = m_chunk.Last();
  if ( !c || c->m_typecode != TCODE_USER_RECORD ) {
    MYON_ERROR("MYON_BinaryArchive::Write3dmAnonymousUserTable() - active chunk not a TCODE_USER_RECORD.");
    rc = false;
  }
  else if ( goo.m_typecode != TCODE_USER_RECORD ) {
    MYON_ERROR("MYON_BinaryArchive::Write3dmAnonymousUserTable() - goo chunk not a TCODE_USER_RECORD.");
    rc = false;
  }
  else {
...
bool MYON_BinaryArchive::EndWrite3dmUserTable()
{
  bool rc = false;
  const MYON_3DM_BIG_CHUNK* c = m_chunk.Last();
  if ( c && c->m_typecode == TCODE_USER_RECORD ) {
    ...
    MYON_ERROR("MYON_BinaryArchive::EndWrite3dmUserTable() - not in a TCODE_USER_RECORD chunk.");
    rc = false;
  }
...
bool MYON_BinaryArchive::BeginRead3dmUserTable(
    MYON_UUID& plugin_id,
    ...
    )
{
  ...
  if ( rc ) 
  {
    ...
    if (rc)
    {
      ...
      {
        MYON_ERROR("MYON_BinaryArchive::BeginRead3dmUserTable() - missing user table UUID");
        rc = false;
      }
      else 
      {
    ...
    if (rc) {
      if ( tcode != TCODE_USER_RECORD ) {
        MYON_ERROR("MYON_BinaryArchive::BeginRead3dmUserTable() - missing user table TCODE_USER_RECORD chunk.");
        EndRead3dmChunk();
        rc = false;
      }
    }
...
bool MYON_BinaryArchive::Read3dmAnonymousUserTable( 
    int archive_3dm_version,
    unsigned int archive_opennurbs_version,
    MYON_3dmGoo& goo
    )
{
  ...
  if (rc && goo.m_typecode != TCODE_USER_RECORD ) {
    MYON_ERROR("MYON_BinaryArchive::Read3dmAnonymousUserTable() do not read a TCODE_USER_RECORD chunk.");
    rc = false;
  }
  return rc;
}

bool MYON_BinaryArchive::EndRead3dmUserTable()
{
  if ( m_chunk.Count() != 2 ) {
    MYON_ERROR("MYON_BinaryArchive::EndRead3dmUserTable() m_chunk.Count() != 2");
    return false;
  }
  const MYON_3DM_BIG_CHUNK* c = m_chunk.Last();
  if ( 0 == c || c->m_typecode != TCODE_USER_RECORD ) {
    MYON_ERROR("MYON_BinaryArchive::EndRead3dmTable() m_chunk.Last()->typecode != TCODE_USER_RECORD");
    return false;
  }
  ...
  if (rc) {
    // end of table chunk
    unsigned int tcode = 0;
    MYON__INT64 big_value = -1;
    rc = BeginRead3dmBigChunk( &tcode, &big_value );
    if ( rc ) {
      if ( tcode != TCODE_ENDOFTABLE ) {
        MYON_ERROR("MYON_BinaryArchive::EndRead3dmTable() missing TCODE_ENDOFTABLE marker.");
      }
      if ( !EndRead3dmChunk() )
        rc = false;
    }
...
bool MYON_BinaryArchive::Write3dmEndMark()
{
  Flush();
  if ( m_chunk.Count() != 0 ) {
    MYON_ERROR( "MYON_BinaryArchive::WriteEndMark() called with unfinished chunks.\n" );
    return false;
  }

  if (false == Begin3dmTable(MYON::archive_mode::write3dm,MYON_3dmArchiveTableType::end_mark))
    return false;

  MYON__UINT64 length = CurrentPosition(); // since no chunks are unfinished, everything
  ...
  return End3dmTable(MYON_3dmArchiveTableType::end_mark,rc);
}

bool MYON_BinaryArchive::Read3dmEndMark( size_t* file_length )
{
  if (false == Begin3dmTable(MYON::archive_mode::read3dm,MYON_3dmArchiveTableType::end_mark))
    return false;
  ...
  if (rc)
  {
    ...
    {
      rc = BeginRead3dmBigChunk(&tcode,&value);
      if ( rc && value > 0 && ((MYON__UINT64)value) >= SizeofChunkLength() )
      {
        MYON__UINT64 u64 = 0;
...
MYON::endian
MYON_BinaryArchive::Endian() const // endian-ness of cpu
{
  return m_endian;
}

MYON::archive_mode MYON_BinaryArchive::Mode() const
{
  return m_mode;
}

bool MYON_BinaryArchive::ReadMode() const
{
  bool bIsReading = false;

  switch (m_mode)
  {
  case MYON::archive_mode::unset_archive_mode:
    break;
  case MYON::archive_mode::read:
    bIsReading = true;
    break;
  case MYON::archive_mode::write:
    break;
  case MYON::archive_mode::readwrite:
    bIsReading = true;
    break;
...
bool MYON_BinaryArchive::WriteMode() const
{
...
bool MYON_BinaryArchive::UnsetMode() const
{
  return (false == ReadMode() && false == WriteMode());
}

void MYON_BinaryArchive::UpdateCRC( size_t count, const void* p )
{
  if ( m_bDoChunkCRC ) {
    MYON_3DM_BIG_CHUNK* c = m_chunk.Last();
    if (c) {
      if ( c->m_do_crc16 )
        c->m_crc16 = MYON_CRC16( c->m_crc16, count, p ); // version 1 files had 16 bit CRC
      if ( c->m_do_crc32 )
        c->m_crc32 = MYON_CRC32( c->m_crc32, count, p ); // version 2 files have 32 bit CRC
    }
  }
}


void MYON_BinaryArchive::Internal_ReportCRCError()
{
  m_crc_error_count++;
  if (nullptr != m_3dm_table_status_list 
    && m_3dm_active_table == m_3dm_table_status_list->m_table_status.m_table_type
    && MYON_3dmArchiveTableStatus::TableState::Finished !=  m_3dm_table_status_list->m_table_status.m_state
    )
  {
...
unsigned int MYON_BinaryArchive::BadCRCCount() const
{
...
*/
unsigned int MYON_BinaryArchive::CriticalErrorCount() const
{
  return m_critical_error_count;
}


void MYON_BinaryArchive::Internal_ReportCriticalError()
{
...
const MYON_3dmArchiveTableStatus MYON_BinaryArchive::Archive3dmTableStatus(
  MYON_3dmArchiveTableType table_type
  )
{
  for (const MYON_3dmTableStatusLink* link = m_3dm_table_status_list; nullptr != link; link = link->m_next)
  {
    if ( table_type == link->m_table_status.m_table_type )
      return link->m_table_status;
  }
  return MYON_3dmArchiveTableStatus::Unset;
}


unsigned int MYON_BinaryArchive::ErrorMessageMask() const
{
  return m_error_message_mask;
}

bool MYON_BinaryArchive::MaskReadError( MYON__UINT64 sizeof_request, MYON__UINT64 sizeof_read ) const
{
  ...
  if (0 == m_3dm_version
    ...
    && MYON_3dmArchiveTableType::Unset == m_3dm_previous_table
    && MYON_3dmArchiveTableType::Unset == m_3dm_active_table
    && MYON_3dmArchiveTableType::Unset == m_3dm_first_failed_table
    && 0 == m_chunk
    && MYON::archive_mode::read3dm == m_mode
    )
  {
    ...
    // false from MYON_BinaryArchive::Read3dmStartSection().
    // MYON_ERROR is not called to prevent annoying everyone
...
MYON__UINT64 MYON_BinaryArchive::ReadBuffer( MYON__UINT64 sizeof_buffer, void* buffer )
{
  ...
  MYON__UINT64 sizeof_read = Read((size_t)sizeof_buffer,buffer);
...
MYON_BinaryFile::MYON_BinaryFile( MYON::archive_mode archive_mode ) 
  : MYON_BinaryArchive( archive_mode )
{}

MYON_BinaryFile::MYON_BinaryFile( MYON::archive_mode archive_mode, FILE* fp ) 
  : MYON_BinaryArchive( archive_mode )
  , m_fp(fp)
{}

MYON_BinaryFile::MYON_BinaryFile( MYON::archive_mode archive_mode, const char* file_system_path ) 
  : MYON_BinaryArchive( archive_mode )
{
  switch (archive_mode)
  {
  ...
  case MYON::archive_mode::read:
  case MYON::archive_mode::read3dm:
    m_fp = MYON::OpenFile(file_system_path,"rb");
    break;
  case MYON::archive_mode::write:
  case MYON::archive_mode::write3dm:
    m_fp = MYON::OpenFile(file_system_path,"wb");
    break;
  default:
    break;
  }
...
MYON_BinaryFile::MYON_BinaryFile( MYON::archive_mode archive_mode, const wchar_t* file_system_path ) 
  : MYON_BinaryArchive( archive_mode )
{
  switch (archive_mode)
  {
  ...
  case MYON::archive_mode::read:
  case MYON::archive_mode::read3dm:
    m_fp = MYON::OpenFile(file_system_path,L"rb");
    break;
  case MYON::archive_mode::write:
  case MYON::archive_mode::write3dm:
    m_fp = MYON::OpenFile(file_system_path,L"wb");
    break;
  default:
    break;
  }
...
MYON_BinaryFile::~MYON_BinaryFile()
{
...
bool MYON_BinaryFile::FileIsOpen() const
{
  return (nullptr != m_fp);
}

void MYON_BinaryFile::CloseFile()
{
  FILE* fp = m_fp;
  if (nullptr != fp)
  {
...
size_t MYON_BinaryArchive::Read( size_t count, void* p )
{
  size_t readcount = 0;
  ...
  else if ( count > 0 )
  {
    ...
    {
      Internal_ReportCriticalError();
      MYON_ERROR("buffer parameter is nullptr.");
    }
    else
    {
      if (m_bChunkBoundaryCheck)
      {
        ...
        {
          const MYON__UINT64 current_pos = CurrentPosition();
          const MYON__UINT64 new_pos = current_pos + ((MYON__UINT64)count);

          if (current_pos < c->m_start_offset)
          {
            MYON_ERROR("Attempt to read before the start of current chunk.");
            count = 0;
          }
          else if ( new_pos > c->m_end_offset )
          {
            MYON_ERROR("Attempt to read beyond end of current chunk.");
            count = 0;
          }
        }
      }
      ...
      if (count > 0)
      {
        ...
        {
          // error occured
          SetStorageDeviceError(MYON_BinaryArchive::eStorageDeviceError::ReadFailed);
          MYON_ERROR("Internal_ReadOverride(count, p) failed.");
        }

        if (readcount > 0)
          Internal_IncrementCurrentPosition((MYON__UINT64)readcount);
...
bool MYON_BinaryArchive::ReadByte(size_t count, void* p)
{
  return (count == Read(count, p));
}

size_t MYON_BinaryArchive::Write( size_t count, const void* p )
{
  size_t writecount = 0;
    ...
    else
    {
      ...
      if (m_bChunkBoundaryCheck)
      {
        ...
        if (nullptr != c )
        {
          ...
          if (current_pos < c->m_start_offset )
          {
            MYON_ERROR("Attempt to write before current chunk boundary.");
            count = 0;
          }
          if ( current_pos > c->m_end_offset )
          {
            MYON_ERROR("Attempt to write after current chunk boundary.");
            count = 0;
          }
        }
      }
      ...
      if (count > 0)
      {
        ...
        {
          SetStorageDeviceError(MYON_BinaryArchive::eStorageDeviceError::WriteFailed);
          MYON_ERROR("Internal_WriteOverride(count, p) failed.");
        }
        ...
        if (writecount > 0)
        {
          ...
          {
            const MYON__UINT64 new_pos = current_pos + (MYON__UINT64)writecount;
            if (new_pos > c->m_end_offset)
              c->m_end_offset = new_pos;
          }
          Internal_IncrementCurrentPosition((MYON__UINT64)writecount);
        }
      }
    }
  }
...
bool MYON_BinaryArchive::WriteByte( size_t count, const void* p )
{
  return (count == Write(count, p));
}

bool MYON_BinaryArchive::EnableCRCCalculation( bool bEnable )
{
...
bool
MYON_BinaryArchive::SetArchive3dmVersion(int v)
{
  bool rc = false;
  ...
  if ( (v >= 1 && v <= 5) || ( v >= 50 && 0 == (v % 10) && v <= MYON_BinaryArchive::CurrentArchiveVersion() ) )
  {
    m_3dm_version = v;
    rc = true;
  }
  ...
  {
    m_3dm_version = 0;
    MYON_ERROR("MYON_BinaryArchive::SetArchive3dmVersion - invalid version");
  }
  return rc;
}

bool
MYON_BinaryArchive::SetOpenNURBS3dmVersion(unsigned int v)
{
...
void 
MYON_BinaryFile::EnableMemoryBuffer(
       int buffer_capacity
       )
{
...
size_t MYON_BinaryFile::Internal_ReadOverride( size_t count, void* p )
{
  ...
  if (rc != count && nullptr != m_fp)
  {
    ...
    {
      MYON_ERROR("fread() failed.");
    }
  }
  return rc;
}

size_t MYON_BinaryFile::Internal_WriteOverride( size_t count, const void* p )
{
  size_t rc = 0;
  if ( m_fp ) 
  {
    if ( m_memory_buffer ) 
    {
      if ( count+m_memory_buffer_ptr >= m_memory_buffer_capacity ) {
        ...
        if (rc != count)
        {
          MYON_ERROR("fwrite() failed - situation A.");
        }
      }
      else 
      {
    ...
    else
    {
      ...
      if (rc != count)
      {
        MYON_ERROR("fwrite() failed - situation B.");
      }
    }
  }
  return rc;
...
bool MYON_BinaryFile::Flush()
{
  ...
  if ( m_fp ) 
  {
    if ( m_memory_buffer && m_memory_buffer_size > 0 ) 
    {
      ...
      if (false == rc)
      {
        MYON_ERROR("fwrite( m_memory_buffer, 1, m_memory_buffer_size, m_fp ) failed.");
      }
      if ( rc && m_memory_buffer_ptr != m_memory_buffer_size ) 
      {
        ...
        MYON__INT64 delta =  (m_memory_buffer_ptr >= m_memory_buffer_size) 
                  ?  ((MYON__INT64)(m_memory_buffer_ptr - m_memory_buffer_size))
                  : -((MYON__INT64)(m_memory_buffer_size - m_memory_buffer_ptr));
        if ( false == MYON_FileStream::SeekFromCurrentPosition(m_fp,delta) )          
        {
          MYON_ERROR("MYON_FileStream::SeekFromCurrentPosition(m_fp,delta) failed.");
          rc = false;
        }
      }
      m_memory_buffer_size = 0;
...
MYON__UINT64 MYON_BinaryFile::Internal_CurrentPositionOverride() const
{
  MYON__UINT64 offset = 0;
  ...
  if ( 0 != m_fp ) 
  {
    ...
    MYON__INT64 offset64 = _ftelli64(m_fp);
    if ( offset64 < 0 )
    {
      MYON_ERROR(" _ftelli64() failed");
    }
    else
    {
      offset = (MYON__UINT64)offset64;
    }
#else
    offset = (MYON__UINT64)ftell(m_fp);
#endif

    if ( m_memory_buffer && m_memory_buffer_size > 0 && m_memory_buffer_ptr > 0 ) 
    {
      // add bytes in memory buffer
      offset += (MYON__INT64)m_memory_buffer_ptr;
    }
  }
  else 
  {
    MYON_ERROR("m_fp is nullptr.");
  }

  return offset;
}

bool MYON_BinaryFile::AtEnd() const
{
  bool rc = true;
  if ( m_fp ) 
  {
    ...
    if ( ReadMode() && m_memory_buffer_ptr >= m_memory_buffer_size ) 
    {
      ...
      else
      {
        ...
        if (1 == fread_count)
        {
          ...
          MYON_FileStream::SeekFromCurrentPosition(m_fp, -1);
        }
      }
    }
  }
...
bool MYON_BinaryFile::Internal_SeekFromCurrentPositionOverride( int offset )
{
  // it appears that the calls to SeekFromCurrentPosition(),
  // and consequent call to fseek(), in MYON_BinaryArchive::EndWrite3DMChunk()
  ...
  //
  // To speed up network saves, MYON_BinaryFile can optionally use
  ...
  if ( m_fp ) 
  {
    if ( nullptr != m_memory_buffer
      && ((MYON__INT_PTR)m_memory_buffer_ptr)+((MYON__INT_PTR)offset) >= 0
    ...
    else
    {
      ...
      Flush();      
      if ( MYON_FileStream::SeekFromCurrentPosition(m_fp,offset) )
      {
        rc = true;
      }
      else 
      {
        MYON_ERROR("MYON_FileStream::SeekFromCurrentPosition(m_fp,offset) failed.");
      }
    }
  }
  return rc;
...
bool MYON_BinaryFile::Internal_SeekToStartOverride()
{
  bool rc = false;
  if ( m_fp ) 
  {
    Flush(); // don't deal with memory buffer I/O in rare seek from start
    if ( MYON_FileStream::SeekFromStart(m_fp,0) )
    {
      rc = true;
    }
    else 
    {
      MYON_ERROR("MYON_FileStream::SeekFromStart(m_fp,0) failed.");
    }
  }
  return rc;
}

MYON_3dmGoo::MYON_3dmGoo()
        : m_typecode(0),
          m_value(0),
          m_goo(0),
          m_next_goo(0),
...
MYON_3dmGoo::MYON_3dmGoo( const MYON_3dmGoo& src )
        : m_typecode(0),
          m_value(0),
          m_goo(0),
          m_next_goo(0),
...
MYON_3dmGoo& MYON_3dmGoo::operator=( const MYON_3dmGoo& src )
{
  if ( this != &src ) {
    if ( m_goo ) {
      onfree(m_goo);
...
void MYON_3dmGoo::Dump(MYON_TextLog& dump) const
{
...
{
	const MYON_Object*  object_array = &object;
	return MYON_WriteMultipleObjectArchive( archive, version, 1, &object_array );
}
...
{
	const MYON_Object*  object_array = &object;
	return MYON_WriteMultipleObjectArchive( filename, 0, 1, &object_array );
}
...
{
	return MYON_WriteMultipleObjectArchive( archive, version, object_list.Count(), object_list.Array() );
}
bool MYON_WriteMultipleObjectArchive(
  const wchar_t* filename,
  int version,
...
)
{
  ...
  bool ok = MYON_WriteMultipleObjectArchive( archive, version, object_list_count, object_list );
  MYON::CloseFile( fp );
  return ok;
}
          ...
          )
{
  ...
  model.m_settings.m_ModelUnitsAndTolerances.m_unit_system.SetUnitSystem( MYON::LengthUnitSystem::None );

  MYON_Layer* layer = new MYON_Layer(MYON_Layer::Default);
  layer->SetId();
  layer->SetIndex(0);
  ...
  {
		const MYON_Geometry* geometry = MYON_Geometry::Cast(object_list[object_index]);
		if ( MYON_BrepEdge::Cast(geometry) )
		{
			// write parent brep
			geometry = static_cast<const MYON_BrepEdge*>(geometry)->Brep();
		}
		else if ( MYON_BrepTrim::Cast(geometry) )
		{
			geometry = nullptr;
		}
		else if ( MYON_BrepLoop::Cast(geometry) )
		{
			geometry = static_cast<const MYON_BrepLoop*>(geometry)->Brep();
		}
		else if ( MYON_BrepFace::Cast(geometry) )
		{
			// write parent brep
			geometry = static_cast<const MYON_BrepFace*>(geometry)->Brep();
		}
		else if ( MYON_CurveProxy::Cast(geometry) )
		{
			// write actual curve
			geometry = static_cast<const MYON_CurveProxy*>(geometry)->ProxyCurve();
		}
		else if ( MYON_SurfaceProxy::Cast(geometry) )
		{
			// write actual surface
			geometry = static_cast<const MYON_SurfaceProxy*>(geometry)->ProxySurface();
		}

    if (nullptr == geometry)
      continue;

    // bManageGeometry = false means ~MYON_ModelGeometryComponent will not delete geometry
    const bool bManageGeometry = false;
    const bool bManageAttributes = true;
    MYON_3dmObjectAttributes* attributes = new MYON_3dmObjectAttributes();
    attributes->m_layer_index = layer->Index();
    attributes->m_uuid = MYON_CreateId();
    MYON_ModelGeometryComponent* mg = MYON_ModelGeometryComponent::CreateForExperts(
      bManageGeometry,
      const_cast<MYON_Geometry*>(geometry), // safe - see bManageGeometry = false comment above.
      bManageAttributes,
      attributes,
      nullptr
    );
  ...
  if ( (0 != version % 10)
    || version < MYON_BinaryArchive::CurrentArchiveVersion() - 10
    || version > MYON_BinaryArchive::CurrentArchiveVersion()
    )
  {
    version = MYON_BinaryArchive::CurrentArchiveVersion();
  }
  model.m_sStartSectionComments = "Archive created by MYON_WriteMultipleObjectArchive";
...
static 
void Dump3dmChunk_ErrorReportHelper( MYON__UINT64 offset, const char* msg, MYON_TextLog& dump )
{
  int ioffset = (int)offset;
  dump.Print("** ERROR near offset %d ** %s\n",ioffset,msg);
}
static
bool DumpChunk_PrintHeaderInfo( MYON__UINT64 offset0, MYON__UINT32 typecode, MYON__INT64 big_value, const char* typecode_name, MYON_TextLog& dump)
{
  bool bShortChunk = (0 != (typecode & TCODE_SHORT));
  if ( 0 == typecode_name )
    typecode_name = MYON_BinaryArchive::TypecodeName(typecode);
  if ( 0 == typecode_name )
...
const char* MYON_BinaryArchive::TypecodeName( unsigned int tcode )
{
...
char* MYON_BinaryArchive::MYON_TypecodeParse( unsigned int tcode, char* typecode_name, size_t max_length )
{
  char* s;
  const char* sub_name;
  ...
  sub_name = MYON_BinaryArchive::TypecodeName(tcode);
  ...
  sub_name = MYON_BinaryArchive::TypecodeName( tcode & 0x7FFF0000 );
  ...
  sub_name = MYON_BinaryArchive::TypecodeName( tcode & TCODE_SHORT );
  if ( sub_name )
  {
  ...
  sub_name = MYON_BinaryArchive::TypecodeName( tcode & TCODE_CRC );
  if ( sub_name )
  {
    if ( slen <= 0 ) return 0; *s++ = ' '; slen--;
    if ( slen <= 0 ) return 0; *s++ = '|'; slen--;
  ...
  sub_name = MYON_BinaryArchive::TypecodeName( tcode & 0x7FFF );
  if ( sub_name )
  {
    if ( slen <= 0 ) return 0; *s++ = ' '; slen--;
    if ( slen <= 0 ) return 0; *s++ = '|'; slen--;
...
static
bool Dump3dmChunk_EndReadChunkHelper( MYON_BinaryArchive& file, MYON__UINT64 offset0, MYON__UINT32 tcode, MYON__INT64 big_value, MYON_TextLog& dump )
{
  const bool bShortChunk = (0 != (tcode & TCODE_SHORT));
  const MYON__UINT64 offset1 = file.CurrentPosition();
  ...
  else if (!bShortChunk) 
  {
    ...
    MYON__INT64 sizeof_crc = (0 != (TCODE_CRC & tcode)) ? 4 : 0;
    MYON__INT64 sizeof_chunk_header = 4+file.SizeofChunkLength();
    MYON__INT64 delta =  (offset1 > offset0)
              ?  ((MYON__INT64)(offset1 - offset0))
              : -((MYON__INT64)(offset0 - offset1));
    const MYON__INT64 extra = big_value - (delta+sizeof_crc-sizeof_chunk_header);
    if ( extra < 0 ) 
    {
...
static 
bool Dump3dmChunk_UserDataHeaderHelper( MYON__UINT64 offset, MYON_BinaryArchive& file, 
                                 int major_userdata_version, int minor_userdata_version, 
                                 MYON_TextLog& dump )
{
  // TCODE_OPENNURBS_CLASS_USERDATA chunks have 2 uuids
  // the first identifies the type of MYON_Object class
  // the second identifies that kind of user data
  MYON_UUID userdata_classid = MYON_nil_uuid;
  MYON_UUID userdata_itemid = MYON_nil_uuid;
  MYON_UUID userdata_appid = MYON_nil_uuid;  // id of plug-in that owns the user data
  int userdata_copycount = -1;
  MYON_Xform userdata_xform;
  ...
  MYON__UINT32 tcode = 0;
  MYON__INT64 big_value = 0;
  const MYON__UINT64 offset0 = file.CurrentPosition();
  ...
  for(;;)
  {
    ...
    const MYON_ClassId* pUserDataClassId = MYON_ClassId::ClassId(userdata_classid);
    if ( pUserDataClassId )
    {
...
unsigned int 
MYON_BinaryArchive::Dump3dmChunk( MYON_TextLog& dump, int recursion_depth )
{
  //MYON_BinaryArchive& file = *this;
  const char* typecode_name = 0;
  bool bShortChunk = false;
  const MYON__UINT64 offset0 = CurrentPosition();
  unsigned int typecode = 0;
  MYON__INT64 big_value;
  ...
  else 
  {
      ...
      case TCODE_PROPERTIES_OPENNURBS_VERSION:
        {
          ...
          dump.PopIndent();           
          if (0 == m_3dm_opennurbs_version && big_value > 0 && ((MYON__UINT64)big_value) < MYON_UNSET_UINT_INDEX)
            MYON_SetBinaryArchiveOpenNURBSVersion(*this,(MYON__UINT32)big_value);
        }
        break;
      ...
      case TCODE_OPENNURBS_CLASS_USERDATA:
        {
          ...
          else
          {
            ...
            {
              const MYON__UINT64 userdata_header_offset = CurrentPosition();
      ...
      case TCODE_USER_TABLE_UUID:
        {
          ...
          else 
          {
            if ( typecode == TCODE_OPENNURBS_CLASS_UUID ) 
            {
              ...
              pClassId = MYON_ClassId::ClassId(uuid);
            }
    ...
    const MYON__UINT64 offset1 = CurrentPosition();
    ...
    else if (!bShortChunk) 
    {
      MYON__INT64 delta =  (offset1 > offset0)
                ?  ((MYON__INT64)(offset1 - offset0))
                : -((MYON__INT64)(offset0 - offset1));
      const MYON__INT64 extra = big_value - (delta-4-SizeofChunkLength());
      if ( extra < 0 ) 
      {
        Dump3dmChunk_ErrorReportHelper(offset0,"Read beyond end of chunk.",dump);
      }
...
MYON_Read3dmBufferArchive::MYON_Read3dmBufferArchive( 
...
: MYON_BinaryArchive(MYON::archive_mode::read3dm)
, m_p(0)
, m_buffer(0)
, m_sizeof_buffer(0)
, m_buffer_position(0)
...
, m_reserved4(0)
{
  if ( sizeof_buffer > 0 && 0 != buffer )
  {
    ...
    if ( m_buffer )
    {
      ...
      MYON_SetBinaryArchiveOpenNURBSVersion(*this,archive_opennurbs_version);
    }
  }
}
...
MYON__UINT64 MYON_Read3dmBufferArchive::Internal_CurrentPositionOverride() const
{
  return (MYON__UINT64)m_buffer_position;
}

bool MYON_Read3dmBufferArchive::Internal_SeekFromCurrentPositionOverride( int offset )
{
  bool rc = false;
  if ( m_buffer )
  {
...
bool MYON_Read3dmBufferArchive::Internal_SeekToStartOverride()
{
  bool rc = false;
  if ( m_buffer ) 
  {
...
bool MYON_Read3dmBufferArchive::AtEnd() const
{
  return (m_buffer_position >= m_sizeof_buffer) ? true : false;
}

size_t MYON_Read3dmBufferArchive::Internal_ReadOverride( size_t count, void* buffer )
{
  if ( count <= 0 || 0 == buffer )
    return 0;
...
size_t MYON_Read3dmBufferArchive::Internal_WriteOverride( size_t, const void* )
{
  // MYON_Read3dmBufferArchive does not support Write() and Flush()
  return 0;
}

bool MYON_Read3dmBufferArchive::Flush()
{
  // MYON_Read3dmBufferArchive does not support Write() and Flush()
  return false;
}
...
size_t MYON_Read3dmBufferArchive::SizeOfBuffer() const
{
  return m_sizeof_buffer;
}

const void* MYON_Read3dmBufferArchive::Buffer() const
{
  return (const void*)m_buffer;
}

MYON_Write3dmBufferArchive::MYON_Write3dmBufferArchive( 
          size_t initial_sizeof_buffer, 
          size_t max_sizeof_buffer, 
          int archive_3dm_version,
          unsigned int archive_opennurbs_version
          )
: MYON_BinaryArchive(MYON::archive_mode::write3dm)
, m_p(0)
, m_buffer(0)
, m_sizeof_buffer(0)
...
, m_reserved4(0)
{
  ...
  if ( archive_3dm_version < 2 )
  {
    ...
    archive_opennurbs_version = MYON::Version();
  }
  SetArchive3dmVersion(archive_3dm_version);
  MYON_SetBinaryArchiveOpenNURBSVersion(*this,archive_opennurbs_version);
}
...
void MYON_Write3dmBufferArchive::AllocBuffer( size_t sz )
{
...
// MYON_BinaryArchive overrides
MYON__UINT64 MYON_Write3dmBufferArchive::Internal_CurrentPositionOverride() const
{
  return (MYON__UINT64)m_buffer_position;
}

bool MYON_Write3dmBufferArchive::Internal_SeekFromCurrentPositionOverride( int offset )
{
  bool rc = false;
  if ( m_buffer )
  {
...
bool MYON_Write3dmBufferArchive::Internal_SeekToStartOverride()
{
  m_buffer_position = 0;
  return true;
}

bool MYON_Write3dmBufferArchive::AtEnd() const
{
  return (m_buffer_position >= m_sizeof_buffer) ? true : false;
}

size_t MYON_Write3dmBufferArchive::Internal_ReadOverride( size_t count, void* buffer )
{
  if ( count <= 0 || 0 == buffer )
    return 0;
...
size_t MYON_Write3dmBufferArchive::Internal_WriteOverride( size_t sz, const void* buffer )
{
  if ( sz <= 0 || 0 == buffer )
    return 0;
...
bool MYON_Write3dmBufferArchive::Flush()
{
  // Nothing to flush
  return true;
}
...
size_t MYON_Write3dmBufferArchive::SizeOfBuffer() const
{
  return m_sizeof_buffer;
}

const void* MYON_Write3dmBufferArchive::Buffer() const
{
  return (const void*)m_buffer;
}

void* MYON_Write3dmBufferArchive::HarvestBuffer()
{
...
size_t MYON_Write3dmBufferArchive::SizeOfArchive() const
{
...
MYON_BinaryArchiveBuffer::MYON_BinaryArchiveBuffer( MYON::archive_mode mode, MYON_Buffer* buffer )
: MYON_BinaryArchive(mode)
, m_buffer(buffer)
{
  if (nullptr != m_buffer)
...
MYON_BinaryArchiveBuffer::~MYON_BinaryArchiveBuffer()
{
  m_buffer = 0;
}

bool MYON_BinaryArchiveBuffer::SetBuffer( MYON_Buffer* buffer )
{
  if ( 0 == m_buffer )
  {
    m_buffer = buffer;
...
MYON_Buffer* MYON_BinaryArchiveBuffer::Buffer() const
{
  return m_buffer;
}

MYON__UINT64 MYON_BinaryArchiveBuffer::Internal_CurrentPositionOverride() const
{
  if ( 0 != m_buffer )
...
bool MYON_BinaryArchiveBuffer::Internal_SeekFromCurrentPositionOverride(int offset)
{
  if ( 0 != m_buffer )
...
bool MYON_BinaryArchiveBuffer::Internal_SeekToStartOverride()
{
  if ( 0 != m_buffer )
...
bool MYON_BinaryArchiveBuffer::AtEnd() const
{
  if ( 0 != m_buffer )
...
size_t MYON_BinaryArchiveBuffer::Internal_ReadOverride( size_t count, void* a )
{
  if ( 0 != m_buffer )
...
size_t MYON_BinaryArchiveBuffer::Internal_WriteOverride( size_t count, const void* a )
{
  if ( 0 != m_buffer )
...
bool MYON_BinaryArchiveBuffer::Flush()
{
  if ( 0 != m_buffer )
    return true;
...
MYON_3dmAnnotationContext::~MYON_3dmAnnotationContext()
{
  // NOTE WELL:
  //  https://mcneel.myjetbrains.com/youtrack/issue/RH-57616
  //  MYON_3dmAnnotationContext::Default is a global const instance.
  ...
  if ( this != &MYON_3dmAnnotationContext::Default)
    Internal_Destroy();
}

MYON_3dmAnnotationContext::MYON_3dmAnnotationContext(const MYON_3dmAnnotationContext& src)
{
  Internal_CopyFrom(src);
}

MYON_3dmAnnotationContext& MYON_3dmAnnotationContext::operator=(const MYON_3dmAnnotationContext& src)
{
  if (this != &src)
  {
    Internal_Destroy();
...
void MYON_3dmAnnotationContext::Internal_CopyFrom(const MYON_3dmAnnotationContext& src)
{
  if (nullptr != src.m_managed_parent_dim_style)
  {
    m_managed_parent_dim_style = new MYON_DimStyle(*src.m_managed_parent_dim_style);
  ...
  {
    m_managed_override_dim_style = new MYON_DimStyle(*src.m_managed_override_dim_style);
  ...
  {
    m_managed_annotation_settings = new MYON_3dmAnnotationSettings(*src.m_managed_annotation_settings);
...
void MYON_3dmAnnotationContext::Internal_Destroy()
{
  SetReferencedAnnotationSettings(nullptr);
  SetReferencedDimStyle(nullptr,nullptr,MYON_UNSET_INT_INDEX);
  m_view_context = MYON_3dmAnnotationContext::Default.m_view_context;
  m_model_length_unit_system = MYON_3dmAnnotationContext::Default.m_model_length_unit_system;
  m_page_length_unit_system = MYON_3dmAnnotationContext::Default.m_page_length_unit_system;
  m_binary_archive = MYON_3dmAnnotationContext::Default.m_binary_archive;
};

const MYON_3dmAnnotationSettings& MYON_3dmAnnotationContext::AnnotationSettings() const
{
  return
    (nullptr != m_annotation_settings)
    ? *m_annotation_settings
    : MYON_3dmSettings::Default.m_AnnotationSettings;
}

void MYON_3dmAnnotationContext::SetReferencedAnnotationSettings(
  const MYON_3dmAnnotationSettings* annotation_settings
)
{
...
void MYON_3dmAnnotationContext::SetManagedAnnotationSettings(
  const MYON_3dmAnnotationSettings& annotation_settings
)
{
  SetReferencedAnnotationSettings(nullptr);
  m_managed_annotation_settings = new MYON_3dmAnnotationSettings(annotation_settings);
  m_annotation_settings = m_managed_annotation_settings;
}

bool MYON_3dmAnnotationContext::AnnotationSettingsAreSet() const
{
  return (nullptr != m_annotation_settings);
}

MYON::active_space MYON_3dmAnnotationContext::ViewContext() const
{
  return m_view_context;
}

void MYON_3dmAnnotationContext::SetViewContext(
  MYON::active_space view_context
)
{
  m_view_context = view_context;
}

MYON::LengthUnitSystem MYON_3dmAnnotationContext::ModelLengthUnitSystem() const
{
  return m_model_length_unit_system;
}
  
void MYON_3dmAnnotationContext::SetModelLengthUnitSystem(
...
MYON::LengthUnitSystem MYON_3dmAnnotationContext::PageLengthUnitSystem() const
{
  return m_page_length_unit_system;
}
  
void MYON_3dmAnnotationContext::SetPageLengthUnitSystem(
...
const MYON_DimStyle& MYON_3dmAnnotationContext::DimStyle() const
{
  return
...
const MYON_DimStyle& MYON_3dmAnnotationContext::ParentDimStyle() const
{
  return
...
void MYON_3dmAnnotationContext::UpdateReferencedDimStyle(
...
)
{
  ...
  {
    MYON_ERROR("Invalid old_pointer value.");
    return;
  }
...
void MYON_3dmAnnotationContext::SetReferencedDimStyle(
  const MYON_DimStyle* parent_dim_style,
  const MYON_DimStyle* override_dim_style,
...
void MYON_3dmAnnotationContext::SetManagedDimStyle(
  const MYON_DimStyle& parent_dim_style,
  const MYON_DimStyle* override_dim_style,
  int V5_3dm_archive_index
)
{
  ...
  MYON_DimStyle* managed_parent = new MYON_DimStyle(parent_dim_style);
  MYON_DimStyle* managed_override 
    = (nullptr == override_dim_style)
    ? nullptr
    : new MYON_DimStyle(*override_dim_style);
...
bool MYON_3dmAnnotationContext::DimStyleIsSet() const
{
...
*/
MYON_UUID MYON_3dmAnnotationContext::ParentDimStyleId() const
{
  return
    (nullptr != m_parent_dim_style)
...
int MYON_3dmAnnotationContext::V5_ArchiveDimStyleIndex() const
{
  return m_V5_3dm_archive_dim_style_index;
}

bool MYON_3dmAnnotationContext::IsOverrideDimStyle() const
{
  return (nullptr != m_override_dim_style);
}

const class MYON_BinaryArchive* MYON_3dmAnnotationContext::BinaryArchive() const
{
  return m_binary_archive;
}
  
void MYON_3dmAnnotationContext::SetReferencedBinaryArchive(
...
bool MYON_3dmAnnotationContext::BinaryArchiveIsSet() const
{
