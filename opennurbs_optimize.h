...
int MYON_FindLocalMinimum( // returns 0 - failed to converge, 1 - success, 2 - failed to converge to requested tolerances
        ...
        double, // tol > 0 (minimum relative step size (use MYON_EPSILON when in doubt)
...
class MYON_LocalZero1
{
public:
  MYON_LocalZero1();
  virtual ~MYON_LocalZero1();
