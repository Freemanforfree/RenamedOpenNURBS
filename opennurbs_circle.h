...
#if !defined(MYON_CIRCLE_INC_)
#define MYON_CIRCLE_INC_

class MYON_NurbsCurve;

/*
Description:
	MYON_Circle is a circle in 3d.  The circle is represented by a radius and an 
...
public:
  ...
  MYON_Circle() = default;
  ~MYON_Circle() = default;
  MYON_Circle(const MYON_Circle&) = default;
  MYON_Circle& operator=(const MYON_Circle&) = default;

  static const MYON_Circle UnitCircle; // unit circle in the xy plane
  ...
  MYON_Circle( // circle through 3 2d points
  ...
  bool Create(
    const MYON_2dPoint& P,
    const MYON_2dVector& tangent_at_P,
    const MYON_2dPoint& Q
    );
  ...
  bool Create(
    const MYON_3dPoint& P,
    const MYON_3dVector& tangent_at_P,
    const MYON_3dPoint& Q
    );
  ...
  bool IsInPlane( const MYON_Plane&, double = MYON_ZERO_TOLERANCE ) const;
  ...
  const MYON_Plane& Plane() const; // plane containing circle
  ...
  */
  ...
  MYON_3dVector TangentAt(double) const;
  ...
  double EquationAt( const MYON_2dPoint& plane_point ) const;

  MYON_2dVector GradientAt( const MYON_2dPoint& plane_point ) const;
  ...
  //   Use MYON_Circle::GetRadianFromNurbFormParameter() and
  //   MYON_Circle::GetParameterFromRadian() to convert between 
  ...
  Remarks:
    ...
    created by MYON_Circle::GetNurbForm.  At nurbs parameter values of 
  ...
  See Also:
    MYON_Circle::GetNurbFormParameterFromRadian
  */
  ...
  Parameters:
    circle_radians_parameter - [in] 0.0 to 2.0*MYON_PI
    nurbs_parameter - [out]
  Example:

          MYON_Circle circle = ...;
          double circle_t = 1.2345; // some number in interval (0,2.0*MYON_PI).
          double nurbs_t;
  ...
  Remarks:
    The NURBS curve parameter is with respect to the NURBS curve
    created by MYON_Circle::GetNurbForm.  At radian values of 
    0.0, 0.5*MYON_PI, MYON_PI, 1.5*MYON_PI, and 2.0*MYON_PI, the nurbs
    parameter and radian parameter are the same.  At all other
    values the nurbs and radian parameter values are different.
  See Also:
