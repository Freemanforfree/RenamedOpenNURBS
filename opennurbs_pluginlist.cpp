...
MYON_PlugInRef::MYON_PlugInRef()
{
  Default();
}

void MYON_PlugInRef::Default()
{
...
bool MYON_PlugInRef::Write( MYON_BinaryArchive& file ) const
{
...
void MYON_PlugInRef::Dump(MYON_TextLog& text_log) const
{
  ...
  const MYON_String plugin_sdk_version = MYON_SdkVersionNumberToString(m_plugin_sdk_version,m_plugin_sdk_service_release);
  text_log.Print(
    "sdk version = %s\n",
...
bool MYON_PlugInRef::Read( MYON_BinaryArchive& file )
{
  Default();
