...
class MYON_CLASS MYON_Base64EncodeStream
{
public:
  MYON_Base64EncodeStream();
  virtual ~MYON_Base64EncodeStream();

  /*
  Description:
    MYON_Base64EncodeStream delivers the base64 encoded stream by
...
private:
  ...
  MYON_Base64EncodeStream(const MYON_Base64EncodeStream&);
  MYON_Base64EncodeStream& operator=(const MYON_Base64EncodeStream&);
};

//////////////////////////////////////////////////////////////////////////////////////////

class MYON_CLASS MYON_DecodeBase64
{
public:
  MYON_DecodeBase64();
  virtual ~MYON_DecodeBase64();
...
/*
class MYON_CLASS MYON_EncodeBase64
{
public:
  MYON_EncodeBase64();
  virtual ~MYON_EncodeBase64();
...
class MYON_CLASS MYON_Base64 final
{
public:
  ...
  static bool Encode(const void* buffer_in, size_t num_bytes, MYON_wString& base64_out, bool append);
};
