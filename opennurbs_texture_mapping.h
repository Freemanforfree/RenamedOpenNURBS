...
///////////////////////////////////////////////////////////////////////////////
//
// Class MYON_TextureMapping
//
class MYON_Line;
class MYON_BrepFace;
class MYON_3dPoint;

typedef int  ( *TEXMAP_INTERSECT_LINE_SURFACE )( const MYON_Line*, const MYON_BrepFace*, MYON_SimpleArray<MYON_X_EVENT>& );
typedef bool ( *TEXMAP_BREP_FACE_CLOSEST_POINT )( const MYON_BrepFace*, const MYON_3dPoint*, MYON_3dPoint& );

class MYON_CLASS MYON_TextureMapping : public MYON_ModelComponent
{
	MYON_OBJECT_DECLARE(MYON_TextureMapping);

public:

  static const MYON_TextureMapping Unset; // nil id

  // MYON_TextureMapping::SurfaceParameterTextureMapping
  // has m_type = MYON_TextureMapping::srfp_mapping and m_id = nil;
  static const MYON_TextureMapping SurfaceParameterTextureMapping;
  ...
  */
  static const MYON_TextureMapping* FromModelComponentRef(
...
public:
  ...
  enum class TYPE : unsigned int
  {
    ...
    box_mapping      = 5,
    mesh_mapping_primitive = 6, // m_mapping_primitive is an MYON_Mesh 
    srf_mapping_primitive  = 7, // m_mapping_primitive is an MYON_Surface
    brep_mapping_primitive = 8,  // m_mapping_primitive is an MYON_Brep
  ...
  static MYON_TextureMapping::TYPE TypeFromUnsigned( 
    unsigned int type_as_unsigned
    );

  static const MYON_wString TypeToString(
    MYON_TextureMapping::TYPE texture_mapping_type
    );
  ...
  //                    In this case, MYON_TextureMapping::Evaluate
  ...
  static MYON_TextureMapping::PROJECTION ProjectionFromUnsigned(
    unsigned int projection_as_unsigned
    );

  static const MYON_wString ProjectionToString(
    MYON_TextureMapping::PROJECTION texture_mapping_projection
    );
  ...
  static MYON_TextureMapping::TEXTURE_SPACE TextureSpaceFromUnsigned(
    unsigned int texture_space_as_unsigned
    );
  
  static const MYON_wString SpaceToString(
    MYON_TextureMapping::TEXTURE_SPACE texture_mapping_space
    );

public:
  MYON_TextureMapping() MYON_NOEXCEPT;
  MYON_TextureMapping(const MYON_TextureMapping& src);
  virtual ~MYON_TextureMapping();
  MYON_TextureMapping& operator=(const MYON_TextureMapping& src);

private:
  void Internal_CopyFrom(
    const MYON_TextureMapping& src
    );
...
public:
  ...
  Example:
    ...
    texture coordinate unit square.
          ...
          MYON_3dVector plane_xaxis(0.0,1.0,0.0);
          MYON_3dVector plane_yaxis(0.0,0,0,1.0);
          MYON_3dPoint plane_origin(0.0,2.0,4.0);
          MYON_Plane plane(plane_origin,plane_xaxis,plane_yaxis);
          MYON_Interval dx( 0.0, 7.0 - 3.0);
          MYON_Interval dy( 0.0, 19.0 - 5.0);
          MYON_Interval dz( 0.0, 1.0 );
          MYON_TextureMapping mapping;
  ...
  */
  ...
  /*
Description:
  Create a Ocs texture mapping.  Note that OCS mappings must be placed on mapping channel MYON_ObjectRenderingAttributes::OCSMappingChannelId()
...
*/
  ...
  */
  ...
  See Also:
    ...
    MYON_Mesh::SetTextureCoordinates
  */
  virtual
  int Evaluate( 
  ...
  Parameters:
    ...
    object_xform - [in] (optional)
      ...
      MYON_MappingRef::m_object_xform.
  Returns:
  ...
  */
  bool HasMatchingTextureCoordinates( 
         ...
         const MYON_Xform* object_xform = nullptr
         ) const; 

  bool HasMatchingTextureCoordinates( 
         const class MYON_MappingTag& tag,
         const MYON_Xform* object_xform = nullptr
         ) const; 
  ...
  */
  ...
  Parameters:
    ...
    mesh_xform - [in] (optional)
      ...
      of MYON_Mesh::m_mapping_xform or MYON_MappingRef::m_object_xform
    bLazy - [in]
  ...
  Example:
          ...
          const MYON_Mesh* mesh = ...;
          bool bLazy = true;
          MYON_SimpleArray<MYON_3dPoint> T(mesh->VertexCount());
  ...
  */
  bool GetTextureCoordinates( 
    ...
    MYON_SimpleArray<MYON_3fPoint>& T,
		const MYON_Xform* mesh_xform = 0,
    bool bLazy = false,
    MYON_SimpleArray<int>* Tside = 0
    ) const;
...
public:
  MYON_TextureMapping::TYPE m_type = MYON_TextureMapping::TYPE::no_mapping;
  MYON_TextureMapping::PROJECTION m_projection = MYON_TextureMapping::PROJECTION::no_projection;
  MYON_TextureMapping::TEXTURE_SPACE m_texture_space = MYON_TextureMapping::TEXTURE_SPACE::single;
  ...
  // ignored.
  MYON_Xform m_Pxyz = MYON_Xform::IdentityTransformation;
  MYON_Xform m_Nxyz = MYON_Xform::IdentityTransformation;

  // Transform applied to mapping coordinate (u,v,w) to 
  // convert it into a texture coordinate.
  MYON_Xform m_uvw = MYON_Xform::IdentityTransformation;

  MYON__UINT32 MappingCRC() const;

  // Custom mapping primitive.
  // Returns nullptr if no custom mapping primitive is stored in this texture mapping definition.
  const MYON_Object* CustomMappingPrimitive(void) const;

  const std::shared_ptr<const MYON_Object>& SharedCustomMappingPrimitive(void) const;
  ...
  const MYON_Mesh* CustomMappingMeshPrimitive(void) const;
  ...
  const MYON_Brep* CustomMappingBrepPrimitive(void) const;
  ...
  const MYON_Surface* CustomMappingSurfacePrimitive(void) const;

  void SetCustomMappingPrimitive(MYON_Object*);
...
private:
  std::shared_ptr<const MYON_Object> m_mapping_primitive = nullptr;
#pragma MYON_PRAGMA_WARNING_POP
};

#if defined(MYON_DLL_TEMPLATE)
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<MYON_TextureMapping*>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<const MYON_TextureMapping*>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ObjectArray<MYON_TextureMapping>;
#endif
