...
#if !defined(MYON_STD_STRING_INC_)
#define MYON_STD_STRING_INC_
...
had to implement MYON_String and MYON_wString.  
...
Over time, opennurbs will transition from using MYON_String and
MYON_wString to using std::string and std::wstring.
...
MYON_DECL
std::string MYON_VARGS_FUNC_CDECL MYON_std_string_format(
  const char* format,
  ...
  ) MYON_NOEXCEPT;

MYON_DECL
std::wstring MYON_VARGS_FUNC_CDECL MYON_std_wstring_format(
...
*/
MYON_DECL
std::string MYON_UTF8_to_std_string( 
  int bTestByteOrder,
...
/*
Description:
  Convert a UTF-16 encoded MYON__UINT16 string to a UTF-8 encoded std:string.
  This function removes byte order marks (BOM) and can repair encoding
  errors.
...
Parameters:
  ...
  sInputUTF - [in]
    UTF-16 encoded MYON__UINT16 string to convert.
  ...
  sUTF8_count - [in]
    ...
    MYON__UINT8 elements in the sUTF8[] buffer.
...
*/
MYON_DECL
std::string MYON_UTF16_to_std_string( 
  int bTestByteOrder,
  const MYON__UINT16* sInputUTF,
  int sInputUTF_count,
  unsigned int* error_status,
  unsigned int error_mask,
  MYON__UINT32 error_code_point,
  const MYON__UINT16** sEndElement
  ) MYON_NOEXCEPT;

/*
Description:
  Convert a UTF-32 encoded MYON__UINT16 string to a UTF-8 encoded std:string.
  This function removes byte order marks (BOM) and can repair encoding
  errors.
...
Parameters:
  ...
  sInputUTF - [in]
    UTF-32 encoded MYON__UINT32 string to convert.
...
*/
MYON_DECL
std::string MYON_UTF32_to_std_string( 
  int bTestByteOrder,
  const MYON__UINT32* sInputUTF,
  int sInputUTF_count,
  unsigned int* error_status,
  unsigned int error_mask,
  MYON__UINT32 error_code_point,
  const MYON__UINT32** sEndElement
  ) MYON_NOEXCEPT;
...
Returns:
  ...
  The returned string does not have a byte order mark (BOM).
*/
std::string MYON_UTF_WideChar_to_std_string( 
  int bTestByteOrder,
...
*/
MYON_DECL
std::string MYON_UTF_std_wstring_to_std_string(
  int bTestByteOrder,
...
*/
MYON_DECL
std::wstring MYON_UTF8_to_std_wstring( 
  int bTestByteOrder,
  const char* sInputUTF,
  int sInputUTF_count,
  unsigned int* error_status,
...
/*
Description:
  Convert a UTF-16 encoded MYON__UINT16 string to a UTF-XX encoded std::wstring.
  This function removes byte order marks (BOM) and can repair encoding
  errors.
...
*/
MYON_DECL
std::wstring MYON_UTF16_to_std_wstring( 
  int bTestByteOrder,
  const MYON__UINT16* sInputUTF,
  int sInputUTF_count,
  unsigned int* error_status,
...
/*
Description:
  Convert a UTF-32 encoded MYON__UINT32 string to a UTF-XX encoded std::wstring.
  This function removes byte order marks (BOM) and can repair encoding
  errors.
...
*/
MYON_DECL
std::wstring MYON_UTF32_to_std_wstring( 
  int bTestByteOrder,
  const MYON__UINT32* sInputUTF,
  int sInputUTF_count,
  unsigned int* error_status,
...
Returns:
  ...
  The returned string does not have a byte order mark (BOM).
*/
std::wstring MYON_UTF_WideChar_to_std_wstring( 
  int bTestByteOrder,
  const wchar_t* sInputUTF,
  int sInputUTF_count,
  unsigned int* error_status,
...
*/
MYON_DECL
std::wstring MYON_UTF_std_string_to_std_wstring(
  int bTestByteOrder,
