...
class MYON_CLASS MYON_NurbsCurve : public MYON_Curve
{
  MYON_OBJECT_DECLARE(MYON_NurbsCurve);

public:
  MYON_NurbsCurve() MYON_NOEXCEPT;
  virtual ~MYON_NurbsCurve();
  MYON_NurbsCurve(const MYON_NurbsCurve&);
	MYON_NurbsCurve& operator=(const MYON_NurbsCurve& src);
  ...
  MYON_NurbsCurve& operator=( MYON_NurbsCurve&& );
#endif

public:
  /*
  Description:
    Use MYON_NurbsCurve::New(...) instead of new MYON_NurbsCurve(...)
  Returns:
    Pointer to an MYON_NurbsCurve.  Destroy by calling delete.
  Remarks:
    See static MYON_Brep* MYON_Brep::New() for details.
  */
  static MYON_NurbsCurve* New();
  static MYON_NurbsCurve* New(
  ...
  */
  ...
  // Description:
  //   Call if memory used by MYON_NurbsCurve becomes invalid.
  ...
  */
  ...
  // Description:
  //   virtual MYON_Curve::GetParameterTolerance override.
  ...
  */
  ...
  // Description:
  //   virtual MYON_Curve::Evaluate override.
  ...
  */
  ...
  See Also:
    MYON_NurbsCurve::RemoveShortSegments
  */
  bool RepairBadKnots(
  ...
  bool Split(
      ...
      MYON_Curve*& left_result, // left portion returned here (must be an MYON_NurbsCurve)
      MYON_Curve*& right_result // right portion returned here (must be an MYON_NurbsCurve)
    ) const override;
  ...
  int GetNurbForm( // returns 0: unable to create NURBS representation
                   ...
                   //            desired accuracy.
        MYON_NurbsCurve& nurbsform,
        double tolerance = 0.0,
        const MYON_Interval* subdomain = nullptr     // OPTIONAL subdomain of curve
        ) const override;
  ...
  Parameters:
    ...
    bezierCurve - [out]
  Returns:
    MYON_DBL_QNAN: no bezier curve is returned.
...
public:
  ...
  Description:
    ...
    MYON_NurbsCurve::GetCV( MYON_3dPoint& ) or 
    MYON_NurbsCurve::GetCV( MYON_4dPoint& ).
  Parameters:
    cv_index - [in]
  Returns:
  ...
  See Also
    MYON_NurbsCurve::CVStyle
    MYON_NurbsCurve::GetCV
    MYON_NurbsCurve::Weight
  */
  double* CV(
        int cv_index
        ) const;
  ...
  Remarks:
    If cv_index or the nurbs curve is not valid, then MYON_4dPoint::Nan is returned.
  ...
  */
  ...
  //   true if successful
  // See Also:
  //   MYON_NurbsCurve::ReserveKnotCapacity
  bool SetKnot(
        int knot_index,
        double knot_value
        );
  ...
  // See Also:
  //   MYON_NurbsCurve::SetKnot, MYON_NurbsCurve::KnotMultiplicity
  double Knot(
        int knot_index
        ) const;
  ...
  // See Also:
  //   MYON_NurbsCurve::SetKnot, MYON_NurbsCurve::Knot, 
  //   MYON_NurbsCurve::InsertKnot
  ...
  */
  ...
  bool GetGrevilleAbcissae( // see MYON_GetGrevilleAbcissae() for details
           double*   // g[cv_count]
           ) const;
  ...
  bool Append( const MYON_NurbsCurve& );
  ...
  */
  ...
  bool ConvertSpanToBezier(
      ...
      MYON_BezierCurve& // bezier returned here
      ) const;
  ...
  */
  ...
  See Also:
    MYON_NurbsCurve::RepairBadKnots()
    MYON_NurbsCurve::RemoveShortSegments()
  */
  ...
  */      
  ...
  Returns:
    true if successful.
  See Also:
    MYON_ChangeRationalNurbsCurveEndWeights
  Remarks:
  ...
  */
  ...
  See Also:
    MYON_ReparameterizeRationalNurbsCurve
  */
...
private:
  ...
  // unsigned int tags = (m_knot_capacity_and_tags & MYON_NurbsCurve::masks::tags);
  // unsigned intknot_capacity = (m_knot_capacity_and_tags & MYON_NurbsCurve::masks::knot_capacity_mask);
  // If knot_capacity > 0, then m_knot[] is an array of at least knot_capacity
  // doubles whose memory is managed by the MYON_NurbsCurve class using 
...
public:
  int     m_cv_capacity;    // If m_cv_capacity > 0, then m_cv[] is an array
                            ...
                            // memory is managed by the MYON_NurbsCurve
...
private:
  #if defined(MYON_HAS_RVALUEREF)
  void Internal_ShallowCopyFrom(const MYON_NurbsCurve& src);
  #endif
private:
  void Internal_DeepCopyFrom(const MYON_NurbsCurve& src);
private:
...
MYON_DECL
bool MYON_Adjust2ndPointToDomain(const MYON_2dPoint& First, MYON_2dPoint& Second, 
                                   const MYON_Interval dom[2]);
