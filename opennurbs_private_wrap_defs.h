...
// OBSOLETE
template <class T>
MYON_PrivateWrap<T>::MYON_PrivateWrap()
...
template <class T >
MYON_PrivateWrap< T >::MYON_PrivateWrap(const MYON_PrivateWrap< T >& src)
...
template <class T >
MYON_PrivateWrap< T >& MYON_PrivateWrap< T >::operator=(const MYON_PrivateWrap< T >& src)
{
  if (this != &src)
    r = src.r;
  return *this;
...
template <class T >
MYON_PrivateWrap< T >::operator const T * () const
{
  return &r;
}

template <class T >
MYON_PrivateWrap< T >::operator T * ()
{
  return &r;
}
