...
MYON_OBJECT_IMPLEMENT(MYON_NurbsSurface,MYON_Surface,"4ED7D4DE-E947-11d3-BFE5-0010830122F0");


MYON_NurbsSurface* MYON_NurbsSurface::New()
{
  // static function replaces new MYON_NurbsSurface();
  return new MYON_NurbsSurface();
}
...
{
  // static function replaces new MYON_NurbsSurface(const MYON_NurbsSurface& nurbs_surface);
  return new MYON_NurbsSurface(nurbs_surface);
}

MYON_NurbsSurface* MYON_NurbsSurface::New(
        const MYON_BezierSurface& bezier_surface
        )
{
  // static function replaces new MYON_NurbsSurface(const MYON_BezierSurface& bezier_surface);
  return new MYON_NurbsSurface(bezier_surface);
}
...
{
  // static function replaces new MYON_NurbsSurface(dim, is_rat, order0, ..., cv_count1 );
  return new MYON_NurbsSurface(dimension,bIsRational,order0,order1,cv_count0,cv_count1);
}

MYON_NurbsSurface::MYON_NurbsSurface()
{
  MYON__SET__THIS__PTR(m_s_MYON_NurbsSurface_ptr);
  Initialize();
}

MYON_NurbsSurface::MYON_NurbsSurface( const MYON_NurbsSurface& src )
{
  MYON__SET__THIS__PTR(m_s_MYON_NurbsSurface_ptr);
  Initialize();
  *this = src;
...
MYON_NurbsSurface::MYON_NurbsSurface( const MYON_BezierSurface& bezier_surface )
{
  MYON__SET__THIS__PTR(m_s_MYON_NurbsSurface_ptr);
  Initialize();
  *this = bezier_surface;
...
unsigned int MYON_NurbsSurface::SizeOf() const
{
...
MYON__UINT32 MYON_NurbsSurface::DataCRC(MYON__UINT32 current_remainder) const
{
  ...
  current_remainder = MYON_CRC32(current_remainder,2*sizeof(m_order[0]),&m_order[0]);
  current_remainder = MYON_CRC32(current_remainder,2*sizeof(m_cv_count[0]),&m_cv_count[0]);
  ...
  current_remainder = MYON_CRC32(current_remainder,KnotCount(0)*sizeof(m_knot[0][0]),m_knot[0]);
  current_remainder = MYON_CRC32(current_remainder,KnotCount(1)*sizeof(m_knot[1][0]),m_knot[1]);

  return current_remainder;
}


bool MYON_NurbsSurface::SetDomain( 
...
int MYON_NurbsSurface::Dimension() const
{
  return m_dim;
}

bool MYON_NurbsSurface::IsRational() const
{
  return m_is_rat?true:false;
}

int MYON_NurbsSurface::CVSize() const
{
  return (m_is_rat) ? m_dim+1 : m_dim;
}

int MYON_NurbsSurface::Order( int dir ) const
{
  return m_order[dir?1:0];
}

int MYON_NurbsSurface::Degree( int dir ) const
{
  return (m_order[dir?1:0]>=2) ? m_order[dir?1:0]-1 : 0;
}

int MYON_NurbsSurface::CVCount( int dir ) const
{
  return m_cv_count[dir?1:0];
}

int MYON_NurbsSurface::CVCount( void ) const
{
  return m_cv_count[0]*m_cv_count[1];
}

int MYON_NurbsSurface::KnotCount( int dir ) const
{
  return MYON_KnotCount( m_order[dir?1:0], m_cv_count[dir?1:0] );
}

double* MYON_NurbsSurface::CV( int i, int j ) const
{
  const int offset = (i * m_cv_stride[0] + j * m_cv_stride[1]);
  return (m_cv && offset >= 0) ? (m_cv + offset) : nullptr;
}

double* MYON_NurbsSurface::CV(
  MYON_2dex cvdex
) const
{
...
const MYON_4dPoint MYON_NurbsSurface::ControlPoint(
  int i,
  int j
) const
{
...
MYON::point_style MYON_NurbsSurface::CVStyle() const
{
  return m_is_rat ? MYON::homogeneous_rational : MYON::not_rational;
}


double MYON_NurbsSurface::Weight( int i, int j ) const
{
  return (m_cv && m_is_rat) ? m_cv[i*m_cv_stride[0] + j*m_cv_stride[1] + m_dim] : 1.0;
}


double MYON_NurbsSurface::Knot( int dir, int i ) const
{
  return (m_knot[dir?1:0]) ? m_knot[dir?1:0][i] : 0.0;
}

int MYON_NurbsSurface::KnotMultiplicity( int dir, int i ) const
{
  dir = dir?1:0;
  return MYON_KnotMultiplicity( m_order[dir], m_cv_count[dir], m_knot[dir], i );
}

const double* MYON_NurbsSurface::Knot( int dir ) const
{
  return m_knot[dir?1:0];
}

bool MYON_NurbsSurface::MakeClampedUniformKnotVector( 
  int dir,
  double delta
  )
{
  if ( dir < 0 || dir > 1 )
    return false;
	DestroySurfaceTree();
  ReserveKnotCapacity( dir, MYON_KnotCount( m_order[dir], m_cv_count[dir] ) );
  return MYON_MakeClampedUniformKnotVector( m_order[dir], m_cv_count[dir], m_knot[dir], delta );
}

bool MYON_NurbsSurface::MakePeriodicUniformKnotVector( 
  int dir,
  double delta
  )
{
  if ( dir < 0 || dir > 1 )
	...
	DestroySurfaceTree();
  ReserveKnotCapacity( dir, MYON_KnotCount( m_order[dir], m_cv_count[dir] ) );
  return MYON_MakePeriodicUniformKnotVector( m_order[dir], m_cv_count[dir], m_knot[dir], delta );
}


double MYON_NurbsSurface::SuperfluousKnot( int dir, int end ) const
  { return(m_knot[dir?1:0]) ? MYON_SuperfluousKnot(m_order[dir?1:0],m_cv_count[dir?1:0],m_knot[dir?1:0],end) : 0.0;}

bool MYON_NurbsSurface::Create(
        int dim,      // dimension (>= 1)
        bool is_rat,  // true to make a rational NURBS
        int order0,    // order (>= 2)
        int order1,    // order (>= 2)
...
void MYON_NurbsSurface::Destroy()
{
...
void MYON_NurbsSurface::EmergencyDestroy()
{
  Initialize();
}


void MYON_NurbsSurface::Initialize()
{
  m_dim = 0;
  m_is_rat = 0;
  m_order[0] = 0;
...
bool MYON_NurbsSurface::ReserveKnotCapacity( int dir, int capacity )
{
  if (dir)
    dir = 1;
...
bool MYON_NurbsSurface::ReserveCVCapacity( int capacity )
{
...
static void MYON_NurbsSurfaceCopyHelper( const MYON_NurbsSurface& src, MYON_NurbsSurface& dest )
{
...
MYON_NurbsSurface& MYON_NurbsSurface::operator=( const MYON_NurbsSurface& src )
{
  if ( this != &src ) 
  {
    MYON_Surface::operator=(src);
    MYON_NurbsSurfaceCopyHelper(src,*this);
  }
  return *this;
}

MYON_NurbsSurface& MYON_NurbsSurface::operator=( const MYON_BezierSurface& bezier_surface )
{
  int i, j;
  DestroySurfaceTree();
...
void MYON_NurbsSurface::Dump( MYON_TextLog& dump ) const
{
  dump.Print( "MYON_NurbsSurface dim = %d is_rat = %d\n"
  ...
  else 
  {
    ...
    for ( i = 0; i < m_cv_count[0]; i++ )
    {
      if ( i > 0 )
        dump.Print("\n");
      sPreamble[0] = 0;
      MYON_String::FormatIntoBuffer(sPreamble, sPremable_capacity,"  CV[%2d]", i);
...
bool MYON_NurbsSurface::IsValid( MYON_TextLog* text_log ) const
{
  bool rc = false;
  ...
  if ( m_dim <= 0 )
  {
    if ( text_log )
    {
      text_log->Print("MYON_NurbsSurface.m_dim = %d (should be > 0).\n",m_dim);
    }
  }
  else if ( m_cv == nullptr )
  {
    if ( text_log )
    {
      text_log->Print("MYON_NurbsSurface.m_cv is nullptr.\n",m_dim);
    }
  }
  else
  {
    ...
    for ( i = 0; i < 2 && rc; i++ )
    {
      ...
      if (m_order[i] < 2 )
      {
        if ( text_log )
        {
          text_log->Print("MYON_NurbsSurface.m_order[i] = %d (should be >= 2).\n",i,m_order[i]);
        }
      }
      else if (m_cv_count[i] < m_order[i] )
      {
        if ( text_log )
        {
          text_log->Print("MYON_NurbsSurface.m_cv_count[%d] = %d (should be >= m_order[%d]=%d).\n",i,m_cv_count[i],i,m_order[i]);
        }
      }
      else if (m_knot[i] == nullptr)
      {
        if ( text_log )
        {
          text_log->Print("MYON_NurbsSurface.m_knot[i] is nullptr.\n");
        }
      }
      else if ( !MYON_IsValidKnotVector( m_order[i], m_cv_count[i], m_knot[i], text_log ) )
      {
        if ( text_log )
        {
          text_log->Print("MYON_NurbsSurface.m_knot[%d] is not a valid knot vector.\n",i);
        }
      }
      else if ( m_cv_stride[i] < CVSize() )
      {
        if ( text_log )
        {
          text_log->Print("MYON_NurbsSurface.m_cv_stride[%d]=%d is too small (should be >= %d).\n",i,m_cv_stride[i],CVSize());
        }
      }
      else
        rc = true;
    ...
    if ( rc )
    {
      ...
      if ( m_cv_stride[0] < a0 || m_cv_stride[1] < a1 )
      {
        if ( m_cv_stride[0] < b0 || m_cv_stride[1] < b1 )
        {
          if ( text_log )
          {
            text_log->Print("MYON_NurbsSurface.m_cv_stride[] = {%d,%d} is not valid.\n",m_cv_stride[0],m_cv_stride[1]);
          }
          rc = false;
        }
      }
...
bool MYON_NurbsSurface::GetBBox( // returns true if successful
       double* boxmin,    // minimum
       double* boxmax,    // maximum
       bool bGrowBox  // true means grow box
       ) const
{
  return MYON_GetPointGridBoundingBox( m_dim, m_is_rat, 
            m_cv_count[0], m_cv_count[1],
            m_cv_stride[0], m_cv_stride[1], 
            m_cv, 
...
bool MYON_NurbsSurface::Transform( const MYON_Xform& xform )
{
  DestroySurfaceTree();
  ...
  return MYON_TransformPointGrid( m_dim, m_is_rat?true:false, m_cv_count[0], m_cv_count[1], m_cv_stride[0], m_cv_stride[1], m_cv, xform );
}

bool MYON_NurbsSurface::IsDeformable() const
{
  return true;
}

bool MYON_NurbsSurface::MakeDeformable()
{
  return true;
}


bool MYON_NurbsSurface::Write(
     ...
     ) const
{
  ...
  if (rc) {
    ...
    if (rc) {
      MYON_BoundingBox bbox; // write invalid bounding box - may be used in future
     ...
     )
{
  ...
  if (rc && major_version==1) {
    ...
    if (rc) {
      MYON_BoundingBox bbox; // read bounding box - may be used in future
...
MYON_Interval MYON_NurbsSurface::Domain( int dir ) const
{
  MYON_Interval d;
  if (dir) dir = 1;
  MYON_GetKnotVectorDomain( m_order[dir], m_cv_count[dir], m_knot[dir], &d.m_t[0], &d.m_t[1] );
  return d;
}

double MYON_NurbsSurface::ControlPolygonLength( int dir ) const
{
  ...
  if ( dir >= 0 && dir <= 1 && m_cv_count[0] >= 2 && m_cv_count[1] >= 2 && m_cv != nullptr )
  {
    ...
    for( i = 0; i < m_cv_count[1-dir]; i++ )
    {
      length = 0.0;
      p = (dir) ? CV(i,0) : CV(0,i);
      MYON_GetPolylineLength( m_dim, m_is_rat, m_cv_count[dir], m_cv_stride[dir], p, &length );
...
bool MYON_NurbsSurface::GetSurfaceSize( 
    double* width, 
    double* height 
    ) const
{
...
int MYON_NurbsSurface::SpanCount( int dir ) const
{
  if (dir) dir = 1;
  return MYON_KnotVectorSpanCount( m_order[dir], m_cv_count[dir], m_knot[dir] );
}

bool MYON_NurbsSurface::GetSpanVector( int dir, double* s ) const
{
  if (dir) dir = 1;
  return MYON_GetKnotVectorSpanVector( m_order[dir], m_cv_count[dir], m_knot[dir], s );
}

bool MYON_NurbsSurface::GetParameterTolerance( // returns tminus < tplus: parameters tminus <= s <= tplus
       int dir,
       ...
       ) const
{
  ...
  if ( t0 <= t1 ) {
    ...
    if ( t < knot[order-1] )
      ...
      t0 = knot[cv_count-2];
    rc = MYON_GetParameterTolerance( t0, t1, t, tminus, tplus );
  }
  return rc;
}
...
bool
MYON_NurbsSurface::Evaluate( // returns false if unable to evaluate
       ...
       ) const
{
  bool rc = false;
  int span_index[2];
  span_index[0] = MYON_NurbsSpanIndex(m_order[0],m_cv_count[0],m_knot[0],s,(side==2||side==3)?-1:1,(hint)?hint[0]:0);
  span_index[1] = MYON_NurbsSpanIndex(m_order[1],m_cv_count[1],m_knot[1],t,(side==3||side==4)?-1:1,(hint)?hint[1]:0);
  rc = MYON_EvaluateNurbsSurfaceSpan(
     m_dim, m_is_rat, 
     m_order[0], m_order[1],
...
MYON_Curve* MYON_NurbsSurface::IsoCurve(
       ...
       ) const
{
  ...
  {
    Scvsize = CVSize();
    MYON_NurbsCurve* nurbscrv = new MYON_NurbsCurve( m_dim, m_is_rat, m_order[dir], m_cv_count[dir] );
    memcpy( nurbscrv->m_knot, m_knot[dir], nurbscrv->KnotCount()*sizeof(*nurbscrv->m_knot) );
    span_index = MYON_NurbsSpanIndex(m_order[1-dir],m_cv_count[1-dir],m_knot[1-dir],c,1,0);
    if ( span_index < 0 )
      span_index = 0;
    else if ( span_index > m_cv_count[1-dir]-m_order[1-dir] )
      span_index = m_cv_count[1-dir]-m_order[1-dir];
    MYON_NurbsCurve N( Scvsize*nurbscrv->CVCount(), 0, m_order[1-dir], m_order[1-dir] );
...
static MYON_NurbsCurve* ToCurve( const MYON_NurbsSurface& srf, int dir, 
                               MYON_NurbsCurve* crv )
{
...
static bool FromCurve( MYON_NurbsCurve& crv, 
       ...
       ) const
{
  ...
  if ( !Domain(dir).Includes( c, true ) )
    return false;
  MYON_NurbsSurface* left_srf = 0;
  MYON_NurbsSurface* right_srf = 0;

  if ( west_or_south_side )
  {
    left_srf = MYON_NurbsSurface::Cast( west_or_south_side );
    if ( !left_srf )
      return false;
  ...
  {
    right_srf = MYON_NurbsSurface::Cast( east_or_north_side );
    if ( !right_srf )
      return false;
    right_srf->DestroySurfaceTree();
  }

  MYON_NurbsCurve crv, left_crv, right_crv;
  if ( !ToCurve( *this, dir, &crv ) )
    return false;
  MYON_Curve *left_side, *right_side;
  left_side = &left_crv;
  ...
  if ( !left_srf )
    left_srf = new MYON_NurbsSurface();
  ...
  if ( !right_srf )
    right_srf = new MYON_NurbsSurface();
...
// virutal MYON_Surface::HasNurbForm() override
int MYON_NurbsSurface::HasNurbForm() const
{
  return 1;
}

// virutal MYON_Surface::GetNurbForm() override
int MYON_NurbsSurface::GetNurbForm(
      MYON_NurbsSurface& srf,
      double // tolerance
      ) const
{
  ...
  //   MYON_NurbsSurfaceCopyHelper().  The operator= call
  ...
  MYON_NurbsSurfaceCopyHelper(*this,srf); // does not copy user data
  return 1;
}

MYON_Surface* MYON_NurbsSurface::Offset(
...
bool MYON_NurbsSurface::IsPlanar(
      MYON_Plane* plane,
      double tolerance
      ) const
{
  MYON_Plane pln;
  double d;
  MYON_3dPoint center, cv;
  MYON_3dVector normal, du, dv;
  MYON_Interval udom = Domain(0);
  MYON_Interval vdom = Domain(1);
  ...
  else
  {
    ...
    {
      pln.xaxis = du;
      pln.yaxis = MYON_CrossProduct( pln.zaxis, pln.xaxis );
      pln.yaxis.Unitize();
      pln.UpdateEquation();
    }
    else if ( dv.Unitize() )
    {
      pln.yaxis = dv;
      pln.xaxis = MYON_CrossProduct( pln.yaxis, pln.zaxis );
      pln.xaxis.Unitize();
      pln.UpdateEquation();
    }
    else
    ...
    //    be 1e-23.
    if (    fabs(pln.zaxis.x) <= MYON_ZERO_TOLERANCE 
         && fabs(pln.zaxis.y) <= MYON_ZERO_TOLERANCE
         && fabs(fabs(pln.zaxis.z)-1.0) <= MYON_SQRT_EPSILON
       )
    {
      pln.xaxis.z = 0.0;
      pln.yaxis.z = 0.0;
    ...
    else if (    fabs(pln.zaxis.y) <= MYON_ZERO_TOLERANCE 
              && fabs(pln.zaxis.z) <= MYON_ZERO_TOLERANCE
              && fabs(fabs(pln.zaxis.x)-1.0) <= MYON_SQRT_EPSILON
            )
    {
      pln.xaxis.x = 0.0;
      pln.yaxis.x = 0.0;
    ...
    else if (    fabs(pln.zaxis.z) <= MYON_ZERO_TOLERANCE 
              && fabs(pln.zaxis.x) <= MYON_ZERO_TOLERANCE
              && fabs(fabs(pln.zaxis.y)-1.0) <= MYON_SQRT_EPSILON
            )
    {
      pln.xaxis.y = 0.0;
      pln.yaxis.y = 0.0;
...
bool 
MYON_NurbsSurface::IsClosed( int dir ) const
{
  bool bIsClosed = false;
  if ( dir >= 0 && dir <= 1 && m_dim > 0 )
  {
    if ( MYON_IsKnotVectorClamped( m_order[dir], m_cv_count[dir], m_knot[dir] ) )
    {
      ...
      if (    MYON_PointsAreCoincident(m_dim,m_is_rat,corners[0],corners[1])
           && MYON_PointsAreCoincident(m_dim,m_is_rat,corners[2],corners[3])
           && MYON_IsPointGridClosed( m_dim, m_is_rat, m_cv_count[0], m_cv_count[1], m_cv_stride[0], m_cv_stride[1], m_cv, dir ) 
         )
      {
        bIsClosed = true;
      }
...
bool 
MYON_NurbsSurface::ChangeSurfaceSeam( 
						int dir,
            double t 
            )
{
...
bool 
MYON_NurbsSurface::IsPeriodic( int dir ) const
{
  bool bIsPeriodic = false;
  if ( dir >= 0 && dir <= 1 )
  {
    int k;
    bIsPeriodic = MYON_IsKnotVectorPeriodic( m_order[dir], m_cv_count[dir], m_knot[dir] );
    if ( bIsPeriodic ) 
    {
...
bool MYON_NurbsSurface::GetNextDiscontinuity( 
                  int dir,
                  MYON::continuity c,
                  double t0,
                  double t1,
                  ...
                  ) const
{
  ...
  MYON_3dVector Vm[6], Vp[6];
  MYON_3dVector Tm, Tp, Km(MYON_3dVector::NanVector), Kp(MYON_3dVector::NanVector);
  MYON_3dVector& D1m = Vm[1+dir];
  MYON_3dVector& D2m = Vm[3+2*dir];
  MYON_3dVector& D1p = Vp[1+dir];
  MYON_3dVector& D2p = Vp[3+2*dir];
  ...
  {
    return MYON_Surface::GetNextDiscontinuity( 
  ...
  if ( m_order[dir] <= 2 )
    c = MYON::PolylineContinuity((int)c);  // no need to look a zero 2nd derivatives
  const MYON::continuity input_c = c; // saved so we can tell if "locus" needs to be dealt with
  c = MYON::ParametricContinuity((int)c);  // strips "locus" from c

  bool bEv2ndDer    = ( c == MYON::continuity::C2_continuous || c == MYON::continuity::G2_continuous || c == MYON::continuity::Gsmooth_continuous );
  ...
  ki = MYON_NurbsSpanIndex(m_order[dir],m_cv_count[dir],m_knot[dir],t0,1,*hint);
  double segtol = (fabs(m_knot[dir][ki]) + fabs(m_knot[dir][ki+1]) + fabs(m_knot[dir][ki+1]-m_knot[dir][ki]))*MYON_SQRT_EPSILON;
    ...
    *hint = ki;
    ...
    if (ki >= m_cv_count[dir]-1) 
    {
      if ( input_c != c && t0 < m_knot[dir][m_cv_count[dir]-1] && t1 >= m_knot[dir][m_cv_count[dir]-1] )
      {
        ...
        return MYON_Surface::GetNextDiscontinuity( dir, input_c, t0, t1, t, hint, dtype, 
                                    cos_angle_tolerance, curvature_tolerance );
      }
      return false;
    }
  ...
  if ( input_c != c )
  {
    ...
    rc = MYON_Surface::GetNextDiscontinuity( dir, input_c, t0, t1, t, hint, dtype, 
                                    cos_angle_tolerance, curvature_tolerance );
  }
...
bool
MYON_NurbsSurface::IsSingular( // true if surface side is collapsed to a point
      ...
      ) const
{
  ...
  if (rc)
    rc = MYON_PointsAreCoincident(m_dim,m_is_rat,point_count,point_stride,points);
...
bool 
MYON_NurbsSurface::SetWeight( int i, int j, double w )
{
  DestroySurfaceTree();
...
bool 
MYON_NurbsSurface::SetCV( int i, int j, MYON::point_style style, const double* Point )
{
  DestroySurfaceTree();
  ...
  case MYON::intrinsic_point_style:  // input Point is euclidean rational
...
bool 
MYON_NurbsSurface::SetCV( int i, int j, const MYON_3dPoint& point )
{
  DestroySurfaceTree();
...
bool 
MYON_NurbsSurface::SetCV( int i, int j, const MYON_4dPoint& point )
{
  DestroySurfaceTree();
...
bool 
MYON_NurbsSurface::GetCV( int i, int j, MYON::point_style style, double* Point ) const
{
...
bool 
MYON_NurbsSurface::GetCV( int i, int j, MYON_3dPoint& point ) const
{
  bool rc = false;
  const double* cv = CV(i,j);
  if ( cv ) {
...
bool 
MYON_NurbsSurface::GetCV( int i, int j, MYON_4dPoint& point ) const
{
  bool rc = false;
...
bool MYON_NurbsSurface::SetKnot( int dir, int knot_index, double k )
{
  DestroySurfaceTree();
  if ( dir ) dir = 1;
...
bool MYON_NurbsSurface::IsContinuous(
    ...
    ) const
{
  ...
  return MYON_Surface::IsContinuous( desired_continuity, s, t, hint,
                                    point_tolerance, d1_tolerance, d2_tolerance,
                                    cos_angle_tolerance, curvature_tolerance );
}

bool
MYON_NurbsSurface::Reverse(int dir)
{
  if (dir < 0 || dir > 1) return false;
  DestroySurfaceTree();
  bool rc0 = MYON_ReverseKnotVector( m_order[dir], m_cv_count[dir], m_knot[dir] );
  bool rc1 = MYON_ReversePointGrid( 3, m_is_rat, m_cv_count[0], m_cv_count[1], m_cv_stride[0], m_cv_stride[1], m_cv, dir );
  return rc0 && rc1;
}

bool
MYON_NurbsSurface::Transpose()
{
  DestroySurfaceTree();
  int i;
  // transpose CV grid
...
bool
MYON_NurbsSurface::SwapCoordinates( int i, int j )
{
  DestroySurfaceTree();
  bool rc = true;
  int k;
  if ( m_cv_count[0] <= m_cv_count[1] ) {
    for ( k = 0; k < m_cv_count[0]; k++ ) {
      if ( !MYON_SwapPointListCoordinates( m_cv_count[1], m_cv_stride[1], CV(k,0), i, j ) )
        rc = false;
    }
  }
  else {
    for ( k = 0; k < m_cv_count[1]; k++ ) {
      if ( !MYON_SwapPointListCoordinates( m_cv_count[0], m_cv_stride[0], CV(0,k), i, j ) )
        rc = false;
    }
  }
  return rc;
...
bool MYON_NurbsSurface::SetCVRow(
       int row_index,
...
bool MYON_NurbsSurface::SetCVColumn(
       int col_index,
       const MYON_3dPoint& point
       )
{
...
double MYON_NurbsSurface::GrevilleAbcissa(
         int dir,    // dir
         ...
         ) const
{
  if (dir) 
    dir = 1;
  return MYON_GrevilleAbcissa( m_order[dir], m_knot[dir] + gindex );
}

bool MYON_NurbsSurface::GetGrevilleAbcissae(
         int dir,
         double* g
         ) const
{
  ...
  // was returned.
  return MYON_GetGrevilleAbcissae( m_order[dir], m_cv_count[dir], m_knot[dir], false, g );
}

bool MYON_NurbsSurface::SetClampedGrevilleKnotVector(
         int dir,        // dir
         ...
         )
{
  ...
  return MYON_GetGrevilleKnotVector( g_stride, g, false, Order(dir), CVCount(dir), m_knot[dir] );
}

bool MYON_NurbsSurface::SetPeriodicGrevilleKnotVector(
         int dir,        // dir
         int g_stride,   // g_stride
         const double* g // g[], Greville abcissa
         )
{
  ...
  if ( !m_knot[dir] && m_order[dir] >= 2 && m_cv_count[dir] >= m_order[dir] )
    ReserveKnotCapacity(dir,KnotCount(dir));
  return MYON_GetGrevilleKnotVector( g_stride, g, true, Order(dir), CVCount(dir), m_knot[dir] );
}


bool MYON_NurbsSurface::ZeroCVs()
{
  DestroySurfaceTree();
  bool rc = false;
  int i, j;
...
bool MYON_NurbsSurface::IsClamped( // determine if knot vector is clamped
      ...
      ) const
{
  bool rc = false;
  if ( dir == 0 || dir == 1)
    rc = MYON_IsKnotVectorClamped( m_order[dir], m_cv_count[dir], m_knot[dir], end );
  return rc;
}

bool MYON_NurbsSurface::IsNatural(int dir, int end) const
{
  if (dir < 0 || dir > 1 || end < 0 || end > 2)
    return false;

  const MYON_Interval domain = Domain(dir);
  size_t parameter_count = 0;
  double parameter_list[2] = {MYON_DBL_QNAN,MYON_DBL_QNAN};
  if (0 == end || 2 == end)
    parameter_list[parameter_count++] = domain[0];
  if (1 == end || 2 == end)
    parameter_list[parameter_count++] = domain[1];
  return MYON_NurbsSurface::IsNatural(dir, parameter_count, parameter_list);
}

bool MYON_NurbsSurface::IsNatural(
  int dir, 
...
) const
{
  ...
  const MYON_Interval domain[2] = { Domain(0), Domain(1) };
  MYON_SimpleArray<double> g(m_cv_count[1 - dir]);
  const int g_count = m_cv_count[1 - dir];
  g.SetCount(g_count);
  if (false == MYON_GetGrevilleAbcissae( // get Greville abcissae from knots
    m_order[1 - dir],
    m_cv_count[1 - dir],
    m_knot[1 - dir],
    false,
  ...
  int cv2dex[2] = {};
  int hint[2] = { 0,0 };
  double st[2] = { MYON_DBL_QNAN, MYON_DBL_QNAN };
  MYON_3dVector D1[2], D2[2], Duv;
  ...
  for (size_t tdex = 0; tdex < parameter_count; ++tdex)
  {
    ...
    {
      const int span_index = MYON_NurbsSpanIndex(m_order[dir], m_cv_count[dir], m_knot[dir], t, side, hint[dir]);
      if (span_index < 0 || span_index + 2*degree_dir > knot_count_dir)
        return false;
      const MYON_Interval span_domain(m_knot[dir][span_index + degree_dir-1], m_knot[dir][span_index + degree_dir]);
...
void MYON_NurbsSurface::MYON_Internal_ConvertToCurve(const MYON_NurbsSurface& srf,
                                                 int dir, MYON_NurbsCurve& crv) {
  crv.DestroyCurveTree();
  if (dir)
    dir = 1;
...
void MYON_NurbsSurface::MYON_Internal_ConvertFromCurve(MYON_NurbsCurve& crv, int dir,
                                                   MYON_NurbsSurface& srf) {
  crv.DestroyCurveTree();
  srf.DestroySurfaceTree();
  if (dir)
...
bool MYON_NurbsSurface::ClampEnd(
          int dir,         // dir 0 = "s", 1 = "t"
          ...
          )
{
  ...
  MYON_Internal_ConvertToCurve(*this,dir,crv);
  bool rc = crv.ClampEnd(end);
  MYON_Internal_ConvertFromCurve(crv,dir,*this);
  return rc;
}

bool MYON_NurbsSurface::InsertKnot(
         int dir,         // dir 0 = "s", 1 = "t"
         double knot_value,
         ...
         )
{
  ...
  if ( (dir == 0 || dir == 1) && IsValid() && knot_multiplicity > 0 && knot_multiplicity < Order(dir) ) 
  {
    ...
    {
      MYON_ERROR("MYON_NurbsSurface::InsertKnot() knot_value not inside domain.");
    }
    else 
    {
      MYON_NurbsCurve crv;
...
bool MYON_NurbsSurface::MakeRational()
{
  if ( !IsRational() ) 
  {
    DestroySurfaceTree();
    MYON_BezierSurface b;
    b.m_dim = m_dim;
    b.m_is_rat = m_is_rat;
...
bool MYON_NurbsSurface::ChangeDimension(
...
bool MYON_NurbsSurface::IncreaseDegree(
         int dir,  // dir 0 = "s", 1 = "t"
...
bool MYON_NurbsSurface::MakeNonRational()
{
  if ( IsRational() ) 
  {
    DestroySurfaceTree();
...
MYON_TensorProduct::MYON_TensorProduct()
{}

MYON_TensorProduct::~MYON_TensorProduct()
{}

bool MYON_NurbsSurface::TensorProduct(
      const MYON_NurbsCurve& nurbscurveA,
      const MYON_NurbsCurve& nurbscurveB,
      MYON_TensorProduct& tensor
      )
{
  DestroySurfaceTree();
  ...
  if ( tensor.DimensionA() > dimA ) {
    MYON_ERROR("MYON_NurbsSurface::TensorProduct() - tensor.DimensionA() > dimA");
    return false;
  }
  if ( tensor.DimensionB() > dimB ) {
    MYON_ERROR("MYON_NurbsSurface::TensorProduct() - tensor.DimensionB() > dimB");
    return false;
  }
...
static
bool MYON_MakeDegreesCompatible(
       MYON_NurbsCurve& nurbs_curveA,
       MYON_NurbsCurve& nurbs_curveB
       )
{
  bool rc = false;
...
static
bool MYON_MakeDomainsCompatible(
       MYON_NurbsCurve& nurbs_curveA,
       MYON_NurbsCurve& nurbs_curveB
       )
{
  MYON_Interval dA = nurbs_curveA.Domain();
  MYON_Interval dB = nurbs_curveB.Domain();
  bool rc = false;
...
bool MYON_NurbsSurface::MYON_Internal_MakeKnotVectorsCompatible(
       MYON_NurbsCurve& nurbs_curveA,
       MYON_NurbsCurve& nurbs_curveB
       )
{
  if ( !MYON_MakeDegreesCompatible( nurbs_curveA, nurbs_curveB ) )
    return false;
  if ( !MYON_MakeDomainsCompatible( nurbs_curveA, nurbs_curveB ) )
    return false;
          ...
          )
  {
    ...
    if ( b == nurbs_curveB.m_knot[ki-1] )
      return false;
    multA = MYON_KnotMultiplicity( order, nurbs_curveA.m_cv_count, nurbs_curveA.m_knot, ki );
    multB = MYON_KnotMultiplicity( order, nurbs_curveB.m_cv_count, nurbs_curveB.m_knot, ki );

    if ( a < b )
    {
      // insert a in nurbs_curveB
      span.Set(nurbs_curveB.m_knot[ki-1], nurbs_curveB.m_knot[ki] );
      ktol = MYON_SQRT_EPSILON*(span.Length() + fabs(nurbs_curveB.m_knot[ki-1]) + fabs(nurbs_curveB.m_knot[ki]) );
      if ( a >= span[1] - ktol )
      {
    ...
    else if ( b < a )
    {
      ...
      ktol = MYON_SQRT_EPSILON*(span.Length() + fabs(nurbs_curveA.m_knot[ki-1]) + fabs(nurbs_curveA.m_knot[ki]) );
      if ( b >= span[1] - ktol )
      {
...
int MYON_NurbsSurface::CreateRuledSurface(
       const MYON_Curve& curveA,
       const MYON_Curve& curveB,
       const MYON_Interval* curveA_domain,
       const MYON_Interval* curveB_domain
       )
{
  DestroySurfaceTree();
  int rcA=1, rcB=1;
  MYON_NurbsCurve nurbs_curveA, nurbs_curveB;
  ...
  if ( !MYON_Internal_MakeKnotVectorsCompatible( nurbs_curveA, nurbs_curveB ) )
    return false;
  ...
  {
    SetCV(i,1,MYON::intrinsic_point_style, nurbs_curveB.CV(i));
  }
...
static
MYON_3dPoint CornerAt( const MYON_Surface& srf, int corner )
{
  double s, t;
  switch (corner)
  {
...
bool MYON_NurbsSurface::CollapseSide(
       int side,
       MYON_3dPoint point
       )
{
  if ( point == MYON_3dPoint::UnsetPoint )
  {
...
int MYON_NurbsSurface::CreateConeSurface(
...
MYON_NurbsSurface* MYON_NurbsSurfaceQuadrilateral( 
             const MYON_3dPoint& P, 
             const MYON_3dPoint& Q, 
             const MYON_3dPoint& R, 
             const MYON_3dPoint& S,
             MYON_NurbsSurface* nurbs_surface
             )
{
  if ( !nurbs_surface )
    nurbs_surface = new MYON_NurbsSurface( 3, false, 2, 2, 2, 2 );
  else
...
bool MYON_NurbsSurface::ConvertSpanToBezier(
    int span_index0,
    int span_index1, 
    MYON_BezierSurface& bezier_surface
    ) const
{
  int i, j;
...
static bool ValidateHermiteData(
  const MYON_SimpleArray<double>& u_Parameters,
  const MYON_SimpleArray<double>& v_Parameters,
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dPoint>>& GridPoints,
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& u_Tangents,
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& v_Tangents,
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& TwistVectors)
{
...
class MYON_NurbsSurface* MYON_NurbsSurface::CreateHermiteSurface(
  const MYON_SimpleArray<double>& u,
  const MYON_SimpleArray<double>& v,
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dPoint>>& GridPoints,
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& u_Tan,
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& v_Tan,
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& Twist,
  class MYON_NurbsSurface* hsrf)
{
...
MYON_HermiteSurface::MYON_HermiteSurface()
  : m_u_count(0)
  , m_v_count(0)
{
}

MYON_HermiteSurface::MYON_HermiteSurface(int u_count, int v_count)
  : m_u_count(0)
  , m_v_count(0)
{
...
bool MYON_HermiteSurface::Create(int u_count, int v_count)
{
  Destroy();
  ...
  for (int i = 0; i < m_u_count; i++)
  {
    MYON_SimpleArray<MYON_3dVector>& arr = m_u_tangents.AppendNew();
    arr.SetCapacity(m_v_count);
    arr.SetCount(m_v_count);
    for (int j = 0; j < m_v_count; j++)
      arr[j] = MYON_3dPoint::UnsetPoint;
  }

  m_v_tangents.SetCapacity(m_u_count);
  for (int i = 0; i < m_u_count; i++)
  {
    MYON_SimpleArray<MYON_3dVector>& arr = m_v_tangents.AppendNew();
    arr.SetCapacity(m_v_count);
    arr.SetCount(m_v_count);
    for (int j = 0; j < m_v_count; j++)
      arr[j] = MYON_3dVector::UnsetVector;
  }

  m_twists.SetCapacity(m_u_count);
  for (int i = 0; i < m_u_count; i++)
  {
    MYON_SimpleArray<MYON_3dVector>& arr = m_twists.AppendNew();
    arr.SetCapacity(m_v_count);
    arr.SetCount(m_v_count);
    for (int j = 0; j < m_v_count; j++)
      arr[j] = MYON_3dVector::UnsetVector;
...
void MYON_HermiteSurface::Destroy()
{
...
bool MYON_HermiteSurface::IsValid() const
{
  for (int i = 0; i < m_u_parameters.Count(); i++)
  {
    if (!MYON_IsValid(m_u_parameters[i]))
      return false;
  }

  for (int i = 0; i < m_v_parameters.Count(); i++)
  {
    if (!MYON_IsValid(m_v_parameters[i]))
      return false;
  }
...
int MYON_HermiteSurface::UCount() const
{
  return m_u_count;
}

int MYON_HermiteSurface::VCount() const
{
  return m_v_count;
}

bool MYON_HermiteSurface::InBounds(int u, int v) const
{
  return (
    0 <= u &&
    u < m_u_count &&
...
double MYON_HermiteSurface::UParameterAt(int u) const
{
  double rc = MYON_UNSET_VALUE;
  if (0 <= u && u < m_u_count)
    rc = m_u_parameters[u];
  return rc;
}

void MYON_HermiteSurface::SetUParameterAt(int u, double param)
{
  if (0 <= u && u < m_u_count)
    m_u_parameters[u] = param;
}

double MYON_HermiteSurface::VParameterAt(int v) const
{
  double rc = MYON_UNSET_VALUE;
  if (0 <= v && v < m_v_count)
    rc = m_v_parameters[v];
...
void MYON_HermiteSurface::SetVParameterAt(int v, double param)
{
  if (0 <= v && v < m_v_count)
    m_v_parameters[v] = param;
}

MYON_3dPoint MYON_HermiteSurface::PointAt(int u, int v) const
{
  MYON_3dPoint rc = MYON_3dPoint::UnsetPoint;
  if (InBounds(u, v))
    rc = m_grid_points[u][v];
  return rc;
}

void MYON_HermiteSurface::SetPointAt(int u, int v, const MYON_3dPoint& point)
{
  if (InBounds(u, v))
    m_grid_points[u][v] = point;
}

MYON_3dVector MYON_HermiteSurface::UTangentAt(int u, int v) const
{
  MYON_3dVector rc = MYON_3dVector::UnsetVector;
  if (InBounds(u, v))
    rc = m_u_tangents[u][v];
  return rc;
}

void MYON_HermiteSurface::SetUTangentAt(int u, int v, const MYON_3dVector& dir)
{
  if (InBounds(u, v))
    m_u_tangents[u][v] = dir;
}

MYON_3dVector MYON_HermiteSurface::VTangentAt(int u, int v) const
{
  MYON_3dVector rc = MYON_3dVector::UnsetVector;
  if (InBounds(u, v))
    rc = m_v_tangents[u][v];
...
void MYON_HermiteSurface::SetVTangentAt(int u, int v, const MYON_3dVector& dir)
{
  if (InBounds(u, v))
    m_v_tangents[u][v] = dir;
}

MYON_3dVector MYON_HermiteSurface::TwistAt(int u, int v) const
{
  MYON_3dVector rc = MYON_3dVector::UnsetVector;
  if (InBounds(u, v))
    rc = m_twists[u][v];
...
void MYON_HermiteSurface::SetTwistAt(int u, int v, const MYON_3dVector& dir)
{
  if (InBounds(u, v))
    m_twists[u][v] = dir;
}

const MYON_SimpleArray<double>& MYON_HermiteSurface::UParameters() const
{
  return m_u_parameters;
}

const MYON_SimpleArray<double>& MYON_HermiteSurface::VParameters() const
{
  return m_v_parameters;
}

const MYON_ClassArray<MYON_SimpleArray<MYON_3dPoint>>& MYON_HermiteSurface::GridPoints() const
{
  return m_grid_points;
}

const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& MYON_HermiteSurface::UTangents() const
{
  return m_u_tangents;
}

const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& MYON_HermiteSurface::VTangents() const
{
  return m_v_tangents;
}

const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& MYON_HermiteSurface::Twists() const
{
  return m_twists;
}

MYON_NurbsSurface* MYON_HermiteSurface::NurbsSurface(MYON_NurbsSurface* pNurbsSurface)
{
  if (!IsValid())
    return nullptr;

  return MYON_NurbsSurface::CreateHermiteSurface(
    UParameters(),
    VParameters(),
    GridPoints(),
    UTangents(),
