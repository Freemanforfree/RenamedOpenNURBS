...
#define MYON_OBSOLETE_V5_RECT RECT
#else
typedef struct tagON_RECT
{
    ...
    int    right;
    int    bottom;
} MYON_OBSOLETE_V5_RECT;
#endif

class MYON_OBSOLETE_V5_AnnotationText : public MYON_wString
{
public:
  MYON_OBSOLETE_V5_AnnotationText();
  ~MYON_OBSOLETE_V5_AnnotationText();

 
  MYON_OBSOLETE_V5_AnnotationText& operator=(const char*);
  MYON_OBSOLETE_V5_AnnotationText& operator=(const wchar_t*);
  ...
  // lfHeight=MYON_Font::Constants::AnnotationFontCellHeight and (0,0) left baseline
  // point of the leftmost character on the first line
  // of text. If (x,y) is a point on the drawn text, then
  // left <= x < right and top <= y < bottom.
  MYON_OBSOLETE_V5_RECT m_rect;
};

// Extension to MYON_OBSOLETE_V2_TextObject added 12/10/2009 for Text background drawing
class MYON_OBSOLETE_V5_TextExtra : public MYON_UserData
{
  MYON_OBJECT_DECLARE(MYON_OBSOLETE_V5_TextExtra);
public:

  MYON_OBSOLETE_V5_TextExtra();
  ~MYON_OBSOLETE_V5_TextExtra();

  static
  MYON_OBSOLETE_V5_TextExtra* TextExtension(class MYON_OBSOLETE_V5_TextObject* pDim, bool bCreate);
  static const 
  MYON_OBSOLETE_V5_TextExtra* TextExtension(const class MYON_OBSOLETE_V5_TextObject* pDim, bool bCreate);
  ...
  MYON_UUID ParentUUID() const;
  void SetParentUUID( MYON_UUID parent_uuid);
  ...
  MYON_Color MaskColor() const;  // Only works right if MaskColorSource returns 2.
  ...
  MYON_UUID  m_parent_uuid;    // uuid of the text using this extension
  ...
  MYON_Color m_mask_color;     // Color to use for mask if m_color_source is 2
...
class MYON_OBSOLETE_V5_DimExtra : public MYON_UserData
{
  MYON_OBJECT_DECLARE(MYON_OBSOLETE_V5_DimExtra);
public:

  MYON_OBSOLETE_V5_DimExtra();
  ~MYON_OBSOLETE_V5_DimExtra();

  static
  MYON_OBSOLETE_V5_DimExtra* DimensionExtension(class MYON_OBSOLETE_V5_DimLinear* pDim, bool bCreate);
  static const 
  MYON_OBSOLETE_V5_DimExtra* DimensionExtension(const class MYON_OBSOLETE_V5_DimLinear* pDim, bool bCreate);
  static
  MYON_OBSOLETE_V5_DimExtra* DimensionExtension(class MYON_OBSOLETE_V5_DimRadial* pDim, bool bCreate);
  static const 
  MYON_OBSOLETE_V5_DimExtra* DimensionExtension(const class MYON_OBSOLETE_V5_DimRadial* pDim, bool bCreate);
  static
  MYON_OBSOLETE_V5_DimExtra* DimensionExtension(class MYON_OBSOLETE_V5_DimOrdinate* pDim, bool bCreate);
  static const 
  MYON_OBSOLETE_V5_DimExtra* DimensionExtension(const class MYON_OBSOLETE_V5_DimOrdinate* pDim, bool bCreate);
  ...
  void SetModelSpaceBasePoint(MYON_3dPoint basepoint);
  MYON_3dPoint ModelSpaceBasePoint() const;
  ...
  void SetDetailMeasured(MYON_UUID detail_id);

  //const wchar_t* ToleranceUpperString() const;
  //MYON_wString& ToleranceUpperString();
  //void SetToleranceUpperString( const wchar_t* upper_string);
  //void SetToleranceUpperString( MYON_wString& upper_string);

  //const wchar_t* ToleranceLowerString() const;
  //MYON_wString& ToleranceLowerString();
  //void SetToleranceLowerString( const wchar_t* lower_string);
  //void SetToleranceLowerString( MYON_wString& lower_string);

  //const wchar_t* AlternateString() const;
  //MYON_wString& AlternateString();
  //void SetAlternateString( const wchar_t* alt_string);
  //void SetAlternateString( MYON_wString& alt_string);

  //const wchar_t* AlternateToleranceUpperString() const;
  //MYON_wString& AlternateToleranceUpperString();
  //void SetAlternateToleranceUpperString( const wchar_t* upper_string);
  //void SetAlternateToleranceUpperString( MYON_wString& upper_string);

  //const wchar_t* AlternateToleranceLowerString() const;
  //MYON_wString& AlternateToleranceLowerString();
  //void SetAlternateToleranceLowerString( const wchar_t* lower_string);
  //void SetAlternateToleranceLowerString( MYON_wString& lower_string);

  MYON_UUID m_partent_uuid;  // the dimension using this extension
  ...
  // m_rect on the MYON_OBSOLETE_V5_AnnotationText.
  ...
  MYON_OBSOLETE_V5_RECT* m_text_rects;

  double m_distance_scale;
  MYON_3dPoint m_modelspace_basepoint;

  // If this dimension measures objects in the model space of a detail view
  // this is the detail view
  // 27 Aug, 2014, v6
  MYON_UUID m_detail_measured;
};
...
/*
  class MYON_OBSOLETE_V5_Annotation
    ...
    Description:
      ...
      Replaces MYON_OBSOLETE_V2_Annotation
*/
class MYON_OBSOLETE_V5_Annotation : public MYON_Geometry
{
  MYON_OBJECT_DECLARE(MYON_OBSOLETE_V5_Annotation);

protected:
  MYON_OBSOLETE_V5_Annotation();
  MYON_OBSOLETE_V5_Annotation(const MYON_OBSOLETE_V5_Annotation&) = default;
  MYON_OBSOLETE_V5_Annotation& operator=(const MYON_OBSOLETE_V5_Annotation&) = default;

public:
  virtual ~MYON_OBSOLETE_V5_Annotation();
...
public:
  static MYON_OBSOLETE_V5_Annotation* CreateFromV2Annotation(
    const class MYON_OBSOLETE_V2_Annotation& V2_annotation,
    const class MYON_3dmAnnotationContext* annotation_context
  );

public:
  static MYON_OBSOLETE_V5_Annotation* CreateFromV6Annotation(
...
public:
  ...
  */
  ...
  /////////////////////////////////////////////////////////////////
  //
  // MYON_OBSOLETE_V5_Annotation interface
  //
...
public:
  ...
  */
  ...
  ////  MYON_UUID dim_style_id,
  ////  int V5_dim_style_index
  ////  );

  ////const MYON_DimStyle* V6_DimStyleOverride() const;
  ...
  ////  const MYON_DimStyle* dim_style_override,
  ////  int V5_dim_style_index
  ////  );
...
public:
  ...
  Returns:
    ...
    Leader:      MYON_UNSET_VALUE
    Text:        MYON_UNSET_VALUE
  */
  virtual 
  ...
  */
  ...
  /*
    ...
    Parameters:
      [in] MYON_INTERNAL_OBSOLETE::V5_eAnnotationType type - dtDimLinear, dtDimAligned, dtDimAngular, etc.
    Returns:
      MYON_INTERNAL_OBSOLETE::V5_eAnnotationType of the object
  */
  void SetType( MYON_INTERNAL_OBSOLETE::V5_eAnnotationType);
  ...
  /*
    ...
    Parameters:
      [in] MYON_Plane& plane in WCS
    Returns:
      const MYON_Plane& - the object's ECS plane in WCS coords
  */
  ...
  */
  ...
  /*
    ...
    Parameters:
      [in] MYON_2dPointArray& pts
    Returns:
      const MYON_2dPointArray& - ref to the object's point array
  */
  void SetPoints( const MYON_2dPointArray&);
  const MYON_2dPointArray& Points() const;
  ...
  /*
    ...
    Parameters:
      ...
      [in] const MYON_2dPoint& pt    the new point value
    Returns:
      MYON_2dPoint   the point coordinates in ECS
  */
  void SetPoint( int, const MYON_2dPoint&);
  MYON_2dPoint Point( int) const;
  ...
  /*
    ...
    Returns:
      const MYON_wString&    The object's UserText
    Remarks:
  ...
  */
  ...
  MYON_DEPRECATED_MSG("use SetTextValue function")
  void SetUserText( const wchar_t* text_value );

  MYON_DEPRECATED_MSG("use TextValue function")
  ...
  See Also:
    MYON_OBSOLETE_V5_AnnotationText::SetTextValue()
    MYON_OBSOLETE_V5_AnnotationText::SetTextFormula()
    MYON_OBSOLETE_V5_AnnotationText::TextFormula()    
  Remarks:
  ...
  */
  ...
  See Also:
    MYON_OBSOLETE_V5_AnnotationText::SetTextFormula()
    MYON_OBSOLETE_V5_AnnotationText::TextValue()    
    MYON_OBSOLETE_V5_AnnotationText::TextFormula()    
  Remarks:
    Annotation text values can be constant or the result 
    of evaluating text formula containing %<...>% 
  ...
  */
  ...
  See Also:
    MYON_OBSOLETE_V5_AnnotationText::SetTextValue()
    MYON_OBSOLETE_V5_AnnotationText::Value()    
    MYON_OBSOLETE_V5_AnnotationText::Formula()    
  Remarks:
    Annotation text values can be constant or the result 
    of evaluating text formula containing %<...>% 
    expressions. The ...TextValue() functions set
  ...
  */
  ...
  /*
    ...
    Parameters:
      [in] MYON::eTextDisplayMode mode - new mode to set
    Returns:
      MYON::eTextDisplayMode  - current mode
    Remarks:
      This is the way the text is oriented with respect to the dimension line or screen:
      Above line, In LIne, Horizontal
  */
  void SetTextDisplayMode( MYON_INTERNAL_OBSOLETE::V5_TextDisplayMode);
  ...
  /*
    ...
    Returns:
      ...
      false   Failure
  */
  bool GetECStoWCSXform( MYON_Xform&) const;
  ...
  /*
    ...
    Returns:
      ...
      false   Failure
  */
  bool GetWCStoECSXform( MYON_Xform& xform) const;
  ...
  */
  ...
  /*
    ...
    Parameters:
      ...
      gdi_height_of_I - [in]
         Value returned by MYON_Font::HeightOfI().
      dimstyle_textheight - [in]
         Height of text in world units.  If the annotation is
         an MYON_OBSOLETE_V5_TextObject, this is the m_textheight value.  
         If the annotation is not an MYON_OBSOLETE_V5_TextObject, pass in 
         the value returned by the dimension style's 
         MYON_DimStyle::TextHeight() 
      dimstyle_textgap - [in]
         The value of the annotation's dimension style's 
         MYON_DimStyle::TextGap().
      dimstyle_textalignment - [in]
         MYON_INTERNAL_OBSOLETE::V5_TextDisplayMode(MYON_DimStyle::TextAlignment()).
      dimscale - [in]
         ...
         is on MYON_3dmSettings::m_AnnotationSettings.m_dimscale.
      cameraX - [in]
  ...
  */
  bool GetTextXform( 
      const MYON_OBSOLETE_V5_RECT gdi_text_rect,
  ...
  */
  bool GetTextPoint( MYON_2dPoint& text_2d_point ) const;

  // enum for tyoe of annotation DimLinear, DimRadius, etc.
  MYON_INTERNAL_OBSOLETE::V5_eAnnotationType m_type;
  ...
  MYON_INTERNAL_OBSOLETE::V5_TextDisplayMode m_textdisplaymode;
  ...
  // MYON_OBSOLETE_V5_DimLinear, MYON_OBSOLETE_V5_DimRadial,
  // MYON_OBSOLETE_V5_DimAngular, MYON_OBSOLETE_V5_TextObject, and
  // MYON_OBSOLETE_V5_Leader that explains how the points are used.
  MYON_2dPointArray m_points;

  // With the addition of tolerances and therefore multi-line
  // text, the MYON_wString in m_usertext will hold multiple 
  ...
  // Alt suffix
  // 
  MYON_OBSOLETE_V5_AnnotationText m_usertext;
...
private:
  // At this point, the MYON_OBSOLETE_V5_Annotation and derived classes
  ...
  // information that is parallel to the information on MYON_Annotation.
   
  // Dimstyle index to use when writing a V5 archive.
  int m_v5_3dm_archive_dimstyle_index = MYON_UNSET_INT_INDEX;
...
// Subclass of MYON_OBSOLETE_V5_Annotation to provide linear dimensions
class MYON_OBSOLETE_V5_DimLinear : public MYON_OBSOLETE_V5_Annotation
{
  MYON_OBJECT_DECLARE(MYON_OBSOLETE_V5_DimLinear);
...
public:
  ...
  /*
    ...
    In the picture below, [n] means MYON_OBSOLETE_V5_Annotation::m_points[n].
  ...
  */
  ...
  enum POINT_INDEX
  {
    ...
    // MYON_COMPONENT_INDEX.m_index value.
    //
...
public:
  ...
  ~MYON_OBSOLETE_V5_DimLinear();
  MYON_OBSOLETE_V5_DimLinear( const MYON_OBSOLETE_V5_DimLinear& ) = default;
  MYON_OBSOLETE_V5_DimLinear& operator=(const MYON_OBSOLETE_V5_DimLinear&) = default;
  ...
  Parameters:
    ...
    destination - [in]
      ...
      is allocated with a call to new MYON_OBSOLETE_V5_DimLinear().
  */
  static MYON_OBSOLETE_V5_DimLinear* CreateFromV6DimLinear(
    const class MYON_DimLinear& V6_dim_linear,
    const class MYON_3dmAnnotationContext* annotation_context,
    MYON_OBSOLETE_V5_DimLinear* destination
  );

  static MYON_OBSOLETE_V5_DimLinear* CreateFromV2LinearDimension( 
  ...
  */
  ...
  Returns:
    2d point or MYON_3dPoint::UnsetPoint if point_index or m_points[]
    array is not valid.
  */
  MYON_2dPoint Dim2dPoint(
       int point_index
       ) const;
  ...
  Returns:
    ...
    array is not valid.
  */
  MYON_3dPoint Dim3dPoint(
       int point_index
       ) const;

  // overrides virual MYON_Object::IsValid
  bool IsValid( MYON_TextLog* text_log = nullptr ) const override;

  // overrides virual MYON_Object::Write
  bool Write(MYON_BinaryArchive&) const override;

  // overrides virual MYON_Object::Read
  ...
  /*
  Description:
    Overrides virtual MYON_OBSOLETE_V5_Annotation::NumericValue();
  Returns:
  ...
  */
  ...
  Parameters:
    ...
    gdi_to_world - [in] 
       transform returned by MYON_OBSOLETE_V5_Annotation::GetTextXform().
    dimstyle - [in]
      dimscale - [in]
    vp - [in]
  ...
  */
  ...
  MYON_OBSOLETE_V5_DimExtra* DimensionExtension();
  const MYON_OBSOLETE_V5_DimExtra* DimensionExtension() const;
};

//////////
// class MYON_OBSOLETE_V5_DimRadial
class MYON_OBSOLETE_V5_DimRadial : public MYON_OBSOLETE_V5_Annotation
{
  MYON_OBJECT_DECLARE(MYON_OBSOLETE_V5_DimRadial);
...
public:
  ...
  */
  ...
  ~MYON_OBSOLETE_V5_DimRadial() = default;
  MYON_OBSOLETE_V5_DimRadial(const MYON_OBSOLETE_V5_DimRadial&) = default;
  MYON_OBSOLETE_V5_DimRadial& operator=(const MYON_OBSOLETE_V5_DimRadial&) = default;


  static MYON_OBSOLETE_V5_DimRadial* CreateFromV6DimRadial(
      const class MYON_DimRadial& V6_dim_radial,
      const class MYON_3dmAnnotationContext* annotation_context,
      MYON_OBSOLETE_V5_DimRadial* destination
    );

  static MYON_OBSOLETE_V5_DimRadial* CreateFromV2RadialDimension(
  ...
  */
  ...
  Description:
    Overrides virtual MYON_OBSOLETE_V5_Annotation::NumericValue();
  Returns:
    If m_type is MYON_INTERNAL_OBSOLETE::V5_eAnnotationType::dtDimDiameter, then the diameter
  ...
  */
  ...
  bool CreateFromV2( 
      const class MYON_OBSOLETE_V2_Annotation& v2_ann,
      const class MYON_3dmAnnotationSettings& settings,
      int dimstyle_index
      );

  bool GetArrowHeadDirection( MYON_2dVector& arrowhead_dir ) const;
  bool GetArrowHeadTip( MYON_2dPoint& arrowhead_tip ) const;
};


//////////
// class MYON_OBSOLETE_V5_DimAngular
class MYON_OBSOLETE_V5_DimAngular : public MYON_OBSOLETE_V5_Annotation
{
  MYON_OBJECT_DECLARE(MYON_OBSOLETE_V5_DimAngular);
...
public:
  ...
  ~MYON_OBSOLETE_V5_DimAngular() = default;
  MYON_OBSOLETE_V5_DimAngular(const MYON_OBSOLETE_V5_DimAngular&) = default;
  MYON_OBSOLETE_V5_DimAngular& operator=(const MYON_OBSOLETE_V5_DimAngular&) = default;

  static MYON_OBSOLETE_V5_DimAngular* CreateFromV6DimAngular(
    const class MYON_DimAngular& V6_dim_angular,
    const class MYON_3dmAnnotationContext* annotation_context,
    MYON_OBSOLETE_V5_DimAngular* destination
  );

  static MYON_OBSOLETE_V5_DimAngular* CreateFromV2AngularDimension( 
  ...
  */
  ...
  bool GetArc( MYON_Arc& arc ) const;

  bool GetExtensionLines(MYON_Line extensions[2]) const;
...
/*
  class MYON_OBSOLETE_V5_DimLinear

  Description:
    Override od MYON_OBSOLETE_V5_Annotation to provide linear dimensions
*/
class MYON_OBSOLETE_V5_DimOrdinate : public MYON_OBSOLETE_V5_Annotation
{
  MYON_OBJECT_DECLARE(MYON_OBSOLETE_V5_DimOrdinate);
...
public:
  ...
  */
  ...
  static MYON_OBSOLETE_V5_DimOrdinate* CreateFromV6DimOrdinate(
  ...
  Parameters:
    ...
    default_offset [in] - kink offset to use if m_kink_offset_0
                          or m_kink_offset_1 are MYON_UNSET_VALUE
  Returns:
    2d point or MYON_3dPoint::UnsetPoint if point_index or m_points[]
    array is not valid.
  */
  ...
  */
  ...
  /*
    Description:
      ...
      MYON_UNSET_VALUE and a default should be used to find the point.
    Parameters:
  ...
  */
  ...
  /*
    ...
    Parameters:
      ...
      default_offset [in] - Use this if offsets are MYON_UNSET_VALUE
      k0, k1 [out] - The kink points
    Remarks:
      The offsets must be set to the right values before calling this, or
      If they are MYON_UNSET_VALUE, they will be set to the defaults
  */
  void CalcKinkPoints( MYON_2dPoint p0, MYON_2dPoint p1, 
...
//////////
// class MYON_OBSOLETE_V5_TextObject
class MYON_OBSOLETE_V5_TextObject : public MYON_OBSOLETE_V5_Annotation
{
  MYON_OBJECT_DECLARE(MYON_OBSOLETE_V5_TextObject);
...
public:
  ...
  Parameters:
    ...
    destination - [in]
      ...
      is allocated with a call to new MYON_OBSOLETE_V5_TextObject().
  */
  static MYON_OBSOLETE_V5_TextObject* CreateFromV6TextObject(
    const class MYON_Text& V6_text_object,
    const class MYON_3dmAnnotationContext* annotation_context,
    MYON_OBSOLETE_V5_TextObject* destination
  );

  static MYON_OBSOLETE_V5_TextObject* CreateFromV2TextObject(
...
//////////
// class MYON_OBSOLETE_V5_Leader
class MYON_OBSOLETE_V5_Leader : public MYON_OBSOLETE_V5_Annotation
{
  MYON_OBJECT_DECLARE(MYON_OBSOLETE_V5_Leader);
...
public:
  ...
  /*
    ...
    Leaders:
      ...
      a leader with no text and an MYON_OBSOLETE_V5_TextObject.
  */
  ...
  //MYON_OBSOLETE_V5_Leader(const MYON_OBSOLETE_V5_Leader&);
  //MYON_OBSOLETE_V5_Leader& operator=(const MYON_OBSOLETE_V5_Leader&);
  ...
  Parameters:
    ...
    destination - [in]
      ...
      is allocated with a call to new MYON_V5_Leader().
  */
  static MYON_OBSOLETE_V5_Leader* CreateFromV6Leader(
  ...
  static MYON_OBSOLETE_V5_Leader* CreateFromV2Leader(
  ...
  */
  ...
  /*
    ...
    Returns:
      ...
      False    Failure
  */
  void AddPoint( const MYON_2dPoint& point);
...
// April 22, 2010 Lowell - Added to support right justified text on left pointing leader tails rr64292
  bool GetTextDirection( MYON_2dVector& text_dir ) const;
  bool GetArrowHeadDirection( MYON_2dVector& arrowhead_dir ) const;
  bool GetArrowHeadTip( MYON_2dPoint& arrowhead_tip ) const;
};
