...
MYON_DECL
double MYON_DomainTolerance(
          double, // start of domain
          double  // end of domain
          );

MYON_DECL
double MYON_KnotTolerance(
          int,           // order (>=2)
          int,           // cv count
...
MYON_DECL
int MYON_KnotCount( // returns (order + cv_count - 2)
          int, // order (>=2)
          int  // cv_count (>=order)
          );
...
Description:
  ...
  MYON_NurbsSpanIndex(order,cv_count,knot,t,0,0) returns the integer
...
MYON_DECL
int MYON_GetSpanIndices( // returns span count, which is one less than length of span_indices[]
          int order,
          int cv_count,
          const double* knot,
...
MYON_DECL
bool MYON_IsValidKnotVector(
          int order,
          int cv_count, 
          const double* knot, 
          MYON_TextLog* text_log = 0
          );
...
bool MYON_MakeKnotVectorPeriodic(
 ...
 Returns:
   true if successful
 See Also:
   MYON_NurbsCurve::MakeClampedUniformKnotVector
*/
MYON_DECL
...
/*
 ...
 Returns:
   true if successful
 See Also:
   MYON_NurbsCurve::MakePeriodicUniformKnotVector
*/
MYON_DECL
...
MYON_DECL
double MYON_GrevilleAbcissa( // get Greville abcissae from knots
          int,           // order (>=2)
          const double*  // knot[] array (length = order-1)
          );

MYON_DECL
bool MYON_GetGrevilleAbcissae( // get Greville abcissae from knots
          int,            // order (>=2)
          int,            // cv count
          const double*,  // knot[] array
