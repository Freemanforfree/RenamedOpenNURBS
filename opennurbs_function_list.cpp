...
struct tagFunctionItem
{
  ...
  void (*m_function)(MYON__UINT_PTR);
  MYON__UINT_PTR m_function_parameter;
};

MYON_FunctionList::MYON_FunctionList(
...
MYON_FunctionList::~MYON_FunctionList()
{
  ...
  if (dtor_error > 0 )
  {
    MYON_ERROR("Destroying a locked list - multiple delete or multiple delete or multiple exists.");
  }
}

unsigned int MYON_FunctionList::AddFunction(
    void (*function)(MYON__UINT_PTR),
    MYON__UINT_PTR function_parameter
    )
{
  if ( 0 == function)
    return 2;
...
unsigned int MYON_FunctionList::RemoveFunction(
    void (*function)(MYON__UINT_PTR),
    MYON__UINT_PTR function_parameter
    )
{
...
unsigned int MYON_FunctionList::IsInList(
    void (*function)(MYON__UINT_PTR),
    MYON__UINT_PTR function_parameter
    ) const
{
...
bool MYON_FunctionList::EmptyList()
{
  if ( false == m_lock.GetDefaultLock() )
    return false;
...
bool MYON_FunctionList::CallFunctions(
  bool bFirstToLast
  )
{
  if ( false == m_lock.GetDefaultLock() )
