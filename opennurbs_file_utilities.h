...
class MYON_CLASS MYON_FileSystem
{
private:
  MYON_FileSystem() = delete;
  ~MYON_FileSystem() = delete;
  MYON_FileSystem(const MYON_FileSystem&) = delete;
  MYON_FileSystem& operator=(const MYON_FileSystem&) = delete;
...
class MYON_CLASS MYON_FileSystemPath
{
private:
  MYON_FileSystemPath() = delete;
  ~MYON_FileSystemPath() = delete;
  MYON_FileSystemPath(const MYON_FileSystemPath&) = delete;
  MYON_FileSystemPath& operator=(const MYON_FileSystemPath&) = delete;

public:
  /*
  Platform dependent character used to separate directory names.
  On Windows platforms: 
    MYON_FileSystemPath::DirectorySeparator = MYON_wString::Backslash.
  On UNIX (including modern Apple) platforms: 
    MYON_FileSystemPath::DirectorySeparator = MYON_wString::Slash.
  */
  ...
  */
  static const MYON_wString VolumeFromPath(
    const wchar_t* path
  );
  ...
  */
  static const MYON_wString DirectoryFromPath(
    const wchar_t* path
  );
  ...
  */
  static const MYON_wString VolumeAndDirectoryFromPath(
    const wchar_t* path
  );
  ...
  */
  static const MYON_wString FileNameFromPath(
    const wchar_t* path,
  ...
  */
  static const MYON_wString FileNameExtensionFromPath(
    const wchar_t* path
  );
  ...
  Parameters:
    ...
    bExpandUser - [in]
      If the path begins with ~ and MYON_FileSystemPath::PlatformPath( MYON_FileSystemPath::PathId::UserHomeDirectory ) 
    ...
    directory_separator - [in]
      ...
      MYON_wString::FileSystemPathSeparator is a good choice if you want
  ...
  Return:
    Cleaned path.
  */
  static const MYON_wString CleanPath(
    bool bTrimLeft,
    bool bTrimRight,
  ...
  Description:
    ...
    is not empty, then the ~ is replaced with absolute path of user's home directory.
  */
  static const MYON_wString ExpandUser(
  ...
  Parameters:
    path - [in]
      path to test
    directory_separator - [in]
      If 0 == directory_separator, then either MYON_wString::FileSystemPathSeparator 
      or MYON_wString::AlternateFileSystemPathSeparator is permitted as a directory
      separator.
      MYON_wString::FileSystemPathSeparator is a good choice if you want
      to use the current runtime's separator.
  Returns:
  ...
  */
  ...
  Description:
    ...
    Sets all directory separators to MYON_FileSystemPath::DirectorySeparator.
  ...
  */
  ...
  Example
      ...
      MYON_wString::GetRelativePath(full_path,base_path) returns
      L"../../../c/d/somefile.txt"
  ...
  Remarks:
    ...
    Path separators on the returned relative path are MYON_wString::FileSystemPathSeparator
  */
  static const MYON_wString RelativePath(
  ...
  static const MYON_wString FullPathFromRelativePath(
    const wchar_t* base_path,
    bool bBasePathIncludesFileName,
  ...
  */
  ...
  Returns:
    ...
    where MYON::OpenFile("fname","r") would look for a file named "fname".
  */
  static const MYON_wString CurrentDirectory(
  ...
  */
  static const MYON_wString RemoveFileName(
    const wchar_t* path,
  ...
  */
  static const MYON_wString RemoveVolumeName(
    const wchar_t* path,
  ...
  */
  static const MYON_wString CombinePaths(
  ...
  /// <summary>
  /// MYON_FileSystemPath::PathId identifies a collection of commonly used directories.
  /// Use MYON_FileSystemPath::PlatformPath() to get the name of the directory.
  /// </summary>
  ...
  */
  static const MYON_wString PlatformPath(
    MYON_FileSystemPath::PathId path_id
  );


  MYON_DEPRECATED_MSG("Use MYON_FileSystem::PathExists")
  static bool PathExists(
    const char* path
    );
  ...
  MYON_DEPRECATED_MSG("Use MYON_FileSystem::IsDirectory")
  static bool IsDirectory(
    const char* path
    );
  ...
  MYON_DEPRECATED_MSG("Use MYON_FileSystem::IsFile")
  static bool IsFile(
    const char* path
    );
...
class MYON_CLASS MYON_FileStream
{
public:
  /*
  Description:
  ...
  Parameters:
    ...
    mode - [in]
  Remarks:
    Use the MYON_FileStream static functions for reading, writing, 
  ...
  */
  ...
  Parameters:
    fp - [in]
      FILE pointer returned by MYON_FileStream::Open().
  Returns:
       0: successful
      -1: null fp parameter
  ...
  */
  ...
  Returns:
    >= 0: current file position
      -1: an error occurred
  */
  static MYON__INT64 CurrentPosition( FILE* fp );
  ...
  Parameters:
    ...
    offset - [in]
  */
  static bool SeekFromCurrentPosition( FILE* fp, MYON__INT64 offset );
  ...
  Parameters:
    ...
    offset - [in]
  */
  static bool SeekFromStart( FILE* fp, MYON__INT64 offset );
  ...
  Parameters:
    ...
    offset - [in]
  */
  static bool SeekFromEnd( FILE* fp, MYON__INT64 offset );
  ...
  */
  static bool Seek( FILE* fp, MYON__INT64 offset, int orgin );
  ...
  */
  static MYON__UINT64 Read( FILE* fp, MYON__UINT64 count, void* buffer );
  ...
  */
  static MYON__UINT64 Write( FILE* fp, MYON__UINT64 count, const void* buffer );
...
class MYON_CLASS MYON_ContentHash
{
public:
  static const MYON_ContentHash Unset;

public:
  MYON_ContentHash() = default;
  ~MYON_ContentHash() = default;
  MYON_ContentHash(const MYON_ContentHash&)  = default;
  MYON_ContentHash& operator=(const MYON_ContentHash&)  = default;

  /*
  Description:
    Create an MYON_ContentHash class with the specified size, hash and times.
  Parameters:
    sha1_name_hash - [in]
      The SHA-1 hash of the name (typically a full path file name).
      When the content is identified by a file name in a file system,
      use MYON_SHA1_Hash::FileSystemPathHash() to calculate this value.
    byte_count - [in] 
      number of bytes in the content.
    sha1_content_hash - [in]
      The SHA-1 hash of the content (typically a buffer or file).
      You may use MYON_SHA1_Has::FileContentHash() or MYON_SHA1_Hash::BufferContentHash()
  ...
  Returns:
    An MYON_ContentHash with size and SHA-1 hash and times set from the parameters,
  */
  static MYON_ContentHash Create(
  ...
  /*
  Description:
    Create an MYON_ContentHash from a memory buffer.
  Parameters:
    sha1_name_hash - [in]
      A SHA-1 hash of the name associated with this content.
      If the buffer has no name, pass MYON_SHA1_Hash::ZeroDigest.
      If the buffer has an empty name, pass MYON_SHA1_Hash::EmptyContentHash.
    buffer - [in]  
    byte_count - [in] 
      number of bytes in buffer[]
  Returns:
    An MYON_ContentHash with size and SHA-1 hash calculated from the parameters,
    hash time = now, and content last modified time = 0.
  */
  static MYON_ContentHash CreateFromBuffer( 
    MYON_SHA1_Hash sha1_name_hash,
    const void* buffer,
    size_t byte_count
   );
  ...
  /*
  Description:
    Create an MYON_ContentHash from a file stream.
  Parameters:
    sha1_file_name_hash - [in]
      A SHA-1 hash of the file name associated with fp.
      Use MYON_SHA1_Has::FileSystemPathHash() to create the value.
      If the name is not known, pass MYON_SHA1_Hash::ZeroDigest.
    fp - [in] pointer to a file opened with MYON:FileOpen(...,"rb")
  Returns:
    An MYON_ContentHash with size and SHA-1 hash and times set from the file,
    hash time = now, and content last modified time set from the file system
    information returned by MYON_FileStream::GetFileInformation().
  */
  static MYON_ContentHash CreateFromFile( 
  ...
  */
  MYON__UINT64 HashCalculationTime() const;
  ...
  */
  MYON__UINT64 ContentLastModifiedTime() const;

  /*
  Returns:
    SHA-1 hash of the name (typically a full path file name).
  */
  MYON_SHA1_Hash NameHash() const;
  ...
  */
  ...
  /// <summary>
  /// MYON_ContentHash::Compare are the possible results of calling MYON_ContentHash::CompareFile().
  /// </summary>
  enum class CompareResult : unsigned char
  {
    /// <summary>
    /// Not set. This value is never returned by MYON_ContentHash::CheckFile().
    /// </summary>
    Unset = 0,
  ...
  static MYON_ContentHash::CompareResult CompareResultFromUnsigned(
  ...
  bFastCompare - [in]
    ...
    exactly match the values in MYON_ContentHash, then
    MYON_ContentHash::CompareResult::EqualContent is returned
    ...
    calculated and compared before MYON_ContentHash::CompareResult::EqualContent
    is returned.
  Returns:
    Result of compare test as a MYON_ContentHash::CompareResult enum.
    MYON_ContentHash::CompareResult::DifferentContentFileIsOlder means file_path content is different and older than "this".
    MYON_ContentHash::CompareResult::DifferentContentFileIsNewer means file_path content is different and newer than "this".
  */
  MYON_ContentHash::CompareResult Compare(
    const wchar_t* file_path,
    bool bFastTest
    ) const;
  ...
  Parameters:
    file_content_hash - [in]
      MYON_ContentHash to compare against this one.
  Returns:
    Result of compare test as a MYON_ContentHash::CompareResult enum.
    MYON_ContentHash::CompareResult::DifferentContentFileIsOlder means file_content_hash is different and older than "this".
    MYON_ContentHash::CompareResult::DifferentContentFileIsNewer means file_content_hash is different and newer than "this".
  */
  MYON_ContentHash::CompareResult Compare(
  ...
  */
  ...
  Returns:
    ...
    False otherwise.
  Remarks:
    Faster than the MYON_ContentHash::EqualContent() and reliable if this content
...
private:
  ...
  MYON__UINT64 m_byte_count = 0;

  // Time this hash was set (always > 0 if this MYON_ContentHash is set).
  MYON__UINT64 m_hash_time = 0; // number of seconds since Jan 1, 1970, UCT

  // Time the content was last modified.
  // This time is often unknown, or set incorrectly.
  MYON__UINT64 m_content_time = 0; // number of seconds since Jan 1, 1970, UCT

  // SHA-1 hash of the content name (file name or other assigned name)
  MYON_SHA1_Hash  m_sha1_name_hash = MYON_SHA1_Hash::ZeroDigest;

  // SHA-1 hash of the content (buffer or file).
  MYON_SHA1_Hash  m_sha1_content_hash = MYON_SHA1_Hash::ZeroDigest;
};

class MYON_CLASS MYON_FileReference
{
public:
  static const MYON_FileReference Unset;

#pragma region RH_C_SHARED_ENUM [MYON_FileReference::Status] [Rhino.FileIO.FileReferenceStatus] [int]
...
#pragma endregion
  ...
  static MYON_FileReference::Status StatusFromUnsigned(
    unsigned int full_path_status_as_unsigned
    );

  MYON_FileReference() = default;
  ~MYON_FileReference() = default;
  MYON_FileReference(const MYON_FileReference&) = default;
  MYON_FileReference& operator=(const MYON_FileReference&) = default;
  ...
  static MYON_FileReference CreateFromFullPath(
    const wchar_t* full_path,
    bool bSetContentHash,
    bool bSetFullPathStatus
    );

#pragma region RH_C_SHARED_ENUM [MYON_FileReference::FindFilePreference] [Rhino.FileIO.FileFindPreference] [int]
...
#pragma endregion
  ...
  Returns:
    If the file is found, then the returned MYON_FileReference::FindFilePreference enum value
    indicates why it was selected.
    If the file is not found, then MYON_FileReference::FindFilePreference::None is returned
  ...
  */
  MYON_FileReference::FindFilePreference FindFile(
    const wchar_t* base_path,
    bool bBasePathIncludesFileName,
  ...
  Remarks:
    ...
    If you prefer a different order, use the version of MYON_FileReference::FindFile
    with 5 MYON_FileReference::FindFilePreference parameters.
  */
  MYON_FileReference::FindFilePreference FindFile(
    const wchar_t* base_path,
    bool bBasePathIncludesFileName,
  ...
  */
  MYON_FileReference::FindFilePreference FindFileAndUpdateReference(
    const wchar_t* base_path,
    bool bBasePathIncludesFileName,
    MYON_FileReference::FindFilePreference first_choice,
    MYON_FileReference::FindFilePreference second_choice,
  ...
  */
  ...
  /*
  Remarks:
    Calling Read() sets m_full_path_status = MYON_FileReference::Status::Unknown,
  ...
  */
  ...
  const MYON_wString& FullPath() const;
  ...
  const MYON_wString& RelativePath() const;
  ...
  */
  const MYON_ContentHash& ContentHash() const;
  void SetContentHash(
    MYON_ContentHash content_hash
    );
  ...
  Parameters:
    recent_time - [in]
      ...
      MYON_SecondsSinceJanOne1970UTC() is used.
      Typically this parameter is the value of MYON_SecondsSinceJanOne1970UTC()
  ...
  */
  const MYON_ContentHash& RecentContentHash(
    MYON__UINT64 recent_time
  ) const;

  /*
  Returns:
    MYON_SHA1_Hash::FileSystemPathHash(FullPath());
  Remarks:
  ...
  See Also:
    MYON_NameHash::CreateFilePathHash( MYON_FileReference& file_reference );
  */
  const MYON_SHA1_Hash& FullPathHash() const;

  MYON_FileReference::Status FullPathStatus() const;
  void SetFullPathStatus(
    MYON_FileReference::Status full_path_status
    );

  MYON_UUID EmbeddedFileId() const;
  void SetEmbeddedFileId(
    MYON_UUID embedded_file_id
    );

private:
  MYON_wString m_full_path;
  MYON_wString m_relative_path;

  // If the referenced file is saved in the model as an embedded file,
  // the MYON_BinaryArchive read code sets m_embedded_file_id
  // at read time.
  mutable MYON_UUID m_embedded_file_id = MYON_nil_uuid;

  // file content hash. Can be calculated long ago, on a different computer,
  // and is saved in 3dm archived.
  MYON_ContentHash m_content_hash; // File content hash.

  mutable MYON_ContentHash m_recent_content_hash;

  // m_full_path_hash is cached runtime information. The value is not saved
  // in .3dm archives. It is calculated on demand.
  mutable MYON_SHA1_Hash m_full_path_hash = MYON_SHA1_Hash::EmptyContentHash; // File path hash.

  MYON_FileReference::Status m_full_path_status = MYON_FileReference::Status::Unknown;

private:
  MYON_FileReference::FindFilePreference Internal_FindFile(
    const wchar_t* base_path,
    bool bBasePathIncludesFileName,
...
*/
class MYON_CLASS MYON_FileIterator
{
public:
  MYON_FileIterator() = default;
  ~MYON_FileIterator();

private:
  MYON_FileIterator(const MYON_FileIterator&) = delete;
  MYON_FileIterator& operator=(const MYON_FileIterator&) = delete;
...
public:
  ...
  */
  ...
  Example:
          ...
          for ( bool bHaveItem = fit.FirstItem(); bHaveItem; bHaveItem = fit.NextItem() )
          {
            ...
            FILE* fp = MYON_FileStream::Open(fullpath,"rb");
            if ( 0 == fp )
            {
              continue;
            }
  ...
  */
  ...
  /*
  Description:
    Reset this MYON_FileIterator so it can be used again.
  */
  void Reset();
  ...
  */
  const MYON_wString CurrentItemName() const;

  /*
  Returns:
    The name of the directory being iterated.
  */
  const MYON_wString DirectoryName() const;
  ...
  */
  MYON__UINT64 CurrentItemSize() const;
  ...
  */
  ...
  const MYON_wString CurrentItemFullPathName() const;

  /*
  Returns:
    File last modified time in seconds since January 1, 1970
  Remarks:
    The times returned by MYON_FileIterator can differ from the time
    returned by MYON_FileStream::GetFileInformation().
  */
  MYON__UINT64 CurrentItemLastModifiedTime() const;

  /*
  Returns:
    Number of matching items iterated through.
  */
  MYON__UINT64 CurrentItemCount() const;

private:
  MYON__UINT32 m_state = 0; // 0 unset, 1=initialized, 2 = itereation in progress. 3 = iteration finished.
  MYON__UINT32 m_reserved = 0;

  MYON_wString m_directory; // directory passed to Initialize() or FirstItem
  MYON_wString m_item_name_filter; // item_name_filter passed to Initialize() or FirstItem
  MYON_wString m_item_name; // Current item name.

  // cached full path name 
  //   m_directory + directory separator + m_item_name
  //  (length = 0 if it is not set)
  mutable MYON_wString m_full_path_name;

  MYON__UINT64 m_count = 0; // number of items iterated through so far
  class MYON_DirectoryIteratorImpl* m_impl = nullptr;
};

class MYON_CLASS MYON_UnicodeTextFile final
{
public:
  enum class Modes { Read, Write };
  enum class Types { Unknown, UTF8, UTF16 };

  MYON_UnicodeTextFile(Types type = Types::Unknown);
  ...
  MYON_UnicodeTextFile(const MYON_UnicodeTextFile&) = delete;
  const MYON_UnicodeTextFile& operator = (const MYON_UnicodeTextFile&) = delete;
