...
typedef bool (*MYON_StreamCallbackFunction)( void* context, MYON__UINT32 size, const void* buffer );

class MYON_CLASS MYON_CompressStream
{
public:
  MYON_CompressStream();
  virtual ~MYON_CompressStream();

  /*
  Description:
    MYON_CompressStream delivers the compressed stream by calling
  ...
  */
  bool SetCallback( 
    MYON_StreamCallbackFunction callback_function,
  ...
  Returns:
    ...
    handle
  */
  MYON_StreamCallbackFunction CallbackFunction() const;
  ...
  */
  MYON__UINT32 OutCRC() const;

private:
  MYON_StreamCallbackFunction m_out_callback_function;
  void* m_out_callback_context;
  MYON__UINT64 m_in_size;
  MYON__UINT64 m_out_size;
  MYON__UINT32 m_in_crc;
  MYON__UINT32 m_out_crc;
...
private:
  ...
  MYON_CompressStream(const MYON_CompressStream&);
  MYON_CompressStream& operator=(const MYON_CompressStream&);
};


class MYON_CLASS MYON_UncompressStream
{
public:
  MYON_UncompressStream();
  virtual ~MYON_UncompressStream();

  /*
  Description:
    MYON_UncompressStream delivers the uncompressed stream by calling
...
private:
  // prohibit use - no implementation
  MYON_UncompressStream(const MYON_UncompressStream&);
  MYON_UncompressStream& operator=(const MYON_UncompressStream&);
};
...
class MYON_CLASS MYON_CompressedBuffer
{
public:
  MYON_CompressedBuffer();
  ~MYON_CompressedBuffer();
  MYON_CompressedBuffer(const MYON_CompressedBuffer& src);
  MYON_CompressedBuffer& operator=(const MYON_CompressedBuffer& src);
  ...
  */
  ...
  /*
  Description:
  Uncompress the contents of this MYON_CompressedBuffer.
  Parameters:
  outbuffer - [in/out]
  ...
  */
  ...
  /*
  Description:
  Destroy the current information in the MYON_CompressedBuffer
  so the class can be reused.
  */
  void Destroy();

  bool Write(MYON_BinaryArchive& binary_archive) const;
  bool Read(MYON_BinaryArchive& binary_archive);

  /////////////////////////////////////////////////
  //
  // Implementation
  //
  bool CompressionInit(struct MYON_CompressedBufferHelper*) const;
  bool CompressionEnd(struct MYON_CompressedBufferHelper*) const;
  ...
  MYON__UINT32 m_crc_uncompressed;
  MYON__UINT32 m_crc_compressed;
