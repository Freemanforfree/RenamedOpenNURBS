...
MYON_OBJECT_IMPLEMENT(MYON_TextContent, MYON_Geometry, "4F0F51FB-35D0-9998-4865-9721D6D2C6A9");

//-----------------------------------------------------------------
MYON::object_type MYON_TextContent::ObjectType() const
{
  return MYON::annotation_object;
}

void MYON_TextContent::Internal_Destroy()
{
  m__runs = MYON_TextRunArray::EmptyArray;
  Internal_DeleteWrappedRuns();
  DestroyRuntimeCache();

  m_annotation_type = MYON_TextContent::Empty.m_annotation_type;
  m_dimstyle_text_position_properties_hash = MYON_TextContent::Empty.m_dimstyle_text_position_properties_hash;
  Internal_ClearTextContentHash();
  m_default_font = &MYON_Font::Default;
}

MYON_TextContent::~MYON_TextContent()
{
  Internal_Destroy();
}

void MYON_TextContent::Internal_DeleteWrappedRuns() const
{
...
void MYON_TextContent::Internal_CopyFrom(
...
)
{
  ...
  {
    m__wrapped_runs = new MYON_TextRunArray(*src.m__wrapped_runs);
  }
...
MYON_TextContent::MYON_TextContent(const MYON_TextContent& src)
  : MYON_Geometry(src)
{
...
MYON_TextContent& MYON_TextContent::operator=(const MYON_TextContent& src)
{
  if (this != &src)
  {
    Internal_Destroy();
...
static bool MYON_V6_Text_IsNotIsValid()
{
  return false; // <- breakpoint here to detect invalid MYON_TextContent objects.
}

bool MYON_TextContent::IsValid(MYON_TextLog* text_log) const
{
  ...
  {
    const MYON_TextRun* run = m__runs[i];
    if (nullptr == run)
      return MYON_V6_Text_IsNotIsValid();
    if (!run->IsValid())
      return MYON_V6_Text_IsNotIsValid();
    if (MYON_TextRun::RunType::kText == run->Type())
  ...
  if (nullptr != m__wrapped_runs)
  {
    ...
    {
      const MYON_TextRun* run = (*m__wrapped_runs)[i];
      if (nullptr == run)
        return MYON_V6_Text_IsNotIsValid();
      if (!run->IsValid())
        return MYON_V6_Text_IsNotIsValid();
...
static bool SubstituteStackTags(const wchar_t* text_string, MYON_wString& text, int length, int start, int& end, int depth)
{
  int i = start;
...
bool MYON_TextContent::Internal_SetText(
...
bool MYON_TextContent::Internal_ParseRtfDefault(
  const wchar_t* rtf_string,
...
bool MYON_TextContent::Internal_ParseRtf(
  const wchar_t* rtf_string,
  const MYON_DimStyle* dimstyle,
  bool bComposeAndUpdateRtf
)
{
  const MYON_wString rtf_w_string(rtf_string);
  ...
  MYON_TextIterator iter(text_string);
  MYON_TextRunBuilder builder(*this, m__runs, dimstyle, dimstyle->TextHeight(), MYON_UNSET_COLOR);
  MYON_RtfParser parser(iter, builder);
  MYON_wString str;
  bool rc = parser.Parse();
  if (rc)
    rc = MYON_TextContent::MeasureTextContent(this, true, false);
  if (rc)
...
const MYON_wString MYON_TextContent::RichText() const
{
  return m_text;
}

const MYON_wString MYON_TextContent::RichTextFromRuns(MYON::RichTextStyle rich_text_style) const
{
  MYON_wString rich_text;
...
const MYON_wString MYON_TextContent::PlatformRichTextFromRuns() const
{
  return RichTextFromRuns(MYON::RichTextStyleFromCurrentPlatform());
}

const MYON_wString MYON_TextContent::PlainTextWithFields() const
{
  return Internal_GetPlainText(false, false);
}

const MYON_wString MYON_TextContent::PlainTextWithFields(MYON_SimpleArray<MYON_3dex>* runmap) const
{
  return Internal_GetPlainText(false, false, runmap);
}


const MYON_wString MYON_TextContent::PlainText() const
{
  return Internal_GetPlainText(true, false);
}

const MYON_wString MYON_TextContent::WrappedPlainTextWithFields() const
{
  return Internal_GetPlainText(false, true);
}


const MYON_wString MYON_TextContent::WrappedPlainText() const
{
...
MYON_SHA1_Hash MYON_TextRunArray::TextRunArrayContentHash() const
{
...
*/
MYON_SHA1_Hash MYON_TextRunArray::TextRunArrayContentHash(
...
) const
{
  ...
  {
    const MYON_TextRun* run = m_a[i];
    if (nullptr == run)
      continue;
    const MYON_SHA1_Hash run_hash = run->TextRunContentHash(bEvaluateFields);
    sha1.AccumulateSubHash(run_hash);
  }
  return sha1.Hash();
}

MYON_SHA1_Hash MYON_TextContent::TextContentHash() const
{
...
void MYON_TextContent::Internal_ClearTextContentHash() const
{
  m_text_content_sub_hash = MYON_SHA1_Hash::ZeroDigest;
  m_text_content_bbox_hash = MYON_SHA1_Hash::ZeroDigest;
  m_text_content_bbox = MYON_BoundingBox::EmptyBoundingBox;
}

MYON_SHA1_Hash MYON_TextContent::Internal_TextContentSubHash() const
{
  if (MYON_SHA1_Hash::ZeroDigest == m_text_content_sub_hash)
  {
    MYON_SHA1 sha1;
...
MYON_SHA1_Hash MYON_TextContent::TextContentHash(
    bool bApplyWrapping,
    bool bEvaluateFields
  ) const
{
  // At this point in time, runs are modified
  // without calling "set" functions on MYON_TextContent
  // so the sha1 needs to be calculated as follows:
  MYON_SHA1 sha1;

  // hash of information we can watch get changed.
  MYON_SHA1_Hash text_content_sub_hash = Internal_TextContentSubHash();
  ...
  // without calling an MYON_TextContent setter function.
  bool bRaw = (false == bApplyWrapping);
  const MYON_TextRunArray* runs = TextRuns(bRaw);
  const int run_count
    = (nullptr != runs)
    ? runs->Count()
    : 0;
...
const MYON_wString MYON_TextContent::Internal_GetPlainText(bool evaluate_fields, bool wrapped) const
{
  return Internal_GetPlainText(evaluate_fields, wrapped, nullptr);
}

const MYON_wString MYON_TextContent::Internal_GetPlainText(bool evaluate_fields, bool wrapped, MYON_SimpleArray<MYON_3dex>* runmap) const
{
  MYON_wString plaintext;
  MYON_TextRunArray* runs = TextRuns(!wrapped);
  if (nullptr == runs)
    return plaintext;
  if (nullptr != runmap)
    runmap->Empty();
  ...
  {
    MYON_TextRun* run = (*runs)[ri];
    if (0 != run)
    {
      if (MYON_TextRun::RunType::kText == run->Type() && 0 < nlcount)
        multiline = true;
      else if (MYON_TextRun::RunType::kNewline == run->Type() ||
        MYON_TextRun::RunType::kParagraph == run->Type())
        nlcount++;
      else if (wrapped && MYON_TextRun::RunType::kSoftreturn == run->Type())
        nlcount++;
    }
  }
  for (int ri = 0; ri < runcount; ri++)
  {
    ...
    {
      if (MYON_TextRun::RunType::kText == run->Type() ||
        MYON_TextRun::RunType::kField == run->Type())
      {
        ...
        if (nullptr != str)
        {
          if (nullptr != runmap)
          {
            MYON_3dex& map = runmap->AppendNew();
            map.i = ri;
      ...
      {
        if (MYON_TextRun::RunType::kNewline == run->Type() || MYON_TextRun::RunType::kParagraph == run->Type())
        {
          if (!wrapped)
            plaintext += L'\r';
          plaintext += L'\n';
...
{
  //if (fabs(plane.origin.DistanceTo(MYON_3dPoint::Origin)) > MYON_ZERO_TOLERANCE)
  //  bWrapped = bWrapped;
  MYON::AnnotationType alignment_annotation_type = MYON_TextContent::Internal_AlignmentAnnotationType(annotation_type);
  *this = MYON_TextContent::Empty;

  dimstyle = &MYON_DimStyle::DimStyleOrDefault(dimstyle);

  const double text_height = dimstyle->TextHeight();

  MYON::TextHorizontalAlignment h_align = MYON::TextHorizontalAlignment::Center;
  MYON::TextVerticalAlignment v_align = MYON::TextVerticalAlignment::Middle;

  switch (alignment_annotation_type)
  {
  case MYON::AnnotationType::Leader:
    h_align = dimstyle->LeaderTextHorizontalAlignment();
    v_align = dimstyle->LeaderTextVerticalAlignment();
    break;
  case MYON::AnnotationType::Text:
    h_align = dimstyle->TextHorizontalAlignment();
    v_align = dimstyle->TextVerticalAlignment();
    break;
  case MYON::AnnotationType::Diameter:
  case MYON::AnnotationType::Radius:
    h_align = dimstyle->LeaderTextHorizontalAlignment();
    v_align = MYON::TextVerticalAlignment::MiddleOfTop; //dimstyle->LeaderTextVerticalAlignment();
    break;
  default:
    break;
  }
  ...
  m_rect_width
    = (rect_width > 0.0 && rect_width < MYON_TextContent::Empty.FormattingRectangleWidth())
    ? rect_width
    : 0.0;
  m_rotation_radians
    = (text_rotation_radians > -2.0*MYON_PI && text_rotation_radians < 2.0*MYON_PI)
    ? text_rotation_radians
    : 0.0;
...
bool MYON_TextContent::ReplaceTextString(
  const wchar_t* RtfString,
  MYON::AnnotationType annotation_type,
  const MYON_DimStyle* dimstyle
)
{
  if (annotation_type == MYON::AnnotationType::Unset)
    MYON_ERROR("Annotation type should not be Unset here\n");
  Internal_Destroy();
  bool rc = Create(RtfString, annotation_type, dimstyle, m_bWrapText, m_rect_width, m_rotation_radians);
  return rc;
}

bool MYON_TextContent::RebuildRuns(
  MYON::AnnotationType annotation_type,
  const MYON_DimStyle* dimstyle
)
{
  MYON_wString rtfstring = RtfText();
  Internal_Destroy();
  bool rc = Create(rtfstring, annotation_type, dimstyle, m_bWrapText, m_rect_width, m_rotation_radians);
  return rc;
}
...
bool MYON_TextContent::RunReplaceString(
  ...
  int end_run_pos)
{
  if (nullptr == repl_str)
    repl_str = L"";
  const MYON_TextRunArray* text_runs = TextRuns(true);
  if (nullptr == text_runs)
    return false;
  if (0 > start_run_idx || 0 > start_run_pos || start_run_idx > end_run_idx || end_run_idx >= text_runs->Count())
    return false;
  const MYON_TextRun* start_run = (*text_runs)[start_run_idx];
  const MYON_TextRun* end_run = (*text_runs)[end_run_idx];
  if (nullptr == start_run || nullptr == end_run)
    return false;
  if (start_run->Type() != MYON_TextRun::RunType::kText && start_run->Type() != MYON_TextRun::RunType::kField)
    return false;
  if (end_run->Type() != MYON_TextRun::RunType::kText && end_run->Type() != MYON_TextRun::RunType::kField)
    return false;
  MYON_wString start_run_string = start_run->TextString();
  MYON_wString end_run_string = end_run->TextString();
  ...
  MYON__UINT32* cp = nullptr;
  int cpcount = MYON_TextContext::ConvertStringToCodepoints(new_string, cp);

  MYON_TextContent* new_text_content = Duplicate();
  MYON_TextRunArray* new_text_runs = new_text_content->TextRuns(true);
  MYON_TextRun* new_start_run = MYON_TextRun::GetManagedTextRun(*(*text_runs)[start_run_idx]);
  ...
  if (end_run_idx > start_run_idx)
  {
    if (end_run_pos < end_string_length - 1)
    {
      ...
      MYON_TextRun* new_end_run = MYON_TextRun::GetManagedTextRun(*(*text_runs)[end_run_idx]);

      cp = nullptr;
      cpcount = MYON_TextContext::ConvertStringToCodepoints(new_string, cp);
...
void MYON_TextContent::Internal_SetRunTextHeight(double height)
{
  ...
  MYON_TextContent::MeasureTextContent(this, true, false);
  if (wrapped)
    WrapText(w);
}


MYON::TextHorizontalAlignment MYON_TextContent::RuntimeHorizontalAlignment() const
{
  return m_runtime_halign;
}

void MYON_TextContent::SetRuntimeHorizontalAlignment(MYON::TextHorizontalAlignment halign) const
{
  m_runtime_halign = halign;
}

void MYON_TextContent::GetAlignment(MYON::TextHorizontalAlignment& horz, MYON::TextVerticalAlignment& vert) const
{
  horz = m_h_align;
  vert = m_v_align;
}

void MYON_TextContent::SetAlignment(
  MYON::TextHorizontalAlignment horz,
  MYON::TextVerticalAlignment vert
)
{
  if (vert != m_v_align)
  {
...
double MYON_TextContent::FormattingRectangleWidth() const
{
  return m_rect_width;
}

void MYON_TextContent::SetFormattingRectangleWidth(double width)
{
  if (MYON_IsValid(width) && !isnan(width))
  {
    m_rect_width = width;
  }
}

double MYON_TextContent::TextRotationRadians() const
{
  return m_rotation_radians;
}

void MYON_TextContent::SetTextRotationRadians(double rotation)
{
  if (MYON_IsValid(rotation) && !isnan(rotation))
  {
    double twopi = MYON_PI * 2.0;
...
double MYON_TextContent::TextRotationDegrees() const
{
  return TextRotationRadians() * MYON_RADIANS_TO_DEGREES;
}

void MYON_TextContent::SetTextRotationDegrees(double rotation)
{
  SetTextRotationRadians(rotation * MYON_DEGREES_TO_RADIANS);
}

unsigned int MYON_TextContent::EvaluationSerialNumber() const
{
  return m_run_evaluation_sn;
}

void MYON_TextContent::SetEvaluationSerialNumber(unsigned int sn) const
{
  m_run_evaluation_sn = sn;
}

// This realigns from current horizontal alignment to new horizontal alignment
static void RealignTextRunArray(MYON_TextRunArray& runs, MYON::TextHorizontalAlignment current_h_align, MYON::TextHorizontalAlignment new_h_align)
{
  if (current_h_align != new_h_align)
  {
    ...
    for (int i = 0; i < runcount; i++)
    {
      MYON_TextRun* run = runs[i];
      if (nullptr != run)
      {
        const MYON_BoundingBox& box = run->BoundingBox();
        double w = box.m_max.x - box.m_min.x;
        if (w > dx)
          dx = w;
      }
    }
    if (MYON::TextHorizontalAlignment::Left == current_h_align)
    {
      if (MYON::TextHorizontalAlignment::Center == new_h_align)
        dx = -dx / 2.0;
      else if (MYON::TextHorizontalAlignment::Right == new_h_align)
        dx = -dx;
    }
    else if (MYON::TextHorizontalAlignment::Center == current_h_align)
    {
      if (MYON::TextHorizontalAlignment::Left == new_h_align)
        dx = dx / 2.0;
      else if (MYON::TextHorizontalAlignment::Right == new_h_align)
        dx = -dx / 2.0;
    }
    else if (MYON::TextHorizontalAlignment::Right == current_h_align)
    {
#if defined(MYON_DEBUG) && defined(MYON_COMPILER_MSC)
      if (MYON::TextHorizontalAlignment::Left == new_h_align)
    ...
    for (int i = 0; i < runcount; i++)
    {
      ...
      if (nullptr != run)
      {
        MYON_2dVector o = run->Offset();
        o.x += dx;
        run->SetOffset(o);
        //MYON_BoundingBox box = run->BoundingBox();
        //MYON_2dPoint p0 = box.m_min;
        //MYON_2dPoint p1 = box.m_max;
        //p0.x += dx;  
        //p1.x += dx;
...
void MYON_TextContent::RealignTextRuns(MYON::TextHorizontalAlignment new_h_align)
{
...
bool MYON_TextContent::HasWrappedRuns() const
{
  return (nullptr != m__wrapped_runs && m__wrapped_runs->Count() > 0);
}

bool MYON_TextContent::TextIsWrapped() const
{
  return (m_bWrapText);
}

void MYON_TextContent::SetTextIsWrapped(bool wrapped)
{
...
bool MYON_TextContent::WrapText(double wrapwidth) const
{
  bool rc = false;
  Internal_DeleteWrappedRuns();
  Internal_ClearTextContentHash();
  ...
  {
    m__wrapped_runs = new MYON_TextRunArray;
    if (nullptr != m__wrapped_runs)
    {
      int newcount = 0;
      int runcount = m__runs.Count();
      ...
      {
        const_cast<MYON_TextContent*>(this)->SetTextIsWrapped(true);
        rc = MYON_TextContent::MeasureTextContent(const_cast<MYON_TextContent*>(this), false, true);
      }
      else
      {
        delete m__wrapped_runs;
...
// virtual
void MYON_TextContent::Dump(MYON_TextLog& text_log) const // for debugging
{}

bool MYON_TextContent::Write(
...
//#define CREATE_MISSING_FONT_TEST_3DM_FILE
      ...
      if (m_text.Length() > 7 && MYON_wString::EqualOrdinal( L"{\\rtf1\\", 7, static_cast<const wchar_t*>(m_text), 7, false) )
      {
        ...
        const MYON_wString MISSING_FONT_TEST_valid_font_rtf_name(L" Courier New;}");
        if (m_text.Find(static_cast<const wchar_t*>(MISSING_FONT_TEST_valid_font_rtf_name)))
        {
          const MYON_wString missing_font_rtf_name(L" Missing Font Test;}");
          MYON_wString modified_text(static_cast<const wchar_t*>(m_text));
    ...
    if (!archive.WritePlane(MYON_Plane::World_xy))
      break;
  ...
  *this = MYON_TextContent::Empty;
  ...
  for (;;)
  {
    ...
    if (!archive.ReadInt(&u))
      break;
    m_h_align = MYON::TextHorizontalAlignmentFromUnsigned(u);
    u = static_cast<unsigned int>(m_v_align);
    if (!archive.ReadInt(&u))
      break;
    m_v_align = MYON::TextVerticalAlignmentFromUnsigned(u);
...
int MYON_TextContent::Dimension() const
{
  return 3;
}


const MYON_BoundingBox MYON_TextContent::TextContentBoundingBox() const
{
  MYON_TextRunArray* runs = const_cast<MYON_TextContent*>(this)->TextRuns(false);
  const int run_count
    = (nullptr != runs)
    ? runs->Count()
    : 0;
  ...
  const MYON_SHA1_Hash text_content_hash = TextContentHash();
  if (
  ...
  for (int i = 0; i < run_count; i++)
  {
    ...
    {
      MYON_BoundingBox runbox = run->BoundingBox();
      if (false == runbox.IsValid())
        continue;

      const MYON_2dVector& runoffset = run->Offset();
...
) const
{
  ...
  const MYON_BoundingBox text_content_bbox = TextContentBoundingBox();
...
void MYON_TextContent::ClearBoundingBox()
{
  Internal_ClearTextContentHash();
}

static void ScaleTextRunHeight(MYON_TextRun* run, double htscale)
{
  if (0 == run)
    return;
  ...
  MYON_BoundingBox box = run->BoundingBox();
  run->SetBoundingBox(MYON_2dPoint(box.m_min.x * htscale, box.m_min.y * htscale), MYON_2dPoint(box.m_max.x * htscale, box.m_max.y * htscale));


}

bool MYON_TextContent::Transform(const MYON_Xform& xform)
{
  MYON_ERROR("DARN! - wish we never called this function.");
  TransformUserData(xform);

  int runcount = m__runs.Count();

  MYON_3dVector ht(0.0, 1.0, 0.0);
  ht.Transform(xform);
  double r = ht.Length();
  ...
  if (MYON_ZERO_TOLERANCE < fabs(1.0 - r) && MYON_ZERO_TOLERANCE < l)
  {
    //run_text_height = l;
...
bool MYON_TextContent::GetRun3dCorners(const MYON_TextRun* run, MYON_3dPoint corners[4]) const
{
  if (nullptr == corners)
    return false;
  if (nullptr == run)
  ...
  const MYON_2dVector offset = run->Offset();
  const MYON_BoundingBox run_bbox = run->BoundingBox();

  corners[0] = MYON_Plane::World_xy.PointAt(run_bbox.m_min.x + offset.x, run_bbox.m_min.y + offset.y);
  corners[1] = MYON_Plane::World_xy.PointAt(run_bbox.m_max.x + offset.x, run_bbox.m_min.y + offset.y);
  corners[2] = MYON_Plane::World_xy.PointAt(run_bbox.m_max.x + offset.x, run_bbox.m_max.y + offset.y);
  corners[3] = MYON_Plane::World_xy.PointAt(run_bbox.m_min.x + offset.x, run_bbox.m_max.y + offset.y);

  return true;
}


MYON_Mesh* MYON_TextContent::Get2dPickMesh() const
{
  ...
  MYON_Mesh* mesh = new MYON_Mesh(runcount, 4 * runcount, false, false);
  if (nullptr == mesh)
    return nullptr;
  ...
  for (int ri = 0; ri < runcount; ri++)
  {
    ...
    if (nullptr == run || MYON_TextRun::RunType::kText != run->Type())
      continue;
...
MYON_Mesh* MYON_TextContent::Get3dPickMesh() const
{
  MYON_Mesh* mesh = Get2dPickMesh();
  return mesh;
}

MYON_Mesh* MYON_TextContent::Get3dMaskPickMesh(double maskoffset) const
{
  MYON_3dPoint corners[4];
  if (Get3dMaskCorners(maskoffset, corners))
  {
    MYON_Mesh* mesh = new MYON_Mesh(1, 4, false, false);
    if (nullptr != mesh)
    {
...
bool MYON_TextContent::Get2dSize(bool raw, double& width, double& height) const
{
  MYON_2dPoint corners[4];
  const MYON_TextRunArray* runs = TextRuns(raw);
...
bool MYON_TextContent::Get2dCorners
(MYON_2dPoint corners[4]) const
{
  if (nullptr == corners)
    return false;
  const MYON_TextRunArray* runs = TextRuns(false);
...
bool MYON_TextContent::Get3dCorners(MYON_3dPoint corners[4]) const
{
  if (nullptr == corners)
    return false;
  bool rc = false;  MYON_2dPoint corners2d[4];
  if (Get2dCorners(corners2d))
  {
    corners[0] = MYON_Plane::World_xy.PointAt(corners2d[0].x, corners2d[0].y);
    corners[1] = MYON_Plane::World_xy.PointAt(corners2d[1].x, corners2d[1].y);
    corners[2] = MYON_Plane::World_xy.PointAt(corners2d[2].x, corners2d[2].y);
    corners[3] = MYON_Plane::World_xy.PointAt(corners2d[3].x, corners2d[3].y);
    rc = true;
  }
  return rc;
}

bool MYON_TextContent::Get3dMaskCorners(double border, MYON_3dPoint corners[4]) const
{
  if (nullptr == corners)
    return false;
  bool rc = false;
  MYON_2dPoint corners2d[4];
  if (Get2dCorners(corners2d))
  {
    corners[0] = MYON_Plane::World_xy.PointAt(corners2d[0].x - border, corners2d[0].y - border);
    corners[1] = MYON_Plane::World_xy.PointAt(corners2d[1].x + border, corners2d[1].y - border);
    corners[2] = MYON_Plane::World_xy.PointAt(corners2d[2].x + border, corners2d[2].y + border);
    corners[3] = MYON_Plane::World_xy.PointAt(corners2d[3].x - border, corners2d[3].y + border);
    rc = true;
  }
  return rc;
}

bool MYON_TextContent::Get3dUnderline(MYON_3dPoint ends[2], double scaled_gap) const
{
  if (nullptr == ends)
    return false;
  bool rc = false;
  ...
  if (Get2dCorners(corners2d))
  {
    ends[0] = MYON_Plane::World_xy.PointAt(corners2d[0].x, corners2d[0].y - scaled_gap);
    ends[1] = MYON_Plane::World_xy.PointAt(corners2d[1].x, corners2d[1].y - scaled_gap);
    rc = true;
  }
  return rc;
}
...
void MYON_TextContent::GetGripPoints(MYON_2dPoint& base, MYON_2dPoint& width) const
{
  MYON_2dPoint p[4];
  base.Set(0.0, 0.0);
  width.Set(0.0, 1.0);
  ...
  switch (m_h_align)
  {
  default: //case MYON::TextHorizontalAlignment::Left:
  {
    width = (p[1] + p[2]) / 2.0;
    switch (m_v_align)
    {
    default: //case MYON::TextVerticalAlignment::Bottom:
      base = p[0];
      break;
...
//static
int MYON_TextContent::FindAndStackFractions(MYON_TextRunArray* runs, int i, MYON_wString wstr)
{
  if (nullptr == runs || 0 > i || runs->Count() - 1 < i
    || wstr.IsEmpty() || MYON_TextRun::RunType::kText != (*runs)[i]->Type())
    return 0;
  ...
  while (0 <= start && !wstr.IsEmpty())
  {
    ...
    if (0 <= delim)
    {
      ...
      if (0 <= end)
      {
        ...
        if (0 < start)
        {
          MYON_wString startstr = wstr.Left(start);
          run->SetDisplayString(startstr);
        }

        MYON_TextRun* stackedrun = MYON_TextRun::GetManagedTextRun();
        *stackedrun = *run;
        MYON_wString str = wstr.Left(end).Right(end - start - 2);
        stackedrun->SetStacked(MYON_TextRun::Stacked::kStacked);
        stackedrun->SetDisplayString(str);
        MYON__UINT32* cp = nullptr;
        int cpcount = MYON_TextContext::ConvertStringToCodepoints(str, cp);
        MYON_TextContent::CreateStackedText(stackedrun, cpcount, cp);
        stackedrun->SetType(MYON_TextRun::RunType::kField);
        ...
        if (!wstr.IsEmpty())
        {
          ...
          {
            // no more fractions
            MYON_TextRun* endrun = MYON_TextRun::GetManagedTextRun();
            *endrun = *run;
            endrun->SetDisplayString(wstr);
            endrun->SetType(MYON_TextRun::RunType::kField);
...
bool MYON_TextContent::CreateStackedText(MYON_TextRun* run)
{

  int cpcount = (int)run->CodepointCount(run->UnicodeString());
  const MYON__UINT32* cp = run->UnicodeString();
  return MYON_TextContent::CreateStackedText(run, cpcount, cp);

}

bool MYON_TextContent::CreateStackedText(MYON_TextRun* run, int cpcount, const MYON__UINT32* cp, MYON__UINT32 stack_delimiter)
{
  if (0 == run)
    return false;
  ...
  if (MYON_TextRun::RunType::kText != run->Type() && MYON_TextRun::RunType::kField != run->Type())
    return false;
  const MYON_TextRun::Stacked stacked = run->IsStacked();
  if (MYON_TextRun::Stacked::kNone == stacked)
    return false;

  const MYON_Font* font = run->Font();
  if (nullptr == font)
    return false;
  // Make 2 runs for the top and bottom of the stack
  MYON_TextRun* top_run = nullptr;
  MYON_TextRun* bottom_run = nullptr;
  if (nullptr != run->m_stacked_text)
  {
    if (nullptr != run->m_stacked_text->m_top_run)
    {
      *run->m_stacked_text->m_top_run = MYON_TextRun::Empty;
    }
    if (nullptr != run->m_stacked_text->m_bottom_run)
    {
      *run->m_stacked_text->m_bottom_run = MYON_TextRun::Empty;
    }
    stack_delimiter = run->m_stacked_text->m_separator;
  }
  if (nullptr == top_run)
    top_run = MYON_TextRun::GetManagedTextRun();
  if (nullptr == bottom_run)
    bottom_run = MYON_TextRun::GetManagedTextRun();

  *top_run = *run;
  *bottom_run = *run;
  top_run->SetStacked(MYON_TextRun::Stacked::kNone);
  bottom_run->SetStacked(MYON_TextRun::Stacked::kNone);
  ...
  //int cpcount = (int)run->CodepointCount(run->UnicodeString());
  //const MYON__UINT32* cp = run->UnicodeString();
  if (MYON_TextRun::Stacked::kTop == stacked)
  {
    top_len = cpcount;
  }
  else if (MYON_TextRun::Stacked::kBottom == stacked)
  {
    top_len = 0;
  }
  else
  ...
  if (MYON_TextRun::Stacked::kTop == stacked || MYON_TextRun::Stacked::kStacked == stacked)
    top_run->SetUnicodeString(top_len, cp);
  if (MYON_TextRun::Stacked::kBottom == stacked)
    bottom_run->SetUnicodeString(cpcount, cp);
  if (MYON_TextRun::Stacked::kStacked == stacked)
    bottom_run->SetUnicodeString(cpcount - top_len - 1, cp + top_len + 1);
  top_run->TextString();
  bottom_run->TextString();

  const MYON_FontMetrics& fm = font->FontMetrics();
  ...
  //MYON_BoundingBox top_box = top_run->BoundingBox();
  //MYON_BoundingBox bottom_box = bottom_run->BoundingBox();
  ...
  MYON_2dPoint box[2];  // total stacked run bounding box
  ...
  if (nullptr == run->m_stacked_text)
    run->m_stacked_text = new MYON_StackedText;
...
MYON_SHA1_Hash MYON_TextContent::DimStyleTextPositionPropertiesHash() const
{
  return m_dimstyle_text_position_properties_hash;
}

MYON::AnnotationType MYON_TextContent::Internal_AlignmentAnnotationType(
  MYON::AnnotationType annotation_type
)
{
...
bool MYON_TextContent::EqualTextPositionProperties(
  MYON::AnnotationType annotation_type,
  const class MYON_DimStyle* dimstyle
) const
{
  return (
    MYON_TextContent::Internal_AlignmentAnnotationType(m_annotation_type) == MYON_TextContent::Internal_AlignmentAnnotationType(annotation_type)
    && m_dimstyle_text_position_properties_hash == MYON_DimStyle::DimStyleOrDefault(dimstyle).TextPositionPropertiesHash()
    );
}


MYON_TextRunArray* MYON_TextContent::TextRuns(bool bRaw) const
{
...
const wchar_t* MYON_TextContent::RtfText() const
{
  return m_text;
}

const MYON_Font& MYON_TextContent::DefaultFont() const
{
...
bool MYON_TextContent::ComposeText()
{
  MYON_wString rtf;
  MYON_wString nothing;
...
// static
bool MYON_TextContent::MeasureTextRun(MYON_TextRun* run)
{
  if (0 == run)
    return false;
  ...
  const int line_count = MYON_FontGlyph::GetGlyphListBoundingBox(run->DisplayString(), font, text_box);
  bool rc = (line_count > 0 && text_box.IsSet());
  if (line_count == 0 && MYON_TextRun::RunType::kText == run->Type())
    run->SetBoundingBox(MYON_2dPoint(0,0), MYON_2dPoint(0,0));
  ...
  if (rc)
  {
    ...
    MYON_Xform scale_xform(MYON_Xform::DiagonalTransformation(height_scale));

    MYON_2dPoint minpt(text_box.m_bbmin.i, text_box.m_bbmin.j), maxpt(text_box.m_bbmax.i, text_box.m_bbmax.j);
    MYON_2dVector advance(text_box.m_advance.i, text_box.m_advance.j);
    minpt.Transform(scale_xform);
    maxpt.Transform(scale_xform);
    advance.Transform(scale_xform);
    // Store bbox and advance on MYON_TextRun in Model units not scaled by annotation scale
    if (MYON_TextRun::RunType::kText == run->Type())
...
double MYON_TextContent::GetLinefeedHeight(MYON_TextRun& run)
{
  double lfht = MYON_FontMetrics::DefaultLineFeedRatio; // (1.6)
  if (nullptr != run.Font())
  {
    ...
    const double legacy_lfht = MYON_FontMetrics::DefaultLineFeedRatio * text_height;
    ...
    //
    const MYON_FontMetrics& fm = run.m_managed_font->FontMetrics();
    ...
    if (!(lfht == legacy_lfht))
      MYON_TextLog::Null.Print(L"Break");
  }
...
static void SetLineOffsets(const MYON_TextRunArray* runs, int ri, int ri0, MYON::TextHorizontalAlignment h_align, double max_line_width, MYON_2dVector offset)
{
  if (nullptr == runs)
    return;
  ...
  if (h_align == MYON::TextHorizontalAlignment::Right)
    osx = max_line_width - width;
  else if (h_align == MYON::TextHorizontalAlignment::Center)
  ...
  for (int i = ri0; i < ri; i++)
  {
    if (i == ri0)
      offset.x += osx;
    MYON_TextRun* text_run = const_cast<MYON_TextRun*>(runs->operator[](i));
    if (nullptr != text_run)
    {
...
//static
bool MYON_TextContent::MeasureTextContent(MYON_TextContent* text, bool raw, bool wrapped)
{
  if (0 == text)
    return false;
  if (!raw && !wrapped)
  ...
  MYON_TextRunArray* runs = nullptr;
  if (raw)
  {
    runs = text->TextRuns(true);
    if (nullptr != runs)
      rc0 = MYON_TextContent::MeasureTextRunArray(runs, text->m_v_align, text->m_h_align);
  }

  if (wrapped)
  {
    MYON_TextRunArray* wruns = text->TextRuns(false);

    if (nullptr != wruns && wruns != runs)
      rc1 = MYON_TextContent::MeasureTextRunArray(wruns, text->m_v_align, text->m_h_align);
  }
...
//static
bool MYON_TextContent::MeasureTextRunArray(
  ...
  MYON::TextHorizontalAlignment h_align)
{
  ...
  int line_index = 0;
  MYON_2dPoint bbmin(1e300, 1e300), bbmax(-1e300, -1e300);
  ...
  MYON_2dPoint current_point(0.0, 0.0);
  //double os_width = 0.0;
  MYON_TextRun* last_text_run = 0;
  ...
  for (int ri = 0; rc && ri < run_count; ri++)
  {
    ...
    if (0 != run)
    {
      ...
      run->SetOffset(MYON_2dVector(0.0, 0.0));
      if (MYON_TextRun::RunType::kNewline == run->Type() ||
        MYON_TextRun::RunType::kSoftreturn == run->Type() ||
        MYON_TextRun::RunType::kParagraph == run->Type())
      {
        ...
        double lfh = MYON_TextContent::GetLinefeedHeight(*run);
        ...
        run->SetAdvance(MYON_2dVector(0.0, -y));
      ...
      else if (MYON_TextRun::RunType::kText == run->Type())
      {
        if (run->IsStacked() != MYON_TextRun::Stacked::kNone)
        {
          MYON_TextContent::CreateStackedText(run);
        }
        else
        {
          // MeasureTextRun() sets Run Bounding Box and Advance
          MYON_TextContent::MeasureTextRun(run);
        }
  ...
  if (v_align == MYON::TextVerticalAlignment::Top)
    osy = -max_line_height;
  else if (v_align == MYON::TextVerticalAlignment::Bottom)
    osy = total_height - linefeed_height;
  else if (v_align == MYON::TextVerticalAlignment::Middle)
  ...
  for (int ri = 0; rc && ri < run_count; ri++)
  {
    ...
    if (0 != run) // && run->Type() == kText
    {
      ...
      o.y += osy;
      run->SetOffset(o);
      if (run->IsStacked() != MYON_TextRun::Stacked::kNone && run->m_stacked_text)
      {
        MYON_TextRun* srun = run->m_stacked_text->m_top_run;
        if (srun)
        {
          MYON_2dVector V(o);
          MYON_2dVector sro = srun->Offset();
          V.x += sro.x;
          V.y += sro.y;
          srun->SetOffset(V);
        }
...
bool MYON_TextContent::FormatTolerance(
  double distance,
...
{
  MYON_wString sDist;
#ifndef MYON_TEXT_BRACKET_FRACTION  // Stacked fraction bracket
  ...
  const MYON::LengthUnitSystem dim_us
    = alt
    ? dimstyle->AlternateDimensionLengthDisplayUnit(0)
    : dimstyle->DimensionLengthDisplayUnit(0);

  bool bracket_stack_frac = MYON_DimStyle::stack_format::None != dimstyle->StackFractionFormat();
  MYON_DimStyle::tolerance_format tolstyle = dimstyle->ToleranceFormat();

  int tolprecision = alt ? dimstyle->AlternateToleranceResolution() : dimstyle->ToleranceResolution();
  MYON_DimStyle::suppress_zero zs = alt ? dimstyle->AlternateZeroSuppress() : dimstyle->ZeroSuppress();


  double length_factor = 1.0; // dimstyle->LengthFactor();  RH-63775
  double unit_length_factor = MYON::UnitScale(units_in, dim_us);
  ...
  case MYON_DimStyle::tolerance_format::Symmetrical:
  {
    ...
    if (MYON_TextContent::FormatLength(tol_uv, dim_length_display, 0.0, tolprecision, zs, bracket_stack_frac, decimal_char, sTol))
    {
      formatted_string += MYON_wString::PlusMinusSymbol;
  ...
  case MYON_DimStyle::tolerance_format::Deviation:
  {
    ...
    wchar_t decimal_char = dimstyle->DecimalSeparator();
    MYON_wString sTol_uv, sTol_lv;
    // Can't use stacked fractions in tolerances because run stacking isn't recursive in MYON_Text
    if (MYON_TextContent::FormatLength(tol_uv, dim_length_display, 0.0, tolprecision, zs, false, decimal_char, sTol_uv) &&
      MYON_TextContent::FormatLength(tol_lv, dim_length_display, 0.0, tolprecision, zs, false, decimal_char, sTol_lv))
    {
      formatted_string += L" [[";
      formatted_string += L"|";
  ...
  case MYON_DimStyle::tolerance_format::Limits:
  {
    ...
    wchar_t decimal_char = dimstyle->DecimalSeparator();
    MYON_wString sDist_u, sDist_l;
    // Can't use stacked fractions in tolerances because run stacking isn't recursive in MYON_Text
    if (MYON_TextContent::FormatLength(tol_uv, dim_length_display, 0.0, tolprecision, zs, false, decimal_char, sDist_u) &&
      MYON_TextContent::FormatLength(tol_lv, dim_length_display, 0.0, tolprecision, zs, false, decimal_char, sDist_l))
    {
      formatted_string += L" [[";
      formatted_string += L"|";
...
bool MYON_TextContent::FormatDistance(
  double distance_in,
  MYON::LengthUnitSystem units_in,
  const MYON_DimStyle* dimstyle,
  bool alt,
  MYON_wString& formatted_string)
{
  ...
  wchar_t decimal_char = dimstyle->DecimalSeparator();
  MYON_TextContent::FormatLength(distance, dim_length_display, roundoff, precision, zs, bracket_stack_frac, decimal_char, formatted_string);
  return true;
}


bool MYON_TextContent::FormatDistanceAndTolerance(
  double distance_in,
  MYON::LengthUnitSystem units_in,
  const MYON_DimStyle* dimstyle,
  bool alt,
  MYON_wString& formatted_string)
{
  if (MYON_DimStyle::tolerance_format::Limits != dimstyle->ToleranceFormat())
    MYON_TextContent::FormatDistance(distance_in, units_in, dimstyle, alt, formatted_string);
  if (MYON_DimStyle::tolerance_format::None != dimstyle->ToleranceFormat())
    MYON_TextContent::FormatTolerance(distance_in, units_in, dimstyle, alt, formatted_string);
...
// static
bool MYON_TextContent::FormatDistanceMeasurement(
  double distance_in,
  MYON::LengthUnitSystem units_in,
  const MYON_DimStyle* dimstyle,
  ...
  MYON_wString& formatted_string)     // Output
{
  ...
  if (nullptr == user_text || 0 == user_text[0])
    user_text = L"<>";
  MYON_wString user_string(user_text);
  ...
  else // no "<>" in the string
  {
    ...
    MYON_TextContent::FormatTolerance(distance_in, units_in, dimstyle, false, formatted_string);
...
// static
bool MYON_TextContent::FormatAngleMeasurement(
  ...
  else
  {
    ...
    for (int i = 0; i < len; i++)
    {
      if (i == cpi)
      {
        ...
        if (MYON_DimStyle::angle_format::DecimalDegrees == dimstyle->AngleFormat() ||
          MYON_DimStyle::angle_format::Radians == dimstyle->AngleFormat() ||
          MYON_DimStyle::angle_format::Grads == dimstyle->AngleFormat())
        {
          double angle = angle_radians;
          if (MYON_DimStyle::angle_format::DecimalDegrees == dimstyle->AngleFormat())
            angle = MYON_RADIANS_TO_DEGREES * angle_radians;
          else if (MYON_DimStyle::angle_format::Grads == dimstyle->AngleFormat())
            angle = angle_radians * 200.0 / MYON_PI;

          double roundoff = dimstyle->AngleRoundOff();
          int resolution = dimstyle->AngleResolution();
          MYON_DimStyle::suppress_zero suppress = dimstyle->AngleZeroSuppress();

          wchar_t decimal_char = dimstyle->DecimalSeparator();
          MYON_TextContent::FormatAngleStringDecimal(angle, resolution, roundoff, suppress, decimal_char, sAngle);
          if (MYON_DimStyle::angle_format::DecimalDegrees == dimstyle->AngleFormat())
            sAngle += MYON_wString::DegreeSymbol;
          else if (MYON_DimStyle::angle_format::Radians == dimstyle->AngleFormat())
            sAngle += L'r';
          else if (MYON_DimStyle::angle_format::Grads == dimstyle->AngleFormat())
            sAngle += L'g';
        }
        else if (MYON_DimStyle::angle_format::DegMinSec == dimstyle->AngleFormat())
        {
          wchar_t decimal_char = dimstyle->DecimalSeparator();
          int resolution = dimstyle->AngleResolution();
          MYON_TextContent::FormatAngleStringDMS(angle_radians, decimal_char, resolution, sAngle);
        }
...
bool MYON_TextContent::FormatLength(
  double distance,
  ...
  MYON_wString & output)
{
  bool rc = MYON_NumberFormatter::FormatLength( distance, output_lengthdisplay,  round_off,  resolution, zero_suppress,  bracket_fractions, output);
  if (rc && MYON_wString::DecimalAsPeriod != decimal_char)
    output.Replace(MYON_wString::DecimalAsPeriod, decimal_char);
  return rc;
}

bool MYON_TextContent::FormatAngleStringDMS(
  double angle_degrees,
  wchar_t decimal_char,
  MYON_wString& formatted_string)
{
  return MYON_TextContent::FormatAngleStringDMS(angle_degrees, decimal_char, 2, formatted_string);
}
...
bool MYON_TextContent::FormatAngleStringDMS(
  ...
  MYON_wString& formatted_string)
{
  bool rc = MYON_NumberFormatter::FormatAngleStringDMS(angle_degrees, resolution, formatted_string);
  if (rc && MYON_wString::DecimalAsPeriod != decimal_char)
    formatted_string.Replace(MYON_wString::DecimalAsPeriod, decimal_char);
  return rc;
}

bool MYON_TextContent::FormatAngleStringDecimal(
  double angle_radians,
  int resolution,
  double roundoff,
  ...
  MYON_wString& formatted_string)
{
  bool rc = MYON_NumberFormatter::FormatAngleStringDecimal(angle_radians, resolution, roundoff, zero_suppression, formatted_string);
  if (rc && MYON_wString::DecimalAsPeriod != decimal_char)
    formatted_string.Replace(MYON_wString::DecimalAsPeriod, decimal_char);
  return rc;
}

bool MYON_TextContent::FormatArea(
  double area_in,
  MYON::LengthUnitSystem units_in,
  const MYON_DimStyle* dimstyle,
  bool alt,
  MYON_wString& formatted_string)
{
  return MYON_TextContent::FormatAreaOrVolume(area_in, true, units_in, dimstyle, alt, formatted_string);
}

bool MYON_TextContent::FormatVolume(
  double volume_in,
  MYON::LengthUnitSystem units_in,
  const MYON_DimStyle* dimstyle,
  bool alt,
  MYON_wString& formatted_string)
{
  return MYON_TextContent::FormatAreaOrVolume(volume_in, false, units_in, dimstyle, alt, formatted_string);
}

bool MYON_TextContent::FormatAreaOrVolume(
  ...
  MYON_wString& formatted_string)
{
  ...
  MYON_DimStyle::OBSOLETE_length_format output_format = MYON_DimStyle::OBSOLETE_length_format::Decimal;

  bool rc = MYON_NumberFormatter::FormatNumber(
    value,
    output_format,
    roundoff,
    precision,
...
MYON::TextVerticalAlignment MYON::TextVerticalAlignmentFromUnsigned(
  unsigned int vertical_alignment_as_unsigned
)
{
  switch (vertical_alignment_as_unsigned)
  {
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextVerticalAlignment::Top);
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextVerticalAlignment::MiddleOfTop);
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextVerticalAlignment::BottomOfTop);
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextVerticalAlignment::Middle);
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextVerticalAlignment::MiddleOfBottom);
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextVerticalAlignment::Bottom);
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextVerticalAlignment::BottomOfBoundingBox);
  }
  MYON_ERROR("invalid vertical_alignment_as_unsigned parameter.");
  return (MYON::TextVerticalAlignment::Top);
}

MYON::TextHorizontalAlignment MYON::TextHorizontalAlignmentFromUnsigned(
  unsigned int horizontal_alignment_as_unsigned
)
{
  switch (horizontal_alignment_as_unsigned)
  {
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextHorizontalAlignment::Left);
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextHorizontalAlignment::Center);
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextHorizontalAlignment::Right);
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextHorizontalAlignment::Auto);
  }
  MYON_ERROR("invalid vertical_alignment_as_unsigned parameter.");
  return (MYON::TextHorizontalAlignment::Left);
}

MYON::TextOrientation MYON::TextOrientationFromUnsigned(
  unsigned int orientation_as_unsigned
)
{
  switch (orientation_as_unsigned)
  {
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextOrientation::InPlane);
    MYON_ENUM_FROM_UNSIGNED_CASE(MYON::TextOrientation::InView);
  }
  MYON_ERROR("invalid orientation_as_unsigned parameter.");
  return (MYON::TextOrientation::InPlane);
}
