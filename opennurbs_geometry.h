...
//
class MYON_CLASS MYON_Geometry : public MYON_Object
{
  // Any object derived from MYON_Geometry should have a
  //   MYON_OBJECT_DECLARE(MYON_...);
  // as the last line of its class definition and a
  //   MYON_OBJECT_IMPLEMENT( MYON_..., MYON_baseclass );
  // in a .cpp file.
  //
  // See the definition of MYON_Object for details.
  MYON_OBJECT_DECLARE(MYON_Geometry);

public:
  const static MYON_Geometry Unset;

public:
  MYON_Geometry() = default;
  ~MYON_Geometry() = default;
  MYON_Geometry(const MYON_Geometry&) = default;
  MYON_Geometry& operator=(const MYON_Geometry&) = default;

#if defined(MYON_HAS_RVALUEREF)
  // rvalue copy constructor
  MYON_Geometry( MYON_Geometry&& ) MYON_NOEXCEPT;
  ...
  MYON_Geometry& operator=( MYON_Geometry&& );
#endif
  ...
  //   true if successful.
  bool GetBoundingBox(
    MYON_3dPoint& bbox_min,
    MYON_3dPoint& bbox_max,
    bool bGrowBox = false
    ) const;
  ...
  */
  virtual bool GetTightBoundingBox( 
    class MYON_BoundingBox& tight_bbox,
    bool bGrowBox = false,
    const class MYON_Xform* xform = nullptr
  ) const;
  ...
  See Also:
    MYON_Geometry::IsDeformable();

  Remarks:
    Classes derived from MYON_Geometry should call
    MYON_Geometry::Transform() to handle user data
  ...
  */
  ...
  /*
  Description:
    Query an object to see if it has an MYON_Brep form.
  Result:
    Returns true if the virtual MYON_Geometry::BrepForm can compute
    an MYON_Brep representation of this object.
  Remarks:
    The default implementation of MYON_Geometry::BrepForm returns 
    false.
  See Also
    MYON_Geometry::BrepForm
  */
  virtual
  ...
  */
  ...
  Description:
    ...
    larger, like an MYON_BrepEdge in an MYON_Brep, then this
  ...
  */
  virtual
  MYON_COMPONENT_INDEX ComponentIndex() const;
  ...
  Parameters:
    objref - [in]
    point - [out]
      If the evaluation cannot be performed, MYON_3dPoint::UnsetPoint
      is returned.
  Returns:
    True if successful.
  */
