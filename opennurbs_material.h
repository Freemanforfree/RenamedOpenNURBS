...
class MYON_PhysicallyBasedMaterial;

///////////////////////////////////////////////////////////////////////////////
//
// Class MYON_Material
//
class MYON_CLASS MYON_Material : public MYON_ModelComponent
{
  MYON_OBJECT_DECLARE(MYON_Material);

public:
  static const double MaxShine; // maximum value of shine exponent = 255.0

  static const MYON_Material Unset;   // nil id


  static const MYON_Material Default; // index = -1, persistent id

  // Default material for locked objects
  static const MYON_Material DefaultLockedObject; // index = -2, persistent id
  ...
  */
  static const MYON_Material* FromModelComponentRef(
  ...
  static int Compare(
    const MYON_Material& a,
    const MYON_Material& b
    );
  ...
  Parameters:
    fresnel_index_of_refraction - [in]
      MYON_Material::Material::Default.m_fresnel_index_of_refraction
      is a good default
    N - [in]
      3d surface normal
    R - [in]
...
public:
  MYON_Material() MYON_NOEXCEPT;
  MYON_Material(const MYON_Material& src);
  ~MYON_Material() = default;
  MYON_Material& operator=(const MYON_Material& src) = default;
...
public:
  ...
  MYON_Color Emission() const;
  MYON_Color Specular() const;

  void SetAmbient(  MYON_Color );
  void SetDiffuse(  MYON_Color );
  void SetEmission( MYON_Color );
  void SetSpecular( MYON_Color );

  // Shine values are in range 0.0 to MYON_Material::MaxShine
  double Shine() const;
  void SetShine( double );         // 0 to MYON_Material::MaxShine
  ...
  MYON_UUID MaterialPlugInId() const;
...
public:
  ...
  */
  MYON_UUID RdkMaterialInstanceId() const;
  ...
  */
  ...
  //Note - it is very important that the lifetime of the returned pointer is the same as the MYON_Material
  //it was called on.  Once the material is deleted, this pointer is no longer valid.
  const std::shared_ptr<MYON_PhysicallyBasedMaterial> PhysicallyBased(void) const;
  std::shared_ptr <MYON_PhysicallyBasedMaterial> PhysicallyBased(void);
  ...
  //Internal use only
  static MYON_UUID PhysicallyBasedUserdataId(void);
...
private:
  ...
  MYON_UUID m_rdk_material_instance_id = MYON_nil_uuid;

public:
  MYON_Color m_ambient = MYON_Color::Black;
  MYON_Color m_diffuse = MYON_Color::Gray126;
  MYON_Color m_emission = MYON_Color::Black;
  MYON_Color m_specular = MYON_Color::White;
  MYON_Color m_reflection = MYON_Color::White;
  MYON_Color m_transparent = MYON_Color::White;
...
public:
  ...
  */
  ...
  m_fresnel_index_of_refraction:
    Default is 1.56.
    This is the value MYON:Material::FresnelReflectionCoefficient() passes
    as the first parameter to MYON_FresnelReflectionCoefficient().
  ...
  */
  ...
  Remarks:
    ...
    calling MYON_FresnelReflectionCoefficient() with m_fresnel_index_of_refraction
  ...
  */
  ...
  Parameters:
    ...
    type - [in] If MYON_Texture::no_texture_type, then
  ...
  Example:
    ...
    a material.
          ...
          for(;;)
          {
            ti = mat.FindTexture(
                        nullptr,
                        MYON_Texture::TYPE::bitmap_texture,
                        ti );
            ...
            const MYON_Texture& bitmap_texture = mat.m_textures[ti];
            ...
          }
  ...
  */
  ...
  MYON_ObjectArray<MYON_Texture> m_textures;

  /*
  Description:
    The m_material_channel[] array is used to provide per face rendering material support for MYON_SubD and MYON_Brep objects.
    MYON_Mesh objects to not support per face render materials.
    The application specifies a base MYON_Material for rendering the subd or brep and a way to find materials from MYON_UUID values.
    MYON_Material.Id() returns the id for any given material.

    MYON_BrepFace::MaterialChannelIndex() and MYON_SubDFace::MaterialChannelIndex()
  ...
  */
  MYON_SimpleArray<MYON_UuidIndex> m_material_channel;

  enum : int
  {
    ///<summary>
    /// Material channel index values stored in the MYON_UuidIndex.m_i field of elements in the m_material_channel[] array
    /// must be between 0 and MYON_Material::MaximumMaterialChannelIndex, inclusive.
    ///</summary>
  ...
  Returns:
    If material_channel_index > 0, the m_id MYON_UUID value of the first element in the 
    m_material_channel[] array with material_channel_index = MYON_Uuid_index.m_i is returned. 
    This id identifies an MYON_Material.
    Otherwise MYON_nil_uuid is returned.
  */
  const MYON_UUID MaterialChannelIdFromIndex(
  ...
  Returns:
    ...
    m_material_channel[] array with material_channel_id = MYON_Uuid_index.m_id is returned.
...
private:
  MYON_UUID m_plugin_id = MYON_nil_uuid;

private:
  bool Internal_ReadV3( MYON_BinaryArchive& archive, int minor_version );
  bool Internal_WriteV3( MYON_BinaryArchive& archive ) const;
  bool Internal_ReadV5( MYON_BinaryArchive& archive );
  bool Internal_WriteV5( MYON_BinaryArchive& archive ) const;
};

MYON_DECL
bool operator==(const MYON_Material&, const MYON_Material&);

MYON_DECL
bool operator!=(const MYON_Material&, const MYON_Material&);

#if defined(MYON_DLL_TEMPLATE)
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<MYON_Material*>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<const MYON_Material*>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ObjectArray<MYON_Material>;

// NO! // MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ClassArray<MYON_Material>;
//  It is a serious error to have an MYON_ClassArray<MYON_Material> and crashes
...
//
class MYON_CLASS MYON_PhysicallyBasedMaterial
{
public:
  MYON_PhysicallyBasedMaterial(const MYON_Material& src);
  MYON_PhysicallyBasedMaterial(const MYON_PhysicallyBasedMaterial& src);
  virtual ~MYON_PhysicallyBasedMaterial();
...
public:
  ...
  virtual MYON_4fColor BaseColor(void) const;
  virtual void SetBaseColor(const MYON_4fColor&);
  ...
  virtual MYON_4fColor SubsurfaceScatteringColor(void) const;
  virtual void SetSubsurfaceScatteringColor(const MYON_4fColor&);
  ...
  virtual MYON_4fColor Emission(void) const;
  virtual void SetEmission(MYON_4fColor);
  ...
  //Texture access functions - exactly the same as MYON_Material.  Provided for ease of use.
  virtual int FindTexture(const wchar_t* filename, MYON_Texture::TYPE type, int i0 = -1) const;
  virtual int AddTexture(const MYON_Texture& tx);
  virtual int AddTexture( const wchar_t* filename, MYON_Texture::TYPE type);
  virtual int DeleteTexture(const wchar_t* filename, MYON_Texture::TYPE type);

  //Access the referenced MYON_Material.
  virtual MYON_Material& Material(void);
  virtual const MYON_Material& Material(void) const;

  //Call this function to set the MYON_Material up to represent the PBR material as well as possible.
  ...
  //These function just route through to MYON_Material - PBR materials need to support the same functionality.
  //
...
public:
    class MYON_CLASS ParametersNames
    {
    public:
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString BaseColor(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString BRDF(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString Subsurface(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString SubsurfaceScatteringColor(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString SubsurfaceScatteringRadius(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString Specular(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString SpecularTint(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString Metallic(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString Roughness(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString Anisotropic(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString AnisotropicRotation(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString Sheen(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString SheenTint(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString Clearcoat(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString ClearcoatRoughness(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString ClearcoatBump(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString OpacityIor(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString Opacity(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString OpacityRoughness(void);
      MYON_DEPRECATED_MSG("Use CRhRdkMaterial::PhysicallyBased::ParameterNames") static MYON_wString Emission(void);
  };
...
private:
  ...
  MYON_PhysicallyBasedMaterial& operator=(const MYON_Material& src) = delete;
  MYON_PhysicallyBasedMaterial& operator=(const MYON_PhysicallyBasedMaterial& src) = delete;
  friend MYON_Material;
  friend bool MYON_PhysicallyBasedMaterial_Supported(const MYON_PhysicallyBasedMaterial& material);
};
