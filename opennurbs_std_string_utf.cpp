  ...
  ) MYON_NOEXCEPT
{
  ...
  for(;;)
  {
    es = 0;
    sNextIn = 0;
    int rc = MYON_ConvertUTF16ToUTF8(
  ...
  ) MYON_NOEXCEPT
{
  ...
  for(;;)
  {
    es = 0;
    sNextIn = 0;
    int rc = MYON_ConvertUTF32ToUTF8(
  ...
  ) MYON_NOEXCEPT
{
  ...
  case sizeof(MYON__UINT16):
    str = MYON_UTF16_to_std_string(
      bTestByteOrder,
  ...
  case sizeof(MYON__UINT32):
    str = MYON_UTF32_to_std_string(
      bTestByteOrder,
  ...
  ) MYON_NOEXCEPT
{
  ...
  for(;;)
  {
    es = 0;
    sNextIn = 0;
    int rc = MYON_ConvertUTF8ToWideChar(
      bTestByteOrder, sUTF8, sUTF8_count,
      buffer, buffer_count-1,
      &es, error_mask, error_code_point,
      &sNextIn
  ...
  ) MYON_NOEXCEPT
{
  ...
  for(;;)
  {
    es = 0;
    sNextIn = 0;
    int rc = MYON_ConvertUTF16ToWideChar(
      bTestByteOrder, sUTF16, sUTF16_count,
      buffer, buffer_count-1,
      &es, error_mask, error_code_point,
      &sNextIn
  ...
  ) MYON_NOEXCEPT
{
  ...
  const int buffer_count = static_cast<int>(sizeof(buffer)/sizeof(buffer[0]));
  unsigned int es;
  const MYON__UINT32* sNextElement;
  ...
  for(;;)
  {
    es = 0;
    sNextElement = 0;
    int rc = MYON_ConvertUTF32ToWideChar(
      bTestByteOrder, sUTF32, sUTF32_count,
      buffer, buffer_count-1,
      &es, error_mask, error_code_point,
      &sNextElement
  ...
  ) MYON_NOEXCEPT
{
  ...
  str = MYON_UTF_WideChar_to_std_string(
    bTestByteOrder,
    sInputUTF.c_str(),
    sInputUTF_count,
    error_status,
