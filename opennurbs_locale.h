...
public:
  ...
  static const MYON_Locale Ordinal;

  // The invariant culture locale.
  // The decimal point is a period.
  static const MYON_Locale InvariantCulture;

private:
  static MYON_Locale m_CurrentCulture;

public:
  // Reference to MYON_Locale::m_CurrentCulture.
  // The value is set by calling MYON_Locale::SetCurrentCulture();
  // The default is a copy of MYON_Locale::Ordinal.
  static const MYON_Locale& CurrentCulture;
  ...
  */
  ...
  // Default construction creates a copy of MYON_Local::Ordinal
  MYON_Locale() MYON_NOEXCEPT;

  ~MYON_Locale() = default;
  MYON_Locale(const MYON_Locale&) = default;
  MYON_Locale& operator=(const MYON_Locale&) = default;

  // Maximum buffer capacity for any MYON_Locale functions
  ...
  Parameters:
    ...
    buffer_capacity - [in]
      ...
      A capacity >= MYON_Locale::BUFFER_MAXIMUM_CAPACITY will be large enough to 
  ...
  */
  ...
  Remarks:
    MYON_Locale::InvariantCulture.BCP47LanguageName() = "";
    MYON_Locale::Oridnal.BCP47LanguageName() = "";
  */
  ...
  */
  ...
  Returns:
    ...
    MYON_LocaleLCID::OrdinalLCID (=0)
      The locale is a copy of MYON_Locale::Ordinal.
    MYON_Locale::InvariantCultureLCID (=0x00000027U)
      The locale is a copy of MYON_Locale::InvariantCulture.
  */
  MYON__UINT32 WindowsLCID() const;
  ...
  */
  ...
  Returns:
    ...
    2: success
       ...
       a call to MYON_Locale::SetPeriodAsCRuntimeDecimalPoint()
  ...
  */
  ...
  /*
  Returns:
    True if this is MYON_Locale:InvariantCulture or a copy.
  */
  bool IsInvariantCulture() const;

  /*
  Returns:
    True if this is MYON_Locale:Ordinal or a copy.
  */
  bool IsOrdinal() const;

  /*
  Returns:
    True if this is MYON_Locale:Ordinal, MYON_Locale:InvariantCulture or a copy
    of one of them.
  */
  ...
  Description:
    ...
    of MYON_String and MYON_wString number formatting and parsing functions.
  Example:

       // Call _sprintf_p_l
       MYON_CRT_locale_t numeric_locale = MYON_Locale::CurrentCulture::NumericLocalePtr();
        _sprintf_p_l(....,locale,...);
  ...
  Returns:
    ...
    a locale parameter.
  */
  MYON_CRT_locale_t NumericLocalePtr() const;
  ...
  Description:
    ...
    The primary use for this function is in opennurbs implementations
    of MYON_String and MYON_wString collate and map functions.
  Example:

       // Call _wcsicoll_l
       MYON_CRT_locale_t coll_locale = MYON_Locale::CurrentCulture::StringCollateAndMapLocalePtr();
  ...
  Returns:
    ...
    a locale parameter.
  */
  MYON_CRT_locale_t StringCollateAndMapLocalePtr() const;
  ...
  Returns:
    MYON_Locale identified by lcid.
    If lcid is not valid or not supported, a copy of MYON_Locale::Ordinal is returned.
  */
  static MYON_Locale FromWindowsLCID(
  ...
  Returns:
    MYON_Locale identified by language_name.
    If locale_name is not valid or not supported, a copy of MYON_Locale::Ordinal is returned.
  */
  static MYON_Locale FromBCP47LanguageName(
  ...
  Returns:
    MYON_Locale identified by locale_name.
    If locale_name is not valid or not supported, a copy of MYON_Locale::Ordinal is returned.
  */
  static MYON_Locale FromWindowsName(
  ...
  */
  static MYON_Locale FromAppleName(
 ...
 Returns:
    MYON_Locale identified by the locale name.
    If the locale name is not valid or not supported, a copy of MYON_Locale::Ordinal is returned.
  */
  static MYON_Locale FromSubtags(
...
private:
  MYON_CRT_locale_t m_numeric_locale = 0;         // pointer to a C runtime locale type
  MYON_CRT_locale_t m_string_coll_map_locale = 0; // pointer to a C runtime locale type
  ...
  MYON__UINT32 m_windows_lcid = 0;    // Microsoft Windows LCID values (0 = ordinal, 0x0027 = invariant culture)
  MYON__UINT32 m_reserved3 = 0;

private:

  // Construct from lcid and matching name
  static MYON_Locale FromWindowsLCIDAndName(
    MYON__UINT32 windows_lcid,
    const char* name
    );
  ...
  //MYON_Locale(
  //  MYON__UINT_PTR string_coll_map_locale_ptr,
  //  MYON__UINT32 windows_lcid,
  //  const char* language_name,
  //  const char* language_code,
  //  const char* script_code,
