...
#if !defined(MYON_INTERSECT_INC_)
#define MYON_INTERSECT_INC_
...
See Also:
  MYON_Intersect( const MYON_Line& lineA, const MYON_Line& line B)
Remarks:
  ...
  do something like the following.
          ...
          bool rc = MYON_IntersectLineLine(lineA,lineB,
                                         &a,&b,
                                         tolerance,
                                         bIntersectSegments);
          if (rc)
          {
            double angle_tolerance_radians = 0.5*MYON_PI/180.0; // or whatever
