...
////////////////////////////////////////////////////////////////
//
//   defines MYON_Xform (4 x 4 transformation matrix)
//
////////////////////////////////////////////////////////////////

#if !defined(MYON_XFORM_INC_)
#define MYON_XFORM_INC_

class MYON_Matrix;
class MYON_Quaternion;

class MYON_CLASS MYON_Xform
{
public:
  // MYON_Xform IdentityTransformation diagonal = (1,1,1,1)
  static const MYON_Xform IdentityTransformation;

  // MYON_Xform ZeroTransformation diagonal = (0,0,0,1)
  static const MYON_Xform ZeroTransformation;

  // MYON_Xform::Zero4x4 - every coefficient is 0.0.
  static const MYON_Xform Zero4x4;

  // MYON_Xform::Unset - every coefficient is MYON_UNSET_VALUE
  static const MYON_Xform Unset;

  // MYON_Xform::Nan - every coefficient is MYON_DBL_QNAN
  static const MYON_Xform Nan;
  ...
  MYON_Xform();
  ~MYON_Xform() = default;
  MYON_Xform(const MYON_Xform&) = default;
  MYON_Xform& operator=(const MYON_Xform&) = default;

  bool operator==(const MYON_Xform& rhs) const;
  ...
  */
  static const MYON_Xform DiagonalTransformation(
    double d
  );
  ...
  */
  ...
  explicit MYON_Xform( double[4][4] );       // from standard double m[4][4]
  explicit MYON_Xform( float[4][4] );        // from standard float m[4][4]
#endif
  
  explicit MYON_Xform( const double[4][4] ); // from standard double m[4][4]
  explicit MYON_Xform( const float[4][4] );  // from standard float m[4][4]
  
  explicit MYON_Xform( const double* );      // from array of 16 doubles (row0,row1,row2,row3)
  explicit MYON_Xform( const float* );       // from array of 16 floats (row0,row1,row2,row3)
  
  explicit MYON_Xform( const MYON_Matrix& ); // from upper left 4x4 of an
                                    // arbitrary matrix.  Any missing
                                    // rows/columns are set to identity. 
	MYON_Xform(const MYON_3dPoint& P,	// as a frame. 
  ...
  MYON_Xform& operator=( const MYON_Matrix& ); // from upper left 4x4 of an
                                               // arbitrary matrix.  Any missing
                                               // rows/columns are set to identity.
  ...
  MYON_4dPoint operator*( const MYON_4dPoint& ) const;
  ...
  MYON_Xform operator*( const MYON_Xform& /*rhs*/ ) const;
  MYON_Xform operator+( const MYON_Xform& ) const;
  MYON_Xform operator-( const MYON_Xform& /*rhs*/ ) const;
  ...
  Returns:
    True if MYON_IsValid() is true for every coefficient in the transformation matrix.
  */
  bool IsValid() const;
  ...
  */
  ...
  /*
  Returns:
    true if matrix is MYON_Xform::Zero4x4, MYON_Xform::ZeroTransformation,
  ...
  */
  ...
  /*
  Returns:
    true if matrix is MYON_Xform::Zero4x4
  ...
  */
  ...
  /*
  Returns:
    true if matrix is MYON_Xform::ZeroTransformation
  ...
  */
	...
	int DecomposeSimilarity(MYON_3dVector& Translation, double& dilation, MYON_Xform& Rotation, double tolerance) const;
	...
	Details:
		If X.DecomposeRigid(T, R) is 1 then X ~	TranslationTransformation(T)*R
		                            -1      X ~ MYON_Xform(-1) *TranslationTransformation(T)*R
	...
	*/
	int IsRigid(double tolerance = MYON_ZERO_TOLERANCE) const;
	int DecomposeRigid(MYON_3dVector& Translation, MYON_Xform& Rotation, double tolerance = MYON_ZERO_TOLERANCE) const;
	...
	*/
	bool IsAffine() const;
	bool IsLinear() const;
	bool DecomposeAffine(MYON_3dVector& Translation, MYON_Xform& Linear) const;
	bool DecomposeAffine(MYON_Xform& Linear, MYON_3dVector& Translation ) const;
  ...
  Returns:
    True - if *this is a proper rotation
  */
  bool GetQuaternion(MYON_Quaternion& Q) const;
  ...
  Returns:
	...
	*/
	bool DecomposeAffine(MYON_3dVector& Translation, MYON_Xform& Rotation, MYON_Xform& OrthBasis, MYON_3dVector& Diagonal) const;
	...
	*/
	...
	Return:
	  true if success.
	*/
	bool DecomposeSymmetric(MYON_Xform& Q, MYON_3dVector& diagonal) const;

  /*
  Description:
    Well ordered dictionary compare that is nan aware.
  */
  int Compare( const MYON_Xform& other ) const;
  ...
  */
  double GetSurfaceNormalXform( MYON_Xform& N_xform ) const;
  ...
  */
  double GetMappingXforms( MYON_Xform& P_xform, MYON_Xform& N_xform ) const;
  ...
  // diagonal is (1,1,1,1)
  MYON_DEPRECATED_MSG("Use xform = MYON_Xform::IdentityTransformation;")
  void Identity();

  MYON_DEPRECATED_MSG("Use xform = MYON_Xform::DiagonalTransformation(d);")
  ...
  */
  MYON_DEPRECATED_MSG("Use xform = MYON_Xform::DiagonalTransformation(x_scale_factor,z_scale_factor,z_scale_factor);")
  void Scale( 
  ...
  */
  MYON_DEPRECATED_MSG("Use xform = MYON_Xform::DiagonalTransformation(scale_vector);")
  void Scale( 
    const MYON_3dVector& scale_vector
    );
  ...
  Parameters:
    ...
    scale_factor - [in]
  */
  MYON_DEPRECATED_MSG("Use xform = MYON_Xform::ScaleTransformation(fixed_point,scale_factor)")
  void Scale
    (
  ...
  static const MYON_Xform ScaleTransformation(
  ...
  */
  ...
  Parameters:
    ...
    z_scale_factor - [in] plane.zaxis scale factor
  */
  MYON_DEPRECATED_MSG("Use xform = MYON_Xform::ScaleTransformation(plane,x_scale_factor,y_scale_factor,z_scale_factor)")
  void Scale
    (
    const MYON_Plane& plane,
    double x_scale_factor,
  ...
  */
  static const MYON_Xform ShearTransformation(
    const MYON_Plane& plane,
  ...
  MYON_DEPRECATED_MSG("Use xform = MYON_Xform::ShearTransformation(plane,x1,y1,z1);")
  void Shear
    (
    const MYON_Plane& plane,
    const MYON_3dVector& x1,
  ...
  MYON_DEPRECATED_MSG("Use xform = MYON_Xform::TranslationTransformation(delta);")
  void Translation( 
    const MYON_3dVector& delta
  );

  MYON_DEPRECATED_MSG("Use xform = MYON_Xform::TranslationTransformation(dx,dy,dz);")
  void Translation( 
    double dx,
    double dy,
    double dz
  ...
  static const MYON_Xform TranslationTransformation(
  ...
  //   for those frames.  See MYON_Xform::ChangeBasis().
  //   
  void Rotation(
    double sin_angle,
    double cos_angle,
    MYON_3dVector rotation_axis,
  ...
  */
  ...
  //
  void Rotation( 
    const MYON_3dVector& X0,
    const MYON_3dVector& Y0,
    const MYON_3dVector& Z0,
    const MYON_3dVector& X1,
    const MYON_3dVector& Y1,
    const MYON_3dVector& Z1
    );
  ...
  */
  ...
  Returns:
    ...
    angle values are MYON_DLB_QNAN.
  See Also:
  ...
  */
  ...
  Returns:
    ...
    Otherwise the MYON_Xform::Nan is returned.
  See Also:
    https://developers.google.com/kml/documentation/kmlreference#orientation
  */
  static const MYON_Xform RotationTransformationFromKMLAnglesRadians(
    double heading_radians,
    double tilt_radians, 
    double roll_radians
  );
  ...
  See Also:
    https://developers.google.com/kml/documentation/kmlreference#orientation
  */
  static const MYON_Xform RotationTransformationFromKMLAnglesDegrees(
    double heading_degrees, 
    double tilt_degrees,
    double roll_degrees
    );
...
*/
  ...
  */
  ...
  static const MYON_Xform MirrorTransformation(
  ...
  //   another.  The predefined world plane MYON_world_plane can
  ...
  //   frame to another.  See MYON_Xform::Rotation().
  bool ChangeBasis( 
    const MYON_Plane& plane0,
    const MYON_Plane& plane1
    );
  ...
  void WorldToCamera( 
         ...
         const MYON_3dVector&, // unit CameraX vector (right)
         const MYON_3dVector&, // unit CameraY vector (up)
         const MYON_3dVector&  // unit CameraZ vector (from screen to camera)
         );
  void CameraToWorld( 
         const MYON_3dPoint&,  // CameraLocation
         const MYON_3dVector&, // unit CameraX vector (right)
...
class MYON_CLASS MYON_ClippingRegion
{
public:
  MYON_ClippingRegion();
  ...
  */
  bool SetObjectToClipTransformation(
    const class MYON_Viewport& viewport
    );

  bool SetObjectToClipTransformation(
    const MYON_Xform object_to_clip_transformation
    );

  MYON_Xform ObjectToClipTransformation() const;
  MYON_Xform InverseObjectToClipTransformation() const;
...
private:
  ...
  // coordinate box.
  MYON_Xform m_xform;
  mutable MYON_Xform m_inverse_xform; // = m_xform.Inverse().
...
public:
  MYON_PlaneEquation m_clip_plane[max_clip_plane_count];
  ...
  */
  int TransformPoints( int count, MYON_4dPoint* p ) const;
  int TransformPoints( int count, MYON_4dPoint* p, unsigned int* pflags ) const;
...
/*
Description:
  MYON_ClippingRegionPoints is a container for storing or referencing 
  clip points and clip flags.
  The values are typically calculated by MYON_ClippingRegion.TransformPoint().
*/
class MYON_CLASS MYON_ClippingRegionPoints
{
public:
  static const MYON_ClippingRegionPoints Empty;

  MYON_ClippingRegionPoints() = default;
  ~MYON_ClippingRegionPoints();
  MYON_ClippingRegionPoints(const MYON_ClippingRegionPoints& src);
  MYON_ClippingRegionPoints& operator=(const MYON_ClippingRegionPoints& src);

#if defined(MYON_HAS_RVALUEREF)
  // rvalue copy constructor
  MYON_ClippingRegionPoints( MYON_ClippingRegionPoints&& ) MYON_NOEXCEPT;
  ...
  MYON_ClippingRegionPoints& operator=( MYON_ClippingRegionPoints&& );
#endif
  ...
  Description:
    ...
    deallocate the memory buffer.  When an MYON_ClippingRegionPoints will be used
...
public:
  ...
  */
  ...
  MYON_3dPoint* m_clip_points = nullptr;
...
#pragma region
/// <summary>
/// MYON_PickType specifies what type of pick is occurring.
/// </summary>
enum class MYON_PickType : unsigned char
{
  ///<summary>
...
class MYON_CLASS MYON_PickPoint
{
public:
  static const MYON_PickPoint Unset;

  MYON_PickPoint() = default;
  ~MYON_PickPoint() = default;
  MYON_PickPoint(const MYON_PickPoint&)= default;
  MYON_PickPoint& operator=(const MYON_PickPoint&) = default;
  ...
  */
  ...
  MYON_3dPoint m_point = MYON_3dPoint::UnsetPoint;
  double m_t[4]; // parameters (unused values are set to MYON_UNSET_VALUE)
  double m_depth = MYON_UNSET_VALUE;  // larger values are in front of smaller values.
  double m_distance = 1.0e300; // smaller values are closer to pick ray.
};

class MYON_CLASS MYON_Localizer
{
public:
  MYON_Localizer();
  ~MYON_Localizer();

  MYON_Localizer(const MYON_Localizer&);
  MYON_Localizer& operator=(const MYON_Localizer&);
  ...
  */
  bool CreateCylinderLocalizer( MYON_3dPoint P, MYON_3dVector D, double r0, double r1 );
  ...
  Returns:
    True if the input is value and the localizer is initialized.
  */
  bool CreatePlaneLocalizer( MYON_3dPoint P, MYON_3dVector N, double h0, double h1 );
  ...
  Returns:
    True if the input is value and the localizer is initialized.
  */
  bool CreateSphereLocalizer( MYON_3dPoint P, double r0, double r1 );
  ...
  */
  double Value(MYON_3dPoint P) const;
  ...
  */
  bool IsZero( const MYON_BoundingBox& bbox ) const;
  ...
  MYON_3dPoint       m_P;
  MYON_3dVector      m_V;
  class MYON_NurbsCurve*   m_nurbs_curve;
  class MYON_NurbsSurface* m_nurbs_surface;
};


class MYON_CLASS MYON_SpaceMorph
{
public:
  MYON_SpaceMorph();
  virtual ~MYON_SpaceMorph();
  ...
  */
  ...
  Returns:
    ...
    Uses MorphPoint()
  */
  bool IsIdentity(const MYON_SimpleArray<MYON_3dPoint>& Points, double tol) const;
  ...
  */
  bool IsIdentity(const class MYON_Surface& Srf, double tol) const;
  ...
  */
  bool IsIdentity(const class MYON_Curve& Crv, double tol) const;
...
private:
  ...
  MYON__UINT_PTR m_reserved1 = 0; // Some reserved field could provide more Morph type information. RH-4091
...
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<MYON_Xform>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ClassArray<MYON_Localizer>;
#endif
