...
static const MYON_UUID ExampleWriteUserData_Id = 
...
CExampleWriteUserData::CExampleWriteUserData(const CExampleWriteUserData& src) : MYON_UserData(src), m_str(src.m_str)
{
  m_sn = ++m__sn;
}
...
void CExampleWriteUserData::Dump( MYON_TextLog& text_log ) const
{
...
bool CExampleWriteUserData::GetDescription( MYON_wString& description )
{
...
bool CExampleWriteUserData::Write(MYON_BinaryArchive& file) const
{
  return file.WriteString(m_str);
}

bool CExampleWriteUserData::Read(MYON_BinaryArchive& file)
{
...
MYON_OBJECT_IMPLEMENT(CExampleWriteUserData,MYON_UserData,"DADD17C5-706D-44ea-9B13-7D9D2C56D085");

MYON_UUID CExampleWriteUserData::Id()
{
