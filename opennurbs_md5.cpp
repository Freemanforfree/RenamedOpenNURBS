...
const MYON_String MYON_MD5_Hash::ToUTF8String(
...
const MYON_wString MYON_MD5_Hash::ToString(
  bool bUpperCaseHexadecimalDigits
  ) const
{
...
bool MYON_MD5_Hash::Read(
  class MYON_BinaryArchive& archive
  )
{
  *this = MYON_MD5_Hash::ZeroDigest;
  bool rc = false;
  int major_version = 0;
  int minor_version = 0;
  ...
  ) const
{
  ...
  void MYON_MD5_Hash::Dump(
class MYON_TextLog& text_log
  ) const
{
  const MYON_wString md5_hash(ToString(true));
  text_log.Print(L"MD5 hash = %ls\n",static_cast<const wchar_t*>(md5_hash));
}


MYON_MD5_Hash MYON_MD5_Hash::BufferHash(
  const void* buffer,
  size_t sizeof_buffer
  )
{
  if ( nullptr == buffer || sizeof_buffer <= 0 )
    return MYON_MD5_Hash::EmptyContentHash;
  MYON_MD5 md5;
  md5.AccumulateBytes(buffer,sizeof_buffer);
  return md5.Hash();
}

MYON_MD5_Hash MYON_MD5_Hash::FileHash(
  ...
  )
{
  ...
  MYON_MD5_Hash md5_hash = MYON_MD5_Hash::FileHash(fp,sizeof_file);
...
MYON_MD5_Hash MYON_MD5_Hash::StringHash(
  const MYON_wString& str,
  MYON__UINT64& byte_count
  )
{
  return MYON_MD5_Hash::StringHash(
  ...
  )
{
  ...
  return MYON_MD5_Hash::BufferHash(str,str_length);
}
...
static MYON__UINT32 MD5_F(MYON__UINT32 x, MYON__UINT32 y, MYON__UINT32 z) 
{
  return (x&y) | (~x&z);
}
 
static MYON__UINT32 MD5_G(MYON__UINT32 x, MYON__UINT32 y, MYON__UINT32 z)
{
  return (x&z) | (y&~z);
}
 
static MYON__UINT32 MD5_H(MYON__UINT32 x, MYON__UINT32 y, MYON__UINT32 z)
{
  return x^y^z;
}
 
static MYON__UINT32 MD5_I(MYON__UINT32 x, MYON__UINT32 y, MYON__UINT32 z)
{
  return y ^ (x | ~z);
}
 
// rotate_left rotates x left n bits.
static MYON__UINT32 MD5_rotate_left(MYON__UINT32 x, int n)
{
  return (x << n) | (x >> (32-n));
}
...
static void MD5_FF(MYON__UINT32 &a, MYON__UINT32 b, MYON__UINT32 c, MYON__UINT32 d, MYON__UINT32 x, MYON__UINT32 s, MYON__UINT32 ac) 
{
  a = MD5_rotate_left(a+ MD5_F(b,c,d) + x + ac, s) + b;
}
 
static void MD5_GG(MYON__UINT32 &a, MYON__UINT32 b, MYON__UINT32 c, MYON__UINT32 d, MYON__UINT32 x, MYON__UINT32 s, MYON__UINT32 ac)
{
  a = MD5_rotate_left(a + MD5_G(b,c,d) + x + ac, s) + b;
}
 
static void MD5_HH(MYON__UINT32 &a, MYON__UINT32 b, MYON__UINT32 c, MYON__UINT32 d, MYON__UINT32 x, MYON__UINT32 s, MYON__UINT32 ac) 
{
  a = MD5_rotate_left(a + MD5_H(b,c,d) + x + ac, s) + b;
}
 
static void MD5_II(MYON__UINT32 &a, MYON__UINT32 b, MYON__UINT32 c, MYON__UINT32 d, MYON__UINT32 x, MYON__UINT32 s, MYON__UINT32 ac) 
{
  ...
  )
{
  ...
  for (int i = 0; i <= str_length && rc; i++)
  {
    for (int j = 0; i+j <= str_length && rc; j++)
    {
      ...
      MYON_MD5_Hash md5_digest1(md5.Hash());
  ...
  if (rc)
  {
    if ( (MYON__UINT64)str_length != md5.ByteCount() )
      rc = false;
  }
...
bool MYON_MD5::Validate()
{
  // http://onlinemd5.com/

  // "" (empty string)
  // d41d8cd9 8f00b204 e9800998 ecf8427e
  const MYON__UINT8 empty_string[16] = {
    0xd4, 0x1d, 0x8c, 0xd9,
    0x8f, 0x00, 0xb2, 0x04,
    0xe9, 0x80, 0x09, 0x98,
    0xec, 0xf8, 0x42, 0x7e };
  ...
  if (0 != memcmp(&MYON_MD5_Hash::EmptyContentHash ,empty_string, sizeof(empty_string)))
    return false;

  // "abc"
  // 90015098 3CD24FB0 D6963F7D 28E17F72
  const MYON__UINT8 abc[16]  = { 
    0x90, 0x01, 0x50, 0x98,
    0x3C, 0xD2, 0x4F, 0xB0,
    0xD6, 0x96, 0x3F, 0x7D,
    0x28, 0xE1, 0x7F, 0x72  };
  ...
  const MYON__UINT8 quickfoxperiod[16] = {
    0xE4, 0xD9, 0x09, 0xC2,
    0x90, 0xD0, 0xFB, 0x1C,
    0xA0, 0x68, 0xFF, 0xAD,
    0xDF, 0x22, 0xCB, 0xD0 };
  ...
  const MYON__UINT8 millionXa[16] = {
    0x77, 0x07, 0xD6, 0xAE,
    0x4E, 0x02, 0x7C, 0x70,
    0xEE, 0xA2, 0xA9, 0x35,
    0xC2, 0x29, 0x6F, 0x21 };
  ...
  for (total_count = 0; total_count < one_million; total_count += a_count)
  {
    ...
    if (md5.ByteCount() != (MYON__UINT64)(total_count+a_count))
      return false;
  }
  
  MYON_MD5_Hash md5_digest(md5.Hash());
  ...
  while (total_count < one_million)
  {
    ...
    total_count += count;
    if (md5.ByteCount() != (MYON__UINT64)total_count)
      return false;
  }

  MYON_MD5_Hash md5_digestx(md5.Hash());
...
MYON__UINT64 MYON_MD5::ByteCount() const
{
  return m_byte_count;
}
...
MYON_MD5_Hash MYON_MD5::Hash() const
{
...
// decodes input (unsigned char) into output (MYON__UINT32). Assumes len is a multiple of 4.
static void  MD5_decode(MYON__UINT32 output[], const MYON__UINT8 input[], MYON__UINT32 len)
{
  for (unsigned int i = 0, j = 0; j < len; i++, j += 4)
    output[i] = ((MYON__UINT32)input[j]) | (((MYON__UINT32)input[j+1]) << 8) |
      (((MYON__UINT32)input[j+2]) << 16) | (((MYON__UINT32)input[j+3]) << 24);
}
 
//////////////////////////////
 
// encodes input (MYON__UINT32) into output (unsigned char). Assumes len is
// a multiple of 4.
static void MD5_encode(MYON__UINT8 output[], const MYON__UINT32 input[], MYON__UINT32 len)
{
  for (MYON__UINT32 i = 0, j = 0; j < len; i++, j += 4) {
...
static void MD5_transform(const MYON__UINT8 block[64], MYON__UINT32 state[4])
{
  MYON__UINT32 a = state[0], b = state[1], c = state[2], d = state[3], x[16];
...
void MYON_MD5::Internal_Accumulate(const MYON__UINT8* input, MYON__UINT32 length)
{
  // MD5 block update operation. Continues an MD5 message-digest
  // operation, processing another message block.

  // compute number of bytes mod 64
  MYON__UINT32 index = m_bit_count[0] / 8 % 64;
  ...
  MYON__UINT32 firstpart = 64 - index;
...
void MYON_MD5::set_final_hash()
{
  ...
  const MYON__UINT32 index = (m_bit_count[0] / 8) % 64;
  const MYON__UINT32 padLen = (index < 56) ? (56 - index) : (120 - index);
