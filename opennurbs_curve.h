...
class MYON_CLASS MYON_MeshCurveParameters
{
public:
  MYON_MeshCurveParameters();
...
/*
Description:
  MYON_Curve is a pure virtual class for curve objects
  - Any class derived from MYON_Curve should have a
      MYON_OBJECT_DECLARE(MYON_...);
    at the beginning of its class definition and a
      MYON_OBJECT_IMPLEMENT( MYON_..., MYON_Curve );
    in a .cpp file.
Example:
  - See the definition of MYON_NurbsCurve for an example.
*/
class MYON_CLASS MYON_Curve : public MYON_Geometry
{
  MYON_OBJECT_DECLARE(MYON_Curve);

public:
  MYON_Curve() MYON_NOEXCEPT;
  virtual ~MYON_Curve();
  MYON_Curve(const MYON_Curve&);
  MYON_Curve& operator=(const MYON_Curve&);
  ...
  MYON_Curve& operator=( MYON_Curve&& );
#endif
...
public:
  ...
  */
  virtual
  MYON_Curve* DuplicateCurve() const;

  // Description:
  //   overrides virtual MYON_Object::ObjectType.
  // Returns:
  //   MYON::curve_object
  ...
  Description:
    ...
    MYON_Curve::Transform() calls MYON_Geometry::Transform(xform),
    which calls MYON_Object::TransformUserData(xform), and then
    calls this->DestroyCurveTree().
  Parameters:
    xform - [in] transformation to apply to object.
  Remarks:
    Classes derived from MYON_Curve should call
    MYON_Curve::Transform() to handle user data
  ...
  */
  ...
  // Returns:
  //   MYON_Arc.m_angle > 0 if curve locus is an arc between
  //   specified points.  If MYON_Arc.m_angle is 2.0*MYON_PI, then the curve
  //   is a circle.
  virtual
  bool IsArc(
  ...
  */
  ...
  Parameters:
    ...
    dtype - [out] if not nullptr, *dtype reports the kind of 
        ...
        is MYON::continuity::Gsmooth_continuous and the curvature changes 
  ...
  */
  ...
  Remarks:
    ...
    code. 
    MYON_Curve::SetStartPoint() returns true if start_point is the same as the start of the curve,
    false otherwise. 
  See Also:
  ...
  */
  ...
  Remarks:
    Some end points cannot be moved.  Be sure to check return
    code.
    MYON_Curve::SetEndPoint() returns true if end_point is the same as the end of the curve,
    false otherwise. 
  See Also:
  ...
  */
  ...
  // See Also:
  //   MYON_Curve::PointAt
  MYON_3dPoint  PointAtStart() const;
 ...
 //                   defaults to MYON_3dVector(0,0,1) for curve in xy-plane
 // Returns:
 //   signed curvature of a planar curve at the parameter t.
 // Remarks:
 //   No error handling.
 // See Also:
 //   MYON_Curve::EvSignedCurvature
  double SignedCurvatureAt(
    double t,
    const MYON_3dVector* plane_normal = nullptr
  ) const;
  ...
  //   true if successful
  // See Also:
  //   MYON_Curve::PointAt, MYON_Curve::TangentAt,
  //   MYON_Curve::Ev1Der, Ev2Der
  bool FrameAt( double t, MYON_Plane& plane) const;
  ...
  */
  ...
  /*
    ...
    Parameters:
      ...
      normal - [in] oriented unit normal of the plane containing the curve.
                    default of nullptr is interpreted as MYON_3dVector(0,0,1)
      side - [in] optional - determines which side to evaluate from
                  =0   default
                  <0   to evaluate from below,
                  >0   to evaluate from above
  ...
  bool EvSignedCurvature(
    ...
    MYON_3dVector& tangent,
    double& kappa,
    const MYON_3dVector* normal = nullptr,
    int side = 0,
    int* hint = 0
  ) const;
  ...
  /*
  Description:
    This evaluator actually does all the work.  The other MYON_Curve
  ...
  */
  ...
  Description:
    ...
    an MYON_Curve object of the same type.  If the pointer is nullptr,
  ...
  */
  ...
  Remarks:
    ...
    then MYON_Curve::NurbsCurve may be easier to use.
  See Also:
    MYON_Curve::NurbsCurve
  */
  virtual
  int GetNurbForm(
        MYON_NurbsCurve& nurbs_curve,
        double tolerance = 0.0,
        const MYON_Interval* subdomain = nullptr
        ) const;
  /*
  Description:
  ...
  */
  ...
  Description:
    Get a NURBS curve representation of this curve.
  Parameters:
    pNurbsCurve - [in/out] if not nullptr, this MYON_NurbsCurve
  ...
  Remarks:
    See MYON_Surface::GetNurbForm for important details about
    the NURBS surface parameterization.
  See Also:
    MYON_Curve::GetNurbForm
  */
  MYON_NurbsCurve* NurbsCurve(
        MYON_NurbsCurve* pNurbsCurve = nullptr,
        double tolerance = 0.0,
        const MYON_Interval* subdomain = nullptr
        ) const;
  ...
  /*
	Description:
		...
		This function is used by some types derived from MYON_Curve to snap parameter values
	Parameters:
		t			- [in]	parameter
  ...
  */
protected:
  bool ParameterSearch( double t, int& index, bool bEnableSnap, const MYON_SimpleArray<double>& m_t, 
															double RelTol=MYON_SQRT_EPSILON) const;

private:
};

#if defined(MYON_DLL_TEMPLATE)
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<MYON_Curve*>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<const MYON_Curve*>;
#endif

class MYON_CLASS MYON_CurveArray : public MYON_SimpleArray<MYON_Curve*>
{
public:
  MYON_CurveArray( int = 0 );
  ~MYON_CurveArray(); // deletes any non-nullptr curves
  ...
  bool Duplicate( MYON_CurveArray& ) const; // operator= copies the pointer values
...
/*
Description:
  Move ends of curves to a common point. Neither curve can be closed or an MYON_CurveProxy.
...
/*
OBSOLETE. Use int MYON_JoinCurves(const MYON_SimpleArray<const MYON_Curve*>& InCurves,
...
Description:
  Join all contiguous curves of an array of MYON_Curves.
Parameters:
...
Remarks:
  ...
  are MYON_PolyCurves. All members of InCurves must have same dimension, at most 3.
  */
MYON_DECL
int MYON_JoinCurves(const MYON_SimpleArray<const MYON_Curve*>& InCurves,
                  MYON_SimpleArray<MYON_Curve*>& OutCurves,
                  double join_tol,
                  bool bPreserveDirection = false,
                  MYON_SimpleArray<int>* key = 0
...
*/
MYON_DECL
bool MYON_SortCurves(
          int curve_count,
          const MYON_Curve* const* curve_list, 
          int* index,
          bool* bReverse
          );
...
MYON_DECL
bool MYON_SortCurves( 
                   const MYON_SimpleArray<const MYON_Curve*>& curves, 
                   MYON_SimpleArray<int>& index, 
                   MYON_SimpleArray<bool>& bReverse 
                   );
...
MYON_DECL
bool MYON_SortCurves( 
          const MYON_SimpleArray<MYON_Curve*>& curves, 
          MYON_SimpleArray<int>& index, 
          MYON_SimpleArray<bool>& bReverse 
          );
