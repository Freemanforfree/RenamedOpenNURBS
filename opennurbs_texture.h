...
////////////////////////////////////////////////////////////////
//
//   defines MYON_Color and MYON_Material
//
////////////////////////////////////////////////////////////////
...
class MYON_CLASS MYON_Texture : public MYON_Object
{
  MYON_OBJECT_DECLARE(MYON_Texture);

public:
  MYON_Texture() = default;
  ~MYON_Texture() = default;
  MYON_Texture(const MYON_Texture&) = default;
  MYON_Texture& operator=(const MYON_Texture&) = default;

public:
  static const MYON_Texture Default;
  ...
  Parameters:
    ...
    error_return - [in]
      ...
      is nullptr, then MYON_Xform::Nan is returned when input parameters are not valid.
  ...
  Example:
    MYON_Brep original_picture = ...;
    MYON_Brep shrunk_picture = original_picture;
    shrunk_picture.ShrinkSurfaces();
    MYON_Material original_material = ...;
    MYON_Material new_material = original_material;
    MYON_Texture& new_texture = new_material.m_textures[0];
    new_texture.m_uvw 
     = MYON_Texture::GetPictureShrinkSurfaceTransformation(
         &original_picture,
         &shrunk_picture,
         &MYON_Xform::IdentityXform)*new_texture.m_uvw;
  */
  static MYON_Xform GetPictureShrinkSurfaceTransformation(
...
public:
  ...
  static int Compare(
    const MYON_Texture& a,
    const MYON_Texture& b
  );
  ...
  */
  ...
  MYON_UUID m_texture_id = MYON_nil_uuid;
  ...
  static MYON_Texture::MAPPING_CHANNEL BuiltInMappingChannelFromUnsigned(
  ...
  // attributes with an MYON_MappingChannel entry that has a 
  // matching m_mapping_channel_id value, then the mapping 
  // identified by MYON_MappingChannel::m_mapping_id is used.
  // If a matching MYON_MappingChannel::m_mapping_id is not
  // found, then an attempt will be made to find a mapping
  // with a MYON_MappingChannel::m_mapping_id of 1. If that also
  ...
  //   during runtime.
  MYON_FileReference m_image_file_reference = MYON_FileReference::Unset;
  ...
  enum class TYPE : unsigned int
  {
    ...
    // They are not supported by the basic MYON_Material definition, and should only be used when
    ...
    // emap_texture is OBSOLETE - set m_mapping_channel_id = MYON_MappingChannel::emap_mapping
    emap_texture = 86U // spherical environment mapping.
  };

  static MYON_Texture::TYPE TypeFromUnsigned(
    unsigned int type_as_unsigned
    );

  MYON_Texture::TYPE m_type = MYON_Texture::TYPE::bitmap_texture;
  ...
  static MYON_Texture::MODE ModeFromUnsigned(
    unsigned int mode_as_unsigned
    );

  MYON_Texture::MODE m_mode = MYON_Texture::MODE::modulate_texture;
  ...
  static MYON_Texture::FILTER FilterFromUnsigned(
  ...
  MYON_Texture::FILTER m_minfilter = MYON_Texture::FILTER::linear_filter;  

  // The magfilter setting controls how the color
  // of the image pixel is calculated when the image pixel
  // corresponds to a fraction of a texture bitmap pixel.
  MYON_Texture::FILTER m_magfilter = MYON_Texture::FILTER::linear_filter;
  ...
  static MYON_Texture::WRAP WrapFromUnsigned(
    unsigned int wrap_as_unsigned
    );

  WRAP m_wrapu = MYON_Texture::WRAP::repeat_wrap;
  WRAP m_wrapv = MYON_Texture::WRAP::repeat_wrap;
  WRAP m_wrapw = MYON_Texture::WRAP::repeat_wrap;

  // Texture coordinate transformation.
  MYON_Xform m_uvw = MYON_Xform::IdentityTransformation;

  // If MYON_UNSET_COLOR != m_border_color, then this color
  // is used when the texture coordinates are <=0 or >=1
  // and the m_wrap* value is clamp_wrap.
  MYON_Color m_border_color = MYON_UNSET_COLOR;
  ...
  // 
  // If MYON_UNSET_COLOR != m_transparent_color, then 
  // a pixel in the bitmap file with a matching RGB
  // value is assigned the alpha value (MYON_Color::Alpha)
  ...
  MYON_Color m_transparent_color = MYON_UNSET_COLOR;
  ...
  // texture in the MYON_Material.m_textures[] array that has
  ...
  MYON_UUID m_transparency_texture_id = MYON_nil_uuid;
  ...
  // decreasing.
  MYON_Interval m_bump_scale = MYON_Interval::ZeroToOne;
  ...
  MYON_Color m_blend_constant_RGB = MYON_Color::Black;
  ...
  // If an MYON_Material m_textures[] array has more than
...
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ClassArray<MYON_Texture>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ObjectArray<MYON_Texture>;
#endif
