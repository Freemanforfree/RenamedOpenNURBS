...
class MYON_CLASS MYON_TensorProduct
{
  // Pure virtual tensor passed to MYON_NurbsSurface::TensorProduct()
public:
  MYON_TensorProduct();
...
class MYON_CLASS MYON_NurbsSurface : public MYON_Surface
{
  MYON_OBJECT_DECLARE(MYON_NurbsSurface);

public:
  /*
  Description:
    Use MYON_NurbsSurface::New(...) instead of new MYON_NurbsSurface(...)
  Returns:
    Pointer to an MYON_NurbsSurface.  Destroy by calling delete.
  Remarks:
    See static MYON_Brep* MYON_Brep::New() for details.
  */
  static MYON_NurbsSurface* New();
  static MYON_NurbsSurface* New(
  ...
  MYON_NurbsSurface();
  MYON_NurbsSurface(const MYON_NurbsSurface& nurbs_surface);
  MYON_NurbsSurface(const MYON_BezierSurface& bezier_surface);
  MYON_NurbsSurface(
  ...
  */
  ...
  int CreateRuledSurface(
         ...
         const MYON_Interval* curveA_domain = nullptr,
         const MYON_Interval* curveB_domain = nullptr
         );
  ...
  */
  int CreateConeSurface(
         ...
         const MYON_Interval* curve_domain = nullptr
         );
  ...
  Parameters:
    side - [in] 0 = south west, 
                ...
                2 = north east,
                3 = north west
    point - [in] point to collapse to.  If point is MYON_3dPoint::UnsetPoint,
  ...
  */
  bool CollapseSide(
    int side,
    MYON_3dPoint point = MYON_3dPoint::UnsetPoint
    );

  void Destroy();

  virtual ~MYON_NurbsSurface();

  void EmergencyDestroy(); // call if memory used by this class becomes invalid

  MYON_NurbsSurface& operator=(const MYON_NurbsSurface&);
  ...
  */
  ...
  Description:
    ...
    Overrides virtual MYON_Surface::Trim.
  ...
  */
  ...
  Description:
    ...
    specified parameter.
    Overrides virtual MYON_Surface::Split.
  ...
  Example:
          ...
          int dir = 1;
          MYON_NurbsSurface* south_side = 0;
          MYON_NurbsSurface* north_side = 0;
...
#pragma clang diagnostic pop
  ...
  // virtual MYON_Surface::GetNurbForm() override.
  // The MYON_NurbsSurface version returns 1 and a copy of the MYON_NurbsSurface.
  int GetNurbForm(
    MYON_NurbsSurface&,
    double = 0.0
    ) const override;

  // virtual MYON_Surface::HasNurbForm() override.
  // The MYON_NurbsSurface version returns 1.
  int HasNurbForm(
    ) const override;
  ...
  Parameters:
    ...
    bezierSurface - [out]
  Returns:
    MYON_DBL_QNAN: no bezier surface is returned.
  ...
  */
  ...
  Description:
    ...
    MYON_NurbsSurface::GetCV( MYON_3dPoint& ) or 
    MYON_NurbsSurface::GetCV( MYON_4dPoint& ).
  Parameters:
  ...
  See Also
    MYON_NurbsSurface::CVStyle
    MYON_NurbsSurface::GetCV
    MYON_NurbsSurface::Weight
  */
  double* CV(
        int i,
        int j
  ...
  Remarks:
    If i, j, or the nurbs surface is not valid, then MYON_4dPoint::Nan is returned.
  ...
  */
  ...
  bool SetCV(               // set a single control vertex
        int i, int j,   // CV index ( 0 <= i <= CVCount(0), 0 <= j <= CVCount(1)
        const MYON_3dPoint& cv// value of control vertex
  ...
  bool SetCV(              // set a single control vertex
        int i, int j,   // CV index ( 0 <= i <= CVCount(0), 0 <= j <= CVCount(1)
        const MYON_4dPoint& cv// value of control vertex
        );
  ...
  bool GetCV(              // get a single control vertex
        int i, int j,   // CV index ( 0 <= i <= CVCount(0), 0 <= j <= CVCount(1)
        MYON_3dPoint& cv     // gets euclidean cv when NURBS is rational
        ) const;

  bool GetCV(              // get a single control vertex
        int i, int j,   // CV index ( 0 <= i <= CVCount(0), 0 <= j <= CVCount(1)
        MYON_4dPoint& cv     // gets homogeneous cv
        ) const;
  ...
  // See Also:
  //   MYON_MakeClampedUniformKnotVector
  ...
  //   Allocates m_knot[] if it is not big enough.
  // See Also:
  //   MYON_MakePeriodicUniformKnotVector
  ...
  */
  ...
  bool GetGrevilleAbcissae( // see MYON_GetGrevilleAbcissa() for details
           int dir,      // dir
           double* g     // g[cv count]
           ) const;
  ...
  */
  ...
  bool TensorProduct(
        const MYON_NurbsCurve&, // A
        const MYON_NurbsCurve&, // B
        MYON_TensorProduct&     // T
        );
  ...
  */
  ...
  /*
   Description:
    Create an MYON_NurbsSurface satisfying Hermite interpolation conditions at a grid of points.
  Parameters:
   u_Parameters
   ...
   hermite_surface -[in]  optional existing MYON_NurbsSurface returned here.
  Returns:
  ...
  */
  static
  class MYON_NurbsSurface* CreateHermiteSurface(
      ...
      class MYON_NurbsSurface* hermite_surface = 0);
...
public:
  ...
  static void MYON_Internal_ConvertToCurve(const MYON_NurbsSurface& srf, int dir,
                                         MYON_NurbsCurve& crv);
  static void MYON_Internal_ConvertFromCurve(MYON_NurbsCurve& crv, int dir,
                                           MYON_NurbsSurface& srf);
  static bool MYON_Internal_MakeKnotVectorsCompatible(
      MYON_NurbsCurve& nurbs_curveA, MYON_NurbsCurve& nurbs_curveB);
...
public:
  ...
  int     m_knot_capacity[2]; // If m_knot_capacity > 0, then m_knot[]
                              ...
                              // MYON_NurbsSurface class using rhmalloc(),
  ...
  int     m_cv_capacity;    // If m_cv_capacity > 0, then m_cv[] is an array
                            ...
                            // memory is managed by the MYON_NurbsSurface
...
class MYON_CLASS MYON_NurbsCage : public MYON_Geometry
{
  MYON_OBJECT_DECLARE(MYON_NurbsCage);
...
public:
  ...
  MYON_NurbsCage( 
    const MYON_3dPoint* box_corners, // array of 8 3d points
    int order0,
    int order1,
    int order2,
    int cv_count0,
  ...
  MYON_NurbsCage( const MYON_BezierCage& src );

  ~MYON_NurbsCage();

  MYON_NurbsCage(const MYON_NurbsCage& src);

  MYON_NurbsCage& operator=(const MYON_NurbsCage& src);

  MYON_NurbsCage& operator=(const MYON_BezierCage& src);

  bool IsValid( class MYON_TextLog* text_log = nullptr ) const override;

  /*
  Description:
    Overrides the pure virtual MYON_Object::Dump function.
  Parameters:
  ...
  */
  ...
  /*
  Description:
    Overrides the pure virtual MYON_Object::SizeOf function.
  Returns:
  ...
  */
  ...
  /*
  Description:
    Overrides the pure virtual MYON_Object::Read function.
  ...
  */
  ...
  /*
  Description:
    Overrides the pure virtual MYON_Object::Write function.
  ...
  */
  ...
  /*
  Description:
    Overrides the pure virtual MYON_Object::ObjectType function.
    Saves the definition of this class in serial binary
    form that can be read by MYON_BezierVolue::Read.
  Parameters:
    archive - [in] target archive
  ...
  */
  ...
  /*
  Description:
    Overrides the pure virtual MYON_Object::DestroyRuntimeCache function.
    Saves the definition of this class in serial binary
    form that can be read by MYON_BezierVolue::Read.
  Parameters:
  ...
  */
  ...
  /*
  Description:
    Overrides virtual MYON_Geometry::Dimension function.
  ...
  */
  ...
  /*
  Description:
    Overrides virtual MYON_Geometry::Transform function.
  ...
  */
  ...
  /*
  Description:
    Overrides virtual MYON_Geometry::IsDeformable function.
  Returns:
  ...
  */
  ...
  /*
  Description:
    Overrides virtual MYON_Geometry::MakeDeformable function.
  Returns:
  ...
  */
  ...
  void EmergencyDestroy(); // call if memory used by MYON_NurbsCage becomes invalid
  ...
  Example:
          ...
          MYON_3dVector Dr = v + v_stride;
          MYON_3dVector Ds = v + 2*v_stride;
          MYON_3dVector Dt = v + 3*v_stride;

          // second order partial derivatives
          MYON_3dVector Drr = v + 4*v_stride;
          MYON_3dVector Drs = v + 5*v_stride;
          MYON_3dVector Drt = v + 6*v_stride;
          MYON_3dVector Dss = v + 7*v_stride;
          MYON_3dVector Dst = v + 8*v_stride;
          MYON_3dVector Dtt = v + 8*v_stride;

  Returns:
    True if successful
  See Also:
    MYON_NurbsCage::PointAt
  */
  bool Evaluate( 
         double r, 
         double s, 
  ...
  */
  ...
  MYON_NurbsSurface* IsoSurface(
         int dir,
         double c,
         MYON_NurbsSurface* srf = 0
         ) const;
  ...
  */
  ...
  Description:
    Expert user function to get a pointer to control vertex
    memory.  If you are not an expert user, please use
    MYON_NurbsCage::GetCV( MYON_3dPoint& ) or 
    MYON_NurbsCage::GetCV( MYON_4dPoint& ).
  Parameters:
  ...
  Remarks:
    ...
    euclidean point with length m_dim.
  See Also
    MYON_NurbsCage::CVStyle
    MYON_NurbsCage::GetCV
    MYON_NurbsCage::Weight
  */
  double* CV(
        int i,
        int j,
  ...
  */
  ...
  Parameters:
    ...
    knot_index - [in] 0 <= knot_index < KnotCount(dir)
  Returns:
    Value of knot or MYON_UNSET_VALUE if input parameters are not valid.
  */
  double Knot(
        int dir,
        int knot_index
...
MYON_DECL
bool MYON_GetCageXform( 
          const MYON_NurbsCage& cage, 
          MYON_Xform& cage_xform 
          );


class MYON_CLASS MYON_MorphControl : public MYON_Geometry
{
  MYON_OBJECT_DECLARE(MYON_MorphControl);

public:
  MYON_MorphControl();
  virtual ~MYON_MorphControl();
  ...
  */
  ...
  MYON_3dex MaxCVIndex() const;
  const double* CV(MYON_3dex) const;
  double Weight(MYON_3dex) const;
  ...
  */
  ...
  bool GetCageMorph( class MYON_CageMorph& cage_morph ) const;


  bool IsIdentity( const MYON_BoundingBox& bbox ) const;

  int m_varient; // 1= curve, 2 = surface, 3 = cage

  // The value of m_varient determines which nurbs object
  // controls the cage
  MYON_NurbsCurve   m_nurbs_curve0;
  MYON_NurbsCurve   m_nurbs_curve;
  MYON_Interval     m_nurbs_curve_domain;

  MYON_NurbsSurface m_nurbs_surface0;
  MYON_NurbsSurface m_nurbs_surface;
  MYON_Interval     m_nurbs_surface_domain[2];

  MYON_Xform        m_nurbs_cage0 = MYON_Xform::IdentityTransformation;
  MYON_NurbsCage    m_nurbs_cage;

  // Rhino captive object ids
  MYON_UuidList m_captive_id;

  // Use MYON_GetCageXform to set m_cage_xform.

  // Used to localize the deformation
  MYON_ClassArray<MYON_Localizer> m_localizers;

  // MYON_SpaceMorphOptions
...
class MYON_CLASS MYON_CageMorph : public MYON_SpaceMorph
{
public:
  MYON_CageMorph();
  virtual ~MYON_CageMorph();


  bool IsIdentity( const MYON_BoundingBox& bbox ) const override;

  const MYON_MorphControl* m_control;
};


// Description:
//   Get an MYON_NurbsSurface definition of a quadrilateral.
// Parameters:
//   P - [in]
//   Q - [in]
//   R - [in]
...
//       then this MYON_NurbsSurface is used to return
//       the quadrilateral.
// Returns:
//   An MYON_NurbsSurface representation of the quadrilateral.
MYON_DECL
MYON_NurbsSurface* MYON_NurbsSurfaceQuadrilateral( 
             ...
             MYON_NurbsSurface* nurbs_surface = nullptr
             );


#if defined(MYON_DLL_TEMPLATE)
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ClassArray<MYON_SimpleArray<MYON_3dPoint>>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>;
#endif
...
Description:
  Create an MYON_NurbsSurface satisfying Hermite interpolation conditions at a grid of points.
Remarks:
  See static MYON_NurbsSurface::CreateHermiteSurface for details.
*/
class MYON_CLASS MYON_HermiteSurface
{
public:
  MYON_HermiteSurface();
  // Constructs a u_count by v_count grid.
  MYON_HermiteSurface(int u_count, int v_count);
  ~MYON_HermiteSurface();
  ...
  MYON_3dPoint PointAt(int u, int v) const;
  void SetPointAt(int u, int v, const MYON_3dPoint& point);

  // Grid of "u" tangent directions (actually first derivatives) to interpolate.
  MYON_3dVector UTangentAt(int u, int v) const;
  void SetUTangentAt(int u, int v, const MYON_3dVector& dir);

  // Grid of "v" tangent directions (actually first derivatives) to interpolate.
  MYON_3dVector VTangentAt(int u, int v) const;
  void SetVTangentAt(int u, int v, const MYON_3dVector& dir);

  // Grid of twist vectors (mixed second partial derivatives) to interpolate.
  MYON_3dVector TwistAt(int u, int v) const;
  void SetTwistAt(int u, int v, const MYON_3dVector& dir);

  // Create an MYON_NurbsSurface satisfying Hermite interpolation conditions at a grid of points
  MYON_NurbsSurface* NurbsSurface(MYON_NurbsSurface* pNurbsSurface = nullptr);

public:
  // The "u" parameters defining the grid of parameter values.
  const MYON_SimpleArray<double>& UParameters() const;
  // The "v" parameters defining the grid of parameter values.
  const MYON_SimpleArray<double>& VParameters() const;
  // Grid of points to interpolate.
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dPoint>>& GridPoints() const;
  // Grid of "u" tangent directions (actually first derivatives) to interpolate.
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& UTangents() const;
  // Grid of "v" tangent directions (actually first derivatives) to interpolate.
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& VTangents() const;
  // Grid of twist vectors (mixed second partial derivatives) to interpolate.
  const MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>>& Twists() const;

private:
  int m_u_count;
  int m_v_count;
  MYON_SimpleArray<double> m_u_parameters;
  MYON_SimpleArray<double> m_v_parameters;
  MYON_ClassArray<MYON_SimpleArray<MYON_3dPoint>> m_grid_points;
  MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>> m_u_tangents;
  MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>> m_v_tangents;
  MYON_ClassArray<MYON_SimpleArray<MYON_3dVector>> m_twists;

private:
  MYON_HermiteSurface(const MYON_HermiteSurface&) = delete;
  MYON_HermiteSurface& operator=(const MYON_HermiteSurface&) = default;
...
#if defined(MYON_DLL_TEMPLATE)
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ClassArray<MYON_NurbsCurve>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ObjectArray<MYON_NurbsCurve>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<MYON_NurbsCurve*>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ClassArray<MYON_NurbsSurface>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ObjectArray<MYON_NurbsSurface>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<MYON_NurbsSurface*>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ClassArray<MYON_NurbsCage>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ObjectArray<MYON_NurbsCage>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<MYON_NurbsCage*>;
#endif
