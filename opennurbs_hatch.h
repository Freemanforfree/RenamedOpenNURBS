...
*/
class MYON_CLASS MYON_HatchLoop
{
public:
  ...
  MYON_HatchLoop();
  MYON_HatchLoop( MYON_Curve* pCurve2d, eLoopType type = ltOuter);
  MYON_HatchLoop( const MYON_HatchLoop& src);
  ~MYON_HatchLoop();

  MYON_HatchLoop& operator=( const MYON_HatchLoop& src);
  ...
  */
  ...
  Remarks:
    The curve is copied
  */
  bool SetCurve( const MYON_Curve& curve);
...
protected:
  friend class MYON_Hatch;
  eLoopType m_type;         // loop type flag - inner or outer
  MYON_Curve* m_p2dCurve;     // 2d closed curve bounding the hatch
...
/*
  ...
  MYON_HatchLine's are used by MYON_HatchPattern
...
class MYON_CLASS MYON_HatchLine
{
public:
  // Default constructor creates MYON_HatchLine::SolidHorizontal
  MYON_HatchLine() = default;
  ~MYON_HatchLine() = default;
  MYON_HatchLine(const MYON_HatchLine&) = default;
  MYON_HatchLine& operator=(const MYON_HatchLine&) = default;

  static const MYON_HatchLine Unset;           // angle = unset
  static const MYON_HatchLine SolidHorizontal; // angle = 0
  static const MYON_HatchLine SolidVertical;   // angle = pi/2
  ...
  bool operator==( const MYON_HatchLine&) const;
  bool operator!=( const MYON_HatchLine&) const;
...
public:
  bool Write( MYON_BinaryArchive&) const;  // serialize definition to binary archive
  bool Read( MYON_BinaryArchive&);  // restore definition from binary archive

private:
  bool WriteV5(MYON_BinaryArchive&) const;  // serialize definition to binary archive
  bool ReadV5(MYON_BinaryArchive&);  // restore definition from binary archive
...
public:
  ...
  */
  ...
  Return:
  */
  void SetBase( const MYON_2dPoint& base);
  ...
  */
  ...
  Return:
  */
  void SetOffset( const MYON_2dVector& offset);
  ...
  */
  void SetDashes( const MYON_SimpleArray<double>& dashes);

  const MYON_SimpleArray<double>& Dashes() const;
...
private:
  ...
  MYON_2dPoint m_base = MYON_2dPoint::Origin;
  MYON_2dVector m_offset = MYON_2dVector::ZeroVector;
  MYON_SimpleArray< double> m_dashes;
};
...
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<MYON_HatchLoop*>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ClassArray<MYON_HatchLine>;
#endif
...
/*
  ...
  The hatch  will be one of 
    MYON_Hatch::MYON_HatchPattern::HatchFillType::Lines     - pat file style definition
    MYON_Hatch::MYON_HatchPattern::HatchFillType::Gradient  - uses a color function
    MYON_Hatch::MYON_HatchPattern::HatchFillType::Solid     - uses entity color

*/
class MYON_CLASS MYON_HatchPattern : public MYON_ModelComponent
{
  MYON_OBJECT_DECLARE( MYON_HatchPattern);

public:
  MYON_HatchPattern() MYON_NOEXCEPT;
  ~MYON_HatchPattern() = default;
  MYON_HatchPattern(const MYON_HatchPattern&);
  MYON_HatchPattern& operator=(const MYON_HatchPattern&) = default;

public:
  static const MYON_HatchPattern Unset;   // index = MYON_UNSET_INT_INDEX, id = nil
  static const MYON_HatchPattern Solid; // index = -1, id set, unique and persistent
  static const MYON_HatchPattern Hatch1;    // index = -2, id set, unique and persistent
  static const MYON_HatchPattern Hatch2;    // index = -3, id set, unique and persistent
  static const MYON_HatchPattern Hatch3;    // index = -4, id set, unique and persistent
  static const MYON_HatchPattern HatchDash; // index = -5, id set, unique and persistent
  static const MYON_HatchPattern Grid;      // index = -6, id set, unique and persistent
  static const MYON_HatchPattern Grid60;    // index = -7, id set, unique and persistent
  static const MYON_HatchPattern Plus;      // index = -8, id set, unique and persistent
  static const MYON_HatchPattern Squares;   // index = -9, id set, unique and persistent
...
public:
  ...
  */
  static const MYON_HatchPattern* FromModelComponentRef(
...
public:
  ...
  static MYON_HatchPattern::HatchFillType HatchFillTypeFromUnsigned(
...
public:
  ...
  Parameters:
  */
  MYON_HatchPattern::HatchFillType FillType() const;
  ...
  */
  void SetFillType(
    MYON_HatchPattern::HatchFillType fill_type
    );
  ...
  */
  ...
  /*
  Description:
    Get the number of MYON_HatchLines in the pattern
  Parameters:
  Return:
    number of lines
  */
  ...
  /*
  Description:
    Add an MYON_HatchLine to the pattern
  Parameters:
  ...
  */
  int AddHatchLine( 
    const MYON_HatchLine& line
    );

  /*
  Description:
    Get the MYON_HatchLine at index
  Parameters:
  ...
  */
  const MYON_HatchLine* HatchLine(
    int index
    ) const;
  ...
  */
  int SetHatchLines(
    const MYON_ClassArray<MYON_HatchLine>& lines
    );
  ...
  const MYON_ClassArray<MYON_HatchLine>& HatchLines() const;

private:
  MYON_HatchPattern::HatchFillType m_type = MYON_HatchPattern::HatchFillType::Solid;
  
  MYON_wString m_description = MYON_wString::EmptyString;  // String description of the pattern

  // Represents a collection of MYON_HatchLine's to make a complete pattern
  ...
  MYON_ClassArray<MYON_HatchLine> m_lines; // used by line hatches
};

#if defined(MYON_DLL_TEMPLATE)
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<MYON_HatchPattern*>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_SimpleArray<const MYON_HatchPattern*>;
MYON_DLL_TEMPLATE template class MYON_CLASS MYON_ObjectArray<MYON_HatchPattern>;
#endif
...
/*
  ...
  The MYON_Hatch object manages the plane and loop array
  Fill definitions are in the MYON_HatchPattern or class derived from MYON_HatchPattern
  MYON_Hatch has an index to get the pattern definition from the pattern table

*/
class MYON_CLASS MYON_Hatch : public MYON_Geometry
{
  MYON_OBJECT_DECLARE( MYON_Hatch);

public:
  // Default constructor
  MYON_Hatch() = default;
  ~MYON_Hatch();
  MYON_Hatch( const MYON_Hatch&);
  MYON_Hatch& operator=(const MYON_Hatch&);

  static MYON_Hatch* HatchFromBrep(
...
private:
  ...
  void Internal_CopyFrom(const MYON_Hatch& src);
public:

  virtual MYON_Hatch* DuplicateHatch() const;
  ...
  */
  bool ScalePattern(MYON_Xform xform);
  ...
  Result:
  Returns a pointer to on MYON_Brep or nullptr.  If the brep
  ...
  See Also
  MYON_Geometry::HasBrepForm
  */
  class MYON_Brep* BrepForm(
      class MYON_Brep* brep = nullptr
    ) const override; 
  ...
  Parameters:
    plane [I] - MYON_Plane to make the hatch on
  ...
  */
  bool Create( const MYON_Plane& plane,
...
/*
  ...
  */
  ...
  Returns:
  */
  void AddLoop( MYON_HatchLoop* loop);
  ...
  */
  ...
  Returns:
    ...
    nullptr if index is out of range
  */
  const MYON_HatchLoop* Loop( int index) const;
  ...
  */
  MYON_Curve* LoopCurve3d( int index) const;
...
/*
  ...
  */
  void SetBasePoint(MYON_2dPoint basepoint);
  ...
  */
  void SetBasePoint(MYON_3dPoint point);
  ...
  */
  MYON_2dPoint BasePoint2d() const;
  ...
  */
  bool ReplaceLoops(MYON_SimpleArray<const MYON_Curve*>& loops);

  /*
  Description:
    Returns gradient fill type for this hatch
  */
  MYON_GradientType GetGradientType() const;
  
  /*
  Description:
    Set the gradient fill type for this hatch
  */
  void SetGradientType(MYON_GradientType gt);

  /*
  Description:
    Get list of color stops used for gradient drawing.
  */
  void GetGradientColors(MYON_SimpleArray<MYON_ColorStop>& colors) const;

  /*
  Description:
    Set list of color stops used for gradient drawing.
  */
  bool SetGradientColors(const MYON_SimpleArray<MYON_ColorStop>& colors);
  ...
  */
  void GetGradientEndPoints(MYON_3dPoint& startPoint, MYON_3dPoint& endPoint) const;

  /*
  Description:
    Set the start and end points for gradient drawing
  */
  bool SetGradientEndPoints(MYON_3dPoint startpoint, MYON_3dPoint endPoint);
...
private:
  ...
  MYON_SimpleArray<MYON_HatchLoop*> m_loops;
...
class MYON_CLASS MYON_CurveRegionBoundaryElement
{
public :
  MYON_CurveRegionBoundaryElement();
  MYON_CurveRegionBoundaryElement(const MYON_CurveRegionBoundaryElement& src);
  ~MYON_CurveRegionBoundaryElement();
  MYON_CurveRegionBoundaryElement& operator=(const MYON_CurveRegionBoundaryElement& src);
  int m_curve_id;
  MYON_Interval m_subdomain;
  bool m_bReversed;
};

//A list of curve subdomains that form a closed boundary with active space on the left.
typedef MYON_ClassArray<MYON_CurveRegionBoundaryElement> MYON_CurveRegionBoundary;
...
typedef MYON_ClassArray<MYON_CurveRegionBoundary> MYON_CurveRegion;
