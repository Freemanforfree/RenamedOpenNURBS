...
///////////////////////////////////////////////////////////////////////////////
class MYON_CLASS MYON_Viewport : public MYON_Geometry 
{
	MYON_OBJECT_DECLARE( MYON_Viewport );
public:
  ...
  static const MYON_3dPoint DefaultCameraLocation;     // (0.0,0.0,100.0)
  static const MYON_3dVector Default3dCameraDirection; // (-0.43301270189221932338186158537647,0.75,-0.5)

  /*
  Description:
    A Y-up parallel projection looking at the origin of the XYplane.
    up  =  MYON_3dVector::Yaxis, 
    dir = -MYON_3dVector::Zaxis
  */
  static const MYON_Viewport DefaultTopViewYUp;

  /*
  Description:
    A Z-up perspective projection looking down on the origin of the XY plane.
    up  = MYON_3dVector::Zaxis, 
    dir = MYON_3dVector:Default3dCameraDirection
  */
  static const MYON_Viewport DefaultPerspectiveViewZUp;

  // Construction
  // Default constructor creates a copy of MYON_Viewport::DefaultTopViewYUp;
	MYON_Viewport() = default;
  ~MYON_Viewport() = default;
	MYON_Viewport( const MYON_Viewport& ) = default;
	MYON_Viewport& operator=( const MYON_Viewport& ) = default;
  ...
  Parameters:
    destination - [in]
      ...
      into a viewport created by calling new MYON_Viewport().
  */
  MYON_Viewport* ShallowCopy(MYON_Viewport* destination) const;
  ...
  Returns:
    ...
    If two MYON_Viewport classes have identical values ViewProjectionContentHash(),
    then they will have identical view projection matrices and generate identical
    images from the same model content.
  */
  MYON_SHA1_Hash ViewProjectionContentHash() const;

  /*
  Returns:
    candidate_point.IsValid() 
    && candidate_point.MaximumCoordinate() < MYON_NONSENSE_WORLD_COORDINATE_VALUE;
  */
  ...
  Returns:
    ...
    && candidate_vector.MaximumCoordinate() < MYON_NONSENSE_WORLD_COORDINATE_VALUE
    && candidate_vector.MaximumCoordinate() > MYON_ZERO_TOLERANCE
    ;
  */
  ...
  */
  ...
  //
  // Remarks:
  //   This overrides the virtual MYON_Object::Dump() function.
  void Dump( 
    MYON_TextLog& // dump_target
    ) const override;

  // Description:
  //   Writes MYON_Viewport definition from a binary archive.
  //
  // Parameters:
  ...
  //
  // Remarks:
  //   This overrides the virtual MYON_Object::Write() function.
  bool Write(
  ...
  // Description:
  //   Reads MYON_Viewport definition from a binary archive.
  //
  // Parameters:
  //   binary_archive - [in] open binary archive
  //
  ...
  //
  // Remarks:
  //   This overrides the virtual MYON_Object::Read() function.
  bool Read(
         MYON_BinaryArchive&  // binary_archive
       ) override;
  ...
  //
  // Remarks:
  //   This is virtual MYON_Geometry function.
  ...
  //
  // Remarks:
  //   This overrides the virtual MYON_Geometry::Transform() function.
  bool Transform( 
  ...
  MYON_DEPRECATED_MSG("Use = MYON_Viewport::DefaultTopViewYUp")
  void Initialize();

  MYON::view_projection Projection() const;
  ...
  Parameters:
    projection - [in]
  See Also:
    MYON_Viewport::SetParallelProjection
    MYON_Viewport::SetPerpectiveProjection
    MYON_Viewport::SetTwoPointPerspectiveProjection    
  */
  bool SetProjection( MYON::view_projection projection );
  ...
  */
  ...
  Parameters:
    target_distance - [in]
      If MYON_UNSET_VALUE this parameter is ignored.  Otherwise
  ...
  */
  ...
  Parameters:
    ...
    up - [in]
      ...
      MYON_3dVector::ZeroVector if you want to use the world axis
  ...
  */
  ...
  /*
  Returns:
    True if the projection is MYON::perspective_view.
  */
  ...
  */
  ...
  /*
  Returns:
    True if the projection is MYON::parallel_view.
  */
  ...
  bool SetCameraLocation( const MYON_3dPoint& );
  bool SetCameraDirection( const MYON_3dVector& );
  bool SetCameraUp( const MYON_3dVector& );

  MYON_3dPoint CameraLocation() const;
  MYON_3dVector CameraDirection() const;
  MYON_3dVector CameraUp() const;
  ...
  */
  ...
  MYON_3dVector CameraX() const; // unit to right vector
  MYON_3dVector CameraY() const; // unit up vector
  MYON_3dVector CameraZ() const; // unit vector in -CameraDirection
  ...
  bool GetCameraExtents( 
      ...
      MYON_BoundingBox& cambbox, // bounding box in camera coordinates
  ...
  bool GetCameraExtents( 
      // returns bounding box in camera coordinates - this is useful information
      // for setting view frustrums to include the point list
      const MYON_BoundingBox&, // world coordinate bounding box
      MYON_BoundingBox& cambbox, // bounding box in camera coordinates
      int bGrowBox = false   // set to true if you want to enlarge an existing camera coordinate box
      ) const;
  ...
  bool GetCameraExtents( 
      // returns bounding box in camera coordinates - this is useful information
      // for setting view frustrums to include the point list
      MYON_3dPoint&,     // world coordinate bounding sphere center
      double,          // world coordinate bounding sphere radius
      MYON_BoundingBox& cambox, // bounding box in camera coordinates
      int bGrowBox = false     // set to true if you want to enlarge an existing camera coordinate box
      ) const;
  ...
  */
  ...
  Parameters:
    ...
    target_distance - [in]
      ...
      is MYON_UNSET_VALUE, this this parameter is ignored. 
      If the projection is perspective and target_distance 
      is not MYON_UNSET_VALUE, then it must be > 0.0 and
  ...
  */
  ...
  Parameters:
    ...
    bGrowNearFar - [in]
      ...
      are not MYON_UNSET_VALUE, the near_dist and far_dist
  ...
  */
  ...
  MYON_2iSize ScreenPortSize() const;
  ...
  bool GetXform( 
         ...
         MYON_Xform& matrix      // 4x4 transformation matrix (acts on the left)
         ) const;
  ...
  */
  ...
  bool Extents( 
         double half_view_angle,        // 1/2 smallest subtended view angle
                        // (0 < angle < pi/2)
         const MYON_BoundingBox& world_bbox// 3d world coordinate bounding box
         );
  bool Extents( 
         double half_view_angle,        // 1/2 smallest subtended view angle
                        // (0 < angle < pi/2)
         const MYON_3dPoint& center, // 3d world coordinate bounding sphere center
  ...
  bool DollyCamera( // Does not update frustum.  To update frustum use 
          ...
          const MYON_3dVector& dolly_vector // dolly vector in world coordinates
          );
  ...
  bool GetDollyCameraVector(
         ...
         MYON_3dVector& dolly_vector // world coordinate dolly vector returned here
         ) const;
  ...
  */
  MYON_Xform ClipModInverseXform() const;
  ...
  */
  ...
  Parameters:
    target_distance - [in]
      ...
      target_distanct.
      If target_distance == MYON_UNSET_VALUE and the frustum
  ...
  Returns:
    ...
    is not valid, then MYON_3dPoint::UnsetPoint is returned.
  */
  MYON_3dPoint FrustumCenterPoint( double target_distance ) const;
  ...
  Remarks:
    The default constructor sets this point on MYON_3dPoint::UnsetPoint.
  ...
  */
  ...
  Parameters:
    target_point - [in]
      When in doubt, the point returned by FrustumCenterPoint(MYON_UNSET_VALUE)
      is a good choice.
  Remarks:
    The default constructor sets this point on MYON_3dPoint::UnsetPoint.
    You must explicitly call one SetTargetPoint() functions to set
  ...
  */
  ...
  Parameters:
    bUseFrustumCenterFallback - [in]
      ...
      not valid, then MYON_UNSET_VALUE is returned.
  ...
  Returns:
    ...
    a positive value is returned.  MYON_UNSET_VALUE is returned
  ...
  */
  ...
  Remarks:
    ...
    manage them.
  */
  bool  SetViewportId(const MYON_UUID& viewport_id );

  MYON_UUID ViewportId(void) const;
  ...
  Parameters:
    viewport_id - [in]    
  */
  void ChangeViewportId(const MYON_UUID& viewport_id);
  ...
  Remarks:
    Each call to MYON_Viewport::InViewFrustum() requires the calculation
    ...
    if you set MYON_ClippingRegion.m_xform to the viewport's world-to-
    clipping coordinate transformation and then call the
    MYON_ClippingRegion::InViewFrustum() functions.
  */
  int InViewFrustum( 
    MYON_3dPoint P
    ) const;
...
protected:
  ...
  MYON::view_projection m_projection = MYON::parallel_view;
  ...
  MYON_3dPoint m_CamLoc  = MYON_Viewport::DefaultCameraLocation;  // camera location
  MYON_3dVector m_CamDir = -MYON_3dVector::ZAxis; // from camera towards view (nonzero and not parallel to m_CamUp)
  MYON_3dVector m_CamUp  = MYON_3dVector::YAxis;  // (nonzero and not parallel to m_CamDir)

  // The camera frame vectors are properly initialized by SetCamera()
  MYON_3dVector m_CamX = MYON_3dVector::XAxis;
  MYON_3dVector m_CamY = MYON_3dVector::YAxis;
  MYON_3dVector m_CamZ = MYON_3dVector::ZAxis;
  ...
  double m_frus_near = MYON_Viewport::DefaultMinNearDist; // 0 < frus_near < frus_far 
  double m_frus_far  = MYON_Viewport::DefaultFarDist;  
  ...
  // is MYON_3dPoint::UnsetPoint.
  MYON_3dPoint m_target_point = MYON_3dPoint::UnsetPoint;

private:
  // When this id matches the viewport id saved in an MYON_DisplayMaterialRef
  // list in MYON_3dmObjectAttributes, then the the display material is used
  ...
  */
  bool SetClipModXform( MYON_Xform clip_mod_xform );
  MYON_Xform m_clip_mods = MYON_Xform::IdentityTransformation;
  MYON_Xform m_clip_mods_inverse = MYON_Xform::IdentityTransformation;

  // Runtime values that depend on the graphics hardware being used.
  // These values are not saved in 3dm files.
  double m__MIN_NEAR_DIST = MYON_Viewport::DefaultMinNearDist;
  double m__MIN_NEAR_OVER_FAR = MYON_Viewport::DefaultMinNearOverFar;

private:
  mutable MYON_SHA1_Hash m_projection_content_sha1 = MYON_SHA1_Hash::ZeroDigest;
};
...
MYON_DECL
bool
MYON_ViewportFromRhinoView( // create MYON_Viewport from legacy Rhino projection info
...
MYON_DECL
bool
MYON_IntersectViewFrustumPlane(
