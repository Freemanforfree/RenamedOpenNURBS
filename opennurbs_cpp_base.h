...
class MYON_CLASS MYON_StopWatch
{
public:
  MYON_StopWatch() = default;
  ~MYON_StopWatch() = default;
  MYON_StopWatch(const MYON_StopWatch&) = default;
  MYON_StopWatch& operator=(const MYON_StopWatch&) = default;
...
public:
  ...
  */
  MYON_StopWatch::State CurrentState() const;
...
private:
  // current state
  MYON_StopWatch::State m_state = MYON_StopWatch::State::Off;
