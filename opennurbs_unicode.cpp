...
int MYON_IsValidUnicodeCodePoint(MYON__UINT32 u)
{
  if (u < 0xD800)
    return true;
...
bool MYON_IsPrivateUseUnicodeCodePoint(MYON__UINT32 unicode_code_point)
{
...
bool MYON_IsStandardUnicodeCodePoint(MYON__UINT32 unicode_code_point)
{
  return 
    0 != MYON_IsValidUnicodeCodePoint(unicode_code_point) 
    && MYON_UnicodeCodePoint::MYON_ByteOrderMark != unicode_code_point
    && false == MYON_IsPrivateUseUnicodeCodePoint(unicode_code_point)
    ;
}
...
)
{
  ...
  return
    MYON_UnicodeCodePoint::MYON_Space == u
    || MYON_UnicodeCodePoint::MYON_NoBreakSpace == u
    || MYON_UnicodeCodePoint::MYON_NarrowNoBreakSpace == u
    || MYON_UnicodeCodePoint::MYON_ZeroWidthSpace == u
    ;
}
...
int MYON_IsValidSingleElementUTF16Value(MYON__UINT32 c)
{
  return ((c <= 0xD7FF) || (c >= 0xE000 && c <= 0xFFFF));
}

int MYON_IsValidUTF16Singleton(MYON__UINT32 c)
{
  return ((c <= 0xD7FF) || (c >= 0xE000 && c <= 0xFFFF));
}
...
{
  return (MYON::endian::little_endian== MYON::Endian()) ? MYON_UTF_16LE : MYON_UTF_16BE;
}

enum MYON_UnicodeEncoding MYON_UnicodeNativeCPU_UTF32()
{
  return (MYON::endian::little_endian== MYON::Endian()) ? MYON_UTF_32LE : MYON_UTF_32BE;
}
...
#pragma MYON_PRAGMA_WARNING_DISABLE_MSC( 4127 )
  if (1 == sizeof(w))
    return MYON_IsValidSingleElementUTF8Value((MYON__UINT32)w);
  if (2 == sizeof(w))
    return MYON_IsValidSingleElementUTF16Value((MYON__UINT32)w);
  return MYON_IsValidUTF32Value((MYON__UINT32)w);
  ...
  )
{
  ...
  return MYON_UTF_unset;
}

unsigned int MYON_UTFSizeofByteOrderMark(
  MYON_UnicodeEncoding e
  )
{
...
static int MYON_IsUTF8ByteOrderMark(
  const char* sUTF8,
  int sUTF8_count
  )
{
...
static int MYON_DecodeUTF8Helper(
    const char* sUTF8,
    int sUTF8_count,
    MYON__UINT32* value,
    ...
    )
{
  ...
  int i0, i1;
  unsigned int error_status;
  MYON__UINT16 sUTF16[2];
  char c;

  MYON_UnicodeErrorParameters local_e = MYON_UnicodeErrorParameters::MaskErrors;
  if (nullptr == e)
    e = &local_e;
  ...
  // If any error conditions exist, then MYON_DecodeUTF8Helper()
  // is used.
  if ( 0 == (0x80 & sUTF8[0]) )
  {
  ...
  error_status = 0;
  u0 = 0xFFFFFFFF;
  i0 = MYON_DecodeUTF8Helper(sUTF8,sUTF8_count,&u0,&error_status);
  ...
  {
    i0 = 1;
    if ( MYON_IsValidUnicodeCodePoint(e->m_error_code_point) )
    {
  ...
  if ( MYON_IsValidUnicodeCodePoint(u0) && 8 == error_status )
  {
     ...
     )
  {
    ...
    u1 = 0xFFFFFFFF;
    i1 = MYON_DecodeUTF8Helper(sUTF8+i0,sUTF8_count-i0,&u1,&error_status);
    if ( i1 > 0 && (0 == error_status || 8 == error_status) )
    {
      error_status = 0;
      sUTF16[0] = (MYON__UINT16)u0;
      sUTF16[1] = (MYON__UINT16)u1;
      u0 = 0xFFFFFFFF;
      if ( 2 == MYON_ConvertUTF16ToUTF32(false,sUTF16,2,&u0,1,&error_status,0,0,0)
           && 0 == error_status
           && MYON_IsValidUnicodeCodePoint(u0)
         )
      {
        *unicode_code_point = u0;
        e->m_error_status |= 4;
...
int MYON_EncodeUTF16( MYON__UINT32 unicode_code_point, MYON__UINT16 sUTF16[2] )
{
  ...
  if ( unicode_code_point < 0xD800 )
  {
    ...
    // = UTF-16 values
    sUTF16[0] = (MYON__UINT16)unicode_code_point;
    return 1;
  }
  ...
  if ( unicode_code_point <= 0x10FFFF )
  {
    ...
    sUTF16[0] = (MYON__UINT16)(0xD800 + (unicode_code_point / 0x400)); // high surrogate value (0xD800 ... 0xDBFF)
    sUTF16[1] = (MYON__UINT16)(0xDC00 + (unicode_code_point & 0x3FF)); // low surrogate value (0xDC00 ... 0xDFFF)
    return 2;
  }
    ...
    )
{
  ...
  if ( 16 != (16 & e->m_error_mask) || !MYON_IsValidUnicodeCodePoint(e->m_error_code_point) )
  {
    // this error is not masked
    return 0;
  }
  ...
  )
{
  ...
  return MYON_DecodeUTF16(sUTF16,sUTF16_count,e,unicode_code_point);
#else
  return MYON_DecodeSwapByteUTF16(sUTF16,sUTF16_count,e,unicode_code_point);
#endif
}
...
{
#if defined(MYON_LITTLE_ENDIAN)
  return MYON_DecodeUTF32(sUTF32,sUTF32_count,e,unicode_code_point);
#else
  return MYON_DecodeSwapByteUTF32(sUTF32,sUTF32_count,e,unicode_code_point);
#endif
}
  ...
  )
{
  ...
  {
    if (MYON_IsValidUnicodeCodePoint(code_point))
    {
#if 1 == MYON_SIZEOF_WCHAR_T
      char sUTF8[6];
      rc = MYON_EncodeUTF8(code_point, sUTF8);
      ...
      MYON__UINT16 sUTF16[2];
      rc = MYON_EncodeUTF16(code_point, sUTF16);
      if (rc > (int)w_capacity)
        rc = 0;
      switch (rc)
      {
...
{
  const MYON_UnicodeEncoding widechar_encoding = MYON_WCHAR_T_ENCODING;
  int rc;
...
#if 1 == MYON_SIZEOF_WCHAR_T
  case MYON_UTF_8:
    rc = MYON_DecodeUTF8((const char*)sWideChar,sWideChar_count,e,unicode_code_point);
    break;

#elif 2 == MYON_SIZEOF_WCHAR_T
  case MYON_UTF_16:
    return MYON_DecodeUTF16((const MYON__UINT16*)sWideChar,sWideChar_count,e,unicode_code_point);
    break;

  case MYON_UTF_16BE:
    rc = MYON_DecodeUTF16BE((const MYON__UINT16*)sWideChar,sWideChar_count,e,unicode_code_point);
    break;

  case MYON_UTF_16LE:
    rc = MYON_DecodeUTF16LE((const MYON__UINT16*)sWideChar,sWideChar_count,e,unicode_code_point);
    break;

#elif 4 == MYON_SIZEOF_WCHAR_T
  case MYON_UTF_32:
    rc = MYON_DecodeUTF32((const MYON__UINT32*)sWideChar,sWideChar_count,e,unicode_code_point);
    break;

  case MYON_UTF_32BE:
    rc = MYON_DecodeUTF32BE((const MYON__UINT32*)sWideChar,sWideChar_count,e,unicode_code_point);
    break;

  case MYON_UTF_32LE:
    rc = MYON_DecodeUTF32LE((const MYON__UINT32*)sWideChar,sWideChar_count,e,unicode_code_point);
    break;
#endif
    ...
    )
{
  ...
  if ( bTestByteOrder && MYON_IsUTF8ByteOrderMark(sInputUTF8,sInputUTF8_count) )
  {
  ...
  {
    j = MYON_DecodeUTF8(sInputUTF8+i,sInputUTF8_count-i,&e,&u);
    if ( j <= 0 )
      break;
    k = MYON_EncodeUTF8(u,s);
    if ( 0 != sOutputUTF8 )
    {
    ...
    )
{
  ...
  if ( bTestByteOrder && MYON_IsUTF8ByteOrderMark(sUTF8,sUTF8_count) )
  {
    // skip UTF-8 byte order element
    sUTF8_count -= 3;
    sUTF8 += 3;
  ...
  {
    j = MYON_DecodeUTF8(sUTF8+i,sUTF8_count-i,&e,&u);
    if ( j <= 0 )
      break;
    k = MYON_EncodeUTF16(u,w);
    if ( 0 != sUTF16 )
    {
    ...
    )
{
  ...
  if ( bSwapBytes )
  {
    ...
    {
      j = MYON_DecodeSwapByteUTF16(sUTF16+i,sUTF16_count-i,&e,&u);
      if ( j <= 0 )
        break;
      k = MYON_EncodeUTF8(u,s);
      if ( 0 != sUTF8 )
  ...
  else
  {
    for ( i = 0; i < sUTF16_count; i += j )
    {
      j = MYON_DecodeUTF16(sUTF16+i,sUTF16_count-i,&e,&u);
      if ( j <= 0 )
        break;
      k = MYON_EncodeUTF8(u,s);
      if ( 0 != sUTF8 )
    ...
    )
{
  ...
  if ( bSwapBytes )
  {
    ...
    {
      j = MYON_DecodeSwapByteUTF16(sInputUTF16+i,sInputUTF16_count-i,&e,&u);
      if ( j <= 0 )
        break;
      k = MYON_EncodeUTF16(u,s);
      if ( 0 != sOutputUTF16 )
      {
  ...
  else
  {
    for ( i = 0; i < sInputUTF16_count; i += j )
    {
      j = MYON_DecodeUTF16(sInputUTF16+i,sInputUTF16_count-i,&e,&u);
      if ( j <= 0 )
        break;
      k = MYON_EncodeUTF16(u,s);
      if ( 0 != sOutputUTF16 )
...
static MYON__UINT32 SwapBytes32(MYON__UINT32 u)
{
  MYON__UINT8 b;
  MYON__UINT8* p = (MYON__UINT8*)&u;
  b = p[0]; p[0] = p[3]; p[3] = b;
  b = p[1]; p[1] = p[2]; p[2] = b;
  return u;
}
    ...
    )
{
  ...
  for ( i = 0; i < sUTF32_count; i++ )
  {
    ...
    if ( !MYON_IsValidUnicodeCodePoint(u) )
    {
      e.m_error_status |= 16;
    ...
    )
{
  ...
  if ( bSwapBytes )
  {
    for ( i = 0; i < sUTF16_count; i += j )
    {
      j = MYON_DecodeSwapByteUTF32(sUTF16+i,sUTF16_count-i,&e,&u);
      if ( j <= 0 )
        break;
      if ( 0 != sUTF32 )
      {
  ...
  else
  {
    for ( i = 0; i < sUTF16_count; i += j )
    {
      j = MYON_DecodeUTF32(sUTF16+i,sUTF16_count-i,&e,&u);
      if ( j <= 0 )
        break;
      if ( 0 != sUTF32 )
      {
    ...
    )
{
  ...
  case sizeof(MYON__UINT16):
    ...
    rc = MYON_ConvertUTF16ToUTF8(
            bTestByteOrder,
            (const MYON__UINT16*)sWideChar,sWideChar_count,
            sUTF8,sUTF8_count,
            error_status,error_mask,error_code_point,
            (const MYON__UINT16**)sNextWideChar
            );
    break;

  case sizeof(MYON__UINT32):
    // assume wchar_t strings are UTF-32 encoded
    rc = MYON_ConvertUTF32ToUTF8(
            bTestByteOrder,
            (const MYON__UINT32*)sWideChar,sWideChar_count,
            sUTF8,sUTF8_count,
            error_status,error_mask,error_code_point,
            (const MYON__UINT32**)sNextWideChar
            );
    break;
    ...
    )
{
  ...
  case sizeof(char):
    // assume wchar_t strings are UTF-8 encoded
    rc = MYON_ConvertUTF8ToUTF16(
            bTestByteOrder,
            (const char*)sWideChar,sWideChar_count,
            (MYON__UINT16*)sUTF16,sUTF16_count,
            error_status,error_mask,error_code_point,
            (const char**)sNextWideChar
            );
    break;
    ...
    )
{
  ...
  case sizeof(MYON__UINT16):
    ...
    rc = MYON_ConvertUTF8ToUTF16(
            bTestByteOrder,
            sUTF8,sUTF8_count,
            (MYON__UINT16*)sWideChar,sWideChar_count,
            error_status,error_mask,error_code_point,
            sNextUTF8
            );
    break;
  ...
  case sizeof(MYON__UINT32):
    ...
    rc = MYON_ConvertUTF8ToUTF32(
            bTestByteOrder,
            sUTF8,sUTF8_count,
            (MYON__UINT32*)sWideChar,sWideChar_count,
            error_status,error_mask,error_code_point,
            sNextUTF8
            );
    break;
    ...
    )
{
  ...
  case sizeof(char):
    ...
    rc = MYON_ConvertUTF16ToUTF8(
            bTestByteOrder,
            (const MYON__UINT16*)sUTF16,sUTF16_count,
            (char*)sWideChar,sWideChar_count,
            error_status,error_mask,error_code_point,
            (const MYON__UINT16**)sNextUTF16
            );
    ...
    )
{
  ...
  case sizeof(char):
    ...
    rc = MYON_ConvertUTF32ToUTF8(
            bTestByteOrder,
            (const MYON__UINT32*)sUTF32,sUTF32_count,
            (char*)sWideChar,sWideChar_count,
            error_status,error_mask,error_code_point,
            (const MYON__UINT32**)sNextUTF32
            );
...
const MYON_wString MYON_wString::FromUnicodeCodePoint(
  MYON__UINT32 code_point
)
{
  return MYON_wString::FromUnicodeCodePoints(&code_point, 1, MYON_UnicodeCodePoint::MYON_ReplacementCharacter);
}


const MYON_wString MYON_wString::FromUnicodeCodePoints(
  const MYON__UINT32* code_points,
  int code_point_count,
  MYON__UINT32 error_code_point
)
{
  const bool bErrorCodePointIsValid = MYON_IsValidUnicodeCodePoint(error_code_point);
  ...
  if (-1 == code_point_count)
  {
    ...
    while (0 != code_points[code_point_count])
    {
      if (
        ...
        && false == MYON_IsValidUnicodeCodePoint(code_points[code_point_count])
        )
      {
        break;
      }
  ...
  int wchar_count = MYON_ConvertUTF32ToWideChar(
    bTestByteOrder,
    code_points,
    code_point_count,
    nullptr,
  ...
  error_status = 0;
  wchar_count = MYON_ConvertUTF32ToWideChar(
    bTestByteOrder,
    code_points,
    code_point_count,
    a,
...
////int MYON_ConvertWindowsCodePageValueToWideChar(
////  int windows_code_page,
////  MYON__UINT32 code_page_character_value,
////  size_t w_capacity,
////  wchar_t* w
////)
////{
...
////  memset(&e, 0, sizeof(e));
////  e.m_error_mask = 0xFF;
////  e.m_error_code_point = MYON_UnicodeCodePoint::MYON_ReplacementCharacter;
////  MYON_DecodeWindowsCodePageValue( windows_code_page, code_page_character_value,  &e,  &unicode_code_point);
////  return MYON_EncodeWideChar(unicode_code_point, w_capacity, w);
////}
...
static int MYON_Internal_ConvertMSSBCPToWideChar(
  const MYON__UINT32* sb_code_page_0x80_to_0xFF_to_unicode,
  const char* sMBCS,
  int sMBCS_count,
  wchar_t* sWideChar,
...
)
{
  ...
  {
    const MYON__UINT32 c = (unsigned char)sMBCS[i];
    MYON__UINT32 unicode_code_point;
    if (c < 0x80)
    ...
    else
    {
      if (c <= 0xFF && nullptr != sb_code_page_0x80_to_0xFF_to_unicode )
      {
        ...
        if (0 == MYON_IsValidUnicodeCodePoint(unicode_code_point))
          unicode_code_point = MYON_UnicodeCodePoint::MYON_ReplacementCharacter;
      }
      else
        unicode_code_point = MYON_UnicodeCodePoint::MYON_ReplacementCharacter;
    ...
    const int w_count = MYON_EncodeWideChar(unicode_code_point, sizeof(w_buffer)/sizeof(w_buffer[0]), w_buffer);
    if (w_count <= 0)
    {
      e |= 16;
      continue;
    ...
    )
{
  ...
  const MYON__UINT32* sb_code_page_0x80_to_0xFF_to_unicode = MYON_MSSBCP_0x80_0xFF_Unicode(windows_code_page);
  if (nullptr != sb_code_page_0x80_to_0xFF_to_unicode)
  {
    ...
    return MYON_Internal_ConvertMSSBCPToWideChar(
  ...
  for (int i = 0; i < sWideChar_count; i++)
  {
    ...
    if ( MYON_wString::ReplacementCharacter == sWideChar[i] )
    {
      if ( nullptr != error_status)
        *error_status |= 16;
    }
  ...
  {
    MYON_ERROR("No Apple CFStringEncoding support for this value of windows_code_page");
    return 0;
  }
  ...
  for (;;)
  {
    ...
    if (nullptr == str)
    {
      MYON_ERROR("[NSString stringWithCString: sMBCS encoding: nsEncoding] failed.");
      break;
    }
    ...
    for (int i = 0; i < len; i++)
    {
      ...
      if (u1 >= 0xD800U && u1 < 0xDC00 && i+1 < len)
      {
        ...
        unicode_code_point = MYON_DecodeUTF16SurrogatePair((unsigned int)u1, (unsigned int)u2, MYON_wString::ReplacementCharacter);
        if (MYON_wString::ReplacementCharacter != unicode_code_point)
          i++;
      }
      else
      {
      ...
      if (
        false == MYON_IsValidUnicodeCodePoint(unicode_code_point)
        || MYON_wString::ReplacementCharacter == unicode_code_point
        )
      {
        unicode_code_point = MYON_wString::ReplacementCharacter;
        if (nullptr != error_status)
          *error_status |= 16;
      }
      if (nullptr != sWideChar && sWideChar_capacity > 0)
...
int MYON_wString::ByteOrder(wchar_t bom_candidate)
{
  if (MYON_UnicodeCodePoint::MYON_ByteOrderMark == bom_candidate)
    return 1;
  if (MYON_UnicodeCodePoint::MYON_ByteOrderMark == MYON_wString::SwapByteOrder(bom_candidate))
    return -1;
  return 0;
}

wchar_t MYON_wString::SwapByteOrder(wchar_t w)
{
...
)
{
  ...
  const int byte_order_mark = (nullptr != sWideChar && sWideChar_count > 0) ? MYON_wString::ByteOrder(sWideChar[0]) : 0;
  if (0 != byte_order_mark)
  {
    ...
    while (sWideChar_count > 0 && 0 != MYON_wString::ByteOrder(sWideChar[0]))
    {
    ...
    if (-1 == byte_order_mark)
    {
      ...
      for (int i = 0; i < sWideChar_count; ++i)
        swappedWideChar[i] = MYON_wString::SwapByteOrder(sWideChar[i]);
      swappedWideChar[sWideChar_count] = 0;
      if (0 == MYON_wString::ByteOrder(swappedWideChar[0]))
      {
        // The 0 == MYON_wString::ByteOrder(swappedWideChar[0]) condition insures we will not recurse again.
        const int rc = MYON_ConvertWideCharToMSMBCP(swappedWideChar, sWideChar_count, windows_code_page, sMBCS, sMBCS_capacity, error_status);
      ...
      else
      {
        ...
        MYON_ERROR("A bug was added after May 2021.");
        onfree(swappedWideChar);
      }
    }
  }
  ...
  if (utf8_code_page == windows_code_page)
  {
    ...
    return MYON_ConvertWideCharToUTF8(false, sWideChar, sWideChar_count, sMBCS, sMBCS_capacity, error_status, error_mask, MYON_UnicodeCodePoint::MYON_ReplacementCharacter, nullptr);
  }
  ...
  // Add support for other platforms as needed.
  MYON_ERROR("Time to figure out how to create Windows code page encodings in MacOS");
  return 0;
#else
  // Add support for other platforms as needed.
  return 0;
...
const MYON_String MYON_wString::MultiByteEncode(int windows_code_page) const
{
  unsigned int error_status0 = 0;
  const int sChar_count0 = MYON_ConvertWideCharToMSMBCP(
    this->Array(),
    this->Length(),
    windows_code_page,
  ...
  const int sChar_count1 = MYON_ConvertWideCharToMSMBCP(
    this->Array(),
    this->Length(),
    windows_code_page,
    s.Array(),
...
const MYON_wString MYON_String::MultiByteDecode(int windows_code_page) const
{
  unsigned int error_status0 = 0;
...
unsigned MYON_UnicodeSubscriptFromDigit(unsigned decimal_digit)
{
...
unsigned MYON_UnicodeSuperscriptFromDigit(unsigned decimal_digit)
{
...
const char* MYON_Big5CodePoint::Decode(
  const char* buffer,
  size_t buffer_count,
  bool bParseNull,
  bool bParseASCII,
...
)
{
  ...
  for (;;)
  {
    ...
    if (0 == buffer[0])
    {
      if (bParseNull)
      {
        *big5_code_point = MYON_Big5CodePoint::Null;
        return buffer + 1;
      }
      break;
    }
    ...
    if (buffer[0] > 0 && buffer[0] <= 0x7F)
    {
      if (bParseASCII)
      {
        *big5_code_point = MYON_Big5CodePoint::Create((MYON__UINT16)buffer[0]);
        return buffer + 1;
      }
      break;
    }
    ...
    if (buffer_count < 2)
      break;
    const MYON__UINT16 db[2] = { ((const unsigned char*)buffer)[0], ((const unsigned char*)buffer)[1] };
    if (
      (db[0] >= 0x81 && db[0] <= 0xFE) 
      &&
      ...
      )
    {
      ...
      *big5_code_point = MYON_Big5CodePoint::Create(db[0] * 0x100 + db[1]);
      return buffer + 2;
    }
  ...
  *big5_code_point = MYON_Big5CodePoint::Error;
  return nullptr;
}

int MYON_Big5CodePoint::Encode(
  char* buffer,
...
) const
{
  ...
  if (IsValid(true, true))
  {
    ...
    MYON_ERROR("Bug in tis if() scope.");    
  }
...
const MYON_Big5CodePoint MYON_Big5CodePoint::Create(unsigned int big5_code_point)
{
  if (big5_code_point > 0xFFFF)
    return MYON_Big5CodePoint::Error;
  MYON_Big5CodePoint cp;
  cp.m_big5_code_point = (big5_code_point <= 0xFFFF) ? ((MYON__UINT16)big5_code_point) : ((MYON__UINT16)0xFFFF);
  return (cp.IsValid(true, true) || 0xFFFF==cp.m_big5_code_point) ? cp : MYON_Big5CodePoint::Error;
}

bool MYON_Big5CodePoint::IsNull() const
{
  return 0 == m_big5_code_point;
}

bool MYON_Big5CodePoint::IsASCII(bool bNullIsASCII) const
{
...
bool MYON_Big5CodePoint::IsValid(bool bNullIsValid, bool bASCIICodePointIsValid) const
{
  if (0 == m_big5_code_point)
  ...
  if (m_big5_code_point >= 0xA3C0 && m_big5_code_point <= 0xA3FE)
  {
    ...
    // The primary use of MYON_Big5CodePoint is to convert legacy BIG5 encoded information
    // into Unicode encoded information and MYON_Big5CodePoint supports this legacy Windows mapping. 
    if (0xA3E1 != m_big5_code_point)
      return false; // reserved for future use
  }

  const MYON__UINT16 db[2] = { (MYON__UINT16)(m_big5_code_point / 0x100U), (MYON__UINT16)(m_big5_code_point % 0x100U) };
  return
...
bool MYON_Big5CodePoint::IsStandard(bool bNullIsValid, bool bASCIICodePointIsValid) const
{
...
bool MYON_Big5CodePoint::IsPrivateUse() const
{
...
unsigned int MYON_Big5CodePoint::Big5CodePoint() const
{
  return m_big5_code_point;
}

int MYON_Big5CodePoint::Compare(const MYON_Big5CodePoint* lhs, const MYON_Big5CodePoint* rhs)
{
...
bool operator==(MYON_Big5CodePoint lhs, MYON_Big5CodePoint rhs)
{
  return 0 == MYON_Big5CodePoint::Compare(&lhs, &rhs);
}
...
bool operator<=(MYON_Big5CodePoint lhs, MYON_Big5CodePoint rhs)
{
  return MYON_Big5CodePoint::Compare(&lhs, &rhs) <= 0;
}
...
const MYON_UnicodeShortCodePoint MYON_UnicodeShortCodePoint::Create(unsigned int unicode_code_point)
{
  MYON_UnicodeShortCodePoint cp;
  cp.m_unicode_code_point
    = (0xFFFE == unicode_code_point || MYON_IsValidUnicodeCodePoint(unicode_code_point))
      ? ((MYON__UINT16)unicode_code_point)
      : ((MYON__UINT16)0xFFFFU)
    ;
  return cp;
}

bool MYON_UnicodeShortCodePoint::IsNull() const
{
  return 0 == m_unicode_code_point;
}

bool MYON_UnicodeShortCodePoint::IsASCII(bool bNullIsASCII) const
{
...
bool MYON_UnicodeShortCodePoint::IsValid(bool bNullIsValid, bool bByteOrderMarkIsValid) const
{
  if (0 == m_unicode_code_point)
    return bNullIsValid ? true : false;
  ...
  return MYON_IsValidUnicodeCodePoint(m_unicode_code_point);
}

bool MYON_UnicodeShortCodePoint::IsStandard(bool bNullIsValid) const
{
  if (IsValid(bNullIsValid,false))
    return MYON_IsStandardUnicodeCodePoint(m_unicode_code_point);

  return false;
}

bool MYON_UnicodeShortCodePoint::IsPrivateUse() const
{
  return MYON_IsPrivateUseUnicodeCodePoint(m_unicode_code_point);
}

unsigned int MYON_UnicodeShortCodePoint::UnicodeCodePoint() const
{
  return m_unicode_code_point;
}

bool MYON_UnicodeShortCodePoint::IsReplacementCharacter() const
{
  return 0xFFFD == m_unicode_code_point;
}

bool MYON_UnicodeShortCodePoint::IsByteOrderMark() const
{
  return 0xFFFE == m_unicode_code_point;
}


int MYON_UnicodeShortCodePoint::Compare(const MYON_UnicodeShortCodePoint* lhs, const MYON_UnicodeShortCodePoint* rhs)
{
...
bool operator==(MYON_UnicodeShortCodePoint lhs, MYON_UnicodeShortCodePoint rhs)
{
  return 0 == MYON_UnicodeShortCodePoint::Compare(&lhs, &rhs);
}
...
bool operator<=(MYON_UnicodeShortCodePoint lhs, MYON_UnicodeShortCodePoint rhs)
{
  return MYON_UnicodeShortCodePoint::Compare(&lhs, &rhs) <= 0;
}
...
const MYON_Big5UnicodePair MYON_Big5UnicodePair::Create(
  MYON_Big5CodePoint big5_code_point,
  MYON_UnicodeShortCodePoint unicode_code_point
)
{
  MYON_Big5UnicodePair p;
...
{
  return MYON_Big5UnicodePair::Create(MYON_Big5CodePoint::Create(big5_code_point), MYON_UnicodeShortCodePoint::Create(unicode_code_point));
}


bool MYON_Big5UnicodePair::IsNull() const
{
  return m_big5.IsNull() && m_unicode.IsNull();
}

bool MYON_Big5UnicodePair::IsASCII(bool bNullIsASCII) const
{
  return m_big5.IsASCII(bNullIsASCII) && m_big5.Big5CodePoint() == m_unicode.UnicodeCodePoint();
}

bool MYON_Big5UnicodePair::IsValid(bool bNullIsValid, bool bASCIICodePointIsValid) const
{
...
const MYON_Big5CodePoint MYON_Big5UnicodePair::Big5() const
{
  return m_big5;
}

const MYON_UnicodeShortCodePoint MYON_Big5UnicodePair::Unicode() const
{
  return m_unicode;
}

unsigned int MYON_Big5UnicodePair::Big5CodePoint() const
{
  return m_big5.Big5CodePoint();
}

unsigned int MYON_Big5UnicodePair::UnicodeCodePoint() const
{
  return m_unicode.UnicodeCodePoint();
}

bool MYON_Big5UnicodePair::IsStandard(bool bNullIsValid, bool bASCIICodePointIsStandard) const
{
  const unsigned big5_code_point = m_big5.Big5CodePoint();
  if (0 == big5_code_point)
    return bNullIsValid ? IsNull() : false;
...
bool MYON_Big5UnicodePair::IsPrivateUse() const
{
  return IsValid(false, false) && (m_big5.IsPrivateUse() || m_unicode.IsPrivateUse());
}


int MYON_Big5UnicodePair::CompareBig5CodePoint(const MYON_Big5UnicodePair* lhs, const MYON_Big5UnicodePair* rhs)
{
...
int MYON_Big5UnicodePair::CompareUnicodeCodePoint(const MYON_Big5UnicodePair* lhs, const MYON_Big5UnicodePair* rhs)
{
...
int MYON_Big5UnicodePair::CompareBig5AndUnicodeCodePoints(const MYON_Big5UnicodePair* lhs, const MYON_Big5UnicodePair* rhs)
{
  int rc = MYON_Big5UnicodePair::CompareBig5CodePoint(lhs, rhs);
  if (0 == rc)
    rc = MYON_Big5UnicodePair::CompareUnicodeCodePoint(lhs, rhs);
  return rc;
}

int MYON_Big5UnicodePair::CompareUnicodeAndBig5CodePoints(const MYON_Big5UnicodePair* lhs, const MYON_Big5UnicodePair* rhs)
{
  int rc = MYON_Big5UnicodePair::CompareUnicodeCodePoint(lhs, rhs);
  if (0 == rc)
    rc = MYON_Big5UnicodePair::CompareBig5CodePoint(lhs, rhs);
  return rc;
}

bool operator==(MYON_Big5UnicodePair lhs, MYON_Big5UnicodePair rhs)
{
  return 0 == MYON_Big5UnicodePair::CompareBig5AndUnicodeCodePoints(&lhs, &rhs);
}
...
const MYON_Big5CodePoint MYON_Big5CodePoint::CreateFromUnicode(
  unsigned int unicode_code_point,
  MYON_Big5CodePoint not_avilable
)
{
  if (unicode_code_point > 0xFFFF)
    return MYON_IsValidUnicodeCodePoint(unicode_code_point) ? not_avilable : MYON_Big5CodePoint::Error;

  return MYON_Big5CodePoint::CreateFromUnicode(MYON_UnicodeShortCodePoint::Create(unicode_code_point), not_avilable);
}

const MYON_Big5CodePoint MYON_Big5CodePoint::CreateFromUnicode(
  const MYON_UnicodeShortCodePoint& unicode_code_point,
  MYON_Big5CodePoint not_avilable
)
{
  if (unicode_code_point.IsASCII(true))
    return MYON_Big5CodePoint::Create(unicode_code_point.UnicodeCodePoint()); // ASCII code point
  ...
  const MYON_Big5UnicodePair key = MYON_Big5UnicodePair::Create(MYON_Big5CodePoint::Null, unicode_code_point);
  const int i = unicode_to_big5.BinarySearch(&key, MYON_Big5UnicodePair::CompareUnicodeCodePoint);
  if (i >= 0)
  {
    const MYON_Big5UnicodePair pair = unicode_to_big5[i];
...
const MYON_UnicodeShortCodePoint MYON_UnicodeShortCodePoint::CreateFromBig5(
  unsigned int big5_code_point,
  MYON_UnicodeShortCodePoint not_avilable
)
{
  return MYON_UnicodeShortCodePoint::CreateFromBig5(MYON_Big5CodePoint::Create(big5_code_point), not_avilable);
}

const MYON_UnicodeShortCodePoint MYON_UnicodeShortCodePoint::CreateFromBig5(
  const MYON_Big5CodePoint& big5_code_point,
  MYON_UnicodeShortCodePoint not_avilable
)
{
  if (big5_code_point.IsASCII(true))
    return MYON_UnicodeShortCodePoint::Create(big5_code_point.Big5CodePoint()); // ASCII code point

  if (false == big5_code_point.IsValid(false, false))
    return MYON_UnicodeShortCodePoint::Error;

  const MYON_SimpleArray<MYON_Big5UnicodePair>& big5_to_unicode = MYON_Big5UnicodePair::Big5ToUnicode();

  const MYON_Big5UnicodePair key = MYON_Big5UnicodePair::Create(big5_code_point, MYON_UnicodeShortCodePoint::Null);
  const int i = big5_to_unicode.BinarySearch(&key, MYON_Big5UnicodePair::CompareBig5CodePoint);
  if (i >= 0)
  {
    const MYON_Big5UnicodePair pair = big5_to_unicode[i];
...
const MYON_SimpleArray< MYON_Big5UnicodePair >& MYON_Big5UnicodePair::Big5ToUnicode()
{
  ...
  static const MYON__UINT16 pairs[][2] = {
  ...
  {0xA260,0x74e9}, // <CJK>
  {0xA261,0x7cce}, // <CJK>
  {0xA262,0x2581}, // LOWER MYONE EIGHTH BLOCK
  {0xA263,0x2582}, // LOWER MYONE QUARTER BLOCK
  ...
  {0xA26A,0x258f}, // LEFT MYONE EIGHTH BLOCK
  {0xA26B,0x258e}, // LEFT MYONE QUARTER BLOCK
  ...
  {0xA2B0,0xff11}, // FULLWIDTH DIGIT MYONE
  ...
  {0xA2B9,0x2160}, // ROMAN NUMERAL MYONE
  ...
  {0xA2C3,0x3021}, // HANGZHOU NUMERAL MYONE
  ...
  {0xC7E9,0x2460}, // CIRCLED DIGIT MYONE
  ...
  {0xC7F3,0x2474}, // PARENTHESIZED DIGIT MYONE
  ...
  static MYON_SimpleArray< MYON_Big5UnicodePair > big5_to_unicode;
  ...
  const MYON_SleepLockGuard getlock(lock);
  if (big5_to_unicode.Capacity() > 0)
  {
  ...
  {
    const MYON_Big5UnicodePair pair = MYON_Big5UnicodePair::Create(MYON_Big5CodePoint::Create(pairs[i][0]), MYON_UnicodeShortCodePoint::Create(pairs[i][1]));
    ...
    else
    {
      ...
      MYON_ERROR("pairs[][2] is no longer valid.");
    }
  }
...
const MYON_SimpleArray< MYON_Big5UnicodePair >& MYON_Big5UnicodePair::UnicodeToBig5()
{
  static MYON_SleepLock lock;
  static MYON_SimpleArray< MYON_Big5UnicodePair > unicode_to_big5;
  ...
  MYON_MemoryAllocationTracking debug_memory_tracking(false);


  const MYON_Big5UnicodePair u_big5_pair_fix[][2] =
  {
    ...
    {MYON_Big5UnicodePair::Create(0xA2CC,0x5341),MYON_Big5UnicodePair::Create(0xA2CC,0x3038)},
    ...
    {MYON_Big5UnicodePair::Create(0xA2CE,0x5345),MYON_Big5UnicodePair::Create(0xA2CE,0x303A)},
  };

  const MYON_Big5UnicodePair u_big5_pair_add[] =
  {
    ...
    MYON_Big5UnicodePair::Create(0xA2CD,0x3039),
  };
  ...
  unicode_to_big5.QuickSortAndRemoveDuplicates(MYON_Big5UnicodePair::CompareUnicodeAndBig5CodePoints);
  if (count0 != unicode_to_big5.Count())
  {
    MYON_ERROR("Input parameter MYON_Big5UnicodePair::Big5ToUnicode() returned corrupt information.");
  }
  ...
  {
    const MYON_Big5UnicodePair key = u_big5_pair_fix[i][0];
    const MYON_Big5UnicodePair fix = u_big5_pair_fix[i][1];
    fixdex[i]
      = (key.Unicode() != fix.Unicode() && key.Big5() == fix.Big5())
      ? unicode_to_big5.BinarySearch(&key, MYON_Big5UnicodePair::CompareUnicodeAndBig5CodePoints)
      : -1;
  }
  ...
  unicode_to_big5.QuickSortAndRemoveDuplicates(MYON_Big5UnicodePair::CompareUnicodeCodePoint);
  if (count1 != unicode_to_big5.UnsignedCount())
  {
    MYON_ERROR("Invalid fixes or additions to unicodeto_big5[].");
  }
