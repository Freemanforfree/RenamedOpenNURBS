...
class MYON_CLASS MYON_SurfaceProxy : public MYON_Surface
{
public:
...
public:
  MYON_SurfaceProxy();
  MYON_SurfaceProxy(const MYON_Surface*);
  MYON_SurfaceProxy(const MYON_SurfaceProxy&);
  MYON_SurfaceProxy& operator=(const MYON_SurfaceProxy&);

  virtual ~MYON_SurfaceProxy();

  void SetProxySurface( const MYON_Surface* proxy_surface );
  const MYON_Surface* ProxySurface() const;
...
public:
  ...
  */
  MYON_Surface* DuplicateSurface() const override;
  ...
  */
  ...
  // override virtual MYON_Surface::IsIsoparametric
  MYON_Surface::ISO IsIsoparametric(
...
private:
  ...
  MYON_OBJECT_DECLARE(MYON_SurfaceProxy);
};
